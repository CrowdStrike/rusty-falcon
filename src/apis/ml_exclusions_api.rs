...
pub async fn create_ml_exclusions_v1(configuration: &configuration::Configuration, body: models::ExclusionsCreateReqV1) -> Result<models::ExclusionsRespV1, Error<CreateMlExclusionsV1Error>> {
...
pub async fn delete_ml_exclusions_v1(configuration: &configuration::Configuration, ids: Vec<String>, comment: Option<&str>) -> Result<models::ExclusionsRespV1, Error<DeleteMlExclusionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_ml_exclusions_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ExclusionsRespV1, Error<GetMlExclusionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn query_ml_exclusions_v1(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::MsaQueryResponse, Error<QueryMlExclusionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn update_ml_exclusions_v1(configuration: &configuration::Configuration, body: models::SvExclusionsUpdateReqV1) -> Result<models::ExclusionsRespV1, Error<UpdateMlExclusionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
