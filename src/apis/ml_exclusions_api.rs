...
pub async fn create_ml_exclusions_v1(configuration: &configuration::Configuration, body: models::ExclusionsPeriodCreateReqV1) -> Result<models::ExclusionsPeriodRespV1, Error<CreateMlExclusionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/policy/entities/ml-exclusions/v1", configuration.base_path);
...
pub async fn delete_ml_exclusions_v1(configuration: &configuration::Configuration, ids: Vec<String>, comment: Option<&str>) -> Result<models::ExclusionsPeriodRespV1, Error<DeleteMlExclusionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_ml_exclusions_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ExclusionsPeriodRespV1, Error<GetMlExclusionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn query_ml_exclusions_v1(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::MsaPeriodQueryResponse, Error<QueryMlExclusionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_offset = offset;
    let p_limit = limit;
    ...
    let uri_str = format!("{}/policy/queries/ml-exclusions/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn update_ml_exclusions_v1(configuration: &configuration::Configuration, body: models::SvExclusionsPeriodUpdateReqV1) -> Result<models::ExclusionsPeriodRespV1, Error<UpdateMlExclusionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
