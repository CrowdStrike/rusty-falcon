...
pub async fn get_credentials_mixin0(configuration: &configuration::Configuration, ) -> Result<models::ModelsRegistryCredentialsResponse, Error<GetCredentialsMixin0Error>> {
