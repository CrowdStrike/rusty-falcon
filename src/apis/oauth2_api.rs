...
pub async fn oauth2_access_token(configuration: &configuration::Configuration, client_id: &str, client_secret: &str, member_cid: Option<&str>) -> Result<models::DomainAccessTokenResponseV1, Error<Oauth2AccessTokenError>> {
...
pub async fn oauth2_revoke_token(configuration: &configuration::Configuration, token: &str, client_id: Option<&str>) -> Result<models::MsaspecResponseFields, Error<Oauth2RevokeTokenError>> {
    // add a prefix to parameters to efficiently prevent name collisions
