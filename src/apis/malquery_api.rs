...
pub async fn get_mal_query_metadata_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::MalquerySampleMetadataResponse, Error<GetMalQueryMetadataV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_mal_query_quotas_v1(configuration: &configuration::Configuration, ) -> Result<models::MalqueryRateLimitsResponse, Error<GetMalQueryQuotasV1Error>> {
...
pub async fn get_mal_query_request_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::MalqueryRequestResponse, Error<GetMalQueryRequestV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn post_mal_query_entities_samples_multidownload_v1(configuration: &configuration::Configuration, body: models::MalqueryMultiDownloadRequestV1) -> Result<models::MalqueryExternalQueryResponse, Error<PostMalQueryEntitiesSamplesMultidownloadV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn post_mal_query_exact_search_v1(configuration: &configuration::Configuration, body: models::MalqueryExternalExactSearchParametersV1) -> Result<models::MalqueryExternalQueryResponse, Error<PostMalQueryExactSearchV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn post_mal_query_fuzzy_search_v1(configuration: &configuration::Configuration, body: models::MalqueryFuzzySearchParametersV1) -> Result<models::MalqueryFuzzySearchResponse, Error<PostMalQueryFuzzySearchV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn post_mal_query_hunt_v1(configuration: &configuration::Configuration, body: models::MalqueryExternalHuntParametersV1) -> Result<models::MalqueryExternalQueryResponse, Error<PostMalQueryHuntV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
