...
pub async fn get_sensor_usage_weekly(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ApiPeriodWeeklyAverageResponse, Error<GetSensorUsageWeeklyError>> {
