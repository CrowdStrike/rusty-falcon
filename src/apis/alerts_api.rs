...
pub enum PostAggregatesAlertsV1Error {
    Status400(crate::models::ApiPeriodAggregatesResponse),
    Status403(crate::models::MsaPeriodReplyMetaOnly),
    Status429(crate::models::MsaPeriodReplyMetaOnly),
    Status500(crate::models::ApiPeriodAggregatesResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum PostEntitiesAlertsV1Error {
    Status400(crate::models::DetectsapiPeriodPostEntitiesAlertsV1Response),
    Status403(crate::models::MsaPeriodReplyMetaOnly),
    Status429(crate::models::MsaPeriodReplyMetaOnly),
    Status500(crate::models::DetectsapiPeriodPostEntitiesAlertsV1Response),
    UnknownValue(serde_json::Value),
}
...
pub async fn get_queries_alerts_v1(
    ...
    filter: Option<&str>,
    q: Option<&str>,
) -> Result<crate::models::MsaspecPeriodQueryResponse, Error<GetQueriesAlertsV1Error>> {
...
pub async fn patch_entities_alerts_v2(
    configuration: &configuration::Configuration,
    body: crate::models::DetectsapiPeriodPatchEntitiesAlertsV2Request,
) -> Result<crate::models::MsaspecPeriodResponseFields, Error<PatchEntitiesAlertsV2Error>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ApiPeriodAggregatesResponse, Error<PostAggregatesAlertsV1Error>> {
    let local_var_configuration = configuration;
...
pub async fn post_entities_alerts_v1(
    configuration: &configuration::Configuration,
    body: crate::models::DetectsapiPeriodPostEntitiesAlertsV1Request,
) -> Result<
    crate::models::DetectsapiPeriodPostEntitiesAlertsV1Response,
