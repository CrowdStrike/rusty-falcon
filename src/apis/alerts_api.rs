...
pub async fn get_queries_alerts_v1(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::DetectsapiAlertQueryResponse, Error<GetQueriesAlertsV1Error>> {
...
pub async fn get_queries_alerts_v2(configuration: &configuration::Configuration, include_hidden: Option<bool>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::DetectsapiAlertQueryResponse, Error<GetQueriesAlertsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn patch_entities_alerts_v2(configuration: &configuration::Configuration, body: models::DetectsapiPatchEntitiesAlertsV2Request) -> Result<models::DetectsapiResponseFields, Error<PatchEntitiesAlertsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn patch_entities_alerts_v3(configuration: &configuration::Configuration, body: models::DetectsapiPatchEntitiesAlertsV3Request, include_hidden: Option<bool>) -> Result<models::DetectsapiResponseFields, Error<PatchEntitiesAlertsV3Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_query_include_hidden = include_hidden;
...
pub async fn post_aggregates_alerts_v1(configuration: &configuration::Configuration, body: Vec<models::DetectsapiAggregateAlertQueryRequest>) -> Result<models::DetectsapiAggregatesResponse, Error<PostAggregatesAlertsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn post_aggregates_alerts_v2(configuration: &configuration::Configuration, body: Vec<models::DetectsapiAggregateAlertQueryRequest>, include_hidden: Option<bool>) -> Result<models::DetectsapiAggregatesResponse, Error<PostAggregatesAlertsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_query_include_hidden = include_hidden;
...
pub async fn post_combined_alerts_v1(configuration: &configuration::Configuration, body: models::DetectsapiPostCombinedAlertsV1RequestSwagger) -> Result<models::DetectsapiPostCombinedAlertsV1ResponseSwagger, Error<PostCombinedAlertsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn post_entities_alerts_v1(configuration: &configuration::Configuration, body: models::DetectsapiPostEntitiesAlertsV1Request) -> Result<models::DetectsapiPostEntitiesAlertsV1ResponseSwagger, Error<PostEntitiesAlertsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn post_entities_alerts_v2(configuration: &configuration::Configuration, body: models::DetectsapiPostEntitiesAlertsV2Request, include_hidden: Option<bool>) -> Result<models::DetectsapiPostEntitiesAlertsV2ResponseSwagger, Error<PostEntitiesAlertsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_query_include_hidden = include_hidden;
