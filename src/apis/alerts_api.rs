...
pub async fn get_queries_alerts_v1(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::DetectsapiPeriodAlertQueryResponse, Error<GetQueriesAlertsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
...
pub async fn get_queries_alerts_v2(configuration: &configuration::Configuration, include_hidden: Option<bool>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::DetectsapiPeriodAlertQueryResponse, Error<GetQueriesAlertsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn patch_entities_alerts_v2(configuration: &configuration::Configuration, body: models::DetectsapiPeriodPatchEntitiesAlertsV2Request) -> Result<models::DetectsapiPeriodResponseFields, Error<PatchEntitiesAlertsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn patch_entities_alerts_v3(configuration: &configuration::Configuration, body: models::DetectsapiPeriodPatchEntitiesAlertsV3Request, include_hidden: Option<bool>) -> Result<models::DetectsapiPeriodResponseFields, Error<PatchEntitiesAlertsV3Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
    let p_include_hidden = include_hidden;
...
pub async fn post_aggregates_alerts_v1(configuration: &configuration::Configuration, body: Vec<models::DetectsapiPeriodAggregateAlertQueryRequest>) -> Result<models::DetectsapiPeriodAggregatesResponse, Error<PostAggregatesAlertsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn post_aggregates_alerts_v2(configuration: &configuration::Configuration, body: Vec<models::DetectsapiPeriodAggregateAlertQueryRequest>, include_hidden: Option<bool>) -> Result<models::DetectsapiPeriodAggregatesResponse, Error<PostAggregatesAlertsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
    let p_include_hidden = include_hidden;
...
pub async fn post_combined_alerts_v1(configuration: &configuration::Configuration, body: models::DetectsapiPeriodPostCombinedAlertsV1RequestSwagger) -> Result<models::DetectsapiPeriodPostCombinedAlertsV1ResponseSwagger, Error<PostCombinedAlertsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn post_entities_alerts_v1(configuration: &configuration::Configuration, body: models::DetectsapiPeriodPostEntitiesAlertsV1Request) -> Result<models::DetectsapiPeriodPostEntitiesAlertsV1ResponseSwagger, Error<PostEntitiesAlertsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn post_entities_alerts_v2(configuration: &configuration::Configuration, body: models::DetectsapiPeriodPostEntitiesAlertsV2Request, include_hidden: Option<bool>) -> Result<models::DetectsapiPeriodPostEntitiesAlertsV2ResponseSwagger, Error<PostEntitiesAlertsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
    let p_include_hidden = include_hidden;
