...
pub async fn entities_states_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DevicecontentapiEntitiesResponseV1, Error<EntitiesStatesV1Error>> {
...
pub async fn queries_states_v1(configuration: &configuration::Configuration, limit: Option<i32>, sort: Option<&str>, offset: Option<i32>, filter: Option<&str>) -> Result<models::DevicecontentapiQueryResponseV1, Error<QueriesStatesV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
