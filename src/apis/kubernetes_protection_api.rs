...
pub async fn create_aws_account(configuration: &configuration::Configuration, body: models::K8sregCreateAwsAccReq) -> Result<models::K8sregCreateAwsAccResp, Error<CreateAwsAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/kubernetes-protection/entities/accounts/aws/v1", configuration.base_path);
...
pub async fn create_azure_subscription(configuration: &configuration::Configuration, body: models::K8sregCreateAzureSubReq) -> Result<models::MsaBaseEntitiesResponse, Error<CreateAzureSubscriptionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/kubernetes-protection/entities/accounts/azure/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn delete_aws_accounts_mixin0(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::MsaspecMetaInfo, Error<DeleteAwsAccountsMixin0Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn delete_azure_subscription(configuration: &configuration::Configuration, ids: Option<Vec<String>>) -> Result<models::MsaBaseEntitiesResponse, Error<DeleteAzureSubscriptionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn find_containers_by_container_run_time_version(configuration: &configuration::Configuration, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::ModelsContainerRuntimePivotResponse, Error<FindContainersByContainerRunTimeVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/container-security/aggregates/containers/find-by-runtimeversion/v1", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FindContainersByContainerRunTimeVersionError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn find_containers_count_affected_by_zero_day_vulnerabilities(configuration: &configuration::Configuration, ) -> Result<models::CommonCountResponse, Error<FindContainersCountAffectedByZeroDayVulnerabilitiesError>> {

    let uri_str = format!("{}/container-security/aggregates/containers/count-by-zero-day/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FindContainersCountAffectedByZeroDayVulnerabilitiesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_aws_accounts_mixin0(configuration: &configuration::Configuration, ids: Option<Vec<String>>, is_horizon_acct: Option<&str>, status: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::K8sregGetAwsAccountsResp, Error<GetAwsAccountsMixin0Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_azure_install_script(configuration: &configuration::Configuration, id: Option<&str>, subscription_id: Option<Vec<String>>) -> Result<models::K8sregGetAzureBashScriptResp, Error<GetAzureInstallScriptError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    let p_query_subscription_id = subscription_id;

    let uri_str = format!("{}/kubernetes-protection/entities/user-script/azure/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if let Some(ref param_value) = p_query_subscription_id {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("subscription_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("subscription_id", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
...
pub async fn get_azure_tenant_config(configuration: &configuration::Configuration, ids: Option<Vec<String>>, limit: Option<i32>, offset: Option<i32>) -> Result<models::K8sregGetAzureTenantConfigResp, Error<GetAzureTenantConfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_query_limit = limit;
    let p_query_offset = offset;

    let uri_str = format!("{}/kubernetes-protection/entities/config/azure/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_azure_tenant_ids(configuration: &configuration::Configuration, ids: Option<Vec<String>>, status: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::K8sregGetAzureTenantInfoResp, Error<GetAzureTenantIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_query_status = status;
    let p_query_limit = limit;
    ...
    let uri_str = format!("{}/kubernetes-protection/entities/tenants/azure/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_clusters(configuration: &configuration::Configuration, cluster_names: Option<Vec<String>>, status: Option<Vec<String>>, account_ids: Option<Vec<String>>, locations: Option<Vec<String>>, cluster_service: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::K8sregGetClustersResp, Error<GetClustersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/kubernetes-protection/entities/kubernetes/clusters/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_query_cluster_names {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("cluster_names".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("cluster_names", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_status {
        req_builder = match "csv" {
    ...
    if let Some(ref param_value) = p_query_locations {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("locations".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("locations", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
...
pub async fn get_combined_cloud_clusters(configuration: &configuration::Configuration, locations: Option<Vec<String>>, ids: Option<Vec<String>>, cluster_service: Option<Vec<String>>, cluster_status: Option<Vec<String>>, limit: Option<i32>, offset: Option<i32>) -> Result<models::K8sregListClusterCloudResp, Error<GetCombinedCloudClustersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_locations = locations;
    let p_query_ids = ids;
    let p_query_cluster_service = cluster_service;
    ...
    let uri_str = format!("{}/kubernetes-protection/entities/cloud_cluster/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if let Some(ref param_value) = p_query_cluster_service {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("cluster_service".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("cluster_service", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_cluster_status {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("cluster_status".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("cluster_status", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_limit {
        req_builder = req_builder.query(&[("limit", &param_value.to_string())]);
...
pub async fn get_helm_values_yaml(configuration: &configuration::Configuration, cluster_name: &str, is_self_managed_cluster: Option<bool>) -> Result<serde_json::Value, Error<GetHelmValuesYamlError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_cluster_name = cluster_name;
    let p_query_is_self_managed_cluster = is_self_managed_cluster;

    let uri_str = format!("{}/kubernetes-protection/entities/integration/agent/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_locations(configuration: &configuration::Configuration, clouds: Option<Vec<String>>) -> Result<models::K8sregGetLocationsResp, Error<GetLocationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_clouds = clouds;

    let uri_str = format!("{}/kubernetes-protection/entities/cloud-locations/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_query_clouds {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("clouds".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("clouds", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
...
pub async fn get_static_scripts(configuration: &configuration::Configuration, ) -> Result<models::K8sregGetScriptsResp, Error<GetStaticScriptsError>> {

    let uri_str = format!("{}/kubernetes-protection/entities/gen/scripts/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn group_containers_by_managed(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsContainerCoverageResponseEntity, Error<GroupContainersByManagedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/containers/group-by-managed/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_azure_accounts(configuration: &configuration::Configuration, ids: Option<Vec<String>>, subscription_id: Option<Vec<String>>, status: Option<&str>, is_horizon_acct: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::K8sregGetAzureSubscriptionsResp, Error<ListAzureAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_query_subscription_id = subscription_id;
    let p_query_status = status;
...
pub async fn patch_azure_service_principal(configuration: &configuration::Configuration, id: &str, client_id: &str) -> Result<models::K8sregGetAzureTenantConfigResp, Error<PatchAzureServicePrincipalError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    let p_query_client_id = client_id;

    let uri_str = format!("{}/kubernetes-protection/entities/service-principal/azure/v1", configuration.base_path);
...
pub async fn post_search_kubernetes_iom_entities(configuration: &configuration::Configuration, body: models::K8siomsSearchRequest, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>) -> Result<models::K8siomsSearchResponse, Error<PostSearchKubernetesIomEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_query_filter = filter;
    let p_query_sort = sort;
    ...
    let uri_str = format!("{}/container-security/combined/kubernetes-ioms/search/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostSearchKubernetesIomEntitiesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn read_cluster_combined(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ModelsClusterEntityResponse, Error<ReadClusterCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_limit = limit;
    ...
    let uri_str = format!("{}/container-security/combined/clusters/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_cluster_combined_v2(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, include_counts: Option<bool>, limit: Option<i32>, offset: Option<i32>) -> Result<models::V2ClusterEntityResponseV2, Error<ReadClusterCombinedV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    ...
    let uri_str = format!("{}/container-security/combined/clusters/v2", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_cluster_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CommonCountResponse, Error<ReadClusterCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/clusters/count/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_cluster_enrichment(configuration: &configuration::Configuration, cluster_id: Vec<String>, filter: Option<&str>) -> Result<models::K8sassetsClusterEnrichmentResponse, Error<ReadClusterEnrichmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_cluster_id = cluster_id;
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/enrichment/clusters/entities/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    req_builder = match "csv" {
        "multi" => req_builder.query(&p_query_cluster_id.into_iter().map(|p| ("cluster_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("cluster_id", &p_query_cluster_id.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    if let Some(ref param_value) = p_query_filter {
        req_builder = req_builder.query(&[("filter", &param_value.to_string())]);
    }
...
pub async fn read_clusters_by_date_range_count(configuration: &configuration::Configuration, ) -> Result<models::ModelsAggregateValuesByFieldResponse, Error<ReadClustersByDateRangeCountError>> {

    let uri_str = format!("{}/container-security/aggregates/clusters/count-by-date/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_clusters_by_kubernetes_version_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsAggregateValuesByFieldResponse, Error<ReadClustersByKubernetesVersionCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/clusters/count-by-kubernetes-version/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ReadClustersByKubernetesVersionCountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn read_clusters_by_status_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsAggregateValuesByFieldResponse, Error<ReadClustersByStatusCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/clusters/count-by-status/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_container_combined(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ModelsContainerEntityResponse, Error<ReadContainerCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_limit = limit;
    ...
    let uri_str = format!("{}/container-security/combined/containers/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_container_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CommonCountResponse, Error<ReadContainerCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/containers/count/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_container_count_by_registry(configuration: &configuration::Configuration, under_assessment: Option<bool>, limit: Option<i32>, filter: Option<&str>) -> Result<models::ModelsApiFilterResponse, Error<ReadContainerCountByRegistryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_under_assessment = under_assessment;
    let p_query_limit = limit;
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/containers/count-by-registry/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_container_enrichment(configuration: &configuration::Configuration, container_id: Vec<String>, filter: Option<&str>) -> Result<models::K8sassetsContainerEnrichmentResponse, Error<ReadContainerEnrichmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_container_id = container_id;
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/enrichment/containers/entities/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    req_builder = match "csv" {
        "multi" => req_builder.query(&p_query_container_id.into_iter().map(|p| ("container_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("container_id", &p_query_container_id.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    if let Some(ref param_value) = p_query_filter {
        req_builder = req_builder.query(&[("filter", &param_value.to_string())]);
    }
...
pub async fn read_container_image_detections_count_by_date(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsApiFilterResponse, Error<ReadContainerImageDetectionsCountByDateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/containers/image-detections-count-by-date/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ReadContainerImageDetectionsCountByDateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn read_container_images_by_most_used(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsAggregateValuesByFieldResponse, Error<ReadContainerImagesByMostUsedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/images/most-used/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ReadContainerImagesByMostUsedError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn read_container_images_by_state(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsApiFilterResponse, Error<ReadContainerImagesByStateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/containers/images-by-state/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_container_vulnerabilities_by_severity_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsAggregateValuesByFieldResponse, Error<ReadContainerVulnerabilitiesBySeverityCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/containers/vulnerability-count-by-severity/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ReadContainerVulnerabilitiesBySeverityCountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn read_containers_by_date_range_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsAggregateValuesByFieldResponse, Error<ReadContainersByDateRangeCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/containers/count-by-date/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ReadContainersByDateRangeCountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn read_containers_sensor_coverage(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsAggregateValuesByFieldResponse, Error<ReadContainersSensorCoverageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/containers/sensor-coverage/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_deployment_combined(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ModelsDeploymentEntityResponse, Error<ReadDeploymentCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_limit = limit;
    ...
    let uri_str = format!("{}/container-security/combined/deployments/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_deployment_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CommonCountResponse, Error<ReadDeploymentCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/deployments/count/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_deployment_enrichment(configuration: &configuration::Configuration, deployment_id: Vec<String>, filter: Option<&str>) -> Result<models::K8sassetsDeploymentEnrichmentResponse, Error<ReadDeploymentEnrichmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_deployment_id = deployment_id;
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/enrichment/deployments/entities/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    req_builder = match "csv" {
        "multi" => req_builder.query(&p_query_deployment_id.into_iter().map(|p| ("deployment_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("deployment_id", &p_query_deployment_id.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    if let Some(ref param_value) = p_query_filter {
        req_builder = req_builder.query(&[("filter", &param_value.to_string())]);
    }
...
pub async fn read_deployments_by_date_range_count(configuration: &configuration::Configuration, ) -> Result<models::ModelsAggregateValuesByFieldResponse, Error<ReadDeploymentsByDateRangeCountError>> {

    let uri_str = format!("{}/container-security/aggregates/deployments/count-by-date/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ReadDeploymentsByDateRangeCountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn read_distinct_container_image_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsApiFilterResponse, Error<ReadDistinctContainerImageCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/images/count-by-distinct/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ReadDistinctContainerImageCountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn read_kubernetes_iom_by_date_range(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::K8siomsKubernetesIomFieldValue, Error<ReadKubernetesIomByDateRangeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/kubernetes-ioms/count-by-date/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_kubernetes_iom_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::K8siomsKubernetesIomCountValue, Error<ReadKubernetesIomCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/kubernetes-ioms/count/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_kubernetes_iom_entities(configuration: &configuration::Configuration, ids: Option<Vec<String>>) -> Result<models::K8siomsKubernetesIomEntityResponse, Error<ReadKubernetesIomEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;

    let uri_str = format!("{}/container-security/entities/kubernetes-ioms/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_namespace_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CommonCountResponse, Error<ReadNamespaceCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/namespaces/count/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_namespaces_by_date_range_count(configuration: &configuration::Configuration, ) -> Result<models::ModelsAggregateValuesByFieldResponse, Error<ReadNamespacesByDateRangeCountError>> {

    let uri_str = format!("{}/container-security/aggregates/namespaces/count-by-date/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ReadNamespacesByDateRangeCountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn read_node_combined(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ModelsNodeEntityResponse, Error<ReadNodeCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_limit = limit;
    ...
    let uri_str = format!("{}/container-security/combined/nodes/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_node_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CommonCountResponse, Error<ReadNodeCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/nodes/count/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_node_enrichment(configuration: &configuration::Configuration, node_name: Vec<String>, filter: Option<&str>) -> Result<models::K8sassetsNodeEnrichmentResponse, Error<ReadNodeEnrichmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_node_name = node_name;
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/enrichment/nodes/entities/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    req_builder = match "csv" {
        "multi" => req_builder.query(&p_query_node_name.into_iter().map(|p| ("node_name".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("node_name", &p_query_node_name.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    if let Some(ref param_value) = p_query_filter {
        req_builder = req_builder.query(&[("filter", &param_value.to_string())]);
    }
...
pub async fn read_nodes_by_cloud_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsAggregateValuesByFieldResponse, Error<ReadNodesByCloudCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/nodes/count-by-cloud/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_nodes_by_container_engine_version_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsAggregateValuesByFieldResponse, Error<ReadNodesByContainerEngineVersionCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/nodes/count-by-container-engine-version/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ReadNodesByContainerEngineVersionCountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn read_nodes_by_date_range_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsAggregateValuesByFieldResponse, Error<ReadNodesByDateRangeCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/nodes/count-by-date/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_pod_combined(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ModelsPodEntityResponse, Error<ReadPodCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_limit = limit;
    ...
    let uri_str = format!("{}/container-security/combined/pods/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_pod_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CommonCountResponse, Error<ReadPodCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/pods/count/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_pod_enrichment(configuration: &configuration::Configuration, pod_id: Vec<String>, filter: Option<&str>) -> Result<models::K8sassetsPodEnrichmentResponse, Error<ReadPodEnrichmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_pod_id = pod_id;
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/enrichment/pods/entities/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    req_builder = match "csv" {
        "multi" => req_builder.query(&p_query_pod_id.into_iter().map(|p| ("pod_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("pod_id", &p_query_pod_id.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    if let Some(ref param_value) = p_query_filter {
        req_builder = req_builder.query(&[("filter", &param_value.to_string())]);
    }
...
pub async fn read_pods_by_date_range_count(configuration: &configuration::Configuration, ) -> Result<models::ModelsAggregateValuesByFieldResponse, Error<ReadPodsByDateRangeCountError>> {

    let uri_str = format!("{}/container-security/aggregates/pods/count-by-date/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_running_container_images(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ModelsContainerImage, Error<ReadRunningContainerImagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_limit = limit;
    ...
    let uri_str = format!("{}/container-security/combined/container-images/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_vulnerable_container_image_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsApiFilterResponse, Error<ReadVulnerableContainerImageCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/containers/count-vulnerable-images/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ReadVulnerableContainerImageCountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn regenerate_api_key(configuration: &configuration::Configuration, ) -> Result<models::K8sregRegenApiKeyResp, Error<RegenerateApiKeyError>> {

    let uri_str = format!("{}/kubernetes-protection/entities/integration/api-key/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn search_and_read_kubernetes_iom_entities(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::K8siomsKubernetesIomEntityResponse, Error<SearchAndReadKubernetesIomEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_limit = limit;
    ...
    let uri_str = format!("{}/container-security/combined/kubernetes-ioms/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SearchAndReadKubernetesIomEntitiesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn search_kubernetes_ioms(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::CommonGenericEntityResponseLeftSquareBracketStringRightSquareBracket, Error<SearchKubernetesIomsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_limit = limit;
    ...
    let uri_str = format!("{}/container-security/queries/kubernetes-ioms/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn trigger_scan(configuration: &configuration::Configuration, scan_type: &str) -> Result<models::MsaBaseEntitiesResponse, Error<TriggerScanError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_scan_type = scan_type;

    let uri_str = format!("{}/kubernetes-protection/entities/scan/trigger/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn update_aws_account(configuration: &configuration::Configuration, ids: Vec<String>, region: Option<&str>) -> Result<models::MsaBaseEntitiesResponse, Error<UpdateAwsAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
