...
pub async fn create_aws_account(configuration: &configuration::Configuration, body: models::K8sregPeriodCreateAwsAccReq) -> Result<models::K8sregPeriodCreateAwsAccResp, Error<CreateAwsAccountError>> {
...
pub async fn create_azure_subscription(configuration: &configuration::Configuration, body: models::K8sregPeriodCreateAzureSubReq) -> Result<models::MsaPeriodBaseEntitiesResponse, Error<CreateAzureSubscriptionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn delete_aws_accounts_mixin0(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::MsaspecPeriodMetaInfo, Error<DeleteAwsAccountsMixin0Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn delete_azure_subscription(configuration: &configuration::Configuration, ids: Option<Vec<String>>) -> Result<models::MsaPeriodBaseEntitiesResponse, Error<DeleteAzureSubscriptionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn find_containers_by_container_run_time_version(configuration: &configuration::Configuration, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::ModelsPeriodContainerRuntimePivotResponse, Error<FindContainersByContainerRunTimeVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    let p_offset = offset;
    let p_sort = sort;
...
pub async fn find_containers_count_affected_by_zero_day_vulnerabilities(configuration: &configuration::Configuration, ) -> Result<models::CommonPeriodCountResponse, Error<FindContainersCountAffectedByZeroDayVulnerabilitiesError>> {
...
pub async fn get_aws_accounts_mixin0(configuration: &configuration::Configuration, ids: Option<Vec<String>>, is_horizon_acct: Option<&str>, status: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::K8sregPeriodGetAwsAccountsResp, Error<GetAwsAccountsMixin0Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_azure_install_script(configuration: &configuration::Configuration, id: Option<&str>, subscription_id: Option<Vec<String>>) -> Result<models::K8sregPeriodGetAzureBashScriptResp, Error<GetAzureInstallScriptError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn get_azure_tenant_config(configuration: &configuration::Configuration, ids: Option<Vec<String>>, limit: Option<i32>, offset: Option<i32>) -> Result<models::K8sregPeriodGetAzureTenantConfigResp, Error<GetAzureTenantConfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
    let p_limit = limit;
    let p_offset = offset;
...
pub async fn get_azure_tenant_ids(configuration: &configuration::Configuration, ids: Option<Vec<String>>, status: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::K8sregPeriodGetAzureTenantInfoResp, Error<GetAzureTenantIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
    let p_status = status;
    let p_limit = limit;
...
pub async fn get_clusters(configuration: &configuration::Configuration, cluster_names: Option<Vec<String>>, status: Option<Vec<String>>, account_ids: Option<Vec<String>>, locations: Option<Vec<String>>, cluster_service: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::K8sregPeriodGetClustersResp, Error<GetClustersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_locations(configuration: &configuration::Configuration, clouds: Option<Vec<String>>) -> Result<models::K8sregPeriodGetLocationsResp, Error<GetLocationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_clouds = clouds;
...
pub async fn get_static_scripts(configuration: &configuration::Configuration, ) -> Result<models::K8sregPeriodGetScriptsResp, Error<GetStaticScriptsError>> {
...
pub async fn group_containers_by_managed(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsPeriodContainerCoverageResponseEntity, Error<GroupContainersByManagedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn list_azure_accounts(configuration: &configuration::Configuration, ids: Option<Vec<String>>, subscription_id: Option<Vec<String>>, status: Option<&str>, is_horizon_acct: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::K8sregPeriodGetAzureSubscriptionsResp, Error<ListAzureAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
    let p_subscription_id = subscription_id;
    let p_status = status;
...
pub async fn patch_azure_service_principal(configuration: &configuration::Configuration, id: &str, client_id: &str) -> Result<models::K8sregPeriodGetAzureTenantConfigResp, Error<PatchAzureServicePrincipalError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn read_cluster_combined(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ModelsPeriodClusterEntityResponse, Error<ReadClusterCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_sort = sort;
    let p_limit = limit;
...
pub async fn read_cluster_combined_v2(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, include_counts: Option<bool>, limit: Option<i32>, offset: Option<i32>) -> Result<models::V2PeriodClusterEntityResponseV2, Error<ReadClusterCombinedV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_sort = sort;
...
pub async fn read_cluster_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CommonPeriodCountResponse, Error<ReadClusterCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_cluster_enrichment(configuration: &configuration::Configuration, cluster_id: Vec<String>, filter: Option<&str>) -> Result<models::K8sassetsPeriodClusterEnrichmentResponse, Error<ReadClusterEnrichmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    req_builder = match "csv" {
        "multi" => req_builder.query(&p_cluster_id.into_iter().map(|p| ("cluster_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("cluster_id", &p_cluster_id.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    if let Some(ref param_value) = p_filter {
        req_builder = req_builder.query(&[("filter", &param_value.to_string())]);
    }
...
pub async fn read_clusters_by_date_range_count(configuration: &configuration::Configuration, ) -> Result<models::ModelsPeriodAggregateValuesByFieldResponse, Error<ReadClustersByDateRangeCountError>> {
...
pub async fn read_clusters_by_kubernetes_version_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsPeriodAggregateValuesByFieldResponse, Error<ReadClustersByKubernetesVersionCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_clusters_by_status_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsPeriodAggregateValuesByFieldResponse, Error<ReadClustersByStatusCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_container_combined(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ModelsPeriodContainerEntityResponse, Error<ReadContainerCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_sort = sort;
    let p_limit = limit;
...
pub async fn read_container_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CommonPeriodCountResponse, Error<ReadContainerCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_container_count_by_registry(configuration: &configuration::Configuration, under_assessment: Option<bool>, limit: Option<i32>, filter: Option<&str>) -> Result<models::ModelsPeriodApiFilterResponse, Error<ReadContainerCountByRegistryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn read_container_enrichment(configuration: &configuration::Configuration, container_id: Vec<String>, filter: Option<&str>) -> Result<models::K8sassetsPeriodContainerEnrichmentResponse, Error<ReadContainerEnrichmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    req_builder = match "csv" {
        "multi" => req_builder.query(&p_container_id.into_iter().map(|p| ("container_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("container_id", &p_container_id.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    if let Some(ref param_value) = p_filter {
        req_builder = req_builder.query(&[("filter", &param_value.to_string())]);
    }
...
pub async fn read_container_image_detections_count_by_date(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsPeriodApiFilterResponse, Error<ReadContainerImageDetectionsCountByDateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_container_images_by_most_used(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsPeriodAggregateValuesByFieldResponse, Error<ReadContainerImagesByMostUsedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_container_images_by_state(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsPeriodApiFilterResponse, Error<ReadContainerImagesByStateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_container_vulnerabilities_by_severity_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsPeriodAggregateValuesByFieldResponse, Error<ReadContainerVulnerabilitiesBySeverityCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_containers_by_date_range_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsPeriodAggregateValuesByFieldResponse, Error<ReadContainersByDateRangeCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_containers_sensor_coverage(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsPeriodAggregateValuesByFieldResponse, Error<ReadContainersSensorCoverageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_deployment_combined(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ModelsPeriodDeploymentEntityResponse, Error<ReadDeploymentCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_sort = sort;
    let p_limit = limit;
...
pub async fn read_deployment_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CommonPeriodCountResponse, Error<ReadDeploymentCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_deployment_enrichment(configuration: &configuration::Configuration, deployment_id: Vec<String>, filter: Option<&str>) -> Result<models::K8sassetsPeriodDeploymentEnrichmentResponse, Error<ReadDeploymentEnrichmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    req_builder = match "csv" {
        "multi" => req_builder.query(&p_deployment_id.into_iter().map(|p| ("deployment_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("deployment_id", &p_deployment_id.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    if let Some(ref param_value) = p_filter {
        req_builder = req_builder.query(&[("filter", &param_value.to_string())]);
    }
...
pub async fn read_deployments_by_date_range_count(configuration: &configuration::Configuration, ) -> Result<models::ModelsPeriodAggregateValuesByFieldResponse, Error<ReadDeploymentsByDateRangeCountError>> {
...
pub async fn read_distinct_container_image_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsPeriodApiFilterResponse, Error<ReadDistinctContainerImageCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_kubernetes_iom_by_date_range(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::K8siomsPeriodKubernetesIomFieldValue, Error<ReadKubernetesIomByDateRangeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_kubernetes_iom_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::K8siomsPeriodKubernetesIomCountValue, Error<ReadKubernetesIomCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_kubernetes_iom_entities(configuration: &configuration::Configuration, ids: Option<Vec<String>>) -> Result<models::K8siomsPeriodKubernetesIomEntityResponse, Error<ReadKubernetesIomEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn read_namespace_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CommonPeriodCountResponse, Error<ReadNamespaceCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_namespaces_by_date_range_count(configuration: &configuration::Configuration, ) -> Result<models::ModelsPeriodAggregateValuesByFieldResponse, Error<ReadNamespacesByDateRangeCountError>> {
...
pub async fn read_node_combined(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ModelsPeriodNodeEntityResponse, Error<ReadNodeCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_sort = sort;
    let p_limit = limit;
...
pub async fn read_node_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CommonPeriodCountResponse, Error<ReadNodeCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_node_enrichment(configuration: &configuration::Configuration, node_name: Vec<String>, filter: Option<&str>) -> Result<models::K8sassetsPeriodNodeEnrichmentResponse, Error<ReadNodeEnrichmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    req_builder = match "csv" {
        "multi" => req_builder.query(&p_node_name.into_iter().map(|p| ("node_name".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("node_name", &p_node_name.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    if let Some(ref param_value) = p_filter {
        req_builder = req_builder.query(&[("filter", &param_value.to_string())]);
    }
...
pub async fn read_nodes_by_cloud_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsPeriodAggregateValuesByFieldResponse, Error<ReadNodesByCloudCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_nodes_by_container_engine_version_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsPeriodAggregateValuesByFieldResponse, Error<ReadNodesByContainerEngineVersionCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_nodes_by_date_range_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsPeriodAggregateValuesByFieldResponse, Error<ReadNodesByDateRangeCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_pod_combined(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ModelsPeriodPodEntityResponse, Error<ReadPodCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_sort = sort;
    let p_limit = limit;
...
pub async fn read_pod_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CommonPeriodCountResponse, Error<ReadPodCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_pod_enrichment(configuration: &configuration::Configuration, pod_id: Vec<String>, filter: Option<&str>) -> Result<models::K8sassetsPeriodPodEnrichmentResponse, Error<ReadPodEnrichmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_pod_id = pod_id;
    let p_filter = filter;
    ...
    req_builder = match "csv" {
        "multi" => req_builder.query(&p_pod_id.into_iter().map(|p| ("pod_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("pod_id", &p_pod_id.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    if let Some(ref param_value) = p_filter {
        req_builder = req_builder.query(&[("filter", &param_value.to_string())]);
    }
...
pub async fn read_pods_by_date_range_count(configuration: &configuration::Configuration, ) -> Result<models::ModelsPeriodAggregateValuesByFieldResponse, Error<ReadPodsByDateRangeCountError>> {
...
pub async fn read_running_container_images(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ModelsPeriodContainerImage, Error<ReadRunningContainerImagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_sort = sort;
    let p_limit = limit;
...
pub async fn read_vulnerable_container_image_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ModelsPeriodApiFilterResponse, Error<ReadVulnerableContainerImageCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn regenerate_api_key(configuration: &configuration::Configuration, ) -> Result<models::K8sregPeriodRegenApiKeyResp, Error<RegenerateApiKeyError>> {
...
pub async fn search_and_read_kubernetes_iom_entities(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::K8siomsPeriodKubernetesIomEntityResponse, Error<SearchAndReadKubernetesIomEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_sort = sort;
    let p_limit = limit;
...
pub async fn search_kubernetes_ioms(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::CommonPeriodGenericEntityResponseLeftSquareBracketStringRightSquareBracket, Error<SearchKubernetesIomsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_sort = sort;
    let p_limit = limit;
...
pub async fn trigger_scan(configuration: &configuration::Configuration, scan_type: &str) -> Result<models::MsaPeriodBaseEntitiesResponse, Error<TriggerScanError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn update_aws_account(configuration: &configuration::Configuration, ids: Vec<String>, region: Option<&str>) -> Result<models::MsaPeriodBaseEntitiesResponse, Error<UpdateAwsAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
    let p_region = region;
