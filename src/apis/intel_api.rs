...
pub async fn get_intel_actor_entities(configuration: &configuration::Configuration, ids: Vec<String>, fields: Option<Vec<String>>) -> Result<models::DomainActorsResponse, Error<GetIntelActorEntitiesError>> {
...
pub async fn get_intel_indicator_entities(configuration: &configuration::Configuration, body: models::MsaIdsRequest) -> Result<models::DomainPublicIndicatorsV3Response, Error<GetIntelIndicatorEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_intel_report_entities(configuration: &configuration::Configuration, ids: Vec<String>, fields: Option<Vec<String>>) -> Result<models::DomainNewsResponse, Error<GetIntelReportEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_query_fields = fields;
...
pub async fn get_intel_rule_entities(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainRulesResponse, Error<GetIntelRuleEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_malware_entities(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainMalwareResponse, Error<GetMalwareEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_vulnerabilities(configuration: &configuration::Configuration, body: models::MsaIdsRequest) -> Result<models::DomainVulnerabilityResponse, Error<GetVulnerabilitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn post_mitre_attacks(configuration: &configuration::Configuration, body: models::MsaIdsRequest) -> Result<(), Error<PostMitreAttacksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn query_intel_actor_entities(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>, fields: Option<Vec<String>>) -> Result<models::DomainActorsResponse, Error<QueryIntelActorEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn query_intel_actor_ids(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::MsaQueryResponse, Error<QueryIntelActorIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
    let p_query_sort = sort;
...
pub async fn query_intel_indicator_ids(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>, include_deleted: Option<bool>, include_relations: Option<bool>) -> Result<models::MsaQueryResponse, Error<QueryIntelIndicatorIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
    let p_query_sort = sort;
...
pub async fn query_intel_report_entities(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>, fields: Option<Vec<String>>) -> Result<models::DomainNewsResponse, Error<QueryIntelReportEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
    let p_query_sort = sort;
...
pub async fn query_intel_report_ids(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::MsaQueryResponse, Error<QueryIntelReportIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
    let p_query_sort = sort;
...
pub async fn query_malware(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::DomainQueryResponse, Error<QueryMalwareError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
    let p_query_sort = sort;
...
pub async fn query_malware_entities(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>, fields: Option<Vec<String>>) -> Result<models::DomainMalwareResponse, Error<QueryMalwareEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
    let p_query_sort = sort;
...
pub async fn query_mitre_attacks(configuration: &configuration::Configuration, id: Option<&str>, ids: Option<Vec<String>>) -> Result<models::DomainQueryMitreAttacksResponse, Error<QueryMitreAttacksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    let p_query_ids = ids;
...
pub async fn query_mitre_attacks_for_malware(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainQueryResponse, Error<QueryMitreAttacksForMalwareError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn query_vulnerabilities(configuration: &configuration::Configuration, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::MsaQueryResponse, Error<QueryVulnerabilitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
    let p_query_sort = sort;
