...
pub async fn aggregate_image_assessment_history(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ImagesApiImageAssessmentHistory, Error<AggregateImageAssessmentHistoryError>> {
...
pub async fn aggregate_image_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ImagesApiImageCount, Error<AggregateImageCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn aggregate_image_count_by_base_os(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ImagesApiImageCountByBaseOs, Error<AggregateImageCountByBaseOsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn aggregate_image_count_by_state(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ImagesApiImageCountByState, Error<AggregateImageCountByStateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn combined_base_images(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CoreEntitiesResponse, Error<CombinedBaseImagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn combined_image_by_vulnerability_count(configuration: &configuration::Configuration, filter: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ImagesApiImageByVulnerabilityCount, Error<CombinedImageByVulnerabilityCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn combined_image_detail(configuration: &configuration::Configuration, filter: Option<&str>, with_config: Option<bool>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ImagesApiCustomerAndImage, Error<CombinedImageDetailError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn combined_image_issues_summary(configuration: &configuration::Configuration, cid: &str, registry: &str, repository: &str, tag: &str, image_digest: Option<&str>, include_base_image_vuln: Option<bool>) -> Result<models::ImagesApiImageIssuesSummary, Error<CombinedImageIssuesSummaryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_cid = cid;
...
pub async fn combined_image_vulnerability_summary(configuration: &configuration::Configuration, cid: &str, registry: &str, repository: &str, tag: &str, image_digest: Option<&str>, include_base_image_vuln: Option<bool>) -> Result<models::ImagesApiImageVulnerabilitiesSummary, Error<CombinedImageVulnerabilitySummaryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_cid = cid;
    let p_query_registry = registry;
    let p_query_repository = repository;
...
pub async fn create_base_images_entities(configuration: &configuration::Configuration, body: models::ModelsCreateBaseImagesRequest) -> Result<models::CoreEntitiesResponse, Error<CreateBaseImagesEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn delete_base_images(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::CoreEntitiesResponse, Error<DeleteBaseImagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_combined_images(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ImagesExtCombinedImagesResponse, Error<GetCombinedImagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_limit = limit;
...
pub async fn read_combined_images_export(configuration: &configuration::Configuration, filter: Option<&str>, expand_vulnerabilities: Option<bool>, expand_detections: Option<bool>, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>) -> Result<models::ImagesApiCombinedImageExport, Error<ReadCombinedImagesExportError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
