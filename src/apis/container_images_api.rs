...
pub async fn aggregate_image_assessment_history(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ImagesPeriodApiImageAssessmentHistory, Error<AggregateImageAssessmentHistoryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/images/assessment-history/v1", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AggregateImageAssessmentHistoryError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn aggregate_image_count(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ImagesPeriodApiImageCount, Error<AggregateImageCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/images/count/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn aggregate_image_count_by_base_os(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ImagesPeriodApiImageCountByBaseOs, Error<AggregateImageCountByBaseOsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/images/count-by-os-distribution/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn aggregate_image_count_by_state(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::ImagesPeriodApiImageCountByState, Error<AggregateImageCountByStateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;

    let uri_str = format!("{}/container-security/aggregates/images/count-by-state/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn combined_base_images(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CorePeriodEntitiesResponse, Error<CombinedBaseImagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;

    let uri_str = format!("{}/container-security/combined/base-images/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn combined_image_by_vulnerability_count(configuration: &configuration::Configuration, filter: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ImagesPeriodApiImageByVulnerabilityCount, Error<CombinedImageByVulnerabilityCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_limit = limit;
    let p_offset = offset;

    let uri_str = format!("{}/container-security/combined/images/by-vulnerability-count/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CombinedImageByVulnerabilityCountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn combined_image_detail(configuration: &configuration::Configuration, filter: Option<&str>, with_config: Option<bool>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ImagesPeriodApiCustomerAndImage, Error<CombinedImageDetailError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    ...
    let uri_str = format!("{}/container-security/combined/images/detail/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn combined_image_issues_summary(configuration: &configuration::Configuration, cid: &str, registry: &str, repository: &str, tag: &str, image_digest: Option<&str>, include_base_image_vuln: Option<bool>) -> Result<models::ImagesPeriodApiImageIssuesSummary, Error<CombinedImageIssuesSummaryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_cid = cid;
    ...
    let uri_str = format!("{}/container-security/combined/images/issues-summary/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn combined_image_vulnerability_summary(configuration: &configuration::Configuration, cid: &str, registry: &str, repository: &str, tag: &str, image_digest: Option<&str>, include_base_image_vuln: Option<bool>) -> Result<models::ImagesPeriodApiImageVulnerabilitiesSummary, Error<CombinedImageVulnerabilitySummaryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_cid = cid;
    let p_registry = registry;
    let p_repository = repository;
    ...
    let uri_str = format!("{}/container-security/combined/images/vulnerabilities-summary/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CombinedImageVulnerabilitySummaryError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn create_base_images_entities(configuration: &configuration::Configuration, body: models::ModelsPeriodCreateBaseImagesRequest) -> Result<models::CorePeriodEntitiesResponse, Error<CreateBaseImagesEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/container-security/entities/base-images/v1", configuration.base_path);
...
pub async fn delete_base_images(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::CorePeriodEntitiesResponse, Error<DeleteBaseImagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_combined_images(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::ImagesPeriodExtCombinedImagesResponse, Error<GetCombinedImagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_sort = sort;
    let p_limit = limit;
    ...
    let uri_str = format!("{}/container-security/combined/image-assessment/images/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_combined_images_export(configuration: &configuration::Configuration, filter: Option<&str>, expand_vulnerabilities: Option<bool>, expand_detections: Option<bool>, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>) -> Result<models::ImagesPeriodApiCombinedImageExport, Error<ReadCombinedImagesExportError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    ...
    let uri_str = format!("{}/container-security/combined/images/export/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
