...
pub async fn read_image_vulnerabilities(
    ...
    body: crate::models::ApiImageLookupRequest,
) -> Result<crate::models::CoreEntitiesResponse, Error<ReadImageVulnerabilitiesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReadImageVulnerabilitiesError> =
