...
pub async fn read_image_vulnerabilities(configuration: &configuration::Configuration, body: models::ApiImageLookupRequest) -> Result<models::CoreEntitiesResponse, Error<ReadImageVulnerabilitiesError>> {
