...
pub async fn aggregate_alerts(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<AggregateAlertsError>> {
...
pub async fn aggregate_allow_list(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<AggregateAllowListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn aggregate_block_list(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<AggregateBlockListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn aggregate_detections(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<AggregateDetectionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn aggregate_device_count_collection(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<AggregateDeviceCountCollectionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn aggregate_escalations(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<AggregateEscalationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn aggregate_fc_incidents(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<AggregateFcIncidentsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn aggregate_prevention_policy(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<AggregatePreventionPolicyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn aggregate_remediations(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<AggregateRemediationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn aggregate_sensor_update_policy(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<AggregateSensorUpdatePolicyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn aggregate_support_issues(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<AggregateSupportIssuesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn aggregate_total_device_counts(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<AggregateTotalDeviceCountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn get_device_count_collection_queries_by_filter(configuration: &configuration::Configuration, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, offset: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<GetDeviceCountCollectionQueriesByFilterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    let p_sort = sort;
    let p_filter = filter;
...
pub async fn query_alert_ids_by_filter(configuration: &configuration::Configuration, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, offset: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryAlertIdsByFilterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    let p_sort = sort;
    let p_filter = filter;
...
pub async fn query_alert_ids_by_filter_v2(configuration: &configuration::Configuration, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, offset: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryAlertIdsByFilterV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    let p_sort = sort;
    let p_filter = filter;
...
pub async fn query_allow_list_filter(configuration: &configuration::Configuration, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, offset: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryAllowListFilterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    let p_sort = sort;
    let p_filter = filter;
...
pub async fn query_block_list_filter(configuration: &configuration::Configuration, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, offset: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryBlockListFilterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    let p_sort = sort;
    let p_filter = filter;
...
pub async fn query_detection_ids_by_filter(configuration: &configuration::Configuration, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, offset: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryDetectionIdsByFilterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    let p_sort = sort;
    let p_filter = filter;
...
pub async fn query_escalations_filter(configuration: &configuration::Configuration, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, offset: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryEscalationsFilterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    let p_sort = sort;
    let p_filter = filter;
...
pub async fn query_incident_ids_by_filter(configuration: &configuration::Configuration, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, offset: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryIncidentIdsByFilterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    let p_sort = sort;
    let p_filter = filter;
...
pub async fn query_remediations_filter(configuration: &configuration::Configuration, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, offset: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryRemediationsFilterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    let p_sort = sort;
    let p_filter = filter;
