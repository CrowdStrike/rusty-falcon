...
pub async fn aggregate_cases(configuration: &configuration::Configuration, body: Vec<models::MsaAggregateQueryRequest>) -> Result<models::MsaAggregatesResponse, Error<AggregateCasesError>> {
...
pub async fn case_add_activity(configuration: &configuration::Configuration, body: models::MessagecenterActivityCreationRequest) -> Result<models::MsaspecResponseFields, Error<CaseAddActivityError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn case_add_attachment(configuration: &configuration::Configuration, case_id: &str, user_uuid: &str, file: std::path::PathBuf) -> Result<models::ApiMessageCenterAttachmentUploadResponse, Error<CaseAddAttachmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn create_case_v2(configuration: &configuration::Configuration, body: models::MessagecenterCaseCreationRequestV2) -> Result<models::MsaReplyAffectedEntities, Error<CreateCaseV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn get_case_activity_by_ids(configuration: &configuration::Configuration, body: models::MsaIdsRequest) -> Result<models::ApiMessageCenterActivityResponse, Error<GetCaseActivityByIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn get_case_entities_by_ids(configuration: &configuration::Configuration, body: models::MsaIdsRequest) -> Result<models::ApiMessageCenterCasesResponse, Error<GetCaseEntitiesByIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn query_activity_by_case_id(configuration: &configuration::Configuration, case_id: &str, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, offset: Option<&str>) -> Result<models::MsaspecQueryResponse, Error<QueryActivityByCaseIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn query_cases_ids_by_filter(configuration: &configuration::Configuration, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, offset: Option<&str>) -> Result<models::MsaspecQueryResponse, Error<QueryCasesIdsByFilterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_limit = limit;
    let p_query_sort = sort;
    let p_query_filter = filter;
