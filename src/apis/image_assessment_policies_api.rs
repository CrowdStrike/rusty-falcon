...
pub async fn create_policies(configuration: &configuration::Configuration, body: models::ModelsPeriodCreatePolicyRequest) -> Result<models::ModelsPeriodPolicyEntityResponse, Error<CreatePoliciesError>> {
...
pub async fn create_policy_groups(configuration: &configuration::Configuration, body: models::ModelsPeriodCreateImageGroupRequest) -> Result<models::ModelsPeriodPolicyGroupEntityResponse, Error<CreatePolicyGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn delete_policy(configuration: &configuration::Configuration, id: &str) -> Result<models::CorePeriodEntitiesResponse, Error<DeletePolicyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn delete_policy_group(configuration: &configuration::Configuration, id: &str) -> Result<models::CorePeriodEntitiesResponse, Error<DeletePolicyGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn read_policies(configuration: &configuration::Configuration, ) -> Result<models::ModelsPeriodPolicyEntityResponse, Error<ReadPoliciesError>> {
...
pub async fn read_policy_exclusions(configuration: &configuration::Configuration, ) -> Result<models::ModelsPeriodPolicyExclusionEntityResponse, Error<ReadPolicyExclusionsError>> {
...
pub async fn read_policy_groups(configuration: &configuration::Configuration, ) -> Result<models::ModelsPeriodPolicyGroupEntityResponse, Error<ReadPolicyGroupsError>> {
...
pub async fn update_policies(configuration: &configuration::Configuration, id: &str, body: models::ModelsPeriodPatchPolicyRequest) -> Result<models::ModelsPeriodPolicyEntityResponse, Error<UpdatePoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_body = body;
...
pub async fn update_policy_exclusions(configuration: &configuration::Configuration, body: models::ModelsPeriodUpdateExclusionsRequest) -> Result<models::ModelsPeriodPolicyExclusionEntityResponse, Error<UpdatePolicyExclusionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn update_policy_groups(configuration: &configuration::Configuration, id: &str, body: models::ModelsPeriodPatchImageGroupRequest) -> Result<models::ModelsPeriodPolicyGroupEntityResponse, Error<UpdatePolicyGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_body = body;
...
pub async fn update_policy_precedence(configuration: &configuration::Configuration, body: models::ModelsPeriodApiPrecedenceRequest) -> Result<models::ModelsPeriodPolicyEntityResponse, Error<UpdatePolicyPrecedenceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
