...
pub async fn get_aggregate_detects(configuration: &configuration::Configuration, body: Vec<models::MsaAggregateQueryRequest>) -> Result<models::MsaAggregatesResponse, Error<GetAggregateDetectsError>> {
...
/// Please use this guide to migrate to [Alerts API](https://falcon.crowdstrike.com/documentation/page/d02475a5/converting-from-detects-api-to-alerts-api)
pub async fn get_detect_summaries(configuration: &configuration::Configuration, body: models::MsaIdsRequest) -> Result<models::DomainMsaDetectSummariesResponse, Error<GetDetectSummariesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
/// Please use this guide to migrate to [Alerts API](https://falcon.crowdstrike.com/documentation/page/d02475a5/converting-from-detects-api-to-alerts-api)
pub async fn query_detects(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::MsaQueryResponse, Error<QueryDetectsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Please use this guide to migrate to [Alerts API](https://falcon.crowdstrike.com/documentation/page/d02475a5/converting-from-detects-api-to-alerts-api)
pub async fn update_detects_by_ids_v2(configuration: &configuration::Configuration, body: models::DomainDetectsEntitiesPatchRequest) -> Result<models::MsaReplyMetaOnly, Error<UpdateDetectsByIdsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
