...
pub async fn aggregate_external_assets(configuration: &configuration::Configuration, body: Vec<models::MsaAggregateQueryRequest>) -> Result<models::MsaAggregatesResponse, Error<AggregateExternalAssetsError>> {
...
pub async fn blob_preview_external_assets(configuration: &configuration::Configuration, asset_id: &str, hash: &str) -> Result<models::DomainExternalAssetsBlobApiTypeV1, Error<BlobPreviewExternalAssetsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_asset_id = asset_id;
    let p_query_hash = hash;
...
pub async fn combined_ecosystem_subsidiaries(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, filter: Option<&str>, sort: Option<&str>, version_id: Option<&str>) -> Result<models::DomainFemEcosystemSubsidiariesEntitiesResponse, Error<CombinedEcosystemSubsidiariesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn delete_external_assets(configuration: &configuration::Configuration, ids: Vec<String>, body: models::DomainExternalAssetApiDeleteRequestV1) -> Result<models::MsaspecQueryResponse, Error<DeleteExternalAssetsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_body_body = body;
...
pub async fn get_ecosystem_subsidiaries(configuration: &configuration::Configuration, ids: Vec<String>, version_id: Option<&str>) -> Result<models::DomainFemEcosystemSubsidiariesEntitiesResponse, Error<GetEcosystemSubsidiariesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_query_version_id = version_id;
...
pub async fn get_external_assets(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainExternalAssetsApiTypeV1, Error<GetExternalAssetsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn patch_external_assets(configuration: &configuration::Configuration, body: models::DomainExternalAssetApiPatchRequestV1) -> Result<models::DomainExternalAssetsApiTypeV1, Error<PatchExternalAssetsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn post_external_assets_inventory_v1(configuration: &configuration::Configuration, body: models::InventoryapiUserExternalAssetCreateRequestV1) -> Result<models::InventoryapiUserExternalAssetCreateResponseV1, Error<PostExternalAssetsInventoryV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn query_ecosystem_subsidiaries(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, filter: Option<&str>, sort: Option<&str>, version_id: Option<&str>) -> Result<models::DomainFemEcosystemSubsidiariesQueryResponse, Error<QueryEcosystemSubsidiariesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
    let p_query_filter = filter;
...
pub async fn query_external_assets(configuration: &configuration::Configuration, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::MsaspecQueryResponse, Error<QueryExternalAssetsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
    let p_query_sort = sort;
...
pub async fn query_external_assets_v2(configuration: &configuration::Configuration, after: Option<&str>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::DomainDiscoverApiResponse, Error<QueryExternalAssetsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
