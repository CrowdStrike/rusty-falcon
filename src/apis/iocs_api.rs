...
pub async fn devices_count(configuration: &configuration::Configuration, r#type: &str, value: &str) -> Result<models::IocapiMsaReplyIocDevicesCount, Error<DevicesCountError>> {
...
pub async fn devices_ran_on(configuration: &configuration::Configuration, r#type: &str, value: &str, limit: Option<&str>, offset: Option<&str>) -> Result<models::IocapiMsaReplyDevicesRanOn, Error<DevicesRanOnError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_type = r#type;
    let p_query_value = value;
...
pub async fn entities_processes(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ProcessesapiMsaProcessDetailResponse, Error<EntitiesProcessesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn processes_ran_on(configuration: &configuration::Configuration, r#type: &str, value: &str, device_id: &str, limit: Option<&str>, offset: Option<&str>) -> Result<models::IocapiMsaReplyProcessesRanOn, Error<ProcessesRanOnError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_type = r#type;
    let p_query_value = value;
