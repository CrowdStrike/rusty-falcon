...
pub async fn execute_command(configuration: &configuration::Configuration, resources: Vec<models::DomainExecuteCommandV1>) -> Result<models::DomainExecuteCommandResultsV1, Error<ExecuteCommandError>> {
    ...
    multipart_form = multipart_form.text("resources", p_form_resources.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string());
...
pub async fn execute_command_proxy(configuration: &configuration::Configuration, body: models::DomainExecuteCommandRequestV1) -> Result<serde_json::Value, Error<ExecuteCommandProxyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_combined_plugin_configs(configuration: &configuration::Configuration, filter: Option<&str>, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>) -> Result<models::DomainConfigsV1, Error<GetCombinedPluginConfigsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
