...
pub async fn search_indicators(configuration: &configuration::Configuration, body: models::RestapiIndicatorsQueryRequest, sort: Option<&str>, filter: Option<&str>, limit: Option<i32>, offset: Option<&str>) -> Result<models::RestapiIndicatorResponse, Error<SearchIndicatorsError>> {
