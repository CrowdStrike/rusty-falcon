...
pub async fn audit_events_query(
    ...
    sort: Option<&str>,
    filter: Option<&str>,
) -> Result<crate::models::MsaQueryResponse, Error<AuditEventsQueryError>> {
...
) -> Result<crate::models::ApiAuditEventDetailsResponseV1, Error<AuditEventsReadError>> {
    let local_var_configuration = configuration;
...
pub async fn customer_settings_read(
    configuration: &configuration::Configuration,
) -> Result<crate::models::ApiCustomerSettingsResponseV1, Error<CustomerSettingsReadError>> {
    let local_var_configuration = configuration;
...
pub async fn tokens_create(
    configuration: &configuration::Configuration,
    body: crate::models::ApiTokenCreateRequestV1,
) -> Result<crate::models::ApiTokenDetailsResponseV1, Error<TokensCreateError>> {
    let local_var_configuration = configuration;
...
pub async fn tokens_delete(
    configuration: &configuration::Configuration,
    ids: Vec<String>,
) -> Result<crate::models::MsaReplyMetaOnly, Error<TokensDeleteError>> {
    let local_var_configuration = configuration;
...
pub async fn tokens_query(
    ...
    sort: Option<&str>,
    filter: Option<&str>,
) -> Result<crate::models::MsaQueryResponse, Error<TokensQueryError>> {
    let local_var_configuration = configuration;
...
pub async fn tokens_read(
    configuration: &configuration::Configuration,
    ids: Option<Vec<String>>,
) -> Result<crate::models::ApiTokenDetailsResponseV1, Error<TokensReadError>> {
    let local_var_configuration = configuration;
...
pub async fn tokens_update(
    configuration: &configuration::Configuration,
    ids: Vec<String>,
    body: crate::models::ApiTokenPatchRequestV1,
) -> Result<crate::models::MsaQueryResponse, Error<TokensUpdateError>> {
    let local_var_configuration = configuration;
