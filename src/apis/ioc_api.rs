...
pub async fn indicator_create_v1(configuration: &configuration::Configuration, body: crate::models::ApiIndicatorCreateReqsV1, X_CS_USERNAME: Option<&str>, retrodetects: Option<serde_json::Value>, ignore_warnings: Option<serde_json::Value>) -> Result<crate::models::ApiIndicatorRespV1, Error<IndicatorCreateV1Error>> {
    let local_var_configuration = configuration;
...
pub async fn indicator_update_v1(configuration: &configuration::Configuration, body: crate::models::ApiIndicatorUpdateReqsV1, X_CS_USERNAME: Option<&str>, retrodetects: Option<serde_json::Value>, ignore_warnings: Option<serde_json::Value>) -> Result<crate::models::ApiIndicatorRespV1, Error<IndicatorUpdateV1Error>> {
    let local_var_configuration = configuration;
