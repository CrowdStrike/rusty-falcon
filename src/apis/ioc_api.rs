...
pub async fn action_get_v1(configuration: &configuration::Configuration, ids: Option<Vec<String>>) -> Result<models::ApiActionRespV1, Error<ActionGetV1Error>> {
...
pub async fn action_query_v1(configuration: &configuration::Configuration, offset: Option<&str>, limit: Option<i32>) -> Result<models::ApiIndicatorQueryRespV1, Error<ActionQueryV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_indicators_report(configuration: &configuration::Configuration, body: models::ApiIndicatorsReportRequest) -> Result<models::MsaEntitiesResponse, Error<GetIndicatorsReportError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn indicator_aggregate_v1(configuration: &configuration::Configuration, body: models::MsaAggregateQueryRequest, filter: Option<&str>, from_parent: Option<bool>) -> Result<models::MsaAggregatesResponse, Error<IndicatorAggregateV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn indicator_combined_v1(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, after: Option<&str>, from_parent: Option<bool>) -> Result<models::ApiIndicatorRespV1, Error<IndicatorCombinedV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_offset = offset;
    let p_query_limit = limit;
...
pub async fn indicator_create_v1(configuration: &configuration::Configuration, body: models::ApiIndicatorCreateReqsV1, retrodetects: Option<bool>, ignore_warnings: Option<bool>) -> Result<models::ApiIndicatorRespV1, Error<IndicatorCreateV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn indicator_delete_v1(configuration: &configuration::Configuration, filter: Option<&str>, ids: Option<Vec<String>>, comment: Option<&str>, from_parent: Option<bool>) -> Result<models::ApiIndicatorQueryRespV1, Error<IndicatorDeleteV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_ids = ids;
...
pub async fn indicator_get_device_count_v1(configuration: &configuration::Configuration, r#type: &str, value: &str) -> Result<models::ApiDeviceCountRespV1, Error<IndicatorGetDeviceCountV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn indicator_get_devices_ran_on_v1(configuration: &configuration::Configuration, r#type: &str, value: &str, limit: Option<&str>, offset: Option<&str>) -> Result<models::ApiDevicesRanOnRespV1, Error<IndicatorGetDevicesRanOnV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_type = r#type;
    let p_query_value = value;
    let p_query_limit = limit;
...
pub async fn indicator_get_processes_ran_on_v1(configuration: &configuration::Configuration, r#type: &str, value: &str, device_id: &str, limit: Option<&str>, offset: Option<&str>) -> Result<models::ApiProcessesRanOnRespV1, Error<IndicatorGetProcessesRanOnV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_type = r#type;
    let p_query_value = value;
...
pub async fn indicator_get_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ApiIndicatorRespV1, Error<IndicatorGetV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn indicator_search_v1(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, after: Option<&str>, from_parent: Option<bool>) -> Result<models::ApiIndicatorQueryRespV1, Error<IndicatorSearchV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_offset = offset;
    let p_query_limit = limit;
...
pub async fn indicator_update_v1(configuration: &configuration::Configuration, body: models::ApiIndicatorUpdateReqsV1, retrodetects: Option<bool>, ignore_warnings: Option<bool>) -> Result<models::ApiIndicatorRespV1, Error<IndicatorUpdateV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_query_retrodetects = retrodetects;
    let p_query_ignore_warnings = ignore_warnings;
...
pub async fn ioc_type_query_v1(configuration: &configuration::Configuration, offset: Option<&str>, limit: Option<i32>) -> Result<models::ApiIndicatorQueryRespV1, Error<IocTypeQueryV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
...
pub async fn platform_query_v1(configuration: &configuration::Configuration, offset: Option<&str>, limit: Option<i32>) -> Result<models::ApiIndicatorQueryRespV1, Error<PlatformQueryV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
...
pub async fn severity_query_v1(configuration: &configuration::Configuration, offset: Option<&str>, limit: Option<i32>) -> Result<models::ApiIndicatorQueryRespV1, Error<SeverityQueryV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
