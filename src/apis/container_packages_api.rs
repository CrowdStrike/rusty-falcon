...
pub async fn read_packages_by_fixable_vuln_count(configuration: &configuration::Configuration, filter: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::PackagesPeriodApiPackagesByVulnCount, Error<ReadPackagesByFixableVulnCountError>> {
...
pub async fn read_packages_by_image_count(configuration: &configuration::Configuration, filter: Option<&str>, limit: Option<i32>) -> Result<models::PackagesPeriodApiPackagesByImageCount, Error<ReadPackagesByImageCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_limit = limit;
...
pub async fn read_packages_by_vuln_count(configuration: &configuration::Configuration, filter: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::PackagesPeriodApiPackagesByVulnCount, Error<ReadPackagesByVulnCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_limit = limit;
    let p_offset = offset;
...
pub async fn read_packages_combined(configuration: &configuration::Configuration, filter: Option<&str>, only_zero_day_affected: Option<bool>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::PackagesPeriodApiCombinedPackage, Error<ReadPackagesCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_packages_combined_export(configuration: &configuration::Configuration, filter: Option<&str>, only_zero_day_affected: Option<bool>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::PackagesPeriodApiCombinedPackageExport, Error<ReadPackagesCombinedExportError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_only_zero_day_affected = only_zero_day_affected;
    let p_sort = sort;
...
pub async fn read_packages_combined_v2(configuration: &configuration::Configuration, filter: Option<&str>, only_zero_day_affected: Option<bool>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::PackagesPeriodApiCombinedPackageV2, Error<ReadPackagesCombinedV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_only_zero_day_affected = only_zero_day_affected;
    let p_sort = sort;
...
pub async fn read_packages_count_by_zero_day(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::CommonPeriodCountResponse, Error<ReadPackagesCountByZeroDayError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
