...
pub async fn read_request_body(configuration: &configuration::Configuration, id: &str, r#fn: &str, filename: &str, sha256: &str) -> Result<serde_json::Value, Error<ReadRequestBodyError>> {
    ...
    let uri_str = format!("{}/faas-gateway/entities/execution-request-body/v2", configuration.base_path);
