...
pub async fn ext_aggregate_cluster_assessments(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::DomainAggregateClusterAssessmentsResponse, Error<ExtAggregateClusterAssessmentsError>> {
...
pub async fn ext_aggregate_failed_containers_by_rules_path(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::DomainAggregateFailedAssetsByRulesResponse, Error<ExtAggregateFailedContainersByRulesPathError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn ext_aggregate_failed_containers_count_by_severity(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::DomainAggregateFailedAssetCountBySeverityResponse, Error<ExtAggregateFailedContainersCountBySeverityError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn ext_aggregate_failed_images_by_rules_path(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::DomainAggregateFailedAssetsByRulesResponse, Error<ExtAggregateFailedImagesByRulesPathError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn ext_aggregate_failed_images_count_by_severity(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::DomainAggregateFailedAssetCountBySeverityResponse, Error<ExtAggregateFailedImagesCountBySeverityError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn ext_aggregate_failed_rules_by_clusters(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::DomainAggregateFailedRulesByClustersResponse, Error<ExtAggregateFailedRulesByClustersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn ext_aggregate_failed_rules_by_images(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::DomainAggregateFailedRulesByImagesResponse, Error<ExtAggregateFailedRulesByImagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn ext_aggregate_failed_rules_count_by_severity(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::DomainAggregateFailedRulesCountBySeverityResponse, Error<ExtAggregateFailedRulesCountBySeverityError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn ext_aggregate_image_assessments(configuration: &configuration::Configuration, filter: Option<&str>, after: Option<&str>, limit: Option<&str>) -> Result<models::DomainAggregateImageAssessmentsResponse, Error<ExtAggregateImageAssessmentsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn ext_aggregate_rules_assessments(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::DomainAggregateRulesAssessmentsResponse, Error<ExtAggregateRulesAssessmentsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn ext_aggregate_rules_by_status(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::DomainAggregateRulesByStatusResponse, Error<ExtAggregateRulesByStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
