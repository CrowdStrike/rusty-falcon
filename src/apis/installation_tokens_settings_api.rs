...
pub async fn customer_settings_update(configuration: &configuration::Configuration, body: models::ApiCustomerSettingsPatchRequestV1) -> Result<models::ApiCustomerSettingsResponseV1, Error<CustomerSettingsUpdateError>> {
