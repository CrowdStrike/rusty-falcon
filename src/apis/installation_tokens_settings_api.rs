...
pub async fn customer_settings_update(configuration: &configuration::Configuration, body: models::ApiPeriodCustomerSettingsPatchRequestV1) -> Result<models::ApiPeriodCustomerSettingsResponseV1, Error<CustomerSettingsUpdateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CustomerSettingsUpdateError> = serde_json::from_str(&content).ok();
