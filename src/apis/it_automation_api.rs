...
pub async fn i_t_automation_cancel_task_execution(configuration: &configuration::Configuration, body: models::ItautomationCancelTaskExecutionRequest) -> Result<models::ItautomationCancelTaskExecutionResponse, Error<ITAutomationCancelTaskExecutionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/it-automation/entities/task-execution-cancel/v1", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationCancelTaskExecutionError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn i_t_automation_combined_scheduled_tasks(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, offset: Option<i32>, limit: Option<i32>) -> Result<models::ItautomationGetScheduledTaskResponse, Error<ITAutomationCombinedScheduledTasksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/it-automation/combined/scheduled-tasks/v1", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationCombinedScheduledTasksError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// After they are created, host groups can be assigned and policy precedence can be set.
pub async fn i_t_automation_create_policy(configuration: &configuration::Configuration, body: models::ItautomationCreatePolicyRequest) -> Result<models::ItautomationCreatePolicyResponse, Error<ITAutomationCreatePolicyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/it-automation/entities/policies/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn i_t_automation_create_scheduled_task(configuration: &configuration::Configuration, body: models::ItautomationCreateScheduledTaskRequest) -> Result<models::ItautomationCreateScheduledTaskResponse, Error<ITAutomationCreateScheduledTaskError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/it-automation/entities/scheduled-tasks/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationCreateScheduledTaskError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn i_t_automation_create_task(configuration: &configuration::Configuration, body: models::ItautomationCreateTaskRequest) -> Result<models::ItautomationCreateTaskResponse, Error<ITAutomationCreateTaskError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/it-automation/entities/tasks/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn i_t_automation_create_task_group(configuration: &configuration::Configuration, body: models::ItautomationCreateTaskGroupRequest) -> Result<models::ItautomationCreateTaskGroupResponse, Error<ITAutomationCreateTaskGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/it-automation/entities/task-groups/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn i_t_automation_create_user_group(configuration: &configuration::Configuration, body: models::ItautomationCreateUserGroupRequest) -> Result<models::ItautomationCreateUserGroupResponse, Error<ITAutomationCreateUserGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/it-automation/entities/it-user-groups/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn i_t_automation_delete_policy(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ItautomationDeletePolicyResponse, Error<ITAutomationDeletePolicyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn i_t_automation_delete_scheduled_tasks(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ItautomationDeleteScheduledTasksResponse, Error<ITAutomationDeleteScheduledTasksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationDeleteScheduledTasksError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn i_t_automation_delete_task(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ItautomationDeleteTaskResponse, Error<ITAutomationDeleteTaskError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn i_t_automation_delete_task_groups(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ItautomationDeleteTaskGroupsResponse, Error<ITAutomationDeleteTaskGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn i_t_automation_delete_user_group(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ItautomationDeleteUserGroupsResponse, Error<ITAutomationDeleteUserGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn i_t_automation_get_associated_tasks(configuration: &configuration::Configuration, id: &str, filter: Option<&str>, sort: Option<&str>, offset: Option<i32>, limit: Option<i32>) -> Result<models::ItautomationFileTaskAssociationResponse, Error<ITAutomationGetAssociatedTasksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    let p_query_filter = filter;
    let p_query_sort = sort;
    ...
    let uri_str = format!("{}/it-automation/combined/associated-tasks/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationGetAssociatedTasksError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn i_t_automation_get_execution_results(configuration: &configuration::Configuration, id: &str, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::ItautomationTaskExecutionResultsResponse, Error<ITAutomationGetExecutionResultsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    let p_query_offset = offset;
    let p_query_limit = limit;
    ...
    let uri_str = format!("{}/it-automation/entities/task-execution-results/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationGetExecutionResultsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn i_t_automation_get_execution_results_search_status(configuration: &configuration::Configuration, id: &str) -> Result<models::ItautomationSearchStatusResponse, Error<ITAutomationGetExecutionResultsSearchStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;

    let uri_str = format!("{}/it-automation/entities/task-execution-results-search/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationGetExecutionResultsSearchStatusError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// The configuration of each policy that match the provided id will be returned.
pub async fn i_t_automation_get_policies(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ItautomationPoliciesApiResponse, Error<ITAutomationGetPoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn i_t_automation_get_scheduled_tasks(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ItautomationGetScheduledTaskResponse, Error<ITAutomationGetScheduledTasksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationGetScheduledTasksError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn i_t_automation_get_task_execution(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ItautomationGetTaskExecutionResponse, Error<ITAutomationGetTaskExecutionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;

    let uri_str = format!("{}/it-automation/entities/task-executions/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn i_t_automation_get_task_execution_host_status(configuration: &configuration::Configuration, ids: Vec<String>, filter: Option<&str>, sort: Option<&str>, offset: Option<i32>, limit: Option<i32>) -> Result<models::ItautomationGetTaskExecutionHostStatusResponse, Error<ITAutomationGetTaskExecutionHostStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_query_filter = filter;
    let p_query_sort = sort;
    ...
    let uri_str = format!("{}/it-automation/entities/task-execution-host-status/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationGetTaskExecutionHostStatusError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn i_t_automation_get_task_executions_by_query(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, offset: Option<i32>, limit: Option<i32>) -> Result<models::ItautomationGetTaskExecutionResponse, Error<ITAutomationGetTaskExecutionsByQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_offset = offset;
    ...
    let uri_str = format!("{}/it-automation/combined/task-executions/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationGetTaskExecutionsByQueryError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn i_t_automation_get_task_groups(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ItautomationGetTaskGroupsResponse, Error<ITAutomationGetTaskGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn i_t_automation_get_task_groups_by_query(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, offset: Option<i32>, limit: Option<i32>) -> Result<models::ItautomationGetTaskGroupsResponse, Error<ITAutomationGetTaskGroupsByQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_offset = offset;
    ...
    let uri_str = format!("{}/it-automation/combined/task-groups/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationGetTaskGroupsByQueryError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn i_t_automation_get_tasks(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ItautomationGetTaskResponse, Error<ITAutomationGetTasksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn i_t_automation_get_tasks_by_query(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, offset: Option<i32>, limit: Option<i32>) -> Result<models::ItautomationGetTaskResponse, Error<ITAutomationGetTasksByQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_offset = offset;
    ...
    let uri_str = format!("{}/it-automation/combined/tasks/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn i_t_automation_get_user_group(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ItautomationGetUserGroupsResponse, Error<ITAutomationGetUserGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn i_t_automation_query_policies(configuration: &configuration::Configuration, platform: &str, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::ItautomationQueryPolicyResponse, Error<ITAutomationQueryPoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/it-automation/queries/policies/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn i_t_automation_rerun_task_execution(configuration: &configuration::Configuration, body: models::ItautomationRerunTaskExecutionRequest) -> Result<models::ItautomationRerunTaskExecutionResponse, Error<ITAutomationRerunTaskExecutionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/it-automation/entities/task-execution-rerun/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationRerunTaskExecutionError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn i_t_automation_run_live_query(configuration: &configuration::Configuration, body: models::ItautomationRunLiveQueryRequest) -> Result<models::ItautomationStartTaskExecutionResponse, Error<ITAutomationRunLiveQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/it-automation/entities/live-query-execution/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn i_t_automation_search_scheduled_tasks(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, offset: Option<i32>, limit: Option<i32>) -> Result<models::ItautomationSearchScheduledTaskResponse, Error<ITAutomationSearchScheduledTasksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_offset = offset;
    ...
    let uri_str = format!("{}/it-automation/queries/scheduled-tasks/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationSearchScheduledTasksError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn i_t_automation_search_task_executions(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, offset: Option<i32>, limit: Option<i32>) -> Result<models::ItautomationSearchTaskExecutionResponse, Error<ITAutomationSearchTaskExecutionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_offset = offset;
    ...
    let uri_str = format!("{}/it-automation/queries/task-executions/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationSearchTaskExecutionsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Can be used together with the entities endpoint to retrieve full information on task groups.
pub async fn i_t_automation_search_task_groups(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, offset: Option<i32>, limit: Option<i32>) -> Result<models::ItautomationSearchTaskGroupsResponse, Error<ITAutomationSearchTaskGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_offset = offset;
    ...
    let uri_str = format!("{}/it-automation/queries/task-groups/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn i_t_automation_search_tasks(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, offset: Option<i32>, limit: Option<i32>) -> Result<models::ItautomationSearchTaskResponse, Error<ITAutomationSearchTasksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_offset = offset;
...
pub async fn i_t_automation_search_user_group(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, offset: Option<i32>, limit: Option<i32>) -> Result<models::ItautomationSearchUserGroupsResponse, Error<ITAutomationSearchUserGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_sort = sort;
    let p_query_offset = offset;
    ...
    let uri_str = format!("{}/it-automation/queries/it-user-groups/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn i_t_automation_start_execution_results_search(configuration: &configuration::Configuration, body: models::ItautomationSearchRequest) -> Result<models::ItautomationSearchStatusResponse, Error<ITAutomationStartExecutionResultsSearchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationStartExecutionResultsSearchError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn i_t_automation_start_task_execution(configuration: &configuration::Configuration, body: models::ItautomationStartTaskExecutionRequest) -> Result<models::ItautomationStartTaskExecutionResponse, Error<ITAutomationStartTaskExecutionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationStartTaskExecutionError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Updates multiple fields for a policy.
pub async fn i_t_automation_update_policies(configuration: &configuration::Configuration, body: models::ItautomationUpdatePolicyRequest) -> Result<models::ItautomationUpdatePolicyResponse, Error<ITAutomationUpdatePoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn i_t_automation_update_policies_precedence(configuration: &configuration::Configuration, platform: &str, body: models::ItautomationUpdatePoliciesPrecedenceRequest) -> Result<models::ItautomationUpdatePoliciesPrecedenceResponse, Error<ITAutomationUpdatePoliciesPrecedenceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_platform = platform;
    let p_body_body = body;

    let uri_str = format!("{}/it-automation/entities/policies-precedence/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::PATCH, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationUpdatePoliciesPrecedenceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Manage host groups assigned to a policy.
pub async fn i_t_automation_update_policy_host_groups(configuration: &configuration::Configuration, body: models::ItautomationUpdatePoliciesHostGroupsRequest) -> Result<models::ItautomationUpdatePolicyResponse, Error<ITAutomationUpdatePolicyHostGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/it-automation/entities/policies-host-groups/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::PATCH, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationUpdatePolicyHostGroupsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn i_t_automation_update_scheduled_task(configuration: &configuration::Configuration, id: &str, body: models::ItautomationUpdateScheduledTaskRequest) -> Result<models::ItautomationUpdateScheduledTasksResponse, Error<ITAutomationUpdateScheduledTaskError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    let p_body_body = body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ITAutomationUpdateScheduledTaskError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn i_t_automation_update_task(configuration: &configuration::Configuration, id: &str, body: models::ItautomationUpdateTaskRequest) -> Result<models::ItautomationUpdateTaskResponse, Error<ITAutomationUpdateTaskError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    let p_body_body = body;
...
pub async fn i_t_automation_update_task_group(configuration: &configuration::Configuration, id: &str, body: models::ItautomationUpdateTaskGroupRequest) -> Result<models::ItautomationUpdateTaskGroupResponse, Error<ITAutomationUpdateTaskGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    let p_body_body = body;
...
pub async fn i_t_automation_update_user_group(configuration: &configuration::Configuration, id: &str, body: models::ItautomationUpdateUserGroupRequest) -> Result<models::ItautomationUpdateUserGroupResponse, Error<ITAutomationUpdateUserGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    let p_body_body = body;
