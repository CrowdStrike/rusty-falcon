...
pub async fn list_feed_types(configuration: &configuration::Configuration, ) -> Result<models::RestapiIndicatorGetFeedsResponse, Error<ListFeedTypesError>> {
...
pub async fn query_feed_archives(configuration: &configuration::Configuration, feed_name: &str, feed_interval: Option<&str>, since: Option<&str>) -> Result<models::RestapiIndicatorFeedQueryResponse, Error<QueryFeedArchivesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
