...
pub async fn combined_query_vulnerabilities(configuration: &configuration::Configuration, filter: &str, after: Option<&str>, limit: Option<i32>, sort: Option<&str>, facet: Option<Vec<String>>) -> Result<models::DomainSpapiCombinedVulnerabilitiesResponse, Error<CombinedQueryVulnerabilitiesError>> {
...
pub async fn get_remediations_v2(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainSpapiRemediationEntitiesResponseV2, Error<GetRemediationsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_vulnerabilities(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainSpapiVulnerabilitiesEntitiesResponseV2, Error<GetVulnerabilitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn query_vulnerabilities(configuration: &configuration::Configuration, filter: &str, after: Option<&str>, limit: Option<i32>, sort: Option<&str>) -> Result<models::DomainSpapiQueryResponse, Error<QueryVulnerabilitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_after = after;
    let p_query_limit = limit;
