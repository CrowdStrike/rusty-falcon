...
pub async fn combined_query_vulnerabilities(configuration: &configuration::Configuration, filter: &str, after: Option<&str>, limit: Option<i32>, sort: Option<&str>, facet: Option<Vec<String>>) -> Result<models::DomainPeriodSpapiCombinedVulnerabilitiesResponse, Error<CombinedQueryVulnerabilitiesError>> {
    ...
    let uri_str = format!("{}/spotlight/combined/vulnerabilities/v1", configuration.base_path);
...
pub async fn get_remediations_v2(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodSpapiRemediationEntitiesResponseV2, Error<GetRemediationsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;

    let uri_str = format!("{}/spotlight/entities/remediations/v2", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_vulnerabilities(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodSpapiVulnerabilitiesEntitiesResponseV2, Error<GetVulnerabilitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;

    let uri_str = format!("{}/spotlight/entities/vulnerabilities/v2", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn query_vulnerabilities(configuration: &configuration::Configuration, filter: &str, after: Option<&str>, limit: Option<i32>, sort: Option<&str>) -> Result<models::DomainPeriodSpapiQueryResponse, Error<QueryVulnerabilitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_after = after;
    let p_limit = limit;
    ...
    let uri_str = format!("{}/spotlight/queries/vulnerabilities/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
