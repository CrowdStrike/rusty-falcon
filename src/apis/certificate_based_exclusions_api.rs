...
pub async fn cb_exclusions_period_create_period_v1(configuration: &configuration::Configuration, body: models::ApiPeriodCertBasedExclusionsCreateReqV1) -> Result<models::ApiPeriodCertBasedExclusionRespV1, Error<CbExclusionsPeriodCreatePeriodV1Error>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CbExclusionsPeriodCreatePeriodV1Error> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn cb_exclusions_period_delete_period_v1(configuration: &configuration::Configuration, ids: Vec<String>, comment: Option<&str>) -> Result<models::ApiPeriodCertBasedExclusionRespV1, Error<CbExclusionsPeriodDeletePeriodV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CbExclusionsPeriodDeletePeriodV1Error> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn cb_exclusions_period_get_period_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ApiPeriodCertBasedExclusionRespV1, Error<CbExclusionsPeriodGetPeriodV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CbExclusionsPeriodGetPeriodV1Error> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn cb_exclusions_period_query_period_v1(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<CbExclusionsPeriodQueryPeriodV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_offset = offset;
    let p_limit = limit;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CbExclusionsPeriodQueryPeriodV1Error> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn cb_exclusions_period_update_period_v1(configuration: &configuration::Configuration, body: models::ApiPeriodCertBasedExclusionsUpdateReqV1) -> Result<models::ApiPeriodCertBasedExclusionRespV1, Error<CbExclusionsPeriodUpdatePeriodV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CbExclusionsPeriodUpdatePeriodV1Error> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn certificates_period_get_period_v1(configuration: &configuration::Configuration, ids: &str) -> Result<models::ApiPeriodRespCertificatesV1, Error<CertificatesPeriodGetPeriodV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CertificatesPeriodGetPeriodV1Error> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
