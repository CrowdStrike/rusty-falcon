...
pub async fn query_combined_firewall_policy_members(configuration: &configuration::Configuration, id: Option<&str>, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<crate::models::ResponsesPolicyMembersRespV1, Error<QueryCombinedFirewallPolicyMembersError>> {
    let local_var_configuration = configuration;
