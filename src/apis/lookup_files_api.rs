...
pub async fn create_file_v1(configuration: &configuration::Configuration, file: std::path::PathBuf, name: &str, x_cs_username: Option<&str>, x_cs_useruuid: Option<&str>, description: Option<&str>, id: Option<&str>, repo: Option<&str>) -> Result<models::DomainPeriodLookupFileWrapper, Error<CreateFileV1Error>> {
...
pub async fn update_file_v1(configuration: &configuration::Configuration, id: &str, x_cs_username: Option<&str>, x_cs_useruuid: Option<&str>, description: Option<&str>, file: Option<std::path::PathBuf>) -> Result<models::DomainPeriodLookupFileWrapper, Error<UpdateFileV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_x_cs_username = x_cs_username;
    let p_x_cs_useruuid = x_cs_useruuid;
