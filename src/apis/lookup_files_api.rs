...
pub async fn update_file_v1(configuration: &configuration::Configuration, id: &str, x_cs_username: Option<&str>, x_cs_useruuid: Option<&str>, description: Option<&str>, file: Option<std::path::PathBuf>) -> Result<models::DomainLookupFileWrapper, Error<UpdateFileV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_id = id;
    let p_header_x_cs_username = x_cs_username;
    let p_header_x_cs_useruuid = x_cs_useruuid;
