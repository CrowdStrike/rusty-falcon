...
pub async fn aggregates_file_details_post_v1(
    configuration: &configuration::Configuration,
    ids: Vec<String>,
    body: Vec<serde_json::Value>,
    filter: Option<&str>,
) -> Result<models::ApiAggregatesResponseV1, Error<AggregatesFileDetailsPostV1Error>> {
...
pub async fn combined_file_details_get_v1(
    configuration: &configuration::Configuration,
    filter: Option<&str>,
    limit: Option<i32>,
    offset: Option<i32>,
) -> Result<models::ApiFileDetailsResponseV1, Error<CombinedFileDetailsGetV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ApiFileDetailsResponseV1`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ApiFileDetailsResponseV1`"
                ))));
            }
        }
    } else {
...
pub async fn entities_file_details_get_v1(
    configuration: &configuration::Configuration,
    ids: Vec<String>,
) -> Result<models::ApiFileDetailsResponseV1, Error<EntitiesFileDetailsGetV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn entities_file_details_patch_v1(
    configuration: &configuration::Configuration,
    body: models::ApiUpdateRequestV1,
) -> Result<models::ApiFileDetailsResponseV1, Error<EntitiesFileDetailsPatchV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn entities_files_bulk_download_post_v1(
    configuration: &configuration::Configuration,
    body: models::ApiBulkDownloadRequestV1,
) -> Result<models::ApiDownloadResponseV1, Error<EntitiesFilesBulkDownloadPostV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ApiDownloadResponseV1`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ApiDownloadResponseV1`"
                ))));
            }
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<EntitiesFilesBulkDownloadPostV1Error> =
...
pub async fn entities_files_delete_v1(
    configuration: &configuration::Configuration,
    ids: Vec<String>,
) -> Result<
    models::ApiMsaResponseLeftSquareBracketStringRightSquareBracket,
    Error<EntitiesFilesDeleteV1Error>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::ApiMsaResponseLeftSquareBracketStringRightSquareBracket`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::ApiMsaResponseLeftSquareBracketStringRightSquareBracket`"
                ))));
            }
        }
    } else {
...
pub async fn entities_files_download_get_v1(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::ApiDownloadResponseV1, Error<EntitiesFilesDownloadGetV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn entities_files_download_post_v1(
    configuration: &configuration::Configuration,
    body: models::ApiDownloadRequestV1,
) -> Result<models::ApiDownloadResponseV1, Error<EntitiesFilesDownloadPostV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn entities_files_upload_post_v1(
    configuration: &configuration::Configuration,
) -> Result<models::ApiFileDetailsResponseV1, Error<EntitiesFilesUploadPostV1Error>> {
    let uri_str = format!(
...
pub async fn queries_file_details_get_v1(
    configuration: &configuration::Configuration,
    filter: Option<&str>,
    limit: Option<i32>,
    offset: Option<i32>,
    ...
    models::ApiMsaResponseLeftSquareBracketStringRightSquareBracket,
    Error<QueriesFileDetailsGetV1Error>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_limit = limit;
