...
pub async fn aggregate_query_scan_host_metadata(
...
) -> Result<models::MsaAggregatesResponse, Error<AggregateQueryScanHostMetadataError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AggregateQueryScanHostMetadataError> =
...
pub async fn aggregate_scans(
    configuration: &configuration::Configuration,
    body: Vec<models::MsaAggregateQueryRequest>,
) -> Result<models::MsaAggregatesResponse, Error<AggregateScansError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn aggregate_scheduled_scans(
    configuration: &configuration::Configuration,
    body: Vec<models::MsaAggregateQueryRequest>,
) -> Result<models::MsaAggregatesResponse, Error<AggregateScheduledScansError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
) -> Result<models::MsaspecQueryResponse, Error<CancelScansError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn create_scan(
...
) -> Result<models::EntitiesOdsScanResponse, Error<CreateScanError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::EntitiesOdsScanResponse`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::EntitiesOdsScanResponse`"
                ))));
            }
        }
    } else {
...
pub async fn delete_scheduled_scans(
    ...
    ids: Vec<String>,
    filter: Option<&str>,
) -> Result<models::MsaspecQueryResponse, Error<DeleteScheduledScansError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_malicious_files_by_ids(
    configuration: &configuration::Configuration,
    ids: Vec<String>,
) -> Result<models::EntitiesOdsScanMaliciousFileResponse, Error<GetMaliciousFilesByIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::EntitiesOdsScanMaliciousFileResponse`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::EntitiesOdsScanMaliciousFileResponse`"
                ))));
            }
        }
    } else {
...
pub async fn get_scan_host_metadata_by_ids(
    configuration: &configuration::Configuration,
    ids: Vec<String>,
) -> Result<models::EntitiesOdsScanHostResponse, Error<GetScanHostMetadataByIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::EntitiesOdsScanHostResponse`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::EntitiesOdsScanHostResponse`"
                ))));
            }
        }
    } else {
...
pub async fn get_scans_by_scan_ids(
    configuration: &configuration::Configuration,
    ids: Vec<String>,
) -> Result<models::EntitiesOdsScanResponse, Error<GetScansByScanIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_scans_by_scan_ids_v2(
    configuration: &configuration::Configuration,
    ids: Vec<String>,
) -> Result<models::EntitiesOdsScanResponseV2, Error<GetScansByScanIdsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::EntitiesOdsScanResponseV2`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::EntitiesOdsScanResponseV2`"
                ))));
            }
        }
    } else {
...
pub async fn get_scheduled_scans_by_scan_ids(
    configuration: &configuration::Configuration,
    ids: Vec<String>,
) -> Result<models::EntitiesOdsScheduleScanResponse, Error<GetScheduledScansByScanIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::EntitiesOdsScheduleScanResponse`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::EntitiesOdsScheduleScanResponse`"
                ))));
            }
        }
    } else {
...
pub async fn query_malicious_files(
    ...
    limit: Option<i32>,
    sort: Option<&str>,
) -> Result<models::MsaspecQueryResponse, Error<QueryMaliciousFilesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
...
pub async fn query_scan_host_metadata(
    ...
    limit: Option<i32>,
    sort: Option<&str>,
) -> Result<models::MsaspecQueryResponse, Error<QueryScanHostMetadataError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_offset = offset;
    let p_query_limit = limit;
...
pub async fn query_scans(
    ...
    limit: Option<i32>,
    sort: Option<&str>,
) -> Result<models::MsaspecQueryResponse, Error<QueryScansError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_offset = offset;
    let p_query_limit = limit;
...
pub async fn query_scheduled_scans(
    ...
    limit: Option<i32>,
    sort: Option<&str>,
) -> Result<models::MsaspecQueryResponse, Error<QueryScheduledScansError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_offset = offset;
    let p_query_limit = limit;
...
) -> Result<models::EntitiesOdsScheduleScanResponse, Error<ScheduleScanError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
