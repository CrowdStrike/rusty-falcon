...
pub async fn aggregate_notifications_exposed_data_records_v1(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::DomainPeriodAggregatesResponse, Error<AggregateNotificationsExposedDataRecordsV1Error>> {
...
pub async fn aggregate_notifications_v1(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::DomainPeriodAggregatesResponse, Error<AggregateNotificationsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn create_actions_v1(configuration: &configuration::Configuration, body: models::DomainPeriodRegisterActionsRequest) -> Result<models::DomainPeriodActionEntitiesResponseV1, Error<CreateActionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn create_export_jobs_v1(configuration: &configuration::Configuration, body: Vec<models::DomainPeriodLaunchExportJobRequestV1>) -> Result<models::DomainPeriodLaunchExportJobResponseV1, Error<CreateExportJobsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn create_rules_v1(configuration: &configuration::Configuration, body: Vec<models::SadomainPeriodCreateRuleRequestV1>) -> Result<models::DomainPeriodRulesEntitiesResponseV1, Error<CreateRulesV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn delete_action_v1(configuration: &configuration::Configuration, id: &str) -> Result<models::DomainPeriodQueryResponse, Error<DeleteActionV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn delete_export_jobs_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodExportJobIdResponseV1, Error<DeleteExportJobsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn delete_notifications_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodNotificationIdResponse, Error<DeleteNotificationsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn delete_rules_v1(configuration: &configuration::Configuration, ids: Vec<String>, notifications_deletion_requested: Option<bool>) -> Result<models::DomainPeriodRuleQueryResponseV1, Error<DeleteRulesV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_actions_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodActionEntitiesResponseV1, Error<GetActionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_export_jobs_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodExportJobEntitiesResponseV1, Error<GetExportJobsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_notifications_detailed_translated_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodNotificationDetailsResponseV1, Error<GetNotificationsDetailedTranslatedV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_notifications_detailed_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodNotificationDetailsResponseV1, Error<GetNotificationsDetailedV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_notifications_exposed_data_records_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ApiPeriodNotificationExposedDataRecordEntitiesResponseV1, Error<GetNotificationsExposedDataRecordsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_notifications_translated_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodNotificationEntitiesResponseV1, Error<GetNotificationsTranslatedV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_notifications_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodNotificationEntitiesResponseV1, Error<GetNotificationsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_rules_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodRulesEntitiesResponseV1, Error<GetRulesV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn preview_rule_v1(configuration: &configuration::Configuration, body: models::DomainPeriodRulePreviewRequest) -> Result<models::DomainPeriodAggregatesResponse, Error<PreviewRuleV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn query_actions_v1(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::DomainPeriodQueryResponse, Error<QueryActionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
...
pub async fn query_notifications_exposed_data_records_v1(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::DomainPeriodQueryResponse, Error<QueryNotificationsExposedDataRecordsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
...
pub async fn query_notifications_v1(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::DomainPeriodQueryResponse, Error<QueryNotificationsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
...
pub async fn query_rules_v1(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>, secondary_sort: Option<&str>) -> Result<models::DomainPeriodRuleQueryResponseV1, Error<QueryRulesV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
...
pub async fn update_action_v1(configuration: &configuration::Configuration, body: models::DomainPeriodUpdateActionRequest) -> Result<models::DomainPeriodActionEntitiesResponseV1, Error<UpdateActionV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn update_notifications_v1(configuration: &configuration::Configuration, body: Vec<models::DomainPeriodUpdateNotificationRequestV1>) -> Result<models::DomainPeriodNotificationEntitiesResponseV1, Error<UpdateNotificationsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn update_rules_v1(configuration: &configuration::Configuration, body: Vec<models::DomainPeriodUpdateRuleRequestV1>) -> Result<models::DomainPeriodRulesEntitiesResponseV1, Error<UpdateRulesV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
