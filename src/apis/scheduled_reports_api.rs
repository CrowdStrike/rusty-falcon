...
pub async fn scheduled_reports_period_get(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodScheduledReportsResultV1, Error<ScheduledReportsPeriodGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;

    let uri_str = format!("{}/reports/entities/scheduled-reports/v1", configuration.base_path);
...
pub async fn scheduled_reports_period_launch(configuration: &configuration::Configuration, body: Vec<models::DomainPeriodReportExecutionLaunchRequestV1>) -> Result<models::DomainPeriodReportExecutionsResponseV1, Error<ScheduledReportsPeriodLaunchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/reports/entities/scheduled-reports/execution/v1", configuration.base_path);
...
pub async fn scheduled_reports_period_query(configuration: &configuration::Configuration, sort: Option<&str>, filter: Option<&str>, q: Option<&str>, offset: Option<&str>, limit: Option<i32>) -> Result<models::MsaPeriodQueryResponse, Error<ScheduledReportsPeriodQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_sort = sort;
    let p_filter = filter;
    let p_q = q;
    ...
    let uri_str = format!("{}/reports/queries/scheduled-reports/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
