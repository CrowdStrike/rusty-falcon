...
pub async fn scheduled_reports_get(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainScheduledReportsResultV1, Error<ScheduledReportsGetError>> {
...
pub async fn scheduled_reports_launch(configuration: &configuration::Configuration, body: Vec<models::DomainReportExecutionLaunchRequestV1>) -> Result<models::DomainReportExecutionsResponseV1, Error<ScheduledReportsLaunchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn scheduled_reports_query(configuration: &configuration::Configuration, sort: Option<&str>, filter: Option<&str>, q: Option<&str>, offset: Option<&str>, limit: Option<i32>) -> Result<models::MsaQueryResponse, Error<ScheduledReportsQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
