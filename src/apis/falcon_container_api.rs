...
pub async fn get_credentials(configuration: &configuration::Configuration, ) -> Result<crate::models::MsaEntitiesResponse, Error<GetCredentialsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/container-security/entities/image-registry-credentials/v1", local_var_configuration.base_path);
