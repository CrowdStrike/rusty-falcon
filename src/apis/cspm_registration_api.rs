...
pub async fn azure_download_certificate(configuration: &configuration::Configuration, tenant_id: Vec<String>) -> Result<models::RegistrationAzureDownloadCertificateResponseV1, Error<AzureDownloadCertificateError>> {
    ...
    req_builder = match "multi" {
        "multi" => req_builder.query(&p_query_tenant_id.into_iter().map(|p| ("tenant_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("tenant_id", &p_query_tenant_id.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
...
pub async fn azure_refresh_certificate(configuration: &configuration::Configuration, tenant_id: Vec<String>, years_valid: Option<&str>) -> Result<models::RegistrationAzureDownloadCertificateResponseV1, Error<AzureRefreshCertificateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_tenant_id = tenant_id;
...
pub async fn connect_cspmgcp_account(configuration: &configuration::Configuration, body: models::RegistrationGcpAccountExtRequestV2) -> Result<models::RegistrationGcpAccountResponseExtV2, Error<ConnectCspmgcpAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn create_cspm_aws_account(configuration: &configuration::Configuration, body: models::RegistrationAwsAccountCreateRequestExtV2) -> Result<models::RegistrationAwsAccountResponseV2, Error<CreateCspmAwsAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn create_cspm_azure_account(configuration: &configuration::Configuration, body: models::RegistrationAzureAccountCreateRequestExternalV1) -> Result<models::RegistrationAzureAccountResponseV1, Error<CreateCspmAzureAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn create_cspm_azure_management_group(configuration: &configuration::Configuration, body: models::RegistrationAzureManagementGroupCreateRequestExternalV1) -> Result<models::RegistrationAzureAccountResponseV1, Error<CreateCspmAzureManagementGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn create_cspmgcp_account(configuration: &configuration::Configuration, body: models::RegistrationGcpAccountCreateRequestExtV1) -> Result<models::RegistrationGcpAccountResponseV1, Error<CreateCspmgcpAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn delete_cspm_aws_account(configuration: &configuration::Configuration, ids: Option<Vec<String>>, organization_ids: Option<Vec<String>>) -> Result<models::MsaspecResponseFields, Error<DeleteCspmAwsAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn delete_cspm_azure_account(configuration: &configuration::Configuration, ids: Option<Vec<String>>, tenant_ids: Option<Vec<String>>, retain_tenant: Option<&str>) -> Result<models::MsaBaseEntitiesResponse, Error<DeleteCspmAzureAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn delete_cspm_azure_management_group(configuration: &configuration::Configuration, tenant_ids: Option<Vec<String>>) -> Result<models::MsaspecResponseFields, Error<DeleteCspmAzureManagementGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_tenant_ids = tenant_ids;
...
pub async fn delete_cspmgcp_account(configuration: &configuration::Configuration, ids: Option<Vec<String>>) -> Result<models::MsaBaseEntitiesResponse, Error<DeleteCspmgcpAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_cloud_event_ids(configuration: &configuration::Configuration, x_cs_useruuid: &str, id: &str) -> Result<models::CdrioamanagerGetCloudEventIdsResponse, Error<GetCloudEventIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_configuration_detection_entities(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::RegistrationExternalIomEventResponseV2, Error<GetConfigurationDetectionEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_configuration_detection_ids_v2(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>, next_token: Option<&str>) -> Result<models::RegistrationIomEventIdsResponseV2, Error<GetConfigurationDetectionIdsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_configuration_detections(configuration: &configuration::Configuration, cloud_provider: Option<&str>, account_id: Option<&str>, azure_subscription_id: Option<&str>, azure_tenant_id: Option<&str>, status: Option<&str>, region: Option<&str>, severity: Option<&str>, service: Option<&str>, next_token: Option<&str>, limit: Option<i32>) -> Result<models::RegistrationExternalIomEventResponse, Error<GetConfigurationDetectionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_cloud_provider = cloud_provider;
    let p_query_account_id = account_id;
    let p_query_azure_subscription_id = azure_subscription_id;
...
pub async fn get_cspm_aws_account(configuration: &configuration::Configuration, scan_type: Option<&str>, ids: Option<Vec<String>>, iam_role_arns: Option<Vec<String>>, organization_ids: Option<Vec<String>>, status: Option<&str>, limit: Option<i32>, cspm_lite: Option<&str>, migrated: Option<&str>, offset: Option<i32>, group_by: Option<&str>) -> Result<models::RegistrationAwsAccountResponseV2, Error<GetCspmAwsAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_cspm_aws_console_setup_urls(configuration: &configuration::Configuration, ids: Option<Vec<String>>, use_existing_cloudtrail: Option<&str>, region: Option<&str>, tags: Option<&str>, template: Option<&str>) -> Result<models::RegistrationAwsConsoleUrlResponseV2, Error<GetCspmAwsConsoleSetupUrlsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_cspm_azure_account(configuration: &configuration::Configuration, ids: Option<Vec<String>>, tenant_ids: Option<Vec<String>>, scan_type: Option<&str>, status: Option<&str>, cspm_lite: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::RegistrationAzureAccountResponseV1, Error<GetCspmAzureAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_query_tenant_ids = tenant_ids;
    let p_query_scan_type = scan_type;
...
pub async fn get_cspm_azure_management_group(configuration: &configuration::Configuration, tenant_ids: Option<Vec<String>>, limit: Option<i32>, offset: Option<i32>) -> Result<models::RegistrationAzureManagementGroupResponseV1, Error<GetCspmAzureManagementGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_tenant_ids = tenant_ids;
    let p_query_limit = limit;
    let p_query_offset = offset;
...
pub async fn get_cspm_policies_details(configuration: &configuration::Configuration, ids: Vec<i32>) -> Result<models::RegistrationPolicyResponseV1, Error<GetCspmPoliciesDetailsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_cspm_policy(configuration: &configuration::Configuration, ids: i32) -> Result<models::RegistrationPolicyResponseV1, Error<GetCspmPolicyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_cspm_policy_settings(configuration: &configuration::Configuration, service: Option<&str>, policy_id: Option<&str>, cloud_platform: Option<&str>) -> Result<models::RegistrationPolicySettingsResponseV1, Error<GetCspmPolicySettingsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_service = service;
...
pub async fn get_cspm_scan_schedule(configuration: &configuration::Configuration, cloud_platform: Option<Vec<String>>) -> Result<models::RegistrationScanScheduleResponseV1, Error<GetCspmScanScheduleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_cloud_platform = cloud_platform;
...
pub async fn get_cspmcgp_account(configuration: &configuration::Configuration, parent_type: Option<&str>, ids: Option<Vec<String>>, scan_type: Option<&str>, status: Option<&str>, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>) -> Result<models::RegistrationGcpAccountResponseV1, Error<GetCspmcgpAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_cspmgcp_service_accounts_ext(configuration: &configuration::Configuration, id: Option<&str>) -> Result<models::RegistrationGcpServiceAccountResponseExtV1, Error<GetCspmgcpServiceAccountsExtError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn get_cspmgcp_user_scripts_attachment(configuration: &configuration::Configuration, parent_type: Option<&str>, ids: Option<Vec<String>>) -> Result<models::RegistrationGcpProvisionGetUserScriptResponseV1, Error<GetCspmgcpUserScriptsAttachmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_parent_type = parent_type;
    let p_query_ids = ids;
...
pub async fn get_cspmgcp_validate_accounts_ext(configuration: &configuration::Configuration, body: models::RegistrationGcpAccountValidationRequestV1) -> Result<models::RegistrationGcpAccountValidationResponseV1, Error<GetCspmgcpValidateAccountsExtError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn patch_cspm_aws_account(configuration: &configuration::Configuration, body: models::RegistrationAwsAccountPatchRequest) -> Result<models::RegistrationAwsAccountResponseV2, Error<PatchCspmAwsAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn update_cspm_azure_account(configuration: &configuration::Configuration, body: models::RegistrationAzureAccountPatchRequest) -> Result<models::RegistrationAzureAccountResponseV1, Error<UpdateCspmAzureAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn update_cspm_azure_account_client_id(configuration: &configuration::Configuration, id: &str, tenant_id: Option<&str>) -> Result<models::RegistrationAzureTenantConfigurationResponseV1, Error<UpdateCspmAzureAccountClientIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    let p_query_tenant_id = tenant_id;
...
pub async fn update_cspm_azure_tenant_default_subscription_id(configuration: &configuration::Configuration, subscription_id: &str, tenant_id: Option<&str>) -> Result<models::RegistrationAzureTenantDefaultSubscriptionIdResponseV1, Error<UpdateCspmAzureTenantDefaultSubscriptionIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn update_cspm_policy_settings(configuration: &configuration::Configuration, body: models::RegistrationPolicyRequestExtV1) -> Result<models::RegistrationPolicySettingsResponseV1, Error<UpdateCspmPolicySettingsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn update_cspm_scan_schedule(configuration: &configuration::Configuration, body: models::RegistrationScanScheduleUpdateRequestV1) -> Result<models::RegistrationScanScheduleResponseV1, Error<UpdateCspmScanScheduleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn update_cspmgcp_account(configuration: &configuration::Configuration, body: models::RegistrationGcpAccountPatchRequestV1) -> Result<models::RegistrationGcpAccountResponseV1, Error<UpdateCspmgcpAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn update_cspmgcp_service_accounts_ext(configuration: &configuration::Configuration, body: models::RegistrationGcpServiceAccountPatchRequestV1) -> Result<models::RegistrationGcpServiceAccountResponseExtV1, Error<UpdateCspmgcpServiceAccountsExtError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn validate_cspmgcp_service_account_ext(configuration: &configuration::Configuration, body: models::RegistrationGcpServiceAccountValidationRequestV1) -> Result<models::RegistrationGcpServiceAccountValidationResponseV1, Error<ValidateCspmgcpServiceAccountExtError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
