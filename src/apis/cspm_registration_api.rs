...
pub async fn azure_download_certificate(configuration: &configuration::Configuration, tenant_id: Vec<String>, refresh: Option<&str>) -> Result<crate::models::RegistrationAzureDownloadCertificateResponseV1, Error<AzureDownloadCertificateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/cloud-connect-cspm-azure/entities/download-certificate/v1", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AzureDownloadCertificateError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_cspm_aws_account(
    ...
    offset: Option<i32>,
    group_by: Option<&str>,
) -> Result<crate::models::RegistrationAwsAccountResponseV2, Error<GetCspmAwsAccountError>> {
    let local_var_configuration = configuration;
...
pub async fn get_ioa_events(
    ...
    offset: Option<i32>,
    limit: Option<i32>,
) -> Result<crate::models::RegistrationExternalIoaEventResponse, Error<GetIoaEventsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_ioa_users(
    ...
    azure_subscription_id: Option<&str>,
    azure_tenant_id: Option<&str>,
) -> Result<crate::models::RegistrationIoaUserResponse, Error<GetIoaUsersError>> {
    let local_var_configuration = configuration;
