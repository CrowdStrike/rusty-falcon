...
pub async fn create_or_update_aws_settings(configuration: &configuration::Configuration, body: models::ModelsPeriodModifyAwsCustomerSettingsV1) -> Result<models::ModelsPeriodCustomerConfigurationsV1, Error<CreateOrUpdateAwsSettingsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/cloud-connect-aws/entities/settings/v1", configuration.base_path);
...
pub async fn delete_aws_accounts(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ModelsPeriodBaseResponseV1, Error<DeleteAwsAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;

    let uri_str = format!("{}/cloud-connect-aws/entities/accounts/v1", configuration.base_path);
...
pub async fn get_aws_accounts(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ModelsPeriodAwsAccountsV1, Error<GetAwsAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_aws_settings(configuration: &configuration::Configuration, ) -> Result<models::ModelsPeriodCustomerConfigurationsV1, Error<GetAwsSettingsError>> {

    let uri_str = format!("{}/cloud-connect-aws/combined/settings/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn provision_aws_accounts(configuration: &configuration::Configuration, body: models::ModelsPeriodCreateAwsAccountsV1, mode: Option<&str>) -> Result<models::ModelsPeriodAwsAccountsV1, Error<ProvisionAwsAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
    let p_mode = mode;
...
pub async fn query_aws_accounts(configuration: &configuration::Configuration, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::ModelsPeriodAwsAccountsV1, Error<QueryAwsAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    let p_offset = offset;
    let p_sort = sort;
    ...
    let uri_str = format!("{}/cloud-connect-aws/combined/accounts/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn query_aws_accounts_for_ids(configuration: &configuration::Configuration, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::MsaPeriodQueryResponse, Error<QueryAwsAccountsForIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    let p_offset = offset;
    let p_sort = sort;
    ...
    let uri_str = format!("{}/cloud-connect-aws/queries/accounts/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn update_aws_accounts(configuration: &configuration::Configuration, body: models::ModelsPeriodUpdateAwsAccountsV1) -> Result<models::ModelsPeriodAwsAccountsV1, Error<UpdateAwsAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn verify_aws_account_access(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ModelsPeriodVerifyAccessResponseV1, Error<VerifyAwsAccountAccessError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;

    let uri_str = format!("{}/cloud-connect-aws/entities/verify-account-access/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
