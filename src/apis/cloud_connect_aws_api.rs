...
pub async fn create_or_update_aws_settings(configuration: &configuration::Configuration, body: models::ModelsModifyAwsCustomerSettingsV1) -> Result<models::ModelsCustomerConfigurationsV1, Error<CreateOrUpdateAwsSettingsError>> {
...
pub async fn delete_aws_accounts(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ModelsBaseResponseV1, Error<DeleteAwsAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_aws_accounts(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ModelsAwsAccountsV1, Error<GetAwsAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_aws_settings(configuration: &configuration::Configuration, ) -> Result<models::ModelsCustomerConfigurationsV1, Error<GetAwsSettingsError>> {
...
pub async fn provision_aws_accounts(configuration: &configuration::Configuration, body: models::ModelsCreateAwsAccountsV1, mode: Option<&str>) -> Result<models::ModelsAwsAccountsV1, Error<ProvisionAwsAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn query_aws_accounts(configuration: &configuration::Configuration, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::ModelsAwsAccountsV1, Error<QueryAwsAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn query_aws_accounts_for_ids(configuration: &configuration::Configuration, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::MsaQueryResponse, Error<QueryAwsAccountsForIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_limit = limit;
    let p_query_offset = offset;
    let p_query_sort = sort;
...
pub async fn update_aws_accounts(configuration: &configuration::Configuration, body: models::ModelsUpdateAwsAccountsV1) -> Result<models::ModelsAwsAccountsV1, Error<UpdateAwsAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn verify_aws_account_access(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ModelsVerifyAccessResponseV1, Error<VerifyAwsAccountAccessError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
