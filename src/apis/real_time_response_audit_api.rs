...
pub async fn r_tr_audit_sessions(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<&str>, offset: Option<&str>, with_command_info: Option<bool>) -> Result<models::DomainPeriodSessionResponseWrapper, Error<RTrAuditSessionsError>> {
    ...
    let uri_str = format!("{}/real-time-response-audit/combined/sessions/v1", configuration.base_path);
