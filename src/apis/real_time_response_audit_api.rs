...
pub async fn r_tr_audit_sessions(
    ...
    if let Some(ref local_var_str) = with_command_info {
        local_var_req_builder =
            local_var_req_builder.query(&[("with_command_info", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RTrAuditSessionsError> =
