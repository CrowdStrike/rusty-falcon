...
pub async fn get_runtime_detections_combined_v2(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::RuntimedetectionsDetectionsEntityResponse, Error<GetRuntimeDetectionsCombinedV2Error>> {
