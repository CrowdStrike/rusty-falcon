...
pub async fn aggregate_users_v1(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::FlightcontrolapiPeriodAggregatesResponse, Error<AggregateUsersV1Error>> {
...
pub async fn combined_user_roles_v1(configuration: &configuration::Configuration, user_uuid: &str, cid: Option<&str>, direct_only: Option<bool>, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::FlightcontrolapiPeriodCombinedUserRolesResponseV1, Error<CombinedUserRolesV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn combined_user_roles_v2(configuration: &configuration::Configuration, user_uuid: &str, cid: Option<&str>, direct_only: Option<bool>, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::FlightcontrolapiPeriodCombinedUserRolesResponseV2, Error<CombinedUserRolesV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_uuid = user_uuid;
    let p_cid = cid;
    let p_direct_only = direct_only;
...
pub async fn create_user(configuration: &configuration::Configuration, body: models::DomainPeriodUserCreateRequest) -> Result<models::ApiPeriodUserMetadataResponse, Error<CreateUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn create_user_v1(configuration: &configuration::Configuration, body: models::DomainPeriodCreateUserRequest, validate_only: Option<bool>) -> Result<models::FlightcontrolapiPeriodUserResponse, Error<CreateUserV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn delete_user(configuration: &configuration::Configuration, user_uuid: &str) -> Result<models::MsaPeriodReplyMetaOnly, Error<DeleteUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_uuid = user_uuid;
...
pub async fn delete_user_v1(configuration: &configuration::Configuration, user_uuid: &str) -> Result<models::MsaspecPeriodResponseFields, Error<DeleteUserV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_uuid = user_uuid;
...
pub async fn entities_roles_v1(configuration: &configuration::Configuration, ids: Vec<String>, cid: Option<&str>) -> Result<models::FlightcontrolapiPeriodGetRolesResponse, Error<EntitiesRolesV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
    let p_cid = cid;
...
pub async fn get_available_role_ids(configuration: &configuration::Configuration, ) -> Result<models::MsaPeriodQueryResponse, Error<GetAvailableRoleIdsError>> {
...
pub async fn get_roles(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ApiPeriodUserRoleResponse, Error<GetRolesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_user_role_ids(configuration: &configuration::Configuration, user_uuid: &str) -> Result<models::MsaPeriodQueryResponse, Error<GetUserRoleIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_uuid = user_uuid;
...
pub async fn grant_user_role_ids(configuration: &configuration::Configuration, user_uuid: &str, body: models::DomainPeriodRoleIds) -> Result<models::ApiPeriodUserRoleIdsResponse, Error<GrantUserRoleIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_uuid = user_uuid;
    let p_body = body;
...
pub async fn queries_roles_v1(configuration: &configuration::Configuration, cid: Option<&str>, user_uuid: Option<&str>, action: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueriesRolesV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_cid = cid;
    let p_user_uuid = user_uuid;
    let p_action = action;
...
pub async fn query_user_v1(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryUserV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_offset = offset;
    let p_limit = limit;
...
pub async fn retrieve_emails_by_cid(configuration: &configuration::Configuration, ) -> Result<models::MsaPeriodQueryResponse, Error<RetrieveEmailsByCidError>> {
...
pub async fn retrieve_user(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ApiPeriodUserMetadataResponse, Error<RetrieveUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn retrieve_user_uuid(configuration: &configuration::Configuration, uid: Vec<String>) -> Result<models::MsaPeriodQueryResponse, Error<RetrieveUserUuidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_uid = uid;
    ...
    req_builder = match "multi" {
        "multi" => req_builder.query(&p_uid.into_iter().map(|p| ("uid".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("uid", &p_uid.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
...
pub async fn retrieve_user_uuids_by_cid(configuration: &configuration::Configuration, ) -> Result<models::MsaPeriodQueryResponse, Error<RetrieveUserUuidsByCidError>> {
...
pub async fn retrieve_users_getv1(configuration: &configuration::Configuration, body: models::MsaspecPeriodIdsRequest) -> Result<models::FlightcontrolapiPeriodUserResponse, Error<RetrieveUsersGetv1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn revoke_user_role_ids(configuration: &configuration::Configuration, user_uuid: &str, ids: Vec<String>) -> Result<models::ApiPeriodUserRoleIdsResponse, Error<RevokeUserRoleIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_uuid = user_uuid;
    let p_ids = ids;
...
pub async fn update_user(configuration: &configuration::Configuration, user_uuid: &str, body: models::DomainPeriodUpdateUserFields) -> Result<models::ApiPeriodUserMetadataResponse, Error<UpdateUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_uuid = user_uuid;
    let p_body = body;
...
pub async fn update_user_v1(configuration: &configuration::Configuration, user_uuid: &str, body: models::DomainPeriodUpdateUserRequest) -> Result<models::FlightcontrolapiPeriodUserResponse, Error<UpdateUserV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_uuid = user_uuid;
    let p_body = body;
...
pub async fn user_action_v1(configuration: &configuration::Configuration, body: models::DomainPeriodUserActionRequest) -> Result<models::MsaspecPeriodResponseFields, Error<UserActionV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn user_roles_action_v1(configuration: &configuration::Configuration, body: models::FlightcontrolapiPeriodGrantInput) -> Result<models::MsaspecPeriodResponseFields, Error<UserRolesActionV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
