...
pub async fn get_assessment_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainAssessmentsResponse, Error<GetAssessmentV1Error>> {
...
pub async fn get_assessments_by_score_v1(configuration: &configuration::Configuration, filter: &str, limit: Option<i32>, after: Option<&str>, sort: Option<&str>) -> Result<models::DomainAssessmentsByScoreResponse, Error<GetAssessmentsByScoreV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_audit_v1(configuration: &configuration::Configuration, ) -> Result<models::DomainAuditResponse, Error<GetAuditV1Error>> {
