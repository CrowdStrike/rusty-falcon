...
pub async fn get_assessment_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodAssessmentsResponse, Error<GetAssessmentV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;

    let uri_str = format!("{}/zero-trust-assessment/entities/assessments/v1", configuration.base_path);
...
pub async fn get_assessments_by_score_v1(configuration: &configuration::Configuration, filter: &str, limit: Option<i32>, after: Option<&str>, sort: Option<&str>) -> Result<models::DomainPeriodAssessmentsByScoreResponse, Error<GetAssessmentsByScoreV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_limit = limit;
    let p_after = after;
    ...
    let uri_str = format!("{}/zero-trust-assessment/queries/assessments/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_audit_v1(configuration: &configuration::Configuration, ) -> Result<models::DomainPeriodAuditResponse, Error<GetAuditV1Error>> {

    let uri_str = format!("{}/zero-trust-assessment/entities/audit/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
