...
pub async fn get_scans(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::MlscannerapiPeriodScanV1Response, Error<GetScansError>> {
...
pub async fn get_scans_aggregates(configuration: &configuration::Configuration, body: models::MsaPeriodAggregateQueryRequest) -> Result<(), Error<GetScansAggregatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn query_submissions_mixin0(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>) -> Result<models::MlscannerapiPeriodQueryResponse, Error<QuerySubmissionsMixin0Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_offset = offset;
    let p_limit = limit;
...
pub async fn scan_samples(configuration: &configuration::Configuration, body: models::MlscannerapiPeriodSamplesScanParameters) -> Result<models::MlscannerapiPeriodQueryResponse, Error<ScanSamplesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
