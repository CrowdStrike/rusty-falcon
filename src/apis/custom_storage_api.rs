...
pub async fn delete_object(configuration: &configuration::Configuration, collection_name: &str, object_key: &str, dry_run: Option<bool>) -> Result<models::CustomType3191042536, Error<DeleteObjectError>> {
    ...
    let uri_str = format!("{}/customobjects/v1/collections/{collection_name}/objects/{object_key}", configuration.base_path, collection_name=crate::apis::urlencode(p_path_collection_name), object_key=crate::apis::urlencode(p_path_object_key));
...
pub async fn describe_collection(configuration: &configuration::Configuration, collection_name: &str) -> Result<models::CustomType1942251022, Error<DescribeCollectionError>> {
    ...
    let uri_str = format!("{}/customobjects/v1/collections/{collection_name}", configuration.base_path, collection_name=crate::apis::urlencode(p_path_collection_name));
...
pub async fn describe_collections(configuration: &configuration::Configuration, names: Vec<String>) -> Result<models::CustomType1942251022, Error<DescribeCollectionsError>> {
    ...
    req_builder = match "csv" {
        "multi" => req_builder.query(&p_query_names.into_iter().map(|p| ("names".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("names", &p_query_names.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
...
pub async fn get_object_metadata(configuration: &configuration::Configuration, collection_name: &str, object_key: &str) -> Result<models::CustomType3191042536, Error<GetObjectMetadataError>> {
    ...
    let uri_str = format!("{}/customobjects/v1/collections/{collection_name}/objects/{object_key}/metadata", configuration.base_path, collection_name=crate::apis::urlencode(p_path_collection_name), object_key=crate::apis::urlencode(p_path_object_key));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_schema(configuration: &configuration::Configuration, collection_name: &str, schema_version: &str) -> Result<reqwest::Response, Error<GetSchemaError>> {
    ...
    let uri_str = format!("{}/customobjects/v1/collections/{collection_name}/schemas/{schema_version}", configuration.base_path, collection_name=crate::apis::urlencode(p_path_collection_name), schema_version=crate::apis::urlencode(p_path_schema_version));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_schema_metadata(configuration: &configuration::Configuration, collection_name: &str, schema_version: &str) -> Result<models::CustomType4161059146, Error<GetSchemaMetadataError>> {
    ...
    let uri_str = format!("{}/customobjects/v1/collections/{collection_name}/schemas/{schema_version}/metadata", configuration.base_path, collection_name=crate::apis::urlencode(p_path_collection_name), schema_version=crate::apis::urlencode(p_path_schema_version));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_objects(configuration: &configuration::Configuration, collection_name: &str, end: Option<&str>, limit: Option<i32>, start: Option<&str>) -> Result<models::CustomType1255839303, Error<ListObjectsError>> {
    ...
    let uri_str = format!("{}/customobjects/v1/collections/{collection_name}/objects", configuration.base_path, collection_name=crate::apis::urlencode(p_path_collection_name));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_objects_by_version(configuration: &configuration::Configuration, collection_name: &str, collection_version: &str, end: Option<&str>, limit: Option<i32>, start: Option<&str>) -> Result<models::CustomType1255839303, Error<ListObjectsByVersionError>> {
    ...
    let uri_str = format!("{}/customobjects/v1/collections/{collection_name}/{collection_version}/objects", configuration.base_path, collection_name=crate::apis::urlencode(p_path_collection_name), collection_version=crate::apis::urlencode(p_path_collection_version));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_schemas(configuration: &configuration::Configuration, collection_name: &str, end: Option<&str>, limit: Option<i32>, start: Option<&str>) -> Result<models::CustomType1255839303, Error<ListSchemasError>> {
    ...
    let uri_str = format!("{}/customobjects/v1/collections/{collection_name}/schemas", configuration.base_path, collection_name=crate::apis::urlencode(p_path_collection_name));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
