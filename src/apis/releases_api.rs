...
pub async fn combined_releases_v1_mixin0(configuration: &configuration::Configuration, authorization: &str, x_cs_username: Option<&str>, filter: Option<&str>, limit: Option<i32>, offset: Option<&str>, sort: Option<&str>) -> Result<models::ReleasesReleaseWrapper, Error<CombinedReleasesV1Mixin0Error>> {
