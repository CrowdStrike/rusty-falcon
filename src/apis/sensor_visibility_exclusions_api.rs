...
pub async fn create_sv_exclusions_v1(
    ...
    body: crate::models::RequestsSvExclusionCreateReqV1,
) -> Result<crate::models::ResponsesMlExclusionRespV1, Error<CreateSvExclusionsV1Error>> {
...
pub async fn delete_sensor_visibility_exclusions_v1(
    ...
    ids: Vec<String>,
    comment: Option<&str>,
) -> Result<crate::models::MsaQueryResponse, Error<DeleteSensorVisibilityExclusionsV1Error>> {
    let local_var_configuration = configuration;
...
pub async fn get_sensor_visibility_exclusions_v1(
    configuration: &configuration::Configuration,
    ids: Vec<String>,
) -> Result<crate::models::ResponsesSvExclusionRespV1, Error<GetSensorVisibilityExclusionsV1Error>>
{
    let local_var_configuration = configuration;
...
pub async fn query_sensor_visibility_exclusions_v1(
    ...
    limit: Option<i32>,
    sort: Option<&str>,
) -> Result<crate::models::MsaQueryResponse, Error<QuerySensorVisibilityExclusionsV1Error>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ResponsesSvExclusionRespV1, Error<UpdateSensorVisibilityExclusionsV1Error>>
{
    let local_var_configuration = configuration;
