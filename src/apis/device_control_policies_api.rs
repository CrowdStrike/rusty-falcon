...
pub async fn create_device_control_policies(configuration: &configuration::Configuration, body: models::DeviceControlCreatePoliciesV1) -> Result<models::DeviceControlRespV2, Error<CreateDeviceControlPoliciesError>> {
...
pub async fn delete_device_control_policies(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::MsaQueryResponse, Error<DeleteDeviceControlPoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_default_device_control_policies(configuration: &configuration::Configuration, ) -> Result<models::DeviceControlRespV1, Error<GetDefaultDeviceControlPoliciesError>> {
...
pub async fn get_device_control_policies(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DeviceControlRespV1, Error<GetDeviceControlPoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn perform_device_control_policies_action(configuration: &configuration::Configuration, action_name: &str, body: models::MsaEntityActionRequestV2) -> Result<models::DeviceControlRespV1, Error<PerformDeviceControlPoliciesActionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn query_combined_device_control_policies(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::DeviceControlRespV1, Error<QueryCombinedDeviceControlPoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn query_combined_device_control_policy_members(configuration: &configuration::Configuration, id: Option<&str>, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::BasePolicyMembersRespV1, Error<QueryCombinedDeviceControlPolicyMembersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    let p_query_filter = filter;
    let p_query_offset = offset;
...
pub async fn query_device_control_policies(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::MsaQueryResponse, Error<QueryDeviceControlPoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_offset = offset;
    let p_query_limit = limit;
...
pub async fn query_device_control_policy_members(configuration: &configuration::Configuration, id: Option<&str>, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::MsaQueryResponse, Error<QueryDeviceControlPolicyMembersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    let p_query_filter = filter;
    let p_query_offset = offset;
...
pub async fn set_device_control_policies_precedence(configuration: &configuration::Configuration, body: models::BaseSetPolicyPrecedenceReqV1) -> Result<models::MsaQueryResponse, Error<SetDeviceControlPoliciesPrecedenceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn update_default_device_control_policies(configuration: &configuration::Configuration, body: models::DeviceControlReqUpdateDefaultDcPolicyV1) -> Result<models::DeviceControlRespV1, Error<UpdateDefaultDeviceControlPoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn update_device_control_policies(configuration: &configuration::Configuration, body: models::DeviceControlUpdatePoliciesReqV1) -> Result<models::DeviceControlRespV1, Error<UpdateDeviceControlPoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
