...
pub async fn connect_d4_cgcp_account(configuration: &configuration::Configuration, body: models::RegistrationGcpAccountExtRequestV2) -> Result<models::RegistrationGcpAccountResponseExtV2, Error<ConnectD4CgcpAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/cloud-connect-gcp/entities/account/v2", configuration.base_path);
...
pub async fn create_d4_c_aws_account(configuration: &configuration::Configuration, body: models::RegistrationAwsAccountCreateRequestD4CExtV2) -> Result<models::RegistrationAwsAccountResponseV2, Error<CreateD4CAwsAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/cloud-connect-aws/entities/account/v2", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn create_d4_cgcp_account(configuration: &configuration::Configuration, body: models::RegistrationGcpAccountCreateRequestExtV1) -> Result<models::RegistrationGcpAccountResponseV1, Error<CreateD4CgcpAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/cloud-connect-gcp/entities/account/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn create_discover_cloud_azure_account(configuration: &configuration::Configuration, body: models::RegistrationAzureAccountCreateRequestExternalV1) -> Result<models::RegistrationAzureAccountResponseV1, Error<CreateDiscoverCloudAzureAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/cloud-connect-azure/entities/account/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateDiscoverCloudAzureAccountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn delete_d4_c_aws_account(configuration: &configuration::Configuration, ids: Option<Vec<String>>, organization_ids: Option<Vec<String>>) -> Result<models::MsaspecResponseFields, Error<DeleteD4CAwsAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn delete_d4_cgcp_account(configuration: &configuration::Configuration, ids: Option<Vec<String>>) -> Result<models::MsaBaseEntitiesResponse, Error<DeleteD4CgcpAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_d4_c_aws_account(configuration: &configuration::Configuration, scan_type: Option<&str>, ids: Option<Vec<String>>, organization_ids: Option<Vec<String>>, status: Option<&str>, limit: Option<i32>, offset: Option<i32>, migrated: Option<&str>) -> Result<models::RegistrationAwsAccountResponseV2, Error<GetD4CAwsAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_d4_c_aws_console_setup_urls(configuration: &configuration::Configuration, region: Option<&str>) -> Result<models::RegistrationAwsConsoleUrlResponseV2, Error<GetD4CAwsConsoleSetupUrlsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_region = region;

    let uri_str = format!("{}/cloud-connect-aws/entities/console-setup-urls/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_d4_caws_account_scripts_attachment(configuration: &configuration::Configuration, ids: Option<Vec<String>>, template: Option<&str>, accounts: Option<Vec<String>>, behavior_assessment_enabled: Option<&str>, sensor_management_enabled: Option<&str>, dspm_enabled: Option<&str>, dspm_regions: Option<Vec<String>>, dspm_role: Option<&str>, use_existing_cloudtrail: Option<&str>, organization_id: Option<&str>, organizational_unit_ids: Option<Vec<String>>, aws_profile: Option<&str>, aws_region: Option<&str>, iam_role_arn: Option<&str>, falcon_client_id: Option<&str>, idp_enabled: Option<&str>, tags: Option<&str>) -> Result<models::RegistrationAwsProvisionGetAccountScriptResponseV2, Error<GetD4CawsAccountScriptsAttachmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    ...
    let uri_str = format!("{}/cloud-connect-aws/entities/user-scripts-download/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if let Some(ref param_value) = p_query_behavior_assessment_enabled {
        req_builder = req_builder.query(&[("behavior_assessment_enabled", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = p_query_dspm_regions {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("dspm_regions".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("dspm_regions", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref param_value) = p_query_organizational_unit_ids {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("organizational_unit_ids".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("organizational_unit_ids", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RegistrationAwsProvisionGetAccountScriptResponseV2`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetD4CawsAccountScriptsAttachmentError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_d4_ccgp_account(configuration: &configuration::Configuration, parent_type: Option<&str>, ids: Option<Vec<String>>, scan_type: Option<&str>, status: Option<&str>, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>) -> Result<models::RegistrationGcpAccountResponseV1, Error<GetD4CcgpAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_d4_cgcp_service_accounts_ext(configuration: &configuration::Configuration, id: Option<&str>) -> Result<models::RegistrationGcpServiceAccountResponseExtV1, Error<GetD4CgcpServiceAccountsExtError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;

    let uri_str = format!("{}/cloud-connect-gcp/entities/service-accounts/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_d4_cgcp_user_scripts(configuration: &configuration::Configuration, parent_type: Option<&str>) -> Result<models::RegistrationGcpProvisionGetUserScriptResponseV1, Error<GetD4CgcpUserScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_parent_type = parent_type;

    let uri_str = format!("{}/cloud-connect-gcp/entities/user-scripts/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_d4_cgcp_user_scripts_attachment(configuration: &configuration::Configuration, parent_type: Option<&str>, ids: Option<Vec<String>>, status: Option<&str>) -> Result<models::RegistrationGcpProvisionGetUserScriptResponseV1, Error<GetD4CgcpUserScriptsAttachmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_parent_type = parent_type;
    let p_query_ids = ids;
    let p_query_status = status;

    let uri_str = format!("{}/cloud-connect-gcp/entities/user-scripts-download/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetD4CgcpUserScriptsAttachmentError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_discover_cloud_azure_account(configuration: &configuration::Configuration, ids: Option<Vec<String>>, tenant_ids: Option<Vec<String>>, scan_type: Option<&str>, status: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::RegistrationAzureAccountResponseV1, Error<GetDiscoverCloudAzureAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_discover_cloud_azure_tenant_ids(configuration: &configuration::Configuration, ) -> Result<models::RegistrationAzureTenantIdsResponseV1, Error<GetDiscoverCloudAzureTenantIdsError>> {

    let uri_str = format!("{}/cloud-connect-azure/entities/tenant-id/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RegistrationAzureTenantIdsResponseV1`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetDiscoverCloudAzureTenantIdsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_discover_cloud_azure_user_scripts(configuration: &configuration::Configuration, ) -> Result<models::RegistrationAzureProvisionGetUserScriptResponseV1, Error<GetDiscoverCloudAzureUserScriptsError>> {

    let uri_str = format!("{}/cloud-connect-azure/entities/user-scripts/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetDiscoverCloudAzureUserScriptsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_discover_cloud_azure_user_scripts_attachment(configuration: &configuration::Configuration, tenant_id: Vec<String>, subscription_ids: Option<Vec<String>>, template: Option<&str>, azure_management_group: Option<bool>) -> Result<models::RegistrationAzureProvisionGetUserScriptResponseV1, Error<GetDiscoverCloudAzureUserScriptsAttachmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/cloud-connect-azure/entities/user-scripts-download/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    req_builder = match "csv" {
        "multi" => req_builder.query(&p_query_tenant_id.into_iter().map(|p| ("tenant-id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("tenant-id", &p_query_tenant_id.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetDiscoverCloudAzureUserScriptsAttachmentError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_horizon_d4_c_scripts(configuration: &configuration::Configuration, single_account: Option<&str>, organization_id: Option<&str>, delete: Option<&str>, account_type: Option<&str>) -> Result<models::RegistrationStaticScriptsResponse, Error<GetHorizonD4CScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/settings-discover/entities/gen/scripts/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RegistrationStaticScriptsResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn update_d4_cgcp_service_accounts_ext(configuration: &configuration::Configuration, body: models::RegistrationGcpServiceAccountPatchRequestV1) -> Result<models::RegistrationGcpServiceAccountResponseExtV1, Error<UpdateD4CgcpServiceAccountsExtError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateD4CgcpServiceAccountsExtError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn update_discover_cloud_azure_account_client_id(configuration: &configuration::Configuration, id: &str, object_id: Option<&str>, tenant_id: Option<&str>) -> Result<models::RegistrationAzureTenantConfigurationResponseV1, Error<UpdateDiscoverCloudAzureAccountClientIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    let p_query_object_id = object_id;
    let p_query_tenant_id = tenant_id;

    let uri_str = format!("{}/cloud-connect-azure/entities/client-id/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::PATCH, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateDiscoverCloudAzureAccountClientIdError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
