...
> {
    ...
    if let Some(ref local_var_str) = organizational_unit_ids {
        local_var_req_builder = match "csv" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
    ...
    if let Some(ref local_var_str) = aws_region {
        local_var_req_builder =
            local_var_req_builder.query(&[("aws_region", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = iam_role_arn {
        local_var_req_builder =
            local_var_req_builder.query(&[("iam_role_arn", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = falcon_client_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("falcon_client_id", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = idp_enabled {
        local_var_req_builder =
            local_var_req_builder.query(&[("idp_enabled", &local_var_str.to_string())]);
    }
