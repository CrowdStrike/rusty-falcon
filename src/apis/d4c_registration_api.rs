...
pub async fn connect_d4_cgcp_account(configuration: &configuration::Configuration, body: models::RegistrationPeriodGcpAccountExtRequestV2) -> Result<models::RegistrationPeriodGcpAccountResponseExtV2, Error<ConnectD4CgcpAccountError>> {
...
pub async fn create_d4_c_aws_account(configuration: &configuration::Configuration, body: models::RegistrationPeriodAwsAccountCreateRequestD4CExtV2) -> Result<models::RegistrationPeriodAwsAccountResponseV2, Error<CreateD4CAwsAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn create_d4_cgcp_account(configuration: &configuration::Configuration, body: models::RegistrationPeriodGcpAccountCreateRequestExtV1) -> Result<models::RegistrationPeriodGcpAccountResponseV1, Error<CreateD4CgcpAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn create_discover_cloud_azure_account(configuration: &configuration::Configuration, body: models::RegistrationPeriodAzureAccountCreateRequestExternalV1) -> Result<models::RegistrationPeriodAzureAccountResponseV1, Error<CreateDiscoverCloudAzureAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn delete_d4_c_aws_account(configuration: &configuration::Configuration, ids: Option<Vec<String>>, organization_ids: Option<Vec<String>>) -> Result<models::MsaspecPeriodResponseFields, Error<DeleteD4CAwsAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn delete_d4_cgcp_account(configuration: &configuration::Configuration, ids: Option<Vec<String>>) -> Result<models::MsaPeriodBaseEntitiesResponse, Error<DeleteD4CgcpAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_d4_c_aws_account(configuration: &configuration::Configuration, scan_type: Option<&str>, ids: Option<Vec<String>>, organization_ids: Option<Vec<String>>, status: Option<&str>, limit: Option<i32>, offset: Option<i32>, migrated: Option<&str>) -> Result<models::RegistrationPeriodAwsAccountResponseV2, Error<GetD4CAwsAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_d4_c_aws_console_setup_urls(configuration: &configuration::Configuration, region: Option<&str>) -> Result<models::RegistrationPeriodAwsConsoleUrlResponseV2, Error<GetD4CAwsConsoleSetupUrlsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_region = region;
...
pub async fn get_d4_ccgp_account(configuration: &configuration::Configuration, parent_type: Option<&str>, ids: Option<Vec<String>>, scan_type: Option<&str>, status: Option<&str>, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>) -> Result<models::RegistrationPeriodGcpAccountResponseV1, Error<GetD4CcgpAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_d4_cgcp_service_accounts_ext(configuration: &configuration::Configuration, id: Option<&str>) -> Result<models::RegistrationPeriodGcpServiceAccountResponseExtV1, Error<GetD4CgcpServiceAccountsExtError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn get_d4_cgcp_user_scripts(configuration: &configuration::Configuration, parent_type: Option<&str>) -> Result<models::RegistrationPeriodGcpProvisionGetUserScriptResponseV1, Error<GetD4CgcpUserScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_parent_type = parent_type;
...
pub async fn get_d4_cgcp_user_scripts_attachment(configuration: &configuration::Configuration, parent_type: Option<&str>, ids: Option<Vec<String>>, status: Option<&str>) -> Result<models::RegistrationPeriodGcpProvisionGetUserScriptResponseV1, Error<GetD4CgcpUserScriptsAttachmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_parent_type = parent_type;
    let p_ids = ids;
    let p_status = status;
...
pub async fn get_discover_cloud_azure_account(configuration: &configuration::Configuration, ids: Option<Vec<String>>, tenant_ids: Option<Vec<String>>, scan_type: Option<&str>, status: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::RegistrationPeriodAzureAccountResponseV1, Error<GetDiscoverCloudAzureAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_discover_cloud_azure_tenant_ids(configuration: &configuration::Configuration, ) -> Result<models::RegistrationPeriodAzureTenantIdsResponseV1, Error<GetDiscoverCloudAzureTenantIdsError>> {
...
pub async fn get_discover_cloud_azure_user_scripts(configuration: &configuration::Configuration, ) -> Result<models::RegistrationPeriodAzureProvisionGetUserScriptResponseV1, Error<GetDiscoverCloudAzureUserScriptsError>> {
...
pub async fn get_discover_cloud_azure_user_scripts_attachment(configuration: &configuration::Configuration, tenant_id: Vec<String>, subscription_ids: Option<Vec<String>>, template: Option<&str>, azure_management_group: Option<bool>) -> Result<models::RegistrationPeriodAzureProvisionGetUserScriptResponseV1, Error<GetDiscoverCloudAzureUserScriptsAttachmentError>> {
    ...
    req_builder = match "csv" {
        "multi" => req_builder.query(&p_tenant_id.into_iter().map(|p| ("tenant-id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
        _ => req_builder.query(&[("tenant-id", &p_tenant_id.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
    };
...
pub async fn get_horizon_d4_c_scripts(configuration: &configuration::Configuration, single_account: Option<&str>, organization_id: Option<&str>, delete: Option<&str>, account_type: Option<&str>) -> Result<models::RegistrationPeriodStaticScriptsResponse, Error<GetHorizonD4CScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn update_d4_cgcp_service_accounts_ext(configuration: &configuration::Configuration, body: models::RegistrationPeriodGcpServiceAccountPatchRequestV1) -> Result<models::RegistrationPeriodGcpServiceAccountResponseExtV1, Error<UpdateD4CgcpServiceAccountsExtError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn update_discover_cloud_azure_account_client_id(configuration: &configuration::Configuration, id: &str, object_id: Option<&str>, tenant_id: Option<&str>) -> Result<models::RegistrationPeriodAzureTenantConfigurationResponseV1, Error<UpdateDiscoverCloudAzureAccountClientIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
