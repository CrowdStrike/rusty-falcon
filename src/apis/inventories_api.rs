...
pub async fn create_inventory(
    ...
    body: crate::models::ModelsPeriodSnapshotInventoryPayload,
) -> Result<crate::models::CommonPeriodEntitiesResponse, Error<CreateInventoryError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateInventoryError> =
