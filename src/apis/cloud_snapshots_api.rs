...
pub async fn get_credentials_mixin0_mixin60(configuration: &configuration::Configuration, ) -> Result<models::ModelsPeriodRegistryCredentialsResponse, Error<GetCredentialsMixin0Mixin60Error>> {
