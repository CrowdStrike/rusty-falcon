...
pub async fn create_deployment_entity(configuration: &configuration::Configuration, body: models::ModelsPeriodCreateDeploymentInput) -> Result<models::DeploymentsPeriodEntityResponse, Error<CreateDeploymentEntityError>> {
...
pub async fn get_credentials_mixin0_mixin61(configuration: &configuration::Configuration, ) -> Result<models::ModelsPeriodRegistryCredentialsResponse, Error<GetCredentialsMixin0Mixin61Error>> {
...
pub async fn get_scan_report(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ScanreportsPeriodEntitiesResponse, Error<GetScanReportError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn read_deployments_combined(configuration: &configuration::Configuration, filter: Option<&str>, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>) -> Result<models::DeploymentsPeriodEntityResponse, Error<ReadDeploymentsCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_limit = limit;
    let p_offset = offset;
...
pub async fn read_deployments_entities(configuration: &configuration::Configuration, ids: Option<Vec<String>>) -> Result<models::DeploymentsPeriodEntityResponse, Error<ReadDeploymentsEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn register_cspm_snapshot_account(configuration: &configuration::Configuration, body: models::ModelsPeriodAccountEntitiesInput) -> Result<models::ModelsPeriodAccountStatusResponse, Error<RegisterCspmSnapshotAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
