...
pub async fn aggregate_assessments_grouped_by_clusters_v2(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, filter: Option<&str>) -> Result<models::DomainPeriodApiAggregateResponseGroupByClustersV2, Error<AggregateAssessmentsGroupedByClustersV2Error>> {
...
pub async fn aggregate_assessments_grouped_by_rules_v2(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, filter: Option<&str>) -> Result<models::DomainPeriodApiAggregateResponseGroupByRulesV1, Error<AggregateAssessmentsGroupedByRulesV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_filter = filter;
...
pub async fn aggregate_compliance_by_asset_type(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::DomainPeriodApiAggregateResponseComplianceByAssetTypeV1, Error<AggregateComplianceByAssetTypeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn aggregate_compliance_by_cluster_type(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::DomainPeriodApiAggregateResponseComplianceByClusterTypeV1, Error<AggregateComplianceByClusterTypeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn aggregate_compliance_by_framework(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::DomainPeriodApiAggregateResponseComplianceByFrameworkV1, Error<AggregateComplianceByFrameworkError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn aggregate_failed_rules_by_clusters_v3(configuration: &configuration::Configuration, filter: Option<&str>, limit: Option<i32>) -> Result<models::DomainPeriodApiAggregateResponseFailedRulesByClustersTypeV2, Error<AggregateFailedRulesByClustersV3Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_limit = limit;
...
pub async fn aggregate_top_failed_images(configuration: &configuration::Configuration, filter: Option<&str>, limit: Option<i32>) -> Result<models::DomainPeriodApiAggregateResponseTopFailedImagesV1, Error<AggregateTopFailedImagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_limit = limit;
...
pub async fn combined_images_findings(configuration: &configuration::Configuration, filter: Option<&str>, after: Option<&str>, limit: Option<i32>) -> Result<models::DomainPeriodApiResponseImagesFindingsV1, Error<CombinedImagesFindingsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_after = after;
    let p_limit = limit;
...
pub async fn combined_nodes_findings(configuration: &configuration::Configuration, filter: Option<&str>, after: Option<&str>, limit: Option<i32>) -> Result<models::DomainPeriodApiResponseNodesFindingsV1, Error<CombinedNodesFindingsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_after = after;
    let p_limit = limit;
...
pub async fn get_rules_metadata_by_id(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodRuleMetadataResponse, Error<GetRulesMetadataByIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
