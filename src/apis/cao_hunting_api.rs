...
pub async fn aggregate_intelligence_queries(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::ApiPeriodIntelligenceQueryAggregatesResponse, Error<AggregateIntelligenceQueriesError>> {
...
pub async fn get_intelligence_queries(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ApiPeriodIntelligenceQueryEntityResponse, Error<GetIntelligenceQueriesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn search_intelligence_queries(configuration: &configuration::Configuration, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<SearchIntelligenceQueriesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
