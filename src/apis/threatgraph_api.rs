...
pub async fn combined_summary_get(configuration: &configuration::Configuration, vertex_type: &str, ids: Vec<String>, scope: Option<&str>, nano: Option<bool>) -> Result<(), Error<CombinedSummaryGetError>> {
    ...
    let uri_str = format!("{}/threatgraph/combined/{vertex_type}/summary/v1", configuration.base_path, vertex_type=crate::apis::urlencode(p_path_vertex_type));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn entities_vertices_get(configuration: &configuration::Configuration, vertex_type: &str, ids: Vec<String>, scope: Option<&str>, nano: Option<bool>) -> Result<models::ThreatgraphVertexDetailsResponse, Error<EntitiesVerticesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_vertex_type = vertex_type;
    let p_query_ids = ids;
    let p_query_scope = scope;
    ...
    let uri_str = format!("{}/threatgraph/entities/{vertex_type}/v1", configuration.base_path, vertex_type=crate::apis::urlencode(p_path_vertex_type));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn entities_vertices_getv2(configuration: &configuration::Configuration, vertex_type: &str, ids: Vec<String>, scope: Option<&str>, nano: Option<bool>) -> Result<models::ThreatgraphVertexDetailsResponse, Error<EntitiesVerticesGetv2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_vertex_type = vertex_type;
    let p_query_ids = ids;
    let p_query_scope = scope;
    ...
    let uri_str = format!("{}/threatgraph/entities/{vertex_type}/v2", configuration.base_path, vertex_type=crate::apis::urlencode(p_path_vertex_type));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn queries_edgetypes_get(configuration: &configuration::Configuration, ) -> Result<(), Error<QueriesEdgetypesGetError>> {
    ...
    let uri_str = format!("{}/threatgraph/queries/edge-types/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
