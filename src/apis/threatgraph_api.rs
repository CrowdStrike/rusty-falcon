...
pub async fn combined_summary_get(configuration: &configuration::Configuration, vertex_type: &str, ids: Vec<String>, scope: Option<&str>, nano: Option<bool>) -> Result<(), Error<CombinedSummaryGetError>> {
    ...
    let uri_str = format!("{}/threatgraph/combined/{vertex_type}/summary/v1", configuration.base_path, vertex_type=crate::apis::urlencode(p_vertex_type));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn entities_vertices_get(configuration: &configuration::Configuration, vertex_type: &str, ids: Vec<String>, scope: Option<&str>, nano: Option<bool>) -> Result<models::ThreatgraphPeriodVertexDetailsResponse, Error<EntitiesVerticesGetError>> {
    ...
    let uri_str = format!("{}/threatgraph/entities/{vertex_type}/v1", configuration.base_path, vertex_type=crate::apis::urlencode(p_vertex_type));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn entities_vertices_getv2(configuration: &configuration::Configuration, vertex_type: &str, ids: Vec<String>, scope: Option<&str>, nano: Option<bool>) -> Result<models::ThreatgraphPeriodVertexDetailsResponse, Error<EntitiesVerticesGetv2Error>> {
    ...
    let uri_str = format!("{}/threatgraph/entities/{vertex_type}/v2", configuration.base_path, vertex_type=crate::apis::urlencode(p_vertex_type));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
