...
pub async fn get_events_body(configuration: &configuration::Configuration, id: &str) -> Result<Vec<i32>, Error<GetEventsBodyError>> {
    ...
    let uri_str = format!("{}/ti/events/entities/events-full-body/v2", configuration.base_path);
...
pub async fn get_events_entities(configuration: &configuration::Configuration, body: models::MsaPeriodIdsRequest) -> Result<models::DomainPeriodEventEntitiesResponse, Error<GetEventsEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/ti/events/entities/events/GET/v2", configuration.base_path);
...
pub async fn get_rules_entities(configuration: &configuration::Configuration, body: models::MsaPeriodIdsRequest) -> Result<models::DomainPeriodRuleEntitiesResponse, Error<GetRulesEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn query_events(configuration: &configuration::Configuration, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::DomainPeriodQueryResponse, Error<QueryEventsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
...
pub async fn query_rules(configuration: &configuration::Configuration, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::DomainPeriodQueryResponse, Error<QueryRulesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
