...
pub async fn get_events_entities(configuration: &configuration::Configuration, body: models::MsaIdsRequest) -> Result<models::DomainEventEntitiesResponse, Error<GetEventsEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_rules_entities(configuration: &configuration::Configuration, body: models::MsaIdsRequest) -> Result<models::DomainRuleEntitiesResponse, Error<GetRulesEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn query_events(configuration: &configuration::Configuration, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::DomainQueryResponse, Error<QueryEventsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn query_rules(configuration: &configuration::Configuration, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>, q: Option<&str>) -> Result<models::DomainQueryResponse, Error<QueryRulesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
    let p_query_sort = sort;
