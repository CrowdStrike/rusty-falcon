...
pub async fn create_executor_node(configuration: &configuration::Configuration, body: models::TypesPeriodExecutorNode) -> Result<models::TypesPeriodExecutorNode, Error<CreateExecutorNodeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/executor_nodes", configuration.base_path);
...
pub async fn create_integration(configuration: &configuration::Configuration, body: models::TypesPeriodCreateIntegrationRequest) -> Result<models::TypesPeriodCreateIntegrationResponse, Error<CreateIntegrationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/integrations", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn create_integration_task(configuration: &configuration::Configuration, body: models::TypesPeriodCreateIntegrationTaskRequest) -> Result<models::TypesPeriodIntegrationTaskResponse, Error<CreateIntegrationTaskError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/integration_tasks", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn delete_executor_node(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<DeleteExecutorNodeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/executor_nodes/{ID}", configuration.base_path, ID=p_id);
...
pub async fn delete_integration(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<DeleteIntegrationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/integrations/{ID}", configuration.base_path, ID=p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn delete_integration_task(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<DeleteIntegrationTaskError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/integration_tasks/{ID}", configuration.base_path, ID=p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn delete_slash_group_slash_left_curly_bracket_id_left_square_bracket_09_right_square_bracket_plus_right_curly_bracket(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<DeleteSlashGroupSlashLeftCurlyBracketIdLeftSquareBracket09RightSquareBracketPlusRightCurlyBracketError>> {
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/group/{ID}", configuration.base_path, ID=p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn delete_tags(configuration: &configuration::Configuration, body: models::TypesPeriodEditTagRequest) -> Result<(), Error<DeleteTagsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn execute_function_data(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesPeriodGeneralQueryResponse, Error<ExecuteFunctionDataError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_field = field;

    let uri_str = format!("{}/application-security/combined/function-data/v1", configuration.base_path);
...
pub async fn execute_function_data_count(configuration: &configuration::Configuration, query_name: &str, cloud_provider: &str, aws_lambda_arn: Option<&str>, gcp_cloud_function_url: Option<&str>, azure_site_subscription_id: Option<&str>, azure_site_resource_group: Option<&str>, azure_function_app_name: Option<&str>) -> Result<models::TypesPeriodCountResponse, Error<ExecuteFunctionDataCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/application-security/aggregates/function-data/count/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if let Some(ref param_value) = p_azure_site_subscription_id {
        req_builder = req_builder.query(&[("azure_site_subscription_id", &param_value.to_string())]);
    }
...
pub async fn execute_function_data_query(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesPeriodGeneralQueryResponse, Error<ExecuteFunctionDataQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_field = field;

    let uri_str = format!("{}/application-security/combined/query-function-data/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn execute_function_data_query_count(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesPeriodCountResponse, Error<ExecuteFunctionDataQueryCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_field = field;

    let uri_str = format!("{}/application-security/aggregates/query-function-data-count/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ExecuteFunctionDataQueryCountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn execute_functions(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesPeriodGeneralQueryResponse, Error<ExecuteFunctionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_field = field;

    let uri_str = format!("{}/application-security/combined/functions/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn execute_functions_count(configuration: &configuration::Configuration, query_name: &str, cloud_provider: Option<Vec<String>>, cloud_account_id: Option<Vec<String>>, region: Option<Vec<String>>, cid: Option<Vec<String>>) -> Result<models::TypesPeriodCountResponse, Error<ExecuteFunctionsCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_name = query_name;
    let p_cloud_provider = cloud_provider;
    ...
    let uri_str = format!("{}/application-security/aggregates/functions/count/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);

    req_builder = req_builder.query(&[("query_name", &p_query_name.to_string())]);
    if let Some(ref param_value) = p_cloud_provider {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("cloud_provider".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("cloud_provider", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_cloud_account_id {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("cloud_account_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("cloud_account_id", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_region {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("region".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("region", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_cid {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("cid".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("cid", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
...
pub async fn execute_functions_overtime(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesPeriodOvertimeResponse, Error<ExecuteFunctionsOvertimeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_field = field;

    let uri_str = format!("{}/application-security/combined/functions-overtime/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn execute_functions_query(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesPeriodGeneralQueryResponse, Error<ExecuteFunctionsQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_field = field;

    let uri_str = format!("{}/application-security/combined/query-functions/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn execute_functions_query_count(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesPeriodCountResponse, Error<ExecuteFunctionsQueryCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_field = field;

    let uri_str = format!("{}/application-security/aggregates/query-functions-count/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn execute_functions_query_overtime(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesPeriodOvertimeResponse, Error<ExecuteFunctionsQueryOvertimeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_field = field;

    let uri_str = format!("{}/application-security/combined/query-functions-overtime/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ExecuteFunctionsQueryOvertimeError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn execute_query(configuration: &configuration::Configuration, body: models::TypesPeriodQueryRequest) -> Result<models::TypesPeriodQueryResponse, Error<ExecuteQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn get_cloud_security_integration_state(configuration: &configuration::Configuration, ) -> Result<models::TypesPeriodGetCloudSecurityIntegrationStateResponse, Error<GetCloudSecurityIntegrationStateError>> {

    let uri_str = format!("{}/aspm-api-gateway/api/v1/cloud_security_config", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetCloudSecurityIntegrationStateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_cspm_inventory_ba_services(configuration: &configuration::Configuration, business_application_name: &str, offset: Option<i32>, limit: Option<i32>) -> Result<models::TypesPeriodGeneralQueryResponse, Error<GetCspmInventoryBaServicesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_business_application_name = business_application_name;
    let p_offset = offset;
    let p_limit = limit;

    let uri_str = format!("{}/application-security/combined/cspm-inventory-ba-services/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    req_builder = req_builder.query(&[("business_application_name", &p_business_application_name.to_string())]);
...
pub async fn get_cspm_inventory_service_details(configuration: &configuration::Configuration, persistent_signature: &str) -> Result<models::TypesPeriodGeneralQueryResponse, Error<GetCspmInventoryServiceDetailsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_persistent_signature = persistent_signature;

    let uri_str = format!("{}/application-security/combined/cspm-inventory-service-data/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    req_builder = req_builder.query(&[("persistent_signature", &p_persistent_signature.to_string())]);
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    if let Some(ref token) = configuration.oauth_access_token {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetCspmInventoryServiceDetailsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_executor_nodes(configuration: &configuration::Configuration, node_type: &str, integration_type: Option<i32>, offset: Option<i32>, limit: Option<i32>, order_by: Option<&str>, direction: Option<&str>, executor_node_ids: Option<Vec<String>>, executor_node_names: Option<Vec<String>>, executor_node_states: Option<Vec<i32>>, executor_node_types: Option<Vec<String>>) -> Result<models::TypesPeriodListExecutorNodesResponse, Error<GetExecutorNodesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if let Some(ref param_value) = p_executor_node_ids {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("executor_node_ids".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("executor_node_ids", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_executor_node_names {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("executor_node_names".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("executor_node_names", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_executor_node_states {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("executor_node_states".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("executor_node_states", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_executor_node_types {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("executor_node_types".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("executor_node_types", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
...
pub async fn get_executor_nodes_metadata(configuration: &configuration::Configuration, executor_node_ids: Option<Vec<String>>, executor_node_names: Option<Vec<String>>, executor_node_states: Option<Vec<i32>>, executor_node_types: Option<Vec<String>>) -> Result<models::TypesPeriodGetExecutorNodesMetadataResponse, Error<GetExecutorNodesMetadataError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_executor_node_ids = executor_node_ids;
    let p_executor_node_names = executor_node_names;
    let p_executor_node_states = executor_node_states;
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/executor_nodes/metadata", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_integration_tasks(configuration: &configuration::Configuration, integration_task_type: Option<i32>, category: Option<&str>, offset: Option<i32>, limit: Option<i32>, order_by: Option<&str>, direction: Option<&str>, integration_task_types: Option<i32>, ids: Option<i32>, names: Option<&str>) -> Result<models::TypesPeriodListIntegrationTasksResponse, Error<GetIntegrationTasksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_integration_tasks_admin(configuration: &configuration::Configuration, integration_task_type: Option<i32>, category: Option<&str>, offset: Option<i32>, limit: Option<i32>, order_by: Option<&str>, direction: Option<&str>, integration_task_types: Option<i32>, ids: Option<i32>, names: Option<&str>) -> Result<models::TypesPeriodListIntegrationTasksResponse, Error<GetIntegrationTasksAdminError>> {
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/integration_tasks/admin", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_integration_tasks_metadata(configuration: &configuration::Configuration, category: Option<&str>, integration_task_types: Option<i32>, ids: Option<i32>, names: Option<&str>) -> Result<models::TypesPeriodGetIntegrationTasksMetadataResponse, Error<GetIntegrationTasksMetadataError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_category = category;
    let p_integration_task_types = integration_task_types;
    let p_ids = ids;
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/integration_tasks/metadata", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_integration_tasks_v2(configuration: &configuration::Configuration, integration_task_type: Option<i32>, category: Option<&str>, offset: Option<i32>, limit: Option<i32>, order_by: Option<&str>, direction: Option<&str>, integration_task_types: Option<i32>, ids: Option<i32>, names: Option<&str>) -> Result<models::TypesPeriodListIntegrationTasksResponse, Error<GetIntegrationTasksV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_integration_task_type = integration_task_type;
    let p_category = category;
    let p_offset = offset;
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/integration_tasks/v2", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_integration_types(configuration: &configuration::Configuration, ) -> Result<models::TypesPeriodListIntegrationTypesResponse, Error<GetIntegrationTypesError>> {

    let uri_str = format!("{}/aspm-api-gateway/api/v1/integration_types", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_integrations(configuration: &configuration::Configuration, integration_type: Option<i32>, category: Option<&str>) -> Result<models::TypesPeriodListIntegrationsResponse, Error<GetIntegrationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_integration_type = integration_type;
    let p_category = category;
...
pub async fn get_integrations_v2(configuration: &configuration::Configuration, integration_type: Option<i32>, category: Option<&str>) -> Result<models::TypesPeriodListIntegrationsResponse, Error<GetIntegrationsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_integration_type = integration_type;
    let p_category = category;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/integrations/v2", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_service_artifacts(configuration: &configuration::Configuration, persistent_signature: &str, optional_time: Option<i32>, revision_id: Option<i32>, limit: Option<i32>, offset: Option<i32>, order_by: Option<Vec<String>>, direction: Option<&str>) -> Result<models::TypesPeriodArtifacts, Error<GetServiceArtifactsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_persistent_signature = persistent_signature;
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/artifacts", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    req_builder = req_builder.query(&[("persistentSignature", &p_persistent_signature.to_string())]);
    ...
    if let Some(ref param_value) = p_order_by {
        req_builder = match "csv" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("orderBy".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("orderBy", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_direction {
        req_builder = req_builder.query(&[("direction", &param_value.to_string())]);
...
pub async fn get_service_violation_types(configuration: &configuration::Configuration, body: models::TypesPeriodGenericUserFacingRequest) -> Result<models::TypesPeriodGetViolationTypesResponse, Error<GetServiceViolationTypesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/services/violations/types", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_services_count(configuration: &configuration::Configuration, body: models::TypesPeriodGetServicesRequest) -> Result<(), Error<GetServicesCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/services/count", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn get_slash_executor_nodes_slash_left_curly_bracket_id_left_square_bracket_09_right_square_bracket_plus_right_curly_bracket_slash_instances_slash_csv(configuration: &configuration::Configuration, id: i32, body: models::TypesPeriodExecutorNode) -> Result<String, Error<GetSlashExecutorNodesSlashLeftCurlyBracketIdLeftSquareBracket09RightSquareBracketPlusRightCurlyBracketSlashInstancesSlashCsvError>> {
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/executor_nodes/{ID}/instances/csv", configuration.base_path, ID=p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_slash_group_slash_left_curly_bracket_id_left_square_bracket_09_right_square_bracket_plus_right_curly_bracket_slash_v2(configuration: &configuration::Configuration, id: i32) -> Result<models::TypesPeriodGroupDetails, Error<GetSlashGroupSlashLeftCurlyBracketIdLeftSquareBracket09RightSquareBracketPlusRightCurlyBracketSlashV2Error>> {
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/group/{ID}/v2", configuration.base_path, ID=p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_slash_groups_slash_hier_slash_v2(configuration: &configuration::Configuration, ) -> Result<models::TypesPeriodGroupHierarchyResponse, Error<GetSlashGroupsSlashHierSlashV2Error>> {

    let uri_str = format!("{}/aspm-api-gateway/api/v1/groups/hier/v2", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetSlashGroupsSlashHierSlashV2Error> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_slash_groups_slash_list_slash_v2(configuration: &configuration::Configuration, r#type: Option<&str>) -> Result<Vec<models::TypesPeriodGroupListItem>, Error<GetSlashGroupsSlashListSlashV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_type = r#type;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/groups/list/v2", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetSlashGroupsSlashListSlashV2Error> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_slash_users_slash_v2(configuration: &configuration::Configuration, pagination: Option<&str>) -> Result<models::TypesPeriodUsersResponse, Error<GetSlashUsersSlashV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_pagination = pagination;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/users/v2", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_tags(configuration: &configuration::Configuration, is_unique: Option<bool>, tag_name: Option<&str>, limit: Option<i32>, offset: Option<i32>, name: Option<Vec<String>>) -> Result<models::TypesPeriodTagsDataResponse, Error<GetTagsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn post_slash_group_slash_left_curly_bracket_id_left_square_bracket_09_right_square_bracket_plus_right_curly_bracket_slash_update_default(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<PostSlashGroupSlashLeftCurlyBracketIdLeftSquareBracket09RightSquareBracketPlusRightCurlyBracketSlashUpdateDefaultError>> {
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/group/{ID}/update_default", configuration.base_path, ID=p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn post_slash_group_slash_v2(configuration: &configuration::Configuration, body: models::TypesPeriodCreateGroupRequest) -> Result<(), Error<PostSlashGroupSlashV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/group/v2", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn run_integration_task(configuration: &configuration::Configuration, id: i32, body: models::TypesPeriodRunIntegrationTaskRequest, category: Option<&str>) -> Result<models::TypesPeriodIntegrationTaskTestConnectionResponse, Error<RunIntegrationTaskError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_body = body;
    let p_category = category;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/integration_tasks/{ID}/run", configuration.base_path, ID=p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn run_integration_task_admin(configuration: &configuration::Configuration, id: i32, body: models::TypesPeriodRunIntegrationTaskRequest, category: Option<&str>) -> Result<models::TypesPeriodIntegrationTaskTestConnectionResponse, Error<RunIntegrationTaskAdminError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_body = body;
    let p_category = category;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/integration_tasks/{ID}/run/admin", configuration.base_path, ID=p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn run_integration_task_v2(configuration: &configuration::Configuration, id: i32, body: models::TypesPeriodRunIntegrationTaskRequest, category: Option<&str>) -> Result<models::TypesPeriodIntegrationTaskTestConnectionResponse, Error<RunIntegrationTaskV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_body = body;
    let p_category = category;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/integration_tasks/{ID}/run/v2", configuration.base_path, ID=p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn service_now_get_deployments(configuration: &configuration::Configuration, ql_filters: Option<&str>, limit: Option<i32>, offset: Option<i32>, order_by: Option<&str>, direction: Option<&str>) -> Result<models::TypesPeriodServiceNowDeploymentsResponse, Error<ServiceNowGetDeploymentsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/servicenow/deployments", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn service_now_get_services(configuration: &configuration::Configuration, ql_filters: Option<&str>, exclude_artifacts: Option<bool>, limit: Option<i32>, offset: Option<i32>, order_by: Option<&str>, direction: Option<&str>) -> Result<models::TypesPeriodServiceNowServicesResponse, Error<ServiceNowGetServicesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ql_filters = ql_filters;
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/servicenow/services", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn set_cloud_security_integration_state(configuration: &configuration::Configuration, body: models::TypesPeriodSetCloudSecurityIntegrationStateRequest) -> Result<(), Error<SetCloudSecurityIntegrationStateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SetCloudSecurityIntegrationStateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn update_executor_node(configuration: &configuration::Configuration, body: models::TypesPeriodExecutorNode) -> Result<models::TypesPeriodExecutorNode, Error<UpdateExecutorNodeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn update_integration(configuration: &configuration::Configuration, id: i32, body: models::TypesPeriodUpdateIntegrationRequest) -> Result<models::TypesPeriodIntegrationResponse, Error<UpdateIntegrationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_body = body;
...
pub async fn update_integration_task(configuration: &configuration::Configuration, id: i32, body: models::TypesPeriodUpdateIntegrationTaskRequest) -> Result<models::TypesPeriodIntegrationTaskResponse, Error<UpdateIntegrationTaskError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_body = body;
...
pub async fn upsert_business_applications(configuration: &configuration::Configuration, body: models::TypesPeriodUpsertBusinessApplicationRequest) -> Result<(), Error<UpsertBusinessApplicationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/business_applications", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
...
pub async fn upsert_tags(configuration: &configuration::Configuration, body: models::TypesPeriodEditUniqueTagRequest) -> Result<(), Error<UpsertTagsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
