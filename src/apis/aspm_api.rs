...
pub async fn create_executor_node(configuration: &configuration::Configuration, body: models::TypesExecutorNode) -> Result<models::TypesExecutorNode, Error<CreateExecutorNodeError>> {
...
pub async fn create_integration(configuration: &configuration::Configuration, body: models::TypesCreateIntegrationRequest) -> Result<models::TypesCreateIntegrationResponse, Error<CreateIntegrationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn create_integration_task(configuration: &configuration::Configuration, body: models::TypesCreateIntegrationTaskRequest) -> Result<models::TypesIntegrationTaskResponse, Error<CreateIntegrationTaskError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn delete_executor_node(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<DeleteExecutorNodeError>> {
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/executor_nodes/{ID}", configuration.base_path, ID=p_path_id);
...
pub async fn delete_integration(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<DeleteIntegrationError>> {
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/integrations/{ID}", configuration.base_path, ID=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn delete_integration_task(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<DeleteIntegrationTaskError>> {
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/integration_tasks/{ID}", configuration.base_path, ID=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn delete_slash_group_slash_left_curly_bracket_id_left_square_bracket_09_right_square_bracket_plus_right_curly_bracket(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<DeleteSlashGroupSlashLeftCurlyBracketIdLeftSquareBracket09RightSquareBracketPlusRightCurlyBracketError>> {
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/group/{ID}", configuration.base_path, ID=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn delete_tags(configuration: &configuration::Configuration, body: models::TypesEditTagRequest) -> Result<(), Error<DeleteTagsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn execute_function_data(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesGeneralQueryResponse, Error<ExecuteFunctionDataError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn execute_function_data_query(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesGeneralQueryResponse, Error<ExecuteFunctionDataQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_field = field;
...
pub async fn execute_function_data_query_count(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesCountResponse, Error<ExecuteFunctionDataQueryCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_field = field;
...
pub async fn execute_functions(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesGeneralQueryResponse, Error<ExecuteFunctionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_field = field;
...
pub async fn execute_functions_count(configuration: &configuration::Configuration, query_name: &str, cloud_provider: Option<Vec<String>>, cloud_account_id: Option<Vec<String>>, region: Option<Vec<String>>, cid: Option<Vec<String>>) -> Result<models::TypesCountResponse, Error<ExecuteFunctionsCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_query_name = query_name;
    let p_query_cloud_provider = cloud_provider;
...
pub async fn execute_functions_overtime(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesOvertimeResponse, Error<ExecuteFunctionsOvertimeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_field = field;
...
pub async fn execute_functions_query(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesGeneralQueryResponse, Error<ExecuteFunctionsQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_field = field;
...
pub async fn execute_functions_query_count(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesCountResponse, Error<ExecuteFunctionsQueryCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_field = field;
...
pub async fn execute_functions_query_overtime(configuration: &configuration::Configuration, field: &str) -> Result<models::TypesOvertimeResponse, Error<ExecuteFunctionsQueryOvertimeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_field = field;
...
pub async fn execute_query(configuration: &configuration::Configuration, body: models::TypesQueryRequest) -> Result<models::TypesQueryResponse, Error<ExecuteQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn get_cloud_security_integration_state(configuration: &configuration::Configuration, ) -> Result<models::TypesGetCloudSecurityIntegrationStateResponse, Error<GetCloudSecurityIntegrationStateError>> {
...
pub async fn get_cspm_inventory_ba_services(configuration: &configuration::Configuration, business_application_name: &str, offset: Option<i32>, limit: Option<i32>) -> Result<models::TypesGeneralQueryResponse, Error<GetCspmInventoryBaServicesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    req_builder = req_builder.query(&[("business_application_name", &p_query_business_application_name.to_string())]);
...
pub async fn get_cspm_inventory_service_details(configuration: &configuration::Configuration, persistent_signature: &str) -> Result<models::TypesGeneralQueryResponse, Error<GetCspmInventoryServiceDetailsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    req_builder = req_builder.query(&[("persistent_signature", &p_query_persistent_signature.to_string())]);
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    if let Some(ref token) = configuration.oauth_access_token {
...
pub async fn get_executor_nodes(configuration: &configuration::Configuration, node_type: &str, integration_type: Option<i32>, offset: Option<i32>, limit: Option<i32>, order_by: Option<&str>, direction: Option<&str>, executor_node_ids: Option<Vec<String>>, executor_node_names: Option<Vec<String>>, executor_node_states: Option<Vec<i32>>, executor_node_types: Option<Vec<String>>) -> Result<models::TypesListExecutorNodesResponse, Error<GetExecutorNodesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_executor_nodes_metadata(configuration: &configuration::Configuration, executor_node_ids: Option<Vec<String>>, executor_node_names: Option<Vec<String>>, executor_node_states: Option<Vec<i32>>, executor_node_types: Option<Vec<String>>) -> Result<models::TypesGetExecutorNodesMetadataResponse, Error<GetExecutorNodesMetadataError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_executor_node_ids = executor_node_ids;
    let p_query_executor_node_names = executor_node_names;
    let p_query_executor_node_states = executor_node_states;
...
pub async fn get_integration_tasks_admin(configuration: &configuration::Configuration, integration_task_type: Option<i32>, category: Option<&str>, offset: Option<i32>, limit: Option<i32>, order_by: Option<&str>, direction: Option<&str>, integration_task_types: Option<i32>, ids: Option<i32>, names: Option<&str>) -> Result<models::TypesListIntegrationTasksResponse, Error<GetIntegrationTasksAdminError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_integration_task_type = integration_task_type;
    let p_query_category = category;
    let p_query_offset = offset;
...
pub async fn get_integration_tasks_metadata(configuration: &configuration::Configuration, category: Option<&str>, integration_task_types: Option<i32>, ids: Option<i32>, names: Option<&str>) -> Result<models::TypesGetIntegrationTasksMetadataResponse, Error<GetIntegrationTasksMetadataError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_category = category;
    let p_query_integration_task_types = integration_task_types;
    let p_query_ids = ids;
...
pub async fn get_integration_types(configuration: &configuration::Configuration, ) -> Result<models::TypesListIntegrationTypesResponse, Error<GetIntegrationTypesError>> {
...
pub async fn get_integrations(configuration: &configuration::Configuration, integration_type: Option<i32>, category: Option<&str>) -> Result<models::TypesListIntegrationsResponse, Error<GetIntegrationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_integration_type = integration_type;
    let p_query_category = category;
...
pub async fn get_integrations_v2(configuration: &configuration::Configuration, integration_type: Option<i32>, category: Option<&str>) -> Result<models::TypesListIntegrationsResponse, Error<GetIntegrationsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_integration_type = integration_type;
    let p_query_category = category;
...
pub async fn get_service_artifacts(configuration: &configuration::Configuration, persistent_signature: &str, optional_time: Option<i32>, revision_id: Option<i32>, limit: Option<i32>, offset: Option<i32>, order_by: Option<Vec<String>>, direction: Option<&str>) -> Result<models::TypesArtifacts, Error<GetServiceArtifactsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_persistent_signature = persistent_signature;
    ...
    req_builder = req_builder.query(&[("persistentSignature", &p_query_persistent_signature.to_string())]);
...
pub async fn get_service_violation_types(configuration: &configuration::Configuration, body: models::TypesGenericUserFacingRequest) -> Result<models::TypesGetViolationTypesResponse, Error<GetServiceViolationTypesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn get_services_count(configuration: &configuration::Configuration, body: models::TypesGetServicesRequest) -> Result<(), Error<GetServicesCountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn get_slash_executor_nodes_slash_left_curly_bracket_id_left_square_bracket_09_right_square_bracket_plus_right_curly_bracket_slash_instances_slash_csv(configuration: &configuration::Configuration, id: i32, body: models::TypesExecutorNode) -> Result<String, Error<GetSlashExecutorNodesSlashLeftCurlyBracketIdLeftSquareBracket09RightSquareBracketPlusRightCurlyBracketSlashInstancesSlashCsvError>> {
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/executor_nodes/{ID}/instances/csv", configuration.base_path, ID=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_slash_group_slash_left_curly_bracket_id_left_square_bracket_09_right_square_bracket_plus_right_curly_bracket_slash_v2(configuration: &configuration::Configuration, id: i32) -> Result<models::TypesGroupDetails, Error<GetSlashGroupSlashLeftCurlyBracketIdLeftSquareBracket09RightSquareBracketPlusRightCurlyBracketSlashV2Error>> {
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/group/{ID}/v2", configuration.base_path, ID=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_slash_groups_slash_hier_slash_v2(configuration: &configuration::Configuration, ) -> Result<models::TypesGroupHierarchyResponse, Error<GetSlashGroupsSlashHierSlashV2Error>> {
...
pub async fn get_slash_groups_slash_list_slash_v2(configuration: &configuration::Configuration, r#type: Option<&str>) -> Result<Vec<models::TypesGroupListItem>, Error<GetSlashGroupsSlashListSlashV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_slash_users_slash_v2(configuration: &configuration::Configuration, pagination: Option<&str>) -> Result<models::TypesUsersResponse, Error<GetSlashUsersSlashV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_tags(configuration: &configuration::Configuration, is_unique: Option<bool>, tag_name: Option<&str>, limit: Option<i32>, offset: Option<i32>, name: Option<Vec<String>>) -> Result<models::TypesTagsDataResponse, Error<GetTagsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn post_slash_group_slash_left_curly_bracket_id_left_square_bracket_09_right_square_bracket_plus_right_curly_bracket_slash_update_default(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<PostSlashGroupSlashLeftCurlyBracketIdLeftSquareBracket09RightSquareBracketPlusRightCurlyBracketSlashUpdateDefaultError>> {
    ...
    let uri_str = format!("{}/aspm-api-gateway/api/v1/group/{ID}/update_default", configuration.base_path, ID=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn post_slash_group_slash_v2(configuration: &configuration::Configuration, body: models::TypesCreateGroupRequest) -> Result<(), Error<PostSlashGroupSlashV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn run_integration_task(configuration: &configuration::Configuration, id: i32, body: models::TypesRunIntegrationTaskRequest, category: Option<&str>) -> Result<models::TypesIntegrationTaskTestConnectionResponse, Error<RunIntegrationTaskError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_body = body;
    let p_query_category = category;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/integration_tasks/{ID}/run", configuration.base_path, ID=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn run_integration_task_admin(configuration: &configuration::Configuration, id: i32, body: models::TypesRunIntegrationTaskRequest, category: Option<&str>) -> Result<models::TypesIntegrationTaskTestConnectionResponse, Error<RunIntegrationTaskAdminError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_body = body;
    let p_query_category = category;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/integration_tasks/{ID}/run/admin", configuration.base_path, ID=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn run_integration_task_v2(configuration: &configuration::Configuration, id: i32, body: models::TypesRunIntegrationTaskRequest, category: Option<&str>) -> Result<models::TypesIntegrationTaskTestConnectionResponse, Error<RunIntegrationTaskV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_body = body;
    let p_query_category = category;

    let uri_str = format!("{}/aspm-api-gateway/api/v1/integration_tasks/{ID}/run/v2", configuration.base_path, ID=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn service_now_get_deployments(configuration: &configuration::Configuration, ql_filters: Option<&str>, limit: Option<i32>, offset: Option<i32>, order_by: Option<&str>, direction: Option<&str>) -> Result<models::TypesServiceNowDeploymentsResponse, Error<ServiceNowGetDeploymentsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn service_now_get_services(configuration: &configuration::Configuration, ql_filters: Option<&str>, exclude_artifacts: Option<bool>, limit: Option<i32>, offset: Option<i32>, order_by: Option<&str>, direction: Option<&str>) -> Result<models::TypesServiceNowServicesResponse, Error<ServiceNowGetServicesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ql_filters = ql_filters;
...
pub async fn set_cloud_security_integration_state(configuration: &configuration::Configuration, body: models::TypesSetCloudSecurityIntegrationStateRequest) -> Result<(), Error<SetCloudSecurityIntegrationStateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn update_executor_node(configuration: &configuration::Configuration, body: models::TypesExecutorNode) -> Result<models::TypesExecutorNode, Error<UpdateExecutorNodeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn update_integration(configuration: &configuration::Configuration, id: i32, body: models::TypesUpdateIntegrationRequest) -> Result<models::TypesIntegrationResponse, Error<UpdateIntegrationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_body = body;
...
pub async fn update_integration_task(configuration: &configuration::Configuration, id: i32, body: models::TypesUpdateIntegrationTaskRequest) -> Result<models::TypesIntegrationTaskResponse, Error<UpdateIntegrationTaskError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_body = body;
...
pub async fn upsert_business_applications(configuration: &configuration::Configuration, body: models::TypesUpsertBusinessApplicationRequest) -> Result<(), Error<UpsertBusinessApplicationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn upsert_tags(configuration: &configuration::Configuration, body: models::TypesEditUniqueTagRequest) -> Result<(), Error<UpsertTagsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
