...
pub async fn get_combined_sensor_installers_by_query(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::DomainPeriodSensorInstallersV1, Error<GetCombinedSensorInstallersByQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
...
pub async fn get_combined_sensor_installers_by_query_v2(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::DomainPeriodSensorInstallersV2, Error<GetCombinedSensorInstallersByQueryV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
...
pub async fn get_sensor_installers_by_query(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<GetSensorInstallersByQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
...
pub async fn get_sensor_installers_by_query_v2(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<GetSensorInstallersByQueryV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
...
pub async fn get_sensor_installers_ccidby_query(configuration: &configuration::Configuration, ) -> Result<models::MsaspecPeriodQueryResponse, Error<GetSensorInstallersCcidbyQueryError>> {
...
pub async fn get_sensor_installers_entities(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodSensorInstallersV1, Error<GetSensorInstallersEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_sensor_installers_entities_v2(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodSensorInstallersV2, Error<GetSensorInstallersEntitiesV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
