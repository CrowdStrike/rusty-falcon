...
pub async fn workflow_activities_combined(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>) -> Result<models::ActivitiesPeriodActivityExternalResponse, Error<WorkflowActivitiesCombinedError>> {
