...
pub async fn workflow_activities_combined(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>) -> Result<models::ActivitiesPeriodLegacyActivityExternalResponse, Error<WorkflowActivitiesCombinedError>> {
...
pub async fn workflow_activities_content_combined(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>) -> Result<models::ActivitiesPeriodActivityExternalResponse, Error<WorkflowActivitiesContentCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_offset = offset;
    let p_limit = limit;
...
pub async fn workflow_definitions_combined(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>) -> Result<models::DefinitionsPeriodDefinitionExternalResponse, Error<WorkflowDefinitionsCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_offset = offset;
    let p_limit = limit;
...
pub async fn workflow_definitions_import(configuration: &configuration::Configuration, data_file: std::path::PathBuf, name: Option<&str>, validate_only: Option<bool>) -> Result<models::DefinitionsPeriodDefinitionImportResponse, Error<WorkflowDefinitionsImportError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn workflow_definitions_update(configuration: &configuration::Configuration, body: models::ModelsPeriodDefinitionUpdateRequestV2, validate_only: Option<bool>) -> Result<models::ApiPeriodResourceIdsResponse, Error<WorkflowDefinitionsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
    let p_validate_only = validate_only;
...
pub async fn workflow_execute(configuration: &configuration::Configuration, body: serde_json::Value, execution_cid: Option<Vec<String>>, definition_id: Option<Vec<String>>, name: Option<&str>, key: Option<&str>, depth: Option<i32>, source_event_url: Option<&str>) -> Result<models::ApiPeriodResourceIdsResponse, Error<WorkflowExecuteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn workflow_execution_results(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ApiPeriodExecutionResultsResponse, Error<WorkflowExecutionResultsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn workflow_executions_action(configuration: &configuration::Configuration, action_name: &str, body: models::ClientPeriodActionRequest) -> Result<models::DefinitionsPeriodDefinitionEntitiesResponse, Error<WorkflowExecutionsActionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn workflow_executions_combined(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>) -> Result<models::ApiPeriodExecutionResultsResponse, Error<WorkflowExecutionsCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_offset = offset;
    let p_limit = limit;
...
pub async fn workflow_get_human_input_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ModelPeriodUserInputReadResponse, Error<WorkflowGetHumanInputV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn workflow_mock_execute(configuration: &configuration::Configuration, body: models::ModelsPeriodMockExecutionCreateRequestV1, execution_cid: Option<Vec<String>>, definition_id: Option<&str>, name: Option<&str>, key: Option<&str>, depth: Option<i32>, source_event_url: Option<&str>, validate_only: Option<bool>) -> Result<models::ApiPeriodResourceIdsResponse, Error<WorkflowMockExecuteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
    let p_execution_cid = execution_cid;
    let p_definition_id = definition_id;
...
pub async fn workflow_system_definitions_de_provision(configuration: &configuration::Configuration, body: models::ClientPeriodSystemDefinitionDeProvisionRequest) -> Result<models::ClientPeriodSystemDefinitionCreateResponse, Error<WorkflowSystemDefinitionsDeProvisionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn workflow_system_definitions_promote(configuration: &configuration::Configuration, body: models::ClientPeriodSystemDefinitionPromoteRequest) -> Result<models::ClientPeriodSystemDefinitionCreateResponse, Error<WorkflowSystemDefinitionsPromoteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn workflow_system_definitions_provision(configuration: &configuration::Configuration, body: models::ClientPeriodSystemDefinitionProvisionRequest) -> Result<models::ClientPeriodSystemDefinitionCreateResponse, Error<WorkflowSystemDefinitionsProvisionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn workflow_triggers_combined(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::TriggersPeriodTriggerExternalResponse, Error<WorkflowTriggersCombinedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn workflow_update_human_input_v1(configuration: &configuration::Configuration, id: &str, body: models::ModelPeriodUserInputUpdateRequest) -> Result<models::ApiPeriodResourceIdsResponse, Error<WorkflowUpdateHumanInputV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_body = body;
