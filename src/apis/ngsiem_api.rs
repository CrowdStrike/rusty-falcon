...
pub async fn get_lookup_from_package_v1(configuration: &configuration::Configuration, repository: &str, package: &str, filename: &str) -> Result<(), Error<GetLookupFromPackageV1Error>> {
    ...
    let uri_str = format!("{}/humio/api/v1/repositories/{repository}/files/{package}/{filename}", configuration.base_path, repository=crate::apis::urlencode(p_repository), package=crate::apis::urlencode(p_package), filename=crate::apis::urlencode(p_filename));
...
pub async fn get_lookup_from_package_with_namespace_v1(configuration: &configuration::Configuration, repository: &str, namespace: &str, package: &str, filename: &str) -> Result<(), Error<GetLookupFromPackageWithNamespaceV1Error>> {
    ...
    let uri_str = format!("{}/humio/api/v1/repositories/{repository}/files/{namespace}/{package}/{filename}", configuration.base_path, repository=crate::apis::urlencode(p_repository), namespace=crate::apis::urlencode(p_namespace), package=crate::apis::urlencode(p_package), filename=crate::apis::urlencode(p_filename));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_lookup_v1(configuration: &configuration::Configuration, repository: &str, filename: &str) -> Result<(), Error<GetLookupV1Error>> {
    ...
    let uri_str = format!("{}/humio/api/v1/repositories/{repository}/files/{filename}", configuration.base_path, repository=crate::apis::urlencode(p_repository), filename=crate::apis::urlencode(p_filename));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_search_status_v1(configuration: &configuration::Configuration, repository: &str, id: &str) -> Result<models::ApiPeriodQueryJobsResults, Error<GetSearchStatusV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_repository = repository;
    let p_id = id;

    let uri_str = format!("{}/humio/api/v1/repositories/{repository}/queryjobs/{id}", configuration.base_path, repository=crate::apis::urlencode(p_repository), id=crate::apis::urlencode(p_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn start_search_v1(configuration: &configuration::Configuration, repository: &str, body: models::ApiPeriodQueryJobInput) -> Result<models::ApiPeriodQueryJobResponse, Error<StartSearchV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_repository = repository;
    let p_body = body;

    let uri_str = format!("{}/humio/api/v1/repositories/{repository}/queryjobs", configuration.base_path, repository=crate::apis::urlencode(p_repository));
...
pub async fn upload_lookup_v1(configuration: &configuration::Configuration, repository: &str, file: std::path::PathBuf) -> Result<(), Error<UploadLookupV1Error>> {
    ...
    let uri_str = format!("{}/humio/api/v1/repositories/{repository}/files", configuration.base_path, repository=crate::apis::urlencode(p_repository));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
