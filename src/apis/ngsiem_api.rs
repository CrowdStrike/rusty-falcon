...
pub async fn create_dashboard_from_template(configuration: &configuration::Configuration, search_domain: Option<&str>, name: Option<&str>, yaml_template: Option<&str>) -> Result<models::ApiCreateDashboardFromTemplateResponseV1, Error<CreateDashboardFromTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_search_domain = search_domain;
    let p_form_name = name;
    let p_form_yaml_template = yaml_template;

    let uri_str = format!("{}/ngsiem-content/entities/dashboards-template/v1", configuration.base_path);
...
pub async fn create_lookup_file(configuration: &configuration::Configuration, search_domain: Option<&str>, filename: Option<&str>, file: Option<&str>) -> Result<models::ApiCreateLookupFileResponseV1, Error<CreateLookupFileError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_search_domain = search_domain;
    let p_form_filename = filename;
    let p_form_file = file;

    let uri_str = format!("{}/ngsiem-content/entities/lookupfiles/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn create_parser(configuration: &configuration::Configuration, body: models::ApiCreateParserRequestV1) -> Result<models::ApiCreateParserResponseV1, Error<CreateParserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/ngsiem-content/entities/parsers/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn create_parser_from_template(configuration: &configuration::Configuration, repository: Option<&str>, name: Option<&str>, yaml_template: Option<&str>) -> Result<models::ApiCreateParserFromTemplateResponseV1, Error<CreateParserFromTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_repository = repository;
    let p_form_name = name;
    let p_form_yaml_template = yaml_template;

    let uri_str = format!("{}/ngsiem-content/entities/parsers-template/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn create_saved_query(configuration: &configuration::Configuration, search_domain: Option<&str>, yaml_template: Option<&str>) -> Result<models::ApiCreateSavedQueryResponseV1, Error<CreateSavedQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_search_domain = search_domain;
    let p_form_yaml_template = yaml_template;

    let uri_str = format!("{}/ngsiem-content/entities/savedqueries-template/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn delete_dashboard(configuration: &configuration::Configuration, ids: Option<&str>, search_domain: Option<&str>) -> Result<models::ApiDeleteDashboardResponseV1, Error<DeleteDashboardError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_query_search_domain = search_domain;

    let uri_str = format!("{}/ngsiem-content/entities/dashboards/v1", configuration.base_path);
...
pub async fn delete_lookup_file(configuration: &configuration::Configuration, filename: Option<&str>, search_domain: Option<&str>) -> Result<models::ApiDeleteLookupFileResponseV1, Error<DeleteLookupFileError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn delete_parser(configuration: &configuration::Configuration, ids: Option<&str>, repository: Option<&str>) -> Result<models::ApiDeleteParserResponseV1, Error<DeleteParserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn delete_saved_query(configuration: &configuration::Configuration, ids: Option<&str>, search_domain: Option<&str>) -> Result<models::ApiDeleteSavedQueryResponseV1, Error<DeleteSavedQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_query_search_domain = search_domain;

    let uri_str = format!("{}/ngsiem-content/entities/savedqueries/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn get_dashboard_template(configuration: &configuration::Configuration, ids: Option<&str>, search_domain: Option<&str>) -> Result<models::ApiGetDashboardTemplateResponseV1, Error<GetDashboardTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_query_search_domain = search_domain;
...
pub async fn get_lookup_file(configuration: &configuration::Configuration, filename: Option<&str>, search_domain: Option<&str>) -> Result<(), Error<GetLookupFileError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filename = filename;
    let p_query_search_domain = search_domain;
...
pub async fn get_lookup_from_package_v1(configuration: &configuration::Configuration, repository: &str, package: &str, filename: &str) -> Result<(), Error<GetLookupFromPackageV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repository = repository;
    let p_path_package = package;
    let p_path_filename = filename;

    let uri_str = format!("{}/humio/api/v1/repositories/{repository}/files/{package}/{filename}", configuration.base_path, repository=crate::apis::urlencode(p_path_repository), package=crate::apis::urlencode(p_path_package), filename=crate::apis::urlencode(p_path_filename));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_lookup_from_package_with_namespace_v1(configuration: &configuration::Configuration, repository: &str, namespace: &str, package: &str, filename: &str) -> Result<(), Error<GetLookupFromPackageWithNamespaceV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repository = repository;
    ...
    let uri_str = format!("{}/humio/api/v1/repositories/{repository}/files/{namespace}/{package}/{filename}", configuration.base_path, repository=crate::apis::urlencode(p_path_repository), namespace=crate::apis::urlencode(p_path_namespace), package=crate::apis::urlencode(p_path_package), filename=crate::apis::urlencode(p_path_filename));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetLookupFromPackageWithNamespaceV1Error> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_lookup_v1(configuration: &configuration::Configuration, repository: &str, filename: &str) -> Result<(), Error<GetLookupV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repository = repository;
    let p_path_filename = filename;

    let uri_str = format!("{}/humio/api/v1/repositories/{repository}/files/{filename}", configuration.base_path, repository=crate::apis::urlencode(p_path_repository), filename=crate::apis::urlencode(p_path_filename));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_parser(configuration: &configuration::Configuration, ids: Option<&str>, repository: Option<&str>) -> Result<models::ApiGetParserResponseV1, Error<GetParserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_query_repository = repository;
...
pub async fn get_parser_template(configuration: &configuration::Configuration, ids: Option<&str>, repository: Option<&str>) -> Result<models::ApiGetParserTemplateResponseV1, Error<GetParserTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_query_repository = repository;
...
pub async fn get_saved_query_template(configuration: &configuration::Configuration, ids: Option<&str>, search_domain: Option<&str>) -> Result<models::ApiGetSavedQueryResponseV1, Error<GetSavedQueryTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_query_search_domain = search_domain;
...
pub async fn get_search_status_v1(configuration: &configuration::Configuration, repository: &str, id: &str) -> Result<models::ApiQueryJobsResults, Error<GetSearchStatusV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repository = repository;
    let p_path_id = id;

    let uri_str = format!("{}/humio/api/v1/repositories/{repository}/queryjobs/{id}", configuration.base_path, repository=crate::apis::urlencode(p_path_repository), id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_dashboards(configuration: &configuration::Configuration, limit: Option<&str>, offset: Option<&str>, filter: Option<&str>, search_domain: Option<&str>) -> Result<models::ApiListDashboardsResponseV1, Error<ListDashboardsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/ngsiem-content/queries/dashboards/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_lookup_files(configuration: &configuration::Configuration, limit: Option<&str>, offset: Option<&str>, filter: Option<&str>, search_domain: Option<&str>) -> Result<models::ApiListLookupFilesResponseV1, Error<ListLookupFilesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_limit = limit;
    let p_query_offset = offset;
    let p_query_filter = filter;
    ...
    let uri_str = format!("{}/ngsiem-content/queries/lookupfiles/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_parsers(configuration: &configuration::Configuration, limit: Option<&str>, offset: Option<&str>, filter: Option<&str>, repository: Option<&str>) -> Result<models::ApiListParsersResponseV1, Error<ListParsersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_limit = limit;
    let p_query_offset = offset;
    let p_query_filter = filter;
    ...
    let uri_str = format!("{}/ngsiem-content/queries/parsers/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_saved_queries(configuration: &configuration::Configuration, limit: Option<&str>, offset: Option<&str>, filter: Option<&str>, search_domain: Option<&str>) -> Result<models::ApiListSavedQueriesResponseV1, Error<ListSavedQueriesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_limit = limit;
    let p_query_offset = offset;
    let p_query_filter = filter;
    ...
    let uri_str = format!("{}/ngsiem-content/queries/savedqueries/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn start_search_v1(configuration: &configuration::Configuration, repository: &str, body: models::ApiQueryJobInput) -> Result<models::ApiQueryJobResponse, Error<StartSearchV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repository = repository;
    let p_body_body = body;

    let uri_str = format!("{}/humio/api/v1/repositories/{repository}/queryjobs", configuration.base_path, repository=crate::apis::urlencode(p_path_repository));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn stop_search_v1(configuration: &configuration::Configuration, repository: &str, id: &str) -> Result<(), Error<StopSearchV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repository = repository;
    let p_path_id = id;
...
pub async fn update_dashboard_from_template(configuration: &configuration::Configuration, search_domain: Option<&str>, ids: Option<&str>, yaml_template: Option<&str>) -> Result<models::ApiUpdateDashboardFromTemplateResponseV1, Error<UpdateDashboardFromTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_search_domain = search_domain;
    let p_form_ids = ids;
    let p_form_yaml_template = yaml_template;
...
pub async fn update_lookup_file(configuration: &configuration::Configuration, search_domain: Option<&str>, filename: Option<&str>, file: Option<&str>) -> Result<models::ApiUpdateLookupFileResponseV1, Error<UpdateLookupFileError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_search_domain = search_domain;
    let p_form_filename = filename;
    let p_form_file = file;
...
pub async fn update_parser(configuration: &configuration::Configuration, body: models::ApiUpdateParserRequestV1) -> Result<models::ApiUpdateParserResponseV1, Error<UpdateParserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn update_saved_query_from_template(configuration: &configuration::Configuration, search_domain: Option<&str>, ids: Option<&str>, yaml_template: Option<&str>) -> Result<models::ApiUpdateSavedQueryResponseV1, Error<UpdateSavedQueryFromTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_search_domain = search_domain;
    let p_form_ids = ids;
    let p_form_yaml_template = yaml_template;
