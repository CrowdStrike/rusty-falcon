...
pub async fn create_registry_entities(configuration: &configuration::Configuration, body: models::RegistryassessmentPeriodExternalRegistryPayload) -> Result<models::DomainPeriodExternalRegistryResponse, Error<CreateRegistryEntitiesError>> {
...
pub async fn delete_registry_entities(configuration: &configuration::Configuration, ids: &str) -> Result<models::DomainPeriodExternalRegistryListResponse, Error<DeleteRegistryEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn launch_export_job(configuration: &configuration::Configuration, body: models::ExportsPeriodLaunchExportRequest) -> Result<models::ExportsPeriodLaunchExportResponse, Error<LaunchExportJobError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn post_image_scan_inventory(configuration: &configuration::Configuration, body: models::ModelsPeriodInventoryScanRequestType) -> Result<(), Error<PostImageScanInventoryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn query_export_jobs(configuration: &configuration::Configuration, filter: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryExportJobsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
...
pub async fn read_export_jobs(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ExportsPeriodExportsResponse, Error<ReadExportJobsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn read_registry_entities(configuration: &configuration::Configuration, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>) -> Result<models::DomainPeriodExternalQueryResponse, Error<ReadRegistryEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    let p_offset = offset;
    let p_sort = sort;
...
pub async fn read_registry_entities_by_uuid(configuration: &configuration::Configuration, ids: &str) -> Result<models::DomainPeriodExternalRegistryListResponse, Error<ReadRegistryEntitiesByUuidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn update_registry_entities(configuration: &configuration::Configuration, id: &str, body: models::RegistryassessmentPeriodExternalRegistryPatchPayload) -> Result<models::DomainPeriodExternalRegistryResponse, Error<UpdateRegistryEntitiesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_body = body;
