...
pub async fn combined_query_evaluation_logic(
    ...
    crate::models::DomainSpapiEvaluationLogicCombinedResponseV1,
...
pub async fn get_evaluation_logic(
    ...
    crate::models::DomainSpapiEvaluationLogicEntitiesResponseV1,
...
pub async fn query_evaluation_logic(
    ...
    limit: Option<i32>,
    sort: Option<&str>,
) -> Result<crate::models::DomainSpapiQueryResponse, Error<QueryEvaluationLogicError>> {
    let local_var_configuration = configuration;
