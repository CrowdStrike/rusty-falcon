...
pub async fn combined_query_evaluation_logic(configuration: &configuration::Configuration, filter: &str, after: Option<&str>, limit: Option<i32>, sort: Option<&str>) -> Result<models::DomainSpapiEvaluationLogicCombinedResponseV1, Error<CombinedQueryEvaluationLogicError>> {
...
pub async fn get_evaluation_logic(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainSpapiEvaluationLogicEntitiesResponseV1, Error<GetEvaluationLogicError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn query_evaluation_logic(configuration: &configuration::Configuration, filter: &str, after: Option<&str>, limit: Option<i32>, sort: Option<&str>) -> Result<models::DomainSpapiQueryResponse, Error<QueryEvaluationLogicError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_after = after;
    let p_query_limit = limit;
