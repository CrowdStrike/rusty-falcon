...
pub async fn dismiss_affected_entity_v3(configuration: &configuration::Configuration, id: &str, data: models::DismissAffectedEntityV3Request) -> Result<models::DismissAffected, Error<DismissAffectedEntityV3Error>> {
...
pub async fn dismiss_security_check_v3(configuration: &configuration::Configuration, id: &str, data: models::DismissSecurityCheckV3Request) -> Result<models::DismissSecurityCheck, Error<DismissSecurityCheckV3Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_data = data;
