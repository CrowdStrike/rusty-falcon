...
pub async fn create_migration_v1(configuration: &configuration::Configuration, body: models::ApiPeriodCreateMigrationRequestV1) -> Result<models::ApiPeriodCreateMigrationResponseV1, Error<CreateMigrationV1Error>> {
...
pub async fn get_host_migration_ids_v1(configuration: &configuration::Configuration, id: &str, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<GetHostMigrationIdsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_offset = offset;
    let p_limit = limit;
...
pub async fn get_host_migrations_v1(configuration: &configuration::Configuration, body: models::MsaPeriodIdsRequest) -> Result<models::ApiPeriodGetHostMigrationResponseV1, Error<GetHostMigrationsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn get_migration_destinations_v1(configuration: &configuration::Configuration, body: models::ApiPeriodGetMigrationDestinationsRequestBodyV1) -> Result<models::ApiPeriodGetMigrationDestinationsResponseV1, Error<GetMigrationDestinationsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn get_migration_ids_v1(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<GetMigrationIdsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
...
pub async fn get_migrations_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ApiPeriodGetMigrationsResponseV1, Error<GetMigrationsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn host_migration_aggregates_v1(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<HostMigrationAggregatesV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn host_migrations_actions_v1(configuration: &configuration::Configuration, id: &str, action_name: &str, body: models::MsaPeriodEntityActionRequestV3) -> Result<models::MsaspecPeriodQueryResponse, Error<HostMigrationsActionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn migration_aggregates_v1(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<MigrationAggregatesV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn migrations_actions_v1(configuration: &configuration::Configuration, action_name: &str, body: models::MsaPeriodEntityActionRequestV3) -> Result<models::MsaspecPeriodQueryResponse, Error<MigrationsActionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_action_name = action_name;
    let p_body = body;
