...
pub async fn create_migration_v1(configuration: &configuration::Configuration, body: models::ApiCreateMigrationRequestV1) -> Result<models::ApiCreateMigrationResponseV1, Error<CreateMigrationV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/host-migration/entities/migrations/v1", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ApiCreateMigrationResponseV1`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ApiCreateMigrationResponseV1`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_host_migration_ids_v1(configuration: &configuration::Configuration, id: &str, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::MsaspecQueryResponse, Error<GetHostMigrationIdsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    ...
    let uri_str = format!("{}/host-migration/queries/host-migrations/v1", configuration.base_path);
...
pub async fn get_host_migrations_v1(configuration: &configuration::Configuration, body: models::MsaIdsRequest) -> Result<models::ApiGetHostMigrationResponseV1, Error<GetHostMigrationsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/host-migration/entities/host-migrations/GET/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ApiGetHostMigrationResponseV1`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ApiGetHostMigrationResponseV1`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_migration_destinations_v1(configuration: &configuration::Configuration, body: models::ApiGetMigrationDestinationsRequestBodyV1) -> Result<models::ApiGetMigrationDestinationsResponseV1, Error<GetMigrationDestinationsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/host-migration/entities/migration-destinations/GET/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ApiGetMigrationDestinationsResponseV1`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ApiGetMigrationDestinationsResponseV1`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_migration_ids_v1(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::MsaspecQueryResponse, Error<GetMigrationIdsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_offset = offset;
    let p_query_limit = limit;
    let p_query_sort = sort;
    ...
    let uri_str = format!("{}/host-migration/queries/migrations/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_migrations_v1(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ApiGetMigrationsResponseV1, Error<GetMigrationsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ApiGetMigrationsResponseV1`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ApiGetMigrationsResponseV1`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn host_migration_aggregates_v1(configuration: &configuration::Configuration, body: Vec<models::MsaAggregateQueryRequest>) -> Result<models::MsaAggregatesResponse, Error<HostMigrationAggregatesV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/host-migration/aggregates/host-migrations/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn host_migrations_actions_v1(configuration: &configuration::Configuration, id: &str, action_name: &str, body: models::MsaEntityActionRequestV3) -> Result<models::MsaspecQueryResponse, Error<HostMigrationsActionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    let p_query_action_name = action_name;
    let p_body_body = body;

    let uri_str = format!("{}/host-migration/entities/host-migrations-actions/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn migration_aggregates_v1(configuration: &configuration::Configuration, body: Vec<models::MsaAggregateQueryRequest>) -> Result<models::MsaAggregatesResponse, Error<MigrationAggregatesV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;

    let uri_str = format!("{}/host-migration/aggregates/migrations/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn migrations_actions_v1(configuration: &configuration::Configuration, action_name: &str, body: models::MsaEntityActionRequestV3) -> Result<models::MsaspecQueryResponse, Error<MigrationsActionsV1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_action_name = action_name;
    let p_body_body = body;

    let uri_str = format!("{}/host-migration/entities/migrations-actions/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
