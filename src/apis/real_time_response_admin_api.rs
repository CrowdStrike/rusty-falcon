...
pub async fn r_tr_create_scripts(configuration: &configuration::Configuration, description: &str, permission_type: &str, file: Option<std::path::PathBuf>, name: Option<&str>, comments_for_audit_log: Option<&str>, content: Option<&str>, platform: Option<Vec<String>>) -> Result<crate::models::MsaReplyMetaOnly, Error<RTrCreateScriptsError>> {
    let local_var_configuration = configuration;
