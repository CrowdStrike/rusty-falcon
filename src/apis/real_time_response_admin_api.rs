...
pub async fn batch_admin_cmd(configuration: &configuration::Configuration, body: models::DomainPeriodBatchExecuteCommandRequest, timeout: Option<i32>, timeout_duration: Option<&str>, host_timeout_duration: Option<&str>) -> Result<models::DomainPeriodMultiCommandExecuteResponseWrapper, Error<BatchAdminCmdError>> {
...
pub async fn r_tr_check_admin_command_status(configuration: &configuration::Configuration, cloud_request_id: &str, sequence_id: i32) -> Result<models::DomainPeriodStatusResponseWrapper, Error<RTrCheckAdminCommandStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn r_tr_create_put_files(configuration: &configuration::Configuration, file: std::path::PathBuf, description: &str, name: Option<&str>, comments_for_audit_log: Option<&str>) -> Result<models::MsaPeriodReplyMetaOnly, Error<RTrCreatePutFilesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_file = file;
...
pub async fn r_tr_create_scripts(configuration: &configuration::Configuration, description: &str, permission_type: &str, file: Option<std::path::PathBuf>, name: Option<&str>, comments_for_audit_log: Option<&str>, content: Option<&str>, platform: Option<Vec<String>>) -> Result<models::MsaPeriodReplyMetaOnly, Error<RTrCreateScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_description = description;
...
pub async fn r_tr_delete_put_files(configuration: &configuration::Configuration, ids: &str) -> Result<models::MsaPeriodReplyMetaOnly, Error<RTrDeletePutFilesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn r_tr_delete_scripts(configuration: &configuration::Configuration, ids: &str) -> Result<models::MsaPeriodReplyMetaOnly, Error<RTrDeleteScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn r_tr_execute_admin_command(configuration: &configuration::Configuration, body: models::DomainPeriodCommandExecuteRequest) -> Result<models::DomainPeriodCommandExecuteResponseWrapper, Error<RTrExecuteAdminCommandError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn r_tr_get_falcon_scripts(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::EmpowerapiPeriodMsaFalconScriptResponse, Error<RTrGetFalconScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn r_tr_get_put_files(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::EmpowerapiPeriodMsaPfResponseV1, Error<RTrGetPutFilesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn r_tr_get_put_files_v2(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::EmpowerapiPeriodMsaPfResponseV2, Error<RTrGetPutFilesV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn r_tr_get_scripts(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::EmpowerapiPeriodMsaPfResponseV1, Error<RTrGetScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn r_tr_get_scripts_v2(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::EmpowerapiPeriodMsaPfResponseV2, Error<RTrGetScriptsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn r_tr_list_falcon_scripts(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::EmpowerapiPeriodMsaIdListResponse, Error<RTrListFalconScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_offset = offset;
    let p_limit = limit;
...
pub async fn r_tr_list_put_files(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>) -> Result<models::BinservapiPeriodMsaPutFileResponse, Error<RTrListPutFilesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_offset = offset;
    let p_limit = limit;
...
pub async fn r_tr_list_scripts(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>) -> Result<models::BinservapiPeriodMsaPutFileResponse, Error<RTrListScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_offset = offset;
    let p_limit = limit;
