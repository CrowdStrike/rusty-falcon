...
pub async fn batch_admin_cmd(configuration: &configuration::Configuration, body: models::DomainBatchExecuteCommandRequest, timeout: Option<i32>, timeout_duration: Option<&str>, host_timeout_duration: Option<&str>) -> Result<models::DomainMultiCommandExecuteResponseWrapper, Error<BatchAdminCmdError>> {
    ...
    let uri_str = format!("{}/real-time-response/combined/batch-admin-command/v1", configuration.base_path);
...
pub async fn r_tr_check_admin_command_status(configuration: &configuration::Configuration, cloud_request_id: &str, sequence_id: i32) -> Result<models::DomainStatusResponseWrapper, Error<RTrCheckAdminCommandStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_cloud_request_id = cloud_request_id;
    let p_query_sequence_id = sequence_id;

    let uri_str = format!("{}/real-time-response/entities/admin-command/v1", configuration.base_path);
...
pub async fn r_tr_create_put_files(configuration: &configuration::Configuration, file: std::path::PathBuf, description: &str, name: Option<&str>, comments_for_audit_log: Option<&str>) -> Result<models::MsaReplyMetaOnly, Error<RTrCreatePutFilesError>> {
    ...
    let uri_str = format!("{}/real-time-response/entities/put-files/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn r_tr_create_scripts(configuration: &configuration::Configuration, description: &str, permission_type: &str, file: Option<std::path::PathBuf>, name: Option<&str>, comments_for_audit_log: Option<&str>, content: Option<&str>, platform: Option<Vec<String>>) -> Result<models::MsaReplyMetaOnly, Error<RTrCreateScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_description = description;
    ...
    let uri_str = format!("{}/real-time-response/entities/scripts/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if let Some(param_value) = p_form_platform {
        multipart_form = multipart_form.text("platform", param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string());
    }
    req_builder = req_builder.multipart(multipart_form);
...
pub async fn r_tr_delete_put_files(configuration: &configuration::Configuration, ids: &str) -> Result<models::MsaReplyMetaOnly, Error<RTrDeletePutFilesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn r_tr_delete_scripts(configuration: &configuration::Configuration, ids: &str) -> Result<models::MsaReplyMetaOnly, Error<RTrDeleteScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn r_tr_execute_admin_command(configuration: &configuration::Configuration, body: models::DomainCommandExecuteRequest) -> Result<models::DomainCommandExecuteResponseWrapper, Error<RTrExecuteAdminCommandError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn r_tr_get_falcon_scripts(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::EmpowerapiMsaFalconScriptResponse, Error<RTrGetFalconScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;

    let uri_str = format!("{}/real-time-response/entities/falcon-scripts/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn r_tr_get_put_file_contents(configuration: &configuration::Configuration, id: &str) -> Result<Vec<i32>, Error<RTrGetPutFileContentsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;

    let uri_str = format!("{}/real-time-response/entities/put-file-contents/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn r_tr_get_put_files(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::EmpowerapiMsaPfResponseV1, Error<RTrGetPutFilesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn r_tr_get_put_files_v2(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::EmpowerapiMsaPfResponseV2, Error<RTrGetPutFilesV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;

    let uri_str = format!("{}/real-time-response/entities/put-files/v2", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn r_tr_get_scripts(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::EmpowerapiMsaPfResponseV1, Error<RTrGetScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn r_tr_get_scripts_v2(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::EmpowerapiMsaPfResponseV2, Error<RTrGetScriptsV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;

    let uri_str = format!("{}/real-time-response/entities/scripts/v2", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn r_tr_list_falcon_scripts(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::EmpowerapiMsaIdListResponse, Error<RTrListFalconScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!("{}/real-time-response/queries/falcon-scripts/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn r_tr_list_put_files(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>) -> Result<models::BinservapiMsaPutFileResponse, Error<RTrListPutFilesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_offset = offset;
    let p_query_limit = limit;
    ...
    let uri_str = format!("{}/real-time-response/queries/put-files/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn r_tr_list_scripts(configuration: &configuration::Configuration, filter: Option<&str>, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>) -> Result<models::BinservapiMsaPutFileResponse, Error<RTrListScriptsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_filter = filter;
    let p_query_offset = offset;
    let p_query_limit = limit;
    ...
    let uri_str = format!("{}/real-time-response/queries/scripts/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
