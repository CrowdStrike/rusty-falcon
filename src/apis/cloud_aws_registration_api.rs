        ...
        match content_type {
            ...
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::RestAwsAccountCreateResponseExtV1`"
                ))));
            }
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CloudRegistrationAwsCreateAccountError> =
...
pub async fn cloud_registration_aws_delete_account(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CloudRegistrationAwsDeleteAccountError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
) -> Result<models::RestAwsAccountCreateResponseExtV1, Error<CloudRegistrationAwsGetAccountsError>>
{
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CloudRegistrationAwsGetAccountsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
) -> Result<models::RestAwsAccountCreateResponseExtV1, Error<CloudRegistrationAwsQueryAccountsError>>
{
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CloudRegistrationAwsQueryAccountsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
) -> Result<models::RestAwsAccountCreateResponseExtV1, Error<CloudRegistrationAwsUpdateAccountError>>
{
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CloudRegistrationAwsUpdateAccountError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
