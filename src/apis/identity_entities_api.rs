...
pub async fn get_sensor_aggregates(configuration: &configuration::Configuration, body: models::MsaAggregateQueryRequest) -> Result<models::MsaAggregatesResponse, Error<GetSensorAggregatesError>> {
...
pub async fn get_sensor_details(configuration: &configuration::Configuration, body: models::MsaIdsRequest) -> Result<models::ApiSensorDetailsResponseSwagger, Error<GetSensorDetailsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn query_sensors_by_filter(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::MsaspecQueryResponse, Error<QuerySensorsByFilterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
