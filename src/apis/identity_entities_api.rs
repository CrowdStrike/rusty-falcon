...
pub async fn get_sensor_aggregates(configuration: &configuration::Configuration, body: models::MsaPeriodAggregateQueryRequest) -> Result<models::MsaPeriodAggregatesResponse, Error<GetSensorAggregatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/identity-protection/aggregates/devices/GET/v1", configuration.base_path);
...
pub async fn get_sensor_details(configuration: &configuration::Configuration, body: models::MsaPeriodIdsRequest) -> Result<models::ApiPeriodSensorDetailsResponseSwagger, Error<GetSensorDetailsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/identity-protection/entities/devices/GET/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn query_sensors_by_filter(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QuerySensorsByFilterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
    ...
    let uri_str = format!("{}/identity-protection/queries/devices/v1", configuration.base_path);
