...
pub async fn cloud_security_assets_entities_get(configuration: &configuration::Configuration, ids: Option<Vec<String>>) -> Result<models::AssetsGetResourcesResponse, Error<CloudSecurityAssetsEntitiesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn cloud_security_assets_queries(configuration: &configuration::Configuration, after: Option<&str>, filter: Option<&str>, sort: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::AssetsGetResourceIdsResponse, Error<CloudSecurityAssetsQueriesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_after = after;
    let p_query_filter = filter;
    let p_query_sort = sort;
