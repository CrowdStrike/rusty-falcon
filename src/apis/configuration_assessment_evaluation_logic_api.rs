...
pub async fn get_evaluation_logic_mixin0(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainPeriodApiEvaluationLogicEntitiesResponseV1, Error<GetEvaluationLogicMixin0Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;

    let uri_str = format!("{}/configuration-assessment/entities/evaluation-logic/v1", configuration.base_path);
