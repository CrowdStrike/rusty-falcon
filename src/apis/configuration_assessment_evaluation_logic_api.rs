...
pub async fn get_evaluation_logic_mixin0(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::DomainApiEvaluationLogicEntitiesResponseV1, Error<GetEvaluationLogicMixin0Error>> {
