...
pub async fn cloud_security_registration_oci_create_account(configuration: &configuration::Configuration, body: models::DomainPeriodOciTenancyCreateRequestExtV1) -> Result<models::DomainPeriodOciTenancyCreateResponseExtV1, Error<CloudSecurityRegistrationOciCreateAccountError>> {
...
pub async fn cloud_security_registration_oci_delete_account(configuration: &configuration::Configuration, ids: Option<Vec<String>>) -> Result<models::MsaspecPeriodResponseFields, Error<CloudSecurityRegistrationOciDeleteAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn cloud_security_registration_oci_download_script(configuration: &configuration::Configuration, body: models::DomainPeriodOciDownloadScriptRequestV1) -> Result<models::DomainPeriodOciProvisionGetAccountScriptResponseV1, Error<CloudSecurityRegistrationOciDownloadScriptError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn cloud_security_registration_oci_get_account(configuration: &configuration::Configuration, filter: Option<&str>, sort: Option<&str>, next_token: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<models::DomainPeriodOciTenancyResponseExtV1, Error<CloudSecurityRegistrationOciGetAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_filter = filter;
    let p_sort = sort;
...
pub async fn cloud_security_registration_oci_rotate_key(configuration: &configuration::Configuration, body: models::DomainPeriodOciTenancyRotateKeyRequestExtV1) -> Result<models::DomainPeriodOciTenancyRotateKeyResponseExtV1, Error<CloudSecurityRegistrationOciRotateKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn cloud_security_registration_oci_update_account(configuration: &configuration::Configuration, body: models::DomainPeriodOciTenancyUpdateRequestExtV1) -> Result<models::DomainPeriodOciTenancyUpdateResponseExtV1, Error<CloudSecurityRegistrationOciUpdateAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn cloud_security_registration_oci_validate_tenancy(configuration: &configuration::Configuration, body: models::DomainPeriodOciValidateRequestV1) -> Result<models::DomainPeriodOciTenancyValidationResponse, Error<CloudSecurityRegistrationOciValidateTenancyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
