...
pub async fn batch_active_responder_cmd(configuration: &configuration::Configuration, body: models::DomainPeriodBatchExecuteCommandRequest, timeout: Option<i32>, timeout_duration: Option<&str>, host_timeout_duration: Option<&str>) -> Result<models::DomainPeriodMultiCommandExecuteResponseWrapper, Error<BatchActiveResponderCmdError>> {
    ...
    let uri_str = format!("{}/real-time-response/combined/batch-active-responder-command/v1", configuration.base_path);
...
pub async fn batch_cmd(configuration: &configuration::Configuration, body: models::DomainPeriodBatchExecuteCommandRequest, timeout: Option<i32>, timeout_duration: Option<&str>, host_timeout_duration: Option<&str>) -> Result<models::DomainPeriodMultiCommandExecuteResponseWrapper, Error<BatchCmdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
    let p_timeout = timeout;
    let p_timeout_duration = timeout_duration;
    ...
    let uri_str = format!("{}/real-time-response/combined/batch-command/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn batch_get_cmd(configuration: &configuration::Configuration, body: models::DomainPeriodBatchGetCommandRequest, timeout: Option<i32>, timeout_duration: Option<&str>, host_timeout_duration: Option<&str>) -> Result<models::DomainPeriodBatchGetCommandResponse, Error<BatchGetCmdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
    let p_timeout = timeout;
    let p_timeout_duration = timeout_duration;
    ...
    let uri_str = format!("{}/real-time-response/combined/batch-get-command/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn batch_get_cmd_status(configuration: &configuration::Configuration, batch_get_cmd_req_id: &str, timeout: Option<i32>, timeout_duration: Option<&str>) -> Result<models::DomainPeriodBatchGetCmdStatusResponse, Error<BatchGetCmdStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    req_builder = req_builder.query(&[("batch_get_cmd_req_id", &p_batch_get_cmd_req_id.to_string())]);
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    if let Some(ref token) = configuration.oauth_access_token {
...
pub async fn batch_init_sessions(configuration: &configuration::Configuration, body: models::DomainPeriodBatchInitSessionRequest, timeout: Option<i32>, timeout_duration: Option<&str>, host_timeout_duration: Option<&str>) -> Result<models::DomainPeriodBatchInitSessionResponse, Error<BatchInitSessionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
    let p_timeout = timeout;
    let p_timeout_duration = timeout_duration;
    ...
    let uri_str = format!("{}/real-time-response/combined/batch-init-session/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn batch_refresh_sessions(configuration: &configuration::Configuration, body: models::DomainPeriodBatchRefreshSessionRequest, timeout: Option<i32>, timeout_duration: Option<&str>) -> Result<models::DomainPeriodBatchRefreshSessionResponse, Error<BatchRefreshSessionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
    let p_timeout = timeout;
    let p_timeout_duration = timeout_duration;

    let uri_str = format!("{}/real-time-response/combined/batch-refresh-session/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn r_tr_aggregate_sessions(configuration: &configuration::Configuration, body: Vec<models::MsaPeriodAggregateQueryRequest>) -> Result<models::MsaPeriodAggregatesResponse, Error<RTrAggregateSessionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/real-time-response/aggregates/sessions/GET/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn r_tr_check_active_responder_command_status(configuration: &configuration::Configuration, cloud_request_id: &str, sequence_id: i32) -> Result<models::DomainPeriodStatusResponseWrapper, Error<RTrCheckActiveResponderCommandStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_cloud_request_id = cloud_request_id;
    let p_sequence_id = sequence_id;

    let uri_str = format!("{}/real-time-response/entities/active-responder-command/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RTrCheckActiveResponderCommandStatusError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn r_tr_check_command_status(configuration: &configuration::Configuration, cloud_request_id: &str, sequence_id: i32) -> Result<models::DomainPeriodStatusResponseWrapper, Error<RTrCheckCommandStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_cloud_request_id = cloud_request_id;
    let p_sequence_id = sequence_id;

    let uri_str = format!("{}/real-time-response/entities/command/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn r_tr_delete_file(configuration: &configuration::Configuration, ids: &str, session_id: &str) -> Result<models::MsaPeriodReplyMetaOnly, Error<RTrDeleteFileError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
    let p_session_id = session_id;

    let uri_str = format!("{}/real-time-response/entities/file/v1", configuration.base_path);
...
pub async fn r_tr_delete_file_v2(configuration: &configuration::Configuration, ids: &str, session_id: &str) -> Result<models::MsaPeriodReplyMetaOnly, Error<RTrDeleteFileV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
    let p_session_id = session_id;

    let uri_str = format!("{}/real-time-response/entities/file/v2", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn r_tr_delete_queued_session(configuration: &configuration::Configuration, session_id: &str, cloud_request_id: &str) -> Result<models::MsaspecPeriodQueryResponse, Error<RTrDeleteQueuedSessionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_session_id = session_id;
    let p_cloud_request_id = cloud_request_id;

    let uri_str = format!("{}/real-time-response/entities/queued-sessions/command/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn r_tr_delete_session(configuration: &configuration::Configuration, session_id: &str) -> Result<models::MsaPeriodReplyMetaOnly, Error<RTrDeleteSessionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_session_id = session_id;

    let uri_str = format!("{}/real-time-response/entities/sessions/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn r_tr_execute_active_responder_command(configuration: &configuration::Configuration, body: models::DomainPeriodCommandExecuteRequest) -> Result<models::DomainPeriodCommandExecuteResponseWrapper, Error<RTrExecuteActiveResponderCommandError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RTrExecuteActiveResponderCommandError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn r_tr_execute_command(configuration: &configuration::Configuration, body: models::DomainPeriodCommandExecuteRequest) -> Result<models::DomainPeriodCommandExecuteResponseWrapper, Error<RTrExecuteCommandError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn r_tr_get_extracted_file_contents(configuration: &configuration::Configuration, session_id: &str, sha256: &str, filename: Option<&str>) -> Result<Vec<i32>, Error<RTrGetExtractedFileContentsError>> {
    ...
    let uri_str = format!("{}/real-time-response/entities/extracted-file-contents/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn r_tr_init_session(configuration: &configuration::Configuration, body: models::DomainPeriodInitRequest, timeout: Option<i32>, timeout_duration: Option<&str>) -> Result<models::DomainPeriodInitResponseWrapper, Error<RTrInitSessionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
    let p_timeout = timeout;
    let p_timeout_duration = timeout_duration;
...
pub async fn r_tr_list_all_sessions(configuration: &configuration::Configuration, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::DomainPeriodListSessionsResponseMsa, Error<RTrListAllSessionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
    ...
    let uri_str = format!("{}/real-time-response/queries/sessions/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn r_tr_list_files(configuration: &configuration::Configuration, session_id: &str) -> Result<models::DomainPeriodListFilesResponseWrapper, Error<RTrListFilesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_session_id = session_id;
...
pub async fn r_tr_list_files_v2(configuration: &configuration::Configuration, session_id: &str) -> Result<models::DomainPeriodListFilesV2ResponseWrapper, Error<RTrListFilesV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_session_id = session_id;
...
pub async fn r_tr_list_queued_sessions(configuration: &configuration::Configuration, body: models::MsaPeriodIdsRequest) -> Result<models::DomainPeriodQueuedSessionResponseWrapper, Error<RTrListQueuedSessionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/real-time-response/entities/queued-sessions/GET/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn r_tr_list_sessions(configuration: &configuration::Configuration, body: models::MsaPeriodIdsRequest) -> Result<models::DomainPeriodSessionResponseWrapper, Error<RTrListSessionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/real-time-response/entities/sessions/GET/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn r_tr_pulse_session(configuration: &configuration::Configuration, body: models::DomainPeriodInitRequest) -> Result<models::DomainPeriodInitResponseWrapper, Error<RTrPulseSessionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;

    let uri_str = format!("{}/real-time-response/entities/refresh-session/v1", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
