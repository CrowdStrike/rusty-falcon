...
pub async fn batch_active_responder_cmd(configuration: &configuration::Configuration, body: models::DomainBatchExecuteCommandRequest, timeout: Option<i32>, timeout_duration: Option<&str>, host_timeout_duration: Option<&str>) -> Result<models::DomainMultiCommandExecuteResponseWrapper, Error<BatchActiveResponderCmdError>> {
...
pub async fn batch_cmd(configuration: &configuration::Configuration, body: models::DomainBatchExecuteCommandRequest, timeout: Option<i32>, timeout_duration: Option<&str>, host_timeout_duration: Option<&str>) -> Result<models::DomainMultiCommandExecuteResponseWrapper, Error<BatchCmdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_query_timeout = timeout;
    let p_query_timeout_duration = timeout_duration;
...
pub async fn batch_get_cmd(configuration: &configuration::Configuration, body: models::DomainBatchGetCommandRequest, timeout: Option<i32>, timeout_duration: Option<&str>, host_timeout_duration: Option<&str>) -> Result<models::DomainBatchGetCommandResponse, Error<BatchGetCmdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_query_timeout = timeout;
    let p_query_timeout_duration = timeout_duration;
...
pub async fn batch_get_cmd_status(configuration: &configuration::Configuration, batch_get_cmd_req_id: &str, timeout: Option<i32>, timeout_duration: Option<&str>) -> Result<models::DomainBatchGetCmdStatusResponse, Error<BatchGetCmdStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    req_builder = req_builder.query(&[("batch_get_cmd_req_id", &p_query_batch_get_cmd_req_id.to_string())]);
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    if let Some(ref token) = configuration.oauth_access_token {
...
pub async fn batch_init_sessions(configuration: &configuration::Configuration, body: models::DomainBatchInitSessionRequest, timeout: Option<i32>, timeout_duration: Option<&str>, host_timeout_duration: Option<&str>) -> Result<models::DomainBatchInitSessionResponse, Error<BatchInitSessionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_query_timeout = timeout;
    let p_query_timeout_duration = timeout_duration;
...
pub async fn batch_refresh_sessions(configuration: &configuration::Configuration, body: models::DomainBatchRefreshSessionRequest, timeout: Option<i32>, timeout_duration: Option<&str>) -> Result<models::DomainBatchRefreshSessionResponse, Error<BatchRefreshSessionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_query_timeout = timeout;
    let p_query_timeout_duration = timeout_duration;
...
pub async fn r_tr_aggregate_sessions(configuration: &configuration::Configuration, body: Vec<models::MsaAggregateQueryRequest>) -> Result<models::MsaAggregatesResponse, Error<RTrAggregateSessionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn r_tr_check_active_responder_command_status(configuration: &configuration::Configuration, cloud_request_id: &str, sequence_id: i32) -> Result<models::DomainStatusResponseWrapper, Error<RTrCheckActiveResponderCommandStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn r_tr_check_command_status(configuration: &configuration::Configuration, cloud_request_id: &str, sequence_id: i32) -> Result<models::DomainStatusResponseWrapper, Error<RTrCheckCommandStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_cloud_request_id = cloud_request_id;
    let p_query_sequence_id = sequence_id;
...
pub async fn r_tr_delete_file(configuration: &configuration::Configuration, ids: &str, session_id: &str) -> Result<models::MsaReplyMetaOnly, Error<RTrDeleteFileError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn r_tr_delete_file_v2(configuration: &configuration::Configuration, ids: &str, session_id: &str) -> Result<models::MsaReplyMetaOnly, Error<RTrDeleteFileV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    let p_query_session_id = session_id;
...
pub async fn r_tr_delete_queued_session(configuration: &configuration::Configuration, session_id: &str, cloud_request_id: &str) -> Result<models::MsaspecQueryResponse, Error<RTrDeleteQueuedSessionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_session_id = session_id;
    let p_query_cloud_request_id = cloud_request_id;
...
pub async fn r_tr_delete_session(configuration: &configuration::Configuration, session_id: &str) -> Result<models::MsaReplyMetaOnly, Error<RTrDeleteSessionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_session_id = session_id;
...
pub async fn r_tr_execute_active_responder_command(configuration: &configuration::Configuration, body: models::DomainCommandExecuteRequest) -> Result<models::DomainCommandExecuteResponseWrapper, Error<RTrExecuteActiveResponderCommandError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn r_tr_execute_command(configuration: &configuration::Configuration, body: models::DomainCommandExecuteRequest) -> Result<models::DomainCommandExecuteResponseWrapper, Error<RTrExecuteCommandError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn r_tr_init_session(configuration: &configuration::Configuration, body: models::DomainInitRequest, timeout: Option<i32>, timeout_duration: Option<&str>) -> Result<models::DomainInitResponseWrapper, Error<RTrInitSessionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_query_timeout = timeout;
    let p_query_timeout_duration = timeout_duration;
...
pub async fn r_tr_list_all_sessions(configuration: &configuration::Configuration, offset: Option<&str>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::DomainListSessionsResponseMsa, Error<RTrListAllSessionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn r_tr_list_files(configuration: &configuration::Configuration, session_id: &str) -> Result<models::DomainListFilesResponseWrapper, Error<RTrListFilesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_session_id = session_id;
...
pub async fn r_tr_list_files_v2(configuration: &configuration::Configuration, session_id: &str) -> Result<models::DomainListFilesV2ResponseWrapper, Error<RTrListFilesV2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_session_id = session_id;
...
pub async fn r_tr_list_queued_sessions(configuration: &configuration::Configuration, body: models::MsaIdsRequest) -> Result<models::DomainQueuedSessionResponseWrapper, Error<RTrListQueuedSessionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn r_tr_list_sessions(configuration: &configuration::Configuration, body: models::MsaIdsRequest) -> Result<models::DomainSessionResponseWrapper, Error<RTrListSessionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
...
pub async fn r_tr_pulse_session(configuration: &configuration::Configuration, body: models::DomainInitRequest) -> Result<models::DomainInitResponseWrapper, Error<RTrPulseSessionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
