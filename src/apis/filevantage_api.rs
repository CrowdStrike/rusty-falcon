...
pub async fn create_policies(configuration: &configuration::Configuration, body: models::PoliciesPeriodCreateRequest) -> Result<models::PoliciesPeriodResponse, Error<CreatePoliciesError>> {
...
pub async fn create_rule_groups(configuration: &configuration::Configuration, body: models::RulegroupsPeriodCreateRequest) -> Result<models::RulegroupsPeriodResponse, Error<CreateRuleGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn create_rules(configuration: &configuration::Configuration, body: models::RulegroupsPeriodRule) -> Result<models::RulegroupsPeriodRulesResponse, Error<CreateRulesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn create_scheduled_exclusions(configuration: &configuration::Configuration, body: models::ScheduledexclusionsPeriodCreateRequest) -> Result<models::ScheduledexclusionsPeriodResponse, Error<CreateScheduledExclusionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn delete_policies(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::PoliciesPeriodDeleteResponse, Error<DeletePoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn delete_rule_groups(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::RulegroupsPeriodDeleteResponse, Error<DeleteRuleGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn delete_rules(configuration: &configuration::Configuration, rule_group_id: &str, ids: Vec<String>) -> Result<models::MsaspecPeriodQueryResponse, Error<DeleteRulesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn delete_scheduled_exclusions(configuration: &configuration::Configuration, policy_id: &str, ids: Vec<String>) -> Result<models::MsaspecPeriodQueryResponse, Error<DeleteScheduledExclusionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_actions_mixin0(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ActionsPeriodGetActionResponse, Error<GetActionsMixin0Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_changes(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::ChangesPeriodGetChangesResponse, Error<GetChangesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_contents(configuration: &configuration::Configuration, id: &str, accept_encoding: Option<&str>) -> Result<models::ContentchangesPeriodChangeContentsResponse, Error<GetContentsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn get_policies(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::PoliciesPeriodResponse, Error<GetPoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_rule_groups(configuration: &configuration::Configuration, ids: Vec<String>) -> Result<models::RulegroupsPeriodResponse, Error<GetRuleGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn get_rules(configuration: &configuration::Configuration, rule_group_id: &str, ids: Vec<String>) -> Result<models::RulegroupsPeriodRulesResponse, Error<GetRulesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_rule_group_id = rule_group_id;
    let p_ids = ids;
...
pub async fn get_scheduled_exclusions(configuration: &configuration::Configuration, policy_id: &str, ids: Vec<String>) -> Result<models::ScheduledexclusionsPeriodResponse, Error<GetScheduledExclusionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_id = policy_id;
    let p_ids = ids;
...
pub async fn high_volume_query_changes(configuration: &configuration::Configuration, after: Option<&str>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::ChangesPeriodHighVolumeQueryResponse, Error<HighVolumeQueryChangesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_after = after;
    let p_limit = limit;
    let p_sort = sort;
...
pub async fn query_actions_mixin0(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryActionsMixin0Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
...
pub async fn query_changes(configuration: &configuration::Configuration, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>, filter: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryChangesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_offset = offset;
    let p_limit = limit;
    let p_sort = sort;
...
pub async fn query_policies(configuration: &configuration::Configuration, r#type: &str, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryPoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_type = r#type;
    let p_offset = offset;
    let p_limit = limit;
...
pub async fn query_rule_groups(configuration: &configuration::Configuration, r#type: &str, offset: Option<i32>, limit: Option<i32>, sort: Option<&str>) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryRuleGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_type = r#type;
    let p_offset = offset;
    let p_limit = limit;
...
pub async fn query_scheduled_exclusions(configuration: &configuration::Configuration, policy_id: &str) -> Result<models::MsaspecPeriodQueryResponse, Error<QueryScheduledExclusionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_id = policy_id;
...
pub async fn signal_changes_external(configuration: &configuration::Configuration, body: models::WorkflowPeriodRequest) -> Result<models::WorkflowPeriodResponse, Error<SignalChangesExternalError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn start_actions(configuration: &configuration::Configuration, body: models::ActionsPeriodCreateActionRequest) -> Result<models::ActionsPeriodActionResponse, Error<StartActionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn update_policies(configuration: &configuration::Configuration, body: models::PoliciesPeriodUpdateRequest) -> Result<models::PoliciesPeriodResponse, Error<UpdatePoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn update_policy_host_groups(configuration: &configuration::Configuration, policy_id: &str, action: &str, ids: Vec<String>) -> Result<models::PoliciesPeriodResponse, Error<UpdatePolicyHostGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_id = policy_id;
    let p_action = action;
    let p_ids = ids;
...
pub async fn update_policy_precedence(configuration: &configuration::Configuration, ids: Vec<String>, r#type: &str) -> Result<models::PoliciesPeriodPrecedenceResponse, Error<UpdatePolicyPrecedenceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
    let p_type = r#type;
...
pub async fn update_policy_rule_groups(configuration: &configuration::Configuration, policy_id: &str, action: &str, ids: Vec<String>) -> Result<models::PoliciesPeriodResponse, Error<UpdatePolicyRuleGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_id = policy_id;
    let p_action = action;
    let p_ids = ids;
...
pub async fn update_rule_group_precedence(configuration: &configuration::Configuration, rule_group_id: &str, ids: Vec<String>) -> Result<models::RulegroupsPeriodResponse, Error<UpdateRuleGroupPrecedenceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_rule_group_id = rule_group_id;
    let p_ids = ids;
...
pub async fn update_rule_groups(configuration: &configuration::Configuration, body: models::RulegroupsPeriodUpdateRequest) -> Result<models::RulegroupsPeriodResponse, Error<UpdateRuleGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn update_rules(configuration: &configuration::Configuration, body: models::RulegroupsPeriodRule) -> Result<models::RulegroupsPeriodRulesResponse, Error<UpdateRulesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
...
pub async fn update_scheduled_exclusions(configuration: &configuration::Configuration, body: models::ScheduledexclusionsPeriodUpdateRequest) -> Result<models::ScheduledexclusionsPeriodResponse, Error<UpdateScheduledExclusionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body = body;
