...
pub async fn query_ioa_exclusions_v1(
    ...
    if let Some(ref local_var_str) = ifn_regex {
        local_var_req_builder =
            local_var_req_builder.query(&[("ifn_regex", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = cl_regex {
        local_var_req_builder =
            local_var_req_builder.query(&[("cl_regex", &local_var_str.to_string())]);
    }
