...
impl ModelsPod {
    pub fn new(agents: Vec<std::collections::HashMap<String, String>>, allow_privilege_escalation: bool, annotations_list: Vec<String>, app_name: String, automount_service_token: bool, cid: String, cloud_account_id: String, cloud_name: String, cloud_region: String, cloud_service: String, cluster_id: String, cluster_name: String, container_count: i32, containers: Vec<std::collections::HashMap<String, String>>, created_at: String, first_seen: String, host_ipc: bool, host_network: bool, host_pid: bool, image_pull_secrets: Vec<String>, ipv4: String, ipv6: String, kac_agent_id: String, labels: std::collections::HashMap<String, String>, labels_list: Vec<String>, last_seen: String, namespace: String, node_ipv4: String, node_name: String, node_selector: String, node_uid: String, owner_id: String, owner_type: String, pod_external_id: String, pod_id: String, pod_name: String, ports: Vec<std::collections::HashMap<String, String>>, privileged: bool, resource_status: String, root_write_access: bool, run_as_root_group: bool, run_as_root_user: bool, scheduler_name: String, service_account_name: String, share_process_namespace: bool, volume_mounts: String) -> ModelsPod {
        ModelsPod {
            agents,
