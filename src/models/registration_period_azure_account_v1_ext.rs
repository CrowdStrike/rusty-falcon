...
pub struct RegistrationPeriodAzureAccountV1Ext {
    ...
    pub azure_permissions_status: Vec<crate::models::DomainPeriodPermission>,
    #[serde(rename = "cid")]
    pub cid: String,
    ...
    pub role_assignments: Option<Vec<crate::models::DomainPeriodAzureRoleAssignment>>,
...
impl RegistrationPeriodAzureAccountV1Ext {
    pub fn new(
        ...
        id: i32,
        updated_at: String,
        azure_permissions_status: Vec<crate::models::DomainPeriodPermission>,
        cid: String,
        show_modal: bool,
