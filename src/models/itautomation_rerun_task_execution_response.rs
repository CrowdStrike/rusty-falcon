...
pub struct ItautomationRerunTaskExecutionResponse {
...
impl ItautomationRerunTaskExecutionResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ItautomationRerunTaskExecutionResponse {
