...
pub struct DomainSpapiCombinedVulnerabilitiesResponse {
    ...
    pub resources: Vec<models::DomainBaseApiVulnerabilityV2>,
}

impl DomainSpapiCombinedVulnerabilitiesResponse {
    pub fn new(meta: models::DomainSpapiQueryMeta, resources: Vec<models::DomainBaseApiVulnerabilityV2>) -> DomainSpapiCombinedVulnerabilitiesResponse {
