...
pub struct ParameterActivityConfigParameterValue {
...
impl ParameterActivityConfigParameterValue {
    pub fn new(required: bool) -> ParameterActivityConfigParameterValue {
        ParameterActivityConfigParameterValue {
            default_value: None,
            deny_override: None,
            helper_text: None,
            required,
