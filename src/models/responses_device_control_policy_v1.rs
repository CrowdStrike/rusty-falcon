...
pub struct ResponsesDeviceControlPolicyV1 {
    ...
    pub settings: Box<crate::models::ResponsesDeviceControlSettingsV1>,
}

impl ResponsesDeviceControlPolicyV1 {
    pub fn new(created_by: String, created_timestamp: String, description: String, enabled: bool, groups: Vec<crate::models::ResponsesHostGroupV1>, id: String, modified_by: String, modified_timestamp: String, name: String, platform_name: PlatformName, settings: crate::models::ResponsesDeviceControlSettingsV1) -> ResponsesDeviceControlPolicyV1 {
