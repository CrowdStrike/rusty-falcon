...
pub struct DomainPeriodKestrelDataExportHeaderMapping {
...
impl DomainPeriodKestrelDataExportHeaderMapping {
    pub fn new(computation_functions: Vec<models::DomainPeriodKestrelDataExportHeaderComputationFunction>, header_name: String, use_data_as_value: bool) -> DomainPeriodKestrelDataExportHeaderMapping {
