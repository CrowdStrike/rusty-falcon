...
impl DomainPeriodKestrelDataExportHeaderMapping {
    pub fn new(computation_functions: Vec<models::DomainPeriodKestrelDataExportHeaderComputationFunction>, header_name: String) -> DomainPeriodKestrelDataExportHeaderMapping {
