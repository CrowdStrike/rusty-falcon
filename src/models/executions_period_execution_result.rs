...
pub struct ExecutionsPeriodExecutionResult {
    ...
    pub flows: Option<Vec<models::ExecutionsPeriodFlowExecutionResult>>,
...
impl ExecutionsPeriodExecutionResult {
    pub fn new(activities: Vec<models::ExecutionsPeriodActivityExecutionResult>, ancestor_executions: Vec<models::ExecutionsPeriodAncestorExecution>, definition_id: String, definition_version: i32, execution_id: String, loops: Vec<models::ExecutionsPeriodLoopResult>, retryable: bool, start_timestamp: String, status: String, trigger: models::ExecutionsPeriodTriggerResult) -> ExecutionsPeriodExecutionResult {
