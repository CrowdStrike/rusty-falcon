...
pub struct SensorUpdateUpdatePoliciesReqV1 {
    /// A collection of policies to update
    #[serde(rename = "resources")]
    pub resources: Vec<models::SensorUpdateUpdatePolicyReqV1>,
}

impl SensorUpdateUpdatePoliciesReqV1 {
    /// A req to update sensorUpdate policies
    pub fn new(resources: Vec<models::SensorUpdateUpdatePolicyReqV1>) -> SensorUpdateUpdatePoliciesReqV1 {
