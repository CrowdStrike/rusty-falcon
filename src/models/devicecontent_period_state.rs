...
pub struct DevicecontentPeriodState {
    #[serde(rename = "cid")]
    pub cid: String,
    #[serde(rename = "content_update_policy_applied_date", skip_serializing_if = "Option::is_none")]
    pub content_update_policy_applied_date: Option<String>,
    #[serde(rename = "content_update_policy_id", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "rapid_response_content", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "vulnerability_management", skip_serializing_if = "Option::is_none")]
