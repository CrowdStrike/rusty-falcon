...
pub struct DomainExternalAssetCertificate {
    ...
    pub issuer: Option<Box<models::DomainExternalAssetCertificateEntityIdentifiers>>,
    ...
    pub subject: Option<Box<models::DomainExternalAssetCertificateEntityIdentifiers>>,
...
impl DomainExternalAssetCertificate {
    pub fn new() -> DomainExternalAssetCertificate {
        DomainExternalAssetCertificate {
            ciphers: None,
