...
pub struct ParameterPeriodActivityConfigParameterValue {
    ...
    #[serde(rename = "deny_override", skip_serializing_if = "Option::is_none")]
    pub deny_override: Option<bool>,
...
impl ParameterPeriodActivityConfigParameterValue {
    pub fn new(required: bool) -> ParameterPeriodActivityConfigParameterValue {
        ParameterPeriodActivityConfigParameterValue {
            default_value: None,
            deny_override: None,
            helper_text: None,
            required,
