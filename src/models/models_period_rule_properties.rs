...
impl ModelsPeriodRuleProperties {
    pub fn new(cvss_attack_complexity: String, cvss_attack_vector: String, cvss_availability_impact: String, cvss_base_score: f64, cvss_confidentiality_impact: String, cvss_exploitability_score: f64, cvss_impact_score: f64, cvss_integrity_impact: String, cvss_privileges_required: String, cvss_scope: String, cvss_source: String, cvss_user_interaction: String, cvss_vector: String, description: String, exploit_date_recorded_timestamp: i64, exploit_sources: Vec<models::IngestionPeriodCveExploitSource>, exploit_status: String, exploit_updated_timestamp: i64, exprt_rating: String, exprt_rating_date_recorded_timestamp: i64, exprt_rating_highest: String, exprt_rating_highest_recorded_timestamp: i64, first_seen_timestamp: i64, references: Vec<models::IngestionPeriodReference>, remediation_count: i32, remediation_sources: Vec<String>, remediations: Vec<String>, runtime: String, scanner_version: String, severity: String, top_exprt_rating_factors: Vec<models::IngestionPeriodExPrtRatingFactors>) -> ModelsPeriodRuleProperties {
