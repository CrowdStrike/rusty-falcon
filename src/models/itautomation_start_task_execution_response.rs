...
pub struct ItautomationStartTaskExecutionResponse {
...
impl ItautomationStartTaskExecutionResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ItautomationStartTaskExecutionResponse {
