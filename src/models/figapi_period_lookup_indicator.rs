...
pub struct FigapiPeriodLookupIndicator {
    ...
    #[serde(rename = "EmailAddressDetails", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "LookupValue", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "MaliciousConfidence", skip_serializing_if = "Option::is_none")]
    pub malicious_confidence: Option<String>,
    /// Indicates when was the confidence was last set
    #[serde(rename = "MaliciousConfidenceValidatedTime", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "UniqueIdentifierDetails", skip_serializing_if = "Option::is_none")]
...
impl FigapiPeriodLookupIndicator {
    pub fn new() -> FigapiPeriodLookupIndicator {
        FigapiPeriodLookupIndicator {
            adversaries: None,
