...
pub struct DomainPeriodDiscoverApiioTHostTriage {
...
impl DomainPeriodDiscoverApiioTHostTriage {
    pub fn new() -> DomainPeriodDiscoverApiioTHostTriage {
        DomainPeriodDiscoverApiioTHostTriage {
            action: None,
            assigned_to: None,
            description: None,
            status: None,
