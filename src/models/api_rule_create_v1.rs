...
impl ApiRuleCreateV1 {
    pub fn new(comment: String, description: String, disposition_id: i32, field_values: Vec<models::DomainFieldValue>, name: String, pattern_severity: String, rulegroup_id: String, ruletype_id: String) -> ApiRuleCreateV1 {
        ApiRuleCreateV1 {
            comment,
            description,
            disposition_id,
