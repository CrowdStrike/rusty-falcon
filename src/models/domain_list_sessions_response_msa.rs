...
pub struct DomainListSessionsResponseMsa {
    #[serde(rename = "errors")]
...
impl DomainListSessionsResponseMsa {
    pub fn new(errors: Vec<models::MsaspecError>, meta: models::MsaspecMetaInfo, resources: Vec<String>) -> DomainListSessionsResponseMsa {
