...
pub struct MsaPeriodAggregationResult {
    #[serde(rename = "buckets")]
    pub buckets: Vec<models::MsaPeriodAggregationResultItem>,
...
impl MsaPeriodAggregationResult {
    pub fn new(buckets: Vec<models::MsaPeriodAggregationResultItem>, name: String) -> MsaPeriodAggregationResult {
