...
impl SadomainPeriodTyposquattingSubdomain {
    pub fn new(has_noisy_domain_prefix: bool, id: String, punycode_domain_prefix: String, punycode_format: String, unicode_domain_prefix: String, unicode_format: String) -> SadomainPeriodTyposquattingSubdomain {
