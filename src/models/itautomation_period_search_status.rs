...
pub struct ItautomationPeriodSearchStatus {
...
impl ItautomationPeriodSearchStatus {
    pub fn new(event_count: i32, is_pending: bool, job_id: String, percent_complete: i32, result_count: i32, status: String) -> ItautomationPeriodSearchStatus {
        ItautomationPeriodSearchStatus {
            event_count,
            is_pending,
            job_id,
            percent_complete,
