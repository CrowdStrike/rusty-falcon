...
pub struct SensorUpdateUpdatePolicyReqV1 {
...
impl SensorUpdateUpdatePolicyReqV1 {
    /// An update for a specific policy
    pub fn new(id: String) -> SensorUpdateUpdatePolicyReqV1 {
        SensorUpdateUpdatePolicyReqV1 {
            description: None,
            id,
            name: None,
            settings: None,
