...
pub struct DomainPeriodApiRemediationIds {
...
impl DomainPeriodApiRemediationIds {
    pub fn new() -> DomainPeriodApiRemediationIds {
        DomainPeriodApiRemediationIds { ids: None }
    }
}
