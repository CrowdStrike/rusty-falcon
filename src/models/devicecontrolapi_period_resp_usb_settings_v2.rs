...
pub struct DevicecontrolapiPeriodRespUsbSettingsV2 {
    /// Array of USB classes
    #[serde(rename = "classes")]
    pub classes: Vec<models::DevicecontrolapiPeriodRespUsbClassSettingsV2>,
...
impl DevicecontrolapiPeriodRespUsbSettingsV2 {
    pub fn new(classes: Vec<models::DevicecontrolapiPeriodRespUsbClassSettingsV2>, end_user_notification: String, enforcement_mode: String, enhanced_file_metadata: bool) -> DevicecontrolapiPeriodRespUsbSettingsV2 {
        DevicecontrolapiPeriodRespUsbSettingsV2 {
            classes,
