...
pub struct ResourcesPeriodRelationship {
    #[serde(rename = "crn", skip_serializing_if = "Option::is_none")]
    pub crn: Option<String>,
    #[serde(rename = "relationship_name", skip_serializing_if = "Option::is_none")]
...
impl ResourcesPeriodRelationship {
    pub fn new() -> ResourcesPeriodRelationship {
        ResourcesPeriodRelationship {
            crn: None,
