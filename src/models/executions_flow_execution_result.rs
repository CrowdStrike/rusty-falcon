...
pub struct ExecutionsFlowExecutionResult {
    #[serde(rename = "condition", skip_serializing_if = "Option::is_none")]
    pub condition: Option<Box<models::ExecutionsConditionResult>>,
...
impl ExecutionsFlowExecutionResult {
    pub fn new(node_id: String, start_timestamp: String, status: String) -> ExecutionsFlowExecutionResult {
        ExecutionsFlowExecutionResult {
            condition: None,
            end_timestamp: None,
            error_code: None,
            error_message: None,
