...
pub struct ModelsApiImageCombinedExport {
    ...
    #[serde(rename = "cve_exploited_status", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "cve_id")]
    pub cve_id: String,
    #[serde(rename = "cve_publication_date", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "package_name_version", skip_serializing_if = "Option::is_none")]
