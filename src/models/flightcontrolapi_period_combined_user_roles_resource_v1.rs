...
pub struct FlightcontrolapiPeriodCombinedUserRolesResourceV1 {
...
impl FlightcontrolapiPeriodCombinedUserRolesResourceV1 {
    pub fn new(role_id: String) -> FlightcontrolapiPeriodCombinedUserRolesResourceV1 {
        FlightcontrolapiPeriodCombinedUserRolesResourceV1 {
            cid: None,
            cid_group_id: None,
            cid_group_name: None,
            grant_type: None,
