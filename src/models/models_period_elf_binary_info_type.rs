...
pub struct ModelsPeriodElfBinaryInfoType {
...
impl ModelsPeriodElfBinaryInfoType {
    pub fn new(details: serde_json::Value, hash: String, malicious: bool, path: String, permissions: String, size: i64) -> ModelsPeriodElfBinaryInfoType {
        ModelsPeriodElfBinaryInfoType {
            details,
            hash,
            layer_hash: None,
            layer_index: None,
