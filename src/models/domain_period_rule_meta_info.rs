...
pub struct DomainPeriodRuleMetaInfo {
    ...
    pub quota: Option<Box<models::DomainPeriodRuleQuota>>,
...
impl DomainPeriodRuleMetaInfo {
    pub fn new(query_time: f64, trace_id: String) -> DomainPeriodRuleMetaInfo {
