...
pub struct MetaGetSecurityChecks {
    #[serde(rename = "pagination", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Option<Box<models::PaginationMetaGetSecurityChecks>>>,
...
impl MetaGetSecurityChecks {
    pub fn new() -> MetaGetSecurityChecks {
