...
pub struct PreventionPeriodCreatePolicyReqV1 {
...
impl PreventionPeriodCreatePolicyReqV1 {
    pub fn new(name: String, platform_name: PlatformName) -> PreventionPeriodCreatePolicyReqV1 {
