...
impl DomainPeriodCaseCreationRequestV2 {
    pub fn new(body: String, detections: Vec<models::MessagesPeriodAlert>, incidents: Vec<models::MessagesPeriodIncident>, malware_submission_id: String, recon_rule_type: String, title: String, r#type: String) -> DomainPeriodCaseCreationRequestV2 {
