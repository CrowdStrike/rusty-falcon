...
impl ApiPeriodRuleV1 {
    pub fn new(action_label: String, comment: String, committed_on: String, created_by: String, created_on: String, customer_id: String, deleted: bool, description: String, disposition_id: i32, enabled: bool, field_values: Vec<models::DomainPeriodFieldValue>, instance_id: String, instance_version: i32, magic_cookie: i64, modified_by: String, modified_on: String, name: String, pattern_id: String, pattern_severity: String, rulegroup_id: String, ruletype_id: String, ruletype_name: String, version_ids: Vec<String>) -> ApiPeriodRuleV1 {
        ApiPeriodRuleV1 {
            action_label,
            comment,
            committed_on,
