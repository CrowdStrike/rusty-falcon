...
impl ApiQueryMetadataJson {
    pub fn new(costs: models::Costs, digest_flow: models::DigestFlow, event_count: i64, extra_data: serde_json::Value, field_order: Vec<String>, filter_query: serde_json::Value, is_aggregate: bool, poll_after: i64, processed_bytes: i64, processed_events: i64, query_end: i64, query_spent: models::QuerySpent, query_start: i64, queued_millis: i64, quota_total_spent: models::QuotaTotalSpent, responder_v_host: i64, result_buffer_size: i64, time_millis: i64, total_work: i64, warning: String, warnings: Vec<String>, work_done: i64) -> ApiQueryMetadataJson {
