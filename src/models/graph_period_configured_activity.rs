...
pub struct GraphPeriodConfiguredActivity {
    ...
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "inline_configuration", skip_serializing_if = "Option::is_none")]
    pub inline_configuration: Option<Box<models::GraphPeriodInlineActivityConfig>>,
...
impl GraphPeriodConfiguredActivity {
    pub fn new(flows: models::PeriodFlows, id: String, name: String, node_id: String, properties: serde_json::Value) -> GraphPeriodConfiguredActivity {
