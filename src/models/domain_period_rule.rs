...
impl DomainPeriodRule {
    pub fn new(created_date: i64, description: String, id: i32, last_modified_date: i64, name: String, rich_text_description: String, short_description: String, tags: Vec<String>, r#type: String) -> DomainPeriodRule {
        DomainPeriodRule {
            created_date,
            description,
            id,
