...
impl DomainPeriodNotificationConfig {
    pub fn new(channel_id: String, cid: String, config_id: String, plugin_id: String, recipients: Vec<String>, severity: String, team_id: String) -> DomainPeriodNotificationConfig {
