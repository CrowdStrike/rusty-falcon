...
pub struct MalqueryRequestMetaInfo {
    #[serde(rename = "options", skip_serializing_if = "Option::is_none")]
    pub options: Option<Box<models::MalqueryExternalHuntOptions>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::MsaspecPaging>>,
    /// Patterns to search for
    #[serde(rename = "patterns", skip_serializing_if = "Option::is_none")]
    pub patterns: Option<Vec<models::MalquerySearchParameter>>,
    ...
    pub stats: Option<Box<models::MalqueryStats>>,
    ...
    pub writes: Option<Box<models::MsaspecWrites>>,
    /// YARA rule to be monitored
    #[serde(rename = "yara_rule", skip_serializing_if = "Option::is_none")]
    pub yara_rule: Option<String>,
}

impl MalqueryRequestMetaInfo {
    pub fn new(trace_id: String) -> MalqueryRequestMetaInfo {
