...
pub struct DetectsapiAggregationResult {
    /// collection of aggregate results matching the criteria
    #[serde(rename = "buckets")]
    pub buckets: Vec<models::DetectsapiAggregationResultItem>,
...
impl DetectsapiAggregationResult {
    pub fn new(buckets: Vec<models::DetectsapiAggregationResultItem>, name: String) -> DetectsapiAggregationResult {
