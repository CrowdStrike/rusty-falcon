...
pub struct DevicePeriodManagedApps {
    ...
    pub airlock: Option<Box<models::DevicePeriodManagedApp>>,
    #[serde(rename = "automox", skip_serializing_if = "Option::is_none")]
    pub automox: Option<Box<models::DevicePeriodManagedApp>>,
    #[serde(
        rename = "aws-verified-access",
        skip_serializing_if = "Option::is_none"
    )]
    pub aws_verified_access: Option<Box<models::DevicePeriodManagedApp>>,
    #[serde(
        rename = "identity-protection",
        skip_serializing_if = "Option::is_none"
    )]
    pub identity_protection: Option<Box<models::DevicePeriodManagedApp>>,
    #[serde(rename = "jumpcloud", skip_serializing_if = "Option::is_none")]
    pub jumpcloud: Option<Box<models::DevicePeriodManagedApp>>,
    #[serde(rename = "netskope", skip_serializing_if = "Option::is_none")]
    pub netskope: Option<Box<models::DevicePeriodManagedApp>>,
}
