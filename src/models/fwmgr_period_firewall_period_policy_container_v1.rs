...
pub struct FwmgrPeriodFirewallPeriodPolicyContainerV1 {
...
impl FwmgrPeriodFirewallPeriodPolicyContainerV1 {
    pub fn new(default_inbound: String, default_outbound: String, enforce: bool, local_logging: bool, platform_id: String, policy_id: String, rule_group_ids: Vec<String>, test_mode: bool) -> FwmgrPeriodFirewallPeriodPolicyContainerV1 {
