...
pub struct RegistrationPeriodAzureAccountExternalV1 {
    #[serde(rename = "account_type", skip_serializing_if = "Option::is_none")]
    pub account_type: Option<String>,
    #[serde(rename = "client_id", skip_serializing_if = "Option::is_none")]
    pub client_id: Option<String>,
    #[serde(rename = "default_subscription", skip_serializing_if = "Option::is_none")]
...
impl RegistrationPeriodAzureAccountExternalV1 {
    pub fn new() -> RegistrationPeriodAzureAccountExternalV1 {
