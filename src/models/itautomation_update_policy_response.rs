...
pub struct ItautomationUpdatePolicyResponse {
    ...
    pub resources: Vec<models::ItautomationPolicy>,
}

impl ItautomationUpdatePolicyResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<models::ItautomationPolicy>) -> ItautomationUpdatePolicyResponse {
