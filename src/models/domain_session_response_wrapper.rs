...
pub struct DomainSessionResponseWrapper {
    ...
    pub resources: Vec<models::DomainSession>,
}

impl DomainSessionResponseWrapper {
    pub fn new(errors: Vec<models::MsaspecError>, meta: models::MsaspecMetaInfo, resources: Vec<models::DomainSession>) -> DomainSessionResponseWrapper {
