...
pub struct ProcessesapiPeriodProcessDetail {
...
impl ProcessesapiPeriodProcessDetail {
    pub fn new(command_line: String, device_id: String, file_name: String, process_id: String, process_id_local: String, start_timestamp: String, start_timestamp_raw: String, stop_timestamp: String, stop_timestamp_raw: String) -> ProcessesapiPeriodProcessDetail {
