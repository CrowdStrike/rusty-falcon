...
pub struct MetaGetDeviceInventory {
    #[serde(rename = "pagination", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Option<Box<models::PaginationMetaGetDeviceInventory>>>,
...
impl MetaGetDeviceInventory {
    pub fn new() -> MetaGetDeviceInventory {
