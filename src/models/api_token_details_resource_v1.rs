...
impl ApiTokenDetailsResourceV1 {
    pub fn new(created_timestamp: String, expires_timestamp: String, id: String, label: String, last_used_timestamp: String, revoked_timestamp: String, status: String, r#type: String, value: String) -> ApiTokenDetailsResourceV1 {
