...
pub struct HostGroupsPeriodCreateGroupsReqV1 {
    ...
    pub resources: Vec<crate::models::HostGroupsPeriodCreateGroupReqV1>,
}

impl HostGroupsPeriodCreateGroupsReqV1 {
    /// A request to create device groups
    pub fn new(
        resources: Vec<crate::models::HostGroupsPeriodCreateGroupReqV1>,
    ) -> HostGroupsPeriodCreateGroupsReqV1 {
        HostGroupsPeriodCreateGroupsReqV1 { resources }
    }
}
