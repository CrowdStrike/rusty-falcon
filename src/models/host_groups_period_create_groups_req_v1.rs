...
pub struct HostGroupsPeriodCreateGroupsReqV1 {
    ...
    pub resources: Vec<models::HostGroupsPeriodCreateGroupReqV1>,
}

impl HostGroupsPeriodCreateGroupsReqV1 {
    /// A request to create device groups
    pub fn new(resources: Vec<models::HostGroupsPeriodCreateGroupReqV1>) -> HostGroupsPeriodCreateGroupsReqV1 {
