...
pub struct DomainPeriodBotnetConfigSource {
    ...
    pub actions: Vec<models::DomainPeriodKeyValuePair>,
    ...
    pub injects: Vec<models::DomainPeriodBotnetInject>,
    ...
    pub variables: Vec<models::DomainPeriodKeyValuePair>,
}

impl DomainPeriodBotnetConfigSource {
    pub fn new(actions: Vec<models::DomainPeriodKeyValuePair>, body: String, botnet: String, config_type: String, injects: Vec<models::DomainPeriodBotnetInject>, sub_botnet: String, subject: String, variables: Vec<models::DomainPeriodKeyValuePair>) -> DomainPeriodBotnetConfigSource {
