...
pub struct ItautomationDeleteTaskGroupsResponse {
...
impl ItautomationDeleteTaskGroupsResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ItautomationDeleteTaskGroupsResponse {
