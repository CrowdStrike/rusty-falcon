...
pub struct ItautomationUpdateTaskResponse {
    ...
    pub resources: Vec<models::ItautomationTask>,
}

impl ItautomationUpdateTaskResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<models::ItautomationTask>) -> ItautomationUpdateTaskResponse {
