...
pub struct DomainPeriodScheduledReportV1 {
    ...
    pub last_execution: Option<Box<crate::models::DomainPeriodReportExecutionSummaryV1>>,
    ...
    pub notifications: Vec<crate::models::DomainPeriodNotifications>,
    #[serde(rename = "report_metadata", skip_serializing_if = "Option::is_none")]
    pub report_metadata: Option<Box<crate::models::DomainPeriodReportMetadata>>,
    #[serde(rename = "report_params")]
    pub report_params: Box<crate::models::DomainPeriodReportParams>,
    #[serde(rename = "schedule")]
    pub schedule: Box<crate::models::DomainPeriodSchedule>,
...
impl DomainPeriodScheduledReportV1 {
    pub fn new(
        ...
        name: String,
        notifications: Vec<crate::models::DomainPeriodNotifications>,
        report_params: crate::models::DomainPeriodReportParams,
        schedule: crate::models::DomainPeriodSchedule,
