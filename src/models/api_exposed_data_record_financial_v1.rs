...
pub struct ApiExposedDataRecordFinancialV1 {
...
impl ApiExposedDataRecordFinancialV1 {
    pub fn new() -> ApiExposedDataRecordFinancialV1 {
        ApiExposedDataRecordFinancialV1 {
            bank_account: None,
            credit_card: None,
