...
pub struct ItautomationPeriodCreateScheduledTaskRequest {
...
impl ItautomationPeriodCreateScheduledTaskRequest {
    pub fn new(is_active: bool, schedule: models::FalconforitapiPeriodSchedule, target: String, task_id: String) -> ItautomationPeriodCreateScheduledTaskRequest {
        ItautomationPeriodCreateScheduledTaskRequest {
