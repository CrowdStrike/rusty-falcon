...
pub struct DomainPeriodApiEvaluationLogicV1 {
    ...
    pub host_info: Option<Box<models::DomainPeriodApiEvaluationLogicHostInfoV1>>,
    ...
    pub simplified_logic: Option<Vec<models::DomainPeriodApiSimplifiedEvaluationLogicItemV1>>,
