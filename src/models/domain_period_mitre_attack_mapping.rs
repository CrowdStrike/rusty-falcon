...
pub struct DomainPeriodMitreAttackMapping {
...
impl DomainPeriodMitreAttackMapping {
    pub fn new(tactic_id: String) -> DomainPeriodMitreAttackMapping {
        DomainPeriodMitreAttackMapping {
            tactic: None,
            tactic_id,
            technique: None,
            technique_id: None,
