...
pub struct ChangesPeriodGetChangesResponse {
    ...
    pub resources: Vec<models::ChangesPeriodChange>,
}

impl ChangesPeriodGetChangesResponse {
    pub fn new(meta: models::MsaspecPeriodMetaInfo, resources: Vec<models::ChangesPeriodChange>) -> ChangesPeriodGetChangesResponse {
