...
pub struct SadomainPeriodTyposquattingBaseDomain {
    ...
    pub whois: Option<Box<models::SadomainPeriodWhoisRecord>>,
}

impl SadomainPeriodTyposquattingBaseDomain {
    pub fn new(id: String, is_registered: bool, punycode_format: String, unicode_format: String) -> SadomainPeriodTyposquattingBaseDomain {
