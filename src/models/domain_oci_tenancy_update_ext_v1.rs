...
pub struct DomainOciTenancyUpdateExtV1 {
    ...
    pub products: Vec<models::DomainCloudOciProductFeature>,
    /// Stack OCID
...
impl DomainOciTenancyUpdateExtV1 {
    pub fn new(products: Vec<models::DomainCloudOciProductFeature>) -> DomainOciTenancyUpdateExtV1 {
        DomainOciTenancyUpdateExtV1 {
            group_name: None,
            home_region: None,
            policy_name: None,
            products,
