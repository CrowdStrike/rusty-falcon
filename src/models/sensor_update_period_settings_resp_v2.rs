...
pub struct SensorUpdatePeriodSettingsRespV2 {
    ...
    pub scheduler: Box<crate::models::PolicyPeriodSensorUpdateScheduler>,
    ...
    pub variants: Vec<crate::models::SensorUpdatePeriodBuildRespV1>,
}

impl SensorUpdatePeriodSettingsRespV2 {
    pub fn new(
        build: String,
        scheduler: crate::models::PolicyPeriodSensorUpdateScheduler,
        sensor_version: String,
        show_early_adopter_builds: bool,
        stage: Stage,
        uninstall_protection: UninstallProtection,
        variants: Vec<crate::models::SensorUpdatePeriodBuildRespV1>,
