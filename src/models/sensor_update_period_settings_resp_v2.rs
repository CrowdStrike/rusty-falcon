...
impl SensorUpdatePeriodSettingsRespV2 {
    pub fn new(build: String, scheduler: models::PolicyPeriodSensorUpdateScheduler, sensor_version: String, show_early_adopter_builds: bool, stage: Stage, uninstall_protection: UninstallProtection, variants: Vec<models::SensorUpdatePeriodBuildRespV1>) -> SensorUpdatePeriodSettingsRespV2 {
