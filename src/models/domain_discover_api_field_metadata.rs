...
pub struct DomainDiscoverApiFieldMetadata {
    /// Providers which have set the value.
    #[serde(rename = "providers", skip_serializing_if = "Option::is_none")]
    pub providers: Option<Vec<String>>,
}

impl DomainDiscoverApiFieldMetadata {
    /// The metadata information for a host for each field
    pub fn new() -> DomainDiscoverApiFieldMetadata {
        DomainDiscoverApiFieldMetadata { providers: None }
    }
}
