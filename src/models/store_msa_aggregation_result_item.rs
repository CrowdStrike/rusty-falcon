...
pub struct StoreMsaAggregationResultItem {
    #[serde(rename = "count")]
    pub count: i64,
    ...
    pub sub_aggregates: Option<Vec<crate::models::StoreMsaAggregationResult>>,
...
impl StoreMsaAggregationResultItem {
    pub fn new(count: i64) -> StoreMsaAggregationResultItem {
        StoreMsaAggregationResultItem {
            count,
            from: None,
            key_as_string: None,
            label: None,
