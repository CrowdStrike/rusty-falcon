...
impl DomainScheduledReportV1 {
    pub fn new(api_client_id: String, created_on: String, customer_id: String, description: String, id: String, last_updated_on: String, name: String, notifications: Vec<models::DomainNotifications>, report_params: models::DomainReportParams, schedule: models::DomainSchedule, schedule_type: String, shared_with: Vec<String>, status: String, r#type: String, user_id: String, user_uuid: String) -> DomainScheduledReportV1 {
