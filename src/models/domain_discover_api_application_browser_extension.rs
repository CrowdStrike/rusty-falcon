...
pub struct DomainDiscoverApiApplicationBrowserExtension {
    ...
    pub installations: Option<Vec<models::DomainDiscoverApiApplicationBrowserExtensionInstallation>>,
    /// The computed serverity of all permissions requested by the browser extension
    #[serde(rename = "permission_severity", skip_serializing_if = "Option::is_none")]
...
impl DomainDiscoverApiApplicationBrowserExtension {
    /// Uniquely identifies a browser extension.
    pub fn new(enabled: bool, id: String) -> DomainDiscoverApiApplicationBrowserExtension {
