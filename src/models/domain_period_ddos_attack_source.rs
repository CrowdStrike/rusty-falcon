...
impl DomainPeriodDdosAttackSource {
    pub fn new(attack_type: String, confidence: String, duration: i64, key: String, network_protocol: String, protocols: Vec<String>, requests: i64, start_time: String, target: String, target_details: models::DomainPeriodDdosTargetDetails, target_domain: String, target_ip: String, target_ports: Vec<i32>) -> DomainPeriodDdosAttackSource {
