...
pub struct BaseSetPolicyPrecedenceReqV1 {
...
impl BaseSetPolicyPrecedenceReqV1 {
    /// Sets the precedence order for policies of a given platform
    pub fn new(ids: Vec<String>, platform_name: PlatformName) -> BaseSetPolicyPrecedenceReqV1 {
        BaseSetPolicyPrecedenceReqV1 { ids, platform_name }
    }
}
/// The name of the platform for which to set precedence
