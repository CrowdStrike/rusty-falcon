...
impl DomainPeriodCloudAwsAccountV1 {
    pub fn new(created_at: String, deleted_at: String, id: i32, updated_at: String, iam_service_permissions_status: Vec<models::DomainPeriodProductPermission>, inventory_filter: Vec<models::DomainPeriodAwsInventoryFilterSetting>, is_custom_rolename: bool, products: Vec<models::DomainPeriodProductFeatures>, resource_metadata: models::DomainPeriodAwsAccountResourceMetadata) -> DomainPeriodCloudAwsAccountV1 {
