...
impl DomainExposedDataRecordSocialV1 {
    pub fn new(aim_id: String, facebook_id: String, icq_id: String, instagram_id: String, msn_id: String, skype_id: String, twitter_id: String, vk_id: String, vk_token: String) -> DomainExposedDataRecordSocialV1 {
