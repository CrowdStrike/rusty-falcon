...
pub struct ItautomationCreateTaskGroupRequest {
...
impl ItautomationCreateTaskGroupRequest {
    pub fn new(access_type: AccessType, name: String) -> ItautomationCreateTaskGroupRequest {
