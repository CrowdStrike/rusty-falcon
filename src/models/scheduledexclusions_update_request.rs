...
pub struct ScheduledexclusionsUpdateRequest {
...
impl ScheduledexclusionsUpdateRequest {
    pub fn new(id: String, name: String, timezone: String) -> ScheduledexclusionsUpdateRequest {
