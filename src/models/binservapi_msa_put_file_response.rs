...
pub struct BinservapiMsaPutFileResponse {
...
impl BinservapiMsaPutFileResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> BinservapiMsaPutFileResponse {
