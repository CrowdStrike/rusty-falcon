...
pub struct EvaluationsEvaluationResource {
    ...
    pub cloud_scopes: Option<Vec<models::ClassificationCloudScopeRule>>,
...
impl EvaluationsEvaluationResource {
    pub fn new() -> EvaluationsEvaluationResource {
        EvaluationsEvaluationResource {
            captured: None,
            cloud_groups: None,
            cloud_labels: None,
            cloud_scopes: None,
