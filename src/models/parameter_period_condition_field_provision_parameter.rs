...
pub struct ParameterPeriodConditionFieldProvisionParameter {
...
impl ParameterPeriodConditionFieldProvisionParameter {
    pub fn new(condition_group_id: String, name: String, operator: String, value: serde_json::Value) -> ParameterPeriodConditionFieldProvisionParameter {
        ParameterPeriodConditionFieldProvisionParameter {
            condition_group_id,
            name,
            operator,
            value,
