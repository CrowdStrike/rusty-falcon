...
pub struct ChangesPeriodHighVolumeQueryResponse {
    ...
    #[serde(rename = "meta")]
    pub meta: Box<models::ChangesPeriodHighVolumeQueryMeta>,
    #[serde(rename = "resources")]
    pub resources: Vec<String>,
}

impl ChangesPeriodHighVolumeQueryResponse {
    pub fn new(meta: models::ChangesPeriodHighVolumeQueryMeta, resources: Vec<String>) -> ChangesPeriodHighVolumeQueryResponse {
