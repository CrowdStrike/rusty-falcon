...
impl GraphMulti {
    pub fn new(array_field: String, array_field_display_name: String, continue_on_partial_execution: bool, max_execution_seconds: i32, max_iteration_count: i32) -> GraphMulti {
        GraphMulti {
            array_field,
