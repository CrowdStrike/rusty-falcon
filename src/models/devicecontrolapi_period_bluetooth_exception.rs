...
pub struct DevicecontrolapiPeriodBluetoothException {
...
impl DevicecontrolapiPeriodBluetoothException {
    pub fn new(id: String) -> DevicecontrolapiPeriodBluetoothException {
        DevicecontrolapiPeriodBluetoothException {
            action: None,
            class: None,
            combined_id: None,
