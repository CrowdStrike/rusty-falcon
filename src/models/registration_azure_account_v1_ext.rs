...
impl RegistrationAzureAccountV1Ext {
    pub fn new(created_at: String, deleted_at: String, id: i32, updated_at: String, azure_permissions_status: Vec<models::DomainPermission>, cid: String, ioa_status: String, iom_status: String, show_modal: bool) -> RegistrationAzureAccountV1Ext {
