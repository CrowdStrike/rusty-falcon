...
pub struct GetEndTransaction {
    ...
    pub errors: Option<Vec<models::Error208252f00cf64de68d28810846b7dd26>>,
    #[serde(rename = "meta", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Option<Box<models::Meta23005461ac9a41fbb4620fe4aa0a3438>>>,
    #[serde(rename = "resources", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub resources: Option<Option<Vec<models::DataTransactionResponseDto31852908d6f14d268312c3fcdb497315>>>,
}
