...
pub struct ApiPatchRuleSearchV1 {
    #[serde(rename = "filter", skip_serializing_if = "Option::is_none")]
    pub filter: Option<String>,
    #[serde(rename = "lookback", skip_serializing_if = "Option::is_none")]
...
impl ApiPatchRuleSearchV1 {
    pub fn new(trigger_mode: String) -> ApiPatchRuleSearchV1 {
        ApiPatchRuleSearchV1 {
            filter: None,
            lookback: None,
            outcome: None,
            trigger_mode,
