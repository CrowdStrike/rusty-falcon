...
impl DeviceControlPeriodSettingsReqV1 {
    pub fn new(classes: Vec<models::DeviceControlPeriodUsbClassExceptionsReqV1>, delete_exceptions: Vec<String>, end_user_notification: EndUserNotification, enforcement_mode: EnforcementMode) -> DeviceControlPeriodSettingsReqV1 {
