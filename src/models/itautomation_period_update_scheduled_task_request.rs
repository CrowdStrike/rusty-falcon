...
pub struct ItautomationPeriodUpdateScheduledTaskRequest {
    ...
    pub schedule: Option<Box<models::FalconforitapiPeriodSchedule>>,
...
impl ItautomationPeriodUpdateScheduledTaskRequest {
    pub fn new() -> ItautomationPeriodUpdateScheduledTaskRequest {
        ItautomationPeriodUpdateScheduledTaskRequest {
