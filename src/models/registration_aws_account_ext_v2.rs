...
pub struct RegistrationAwsAccountExtV2 {
    ...
    #[serde(rename = "sensor_management_enabled", skip_serializing_if = "Option::is_none")]
...
impl RegistrationAwsAccountExtV2 {
    pub fn new(account_id: String, cloudtrail_region: String, iam_role_arn: String, organization_id: String) -> RegistrationAwsAccountExtV2 {
