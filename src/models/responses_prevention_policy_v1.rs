...
pub struct ResponsesPreventionPolicyV1 {
    ...
    pub ioa_rule_groups: Vec<crate::models::ResponsesIoaRuleGroupV1>,
    ...
    pub prevention_settings: Vec<crate::models::ResponsesPreventionCategoryV1>,
}

impl ResponsesPreventionPolicyV1 {
    /// A fully formed prevention policy
    pub fn new(cid: String, created_by: String, created_timestamp: String, description: String, enabled: bool, groups: Vec<crate::models::ResponsesHostGroupV1>, id: String, ioa_rule_groups: Vec<crate::models::ResponsesIoaRuleGroupV1>, modified_by: String, modified_timestamp: String, name: String, platform_name: PlatformName, prevention_settings: Vec<crate::models::ResponsesPreventionCategoryV1>) -> ResponsesPreventionPolicyV1 {
