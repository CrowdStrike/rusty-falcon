...
pub struct ItautomationSearchTaskResponse {
...
impl ItautomationSearchTaskResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ItautomationSearchTaskResponse {
