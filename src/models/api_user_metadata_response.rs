...
pub struct ApiUserMetadataResponse {
    ...
    pub resources: Vec<models::DomainUserMetadata>,
}

impl ApiUserMetadataResponse {
    pub fn new(errors: Vec<models::MsaspecError>, meta: models::MsaspecMetaInfo, resources: Vec<models::DomainUserMetadata>) -> ApiUserMetadataResponse {
