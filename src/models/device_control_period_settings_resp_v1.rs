...
impl DeviceControlPeriodSettingsRespV1 {
    pub fn new(classes: Vec<models::DeviceControlPeriodUsbClassExceptionsResponse>, end_user_notification: EndUserNotification, enforcement_mode: EnforcementMode, enhanced_file_metadata: bool) -> DeviceControlPeriodSettingsRespV1 {
