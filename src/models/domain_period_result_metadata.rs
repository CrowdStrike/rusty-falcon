...
impl DomainPeriodResultMetadata {
    pub fn new(execution_delay: i64, execution_duration: i64, execution_finish: String, execution_start: String, queue_duration: i64, queue_start: String, report_file_name: String, report_finish: String, result_count: i32, result_id: String, search_window_end: String, search_window_start: String, use_ingest_time: bool) -> DomainPeriodResultMetadata {
