...
impl DomainPeriodApiDetectionDocument {
    pub fn new(behaviors_processed: Vec<String>, cid: String, created_timestamp: String, detection_id: String, device: models::DetectsPeriodDeviceDetailIndexed, email_sent: bool, first_behavior: String, hostinfo: models::DetectsPeriodHostInfo, last_behavior: String, max_confidence: i32, max_severity: i32, max_severity_displayname: String, seconds_to_resolved: i64, seconds_to_triaged: i64, show_in_ui: bool, status: String) -> DomainPeriodApiDetectionDocument {
