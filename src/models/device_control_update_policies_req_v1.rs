...
pub struct DeviceControlUpdatePoliciesReqV1 {
    /// List of policies to update. Maximum batch size: 1000.
    #[serde(rename = "resources")]
    pub resources: Vec<models::DeviceControlUpdatePolicyReqV1>,
}

impl DeviceControlUpdatePoliciesReqV1 {
    /// A req to update DeviceControl policies
    pub fn new(resources: Vec<models::DeviceControlUpdatePolicyReqV1>) -> DeviceControlUpdatePoliciesReqV1 {
