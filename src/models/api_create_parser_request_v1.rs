...
impl ApiCreateParserRequestV1 {
    pub fn new(fields_to_be_removed_before_parsing: Vec<String>, fields_to_tag: Vec<String>, name: String, repository: String, script: String) -> ApiCreateParserRequestV1 {
