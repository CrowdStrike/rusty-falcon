...
impl DeviceapiDeviceDetailsResponseSwagger {
    pub fn new(errors: Vec<models::MsaspecError>, meta: models::MsaspecMetaInfo, resources: Vec<models::DeviceapiDeviceSwagger>) -> DeviceapiDeviceDetailsResponseSwagger {
