...
impl DomainPeriodKestrelDataExportParams {
    pub fn new(export_mapping: Vec<models::DomainPeriodKestrelDataExportHeaderMapping>, export_mapping_v2: Vec<models::DomainPeriodKestrelDataExportHeaderMappingV2>, gqe_query: String, view_id: String) -> DomainPeriodKestrelDataExportParams {
