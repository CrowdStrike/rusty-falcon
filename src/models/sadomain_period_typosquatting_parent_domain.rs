...
pub struct SadomainPeriodTyposquattingParentDomain {
...
impl SadomainPeriodTyposquattingParentDomain {
    pub fn new(id: String, punycode_format: String, unicode_format: String) -> SadomainPeriodTyposquattingParentDomain {
