...
impl DomainMultiCommandExecuteResponseWrapper {
    pub fn new(combined: models::DomainMultiCommandExecuteResponse, errors: Vec<models::MsaspecError>, meta: models::MsaspecMetaInfo) -> DomainMultiCommandExecuteResponseWrapper {
