...
pub struct DomainPeriodScanProfile {
    ...
    pub metadata: Option<Vec<models::DomainPeriodScanProfileMetadata>>,
    ...
    pub schedule: Option<Box<models::DomainPeriodSchedule>>,
...
impl DomainPeriodScanProfile {
    pub fn new(deleted: bool, id: String) -> DomainPeriodScanProfile {
