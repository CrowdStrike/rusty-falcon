...
pub struct DeviceControlUsbCustomNotifications {
    ...
    pub blocked_notification: Option<Box<models::DeviceControlUsbCustomNotification>>,
    #[serde(rename = "restricted_notification", skip_serializing_if = "Option::is_none")]
    pub restricted_notification: Option<Box<models::DeviceControlUsbCustomNotification>>,
}
