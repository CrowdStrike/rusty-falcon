...
pub struct FwmgrMsaAggregationResult {
    #[serde(rename = "buckets")]
    pub buckets: Vec<models::FwmgrMsaAggregationResultItem>,
...
impl FwmgrMsaAggregationResult {
    pub fn new(buckets: Vec<models::FwmgrMsaAggregationResultItem>, name: String) -> FwmgrMsaAggregationResult {
