...
pub struct ItautomationSearchScheduledTaskResponse {
...
impl ItautomationSearchScheduledTaskResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ItautomationSearchScheduledTaskResponse {
