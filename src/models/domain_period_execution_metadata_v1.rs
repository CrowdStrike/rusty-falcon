...
impl DomainPeriodExecutionMetadataV1 {
    pub fn new(report_params: models::DomainPeriodReportParams, retry_allowed: bool, retry_performed: bool, retry_report_execution_id: String, subtype: String, unscheduled_execution_type: String, xdr_data: models::DomainPeriodXdrData, xdr_params: models::DomainPeriodXdrParams) -> DomainPeriodExecutionMetadataV1 {
