...
pub struct FirewallPeriodPolicyV1 {
    ...
    #[serde(rename = "rule_set_id")]
    pub rule_set_id: String,
}

impl FirewallPeriodPolicyV1 {
    pub fn new(channel_version: i32, cid: String, created_by: String, created_timestamp: String, description: String, enabled: bool, groups: Vec<models::HostGroupsPeriodHostGroupV1>, id: String, modified_by: String, modified_timestamp: String, name: String, platform_name: PlatformName, rule_set_id: String) -> FirewallPeriodPolicyV1 {
