...
pub struct MsaAggregationResultItem {
    #[serde(rename = "count")]
    pub count: i64,
    ...
    pub sub_aggregates: Option<Vec<crate::models::MsaAggregationResult>>,
...
impl MsaAggregationResultItem {
    pub fn new(count: i64) -> MsaAggregationResultItem {
