...
pub struct DeviceControlPeriodPolicyV1 {
    ...
    pub settings: Box<models::DeviceControlPeriodSettingsRespV1>,
}

impl DeviceControlPeriodPolicyV1 {
    pub fn new(cid: String, created_by: String, created_timestamp: String, description: String, enabled: bool, groups: Vec<models::HostGroupsPeriodHostGroupV1>, id: String, modified_by: String, modified_timestamp: String, name: String, platform_name: PlatformName, settings: models::DeviceControlPeriodSettingsRespV1) -> DeviceControlPeriodPolicyV1 {
