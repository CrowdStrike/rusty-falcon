...
pub struct ApiDeleteDashboardResponseV1 {
...
impl ApiDeleteDashboardResponseV1 {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ApiDeleteDashboardResponseV1 {
