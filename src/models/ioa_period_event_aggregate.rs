...
pub struct IoaPeriodEventAggregate {
    ...
    pub resource: Box<crate::models::PeriodResource>,
    #[serde(rename = "score", skip_serializing_if = "Option::is_none")]
    pub score: Option<i32>,
    #[serde(rename = "threatintel", skip_serializing_if = "Option::is_none")]
    pub threatintel: Option<Box<crate::models::DetectionPeriodAggregateThreatIntel>>,
    #[serde(rename = "timestamps", skip_serializing_if = "Option::is_none")]
    pub timestamps: Option<Vec<String>>,
}

impl IoaPeriodEventAggregate {
    pub fn new(resource: crate::models::PeriodResource) -> IoaPeriodEventAggregate {
