...
pub struct MetaGetAlertsResponse {
    #[serde(rename = "pagination", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Option<Box<models::PaginationMetaGetAlertsResponse>>>,
...
impl MetaGetAlertsResponse {
    pub fn new() -> MetaGetAlertsResponse {
