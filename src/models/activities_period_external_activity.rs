...
pub struct ActivitiesPeriodExternalActivity {
...
impl ActivitiesPeriodExternalActivity {
    pub fn new(cid: String, description: String, disruptive: bool, has_permission: bool, id: String, name: String) -> ActivitiesPeriodExternalActivity {
        ActivitiesPeriodExternalActivity {
            api_scope: None,
            app_id: None,
            cid,
            class: None,
