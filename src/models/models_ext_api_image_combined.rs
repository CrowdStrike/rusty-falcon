...
pub struct ModelsExtApiImageCombined {
...
impl ModelsExtApiImageCombined {
    pub fn new(ai_related: bool, architecture: String, base_os: String, cid: String, containers: i64, detections: i32, first_seen: String, highest_detection_severity: String, highest_vulnerability_severity: String, image_digest: String, image_id: String, last_seen: String, layers_with_vulnerabilities: i32, packages: i32, registry: String, report_url_by_id_and_digest: String, report_url_by_repo_and_tag: String, repository: String, tag: String, vulnerabilities: i32, warning: i32) -> ModelsExtApiImageCombined {
        ModelsExtApiImageCombined {
            ai_related,
            architecture,
            base_os,
            cid,
