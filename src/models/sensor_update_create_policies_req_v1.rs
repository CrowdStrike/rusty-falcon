...
pub struct SensorUpdateCreatePoliciesReqV1 {
    /// A collection of policies to create
    #[serde(rename = "resources")]
    pub resources: Vec<models::SensorUpdateCreatePolicyReqV1>,
}

impl SensorUpdateCreatePoliciesReqV1 {
    /// A req to create sensor update policies
    pub fn new(resources: Vec<models::SensorUpdateCreatePolicyReqV1>) -> SensorUpdateCreatePoliciesReqV1 {
