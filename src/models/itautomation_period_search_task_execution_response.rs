...
pub struct ItautomationPeriodSearchTaskExecutionResponse {
...
impl ItautomationPeriodSearchTaskExecutionResponse {
    pub fn new(meta: models::MsaspecPeriodMetaInfo, resources: Vec<String>) -> ItautomationPeriodSearchTaskExecutionResponse {
        ItautomationPeriodSearchTaskExecutionResponse {
            errors: None,
            meta: Box::new(meta),
            resources,
        }
