...
pub struct DomainPeriodPolicyInfo {
    ...
    #[serde(rename = "attack_tool_command", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "hipaa_benchmark_ids", skip_serializing_if = "Option::is_none")]
    pub hipaa_benchmark_ids: Option<Vec<i32>>,
    #[serde(rename = "hitrust_benchmark_ids", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "policy_confidence_score", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "policy_severity_score", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "resource_type_friendly_name", skip_serializing_if = "Option::is_none")]
...
impl DomainPeriodPolicyInfo {
    pub fn new(created_at: String, deleted_at: String, id: i32, updated_at: String, account_scope: String, is_enabled: bool, is_remediable: bool) -> DomainPeriodPolicyInfo {
