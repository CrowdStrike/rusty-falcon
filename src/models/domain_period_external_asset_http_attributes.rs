...
pub struct DomainPeriodExternalAssetHttpAttributes {
...
impl DomainPeriodExternalAssetHttpAttributes {
    pub fn new(response_headers: String) -> DomainPeriodExternalAssetHttpAttributes {
        DomainPeriodExternalAssetHttpAttributes {
            cookies: None,
            meta: None,
            response_headers,
            technologies: None,
