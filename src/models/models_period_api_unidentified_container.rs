...
impl ModelsPeriodApiUnidentifiedContainer {
    pub fn new(
        assessed_images: Vec<models::ModelsPeriodImageInformation>,
        assessed_images_count: String,
        cid: String,
        cluster_name: String,
        containers_impacted: Vec<models::ModelsPeriodContainerInformation>,
        ...
        severity: String,
        unassessed_images: Vec<models::ModelsPeriodImageInformation>,
