...
pub struct ItautomationSearchTaskGroupsResponse {
...
impl ItautomationSearchTaskGroupsResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ItautomationSearchTaskGroupsResponse {
