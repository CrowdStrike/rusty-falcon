...
pub struct K8sregPeriodAwsAccountResp {
    ...
    pub aws_permissions_status: Vec<crate::models::K8sregPeriodAccountPermissionsStatus>,
    #[serde(rename = "cid")]
    pub cid: String,
...
impl K8sregPeriodAwsAccountResp {
    pub fn new(
        account_id: String,
        aws_permissions_status: Vec<crate::models::K8sregPeriodAccountPermissionsStatus>,
        cid: String,
        created_at: String,
        from_cspm: bool,
        iam_role_arn: String,
