...
impl DefinitionsDefinitionExt {
    pub fn new(enabled: bool, has_validation_errors: bool, id: String, last_modified_timestamp: String, name: String, node_registry: std::collections::HashMap<String, String>, parent: models::V2Model, trigger: models::V2Trigger, uniq_node_seen: std::collections::HashMap<String, bool>, version: i32) -> DefinitionsDefinitionExt {
