...
pub struct PreventionPeriodCreatePoliciesReqV1 {
    ...
    pub resources: Vec<models::PreventionPeriodCreatePolicyReqV1>,
}

impl PreventionPeriodCreatePoliciesReqV1 {
    /// A request to create prevention policies
    pub fn new(resources: Vec<models::PreventionPeriodCreatePolicyReqV1>) -> PreventionPeriodCreatePoliciesReqV1 {
