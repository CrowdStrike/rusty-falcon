...
impl ExecutionsExecutionResult {
    pub fn new(
        activities: Vec<models::ExecutionsActivityExecutionResult>,
        ancestor_executions: Vec<models::ExecutionsAncestorExecution>,
        definition_id: String,
        definition_name: String,
        definition_version: i32,
        execution_id: String,
        loops: Vec<models::ExecutionsLoopResult>,
        retryable: bool,
        start_timestamp: String,
        status: String,
        trigger: models::ExecutionsTriggerResult,
