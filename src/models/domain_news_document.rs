...
impl DomainNewsDocument {
    pub fn new(actors: Vec<crate::models::DomainSimpleActor>, created_date: i64, id: i64, last_modified_date: i64, motivations: Vec<crate::models::DomainEntity>, name: String, slug: String, tags: Vec<crate::models::DomainEntity>, target_countries: Vec<crate::models::DomainEntity>, target_industries: Vec<crate::models::DomainEntity>, thumbnail: crate::models::DomainImage) -> DomainNewsDocument {
        DomainNewsDocument {
            active: None,
            actors,
            attachments: None,
