...
pub struct RegistrationAzureTenantDefaultSubscriptionIdResponseV1 {
    #[serde(rename = "errors")]
...
impl RegistrationAzureTenantDefaultSubscriptionIdResponseV1 {
    pub fn new(errors: Vec<models::MsaspecError>, meta: models::MsaspecMetaInfo, resources: models::Resources) -> RegistrationAzureTenantDefaultSubscriptionIdResponseV1 {
