...
pub struct ItautomationPeriodStartTaskExecutionRequest {
...
impl ItautomationPeriodStartTaskExecutionRequest {
    pub fn new(task_id: String) -> ItautomationPeriodStartTaskExecutionRequest {
        ItautomationPeriodStartTaskExecutionRequest {
