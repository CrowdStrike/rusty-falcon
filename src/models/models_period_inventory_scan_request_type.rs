...
impl ModelsPeriodInventoryScanRequestType {
    pub fn new(agent_uuid: String, agent_version: String, agent_version_hash: String, cluster_id: String, cluster_name: String, helm_version: String, host_ip: String, host_name: String, inventory: models::ModelsPeriodInventoryType, original_image_name: String, runmode: String, scan_request: models::ModelsPeriodScanRequestType) -> ModelsPeriodInventoryScanRequestType {
