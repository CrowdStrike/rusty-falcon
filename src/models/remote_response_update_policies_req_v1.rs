...
pub struct RemoteResponseUpdatePoliciesReqV1 {
    /// A collection of policies to update
    #[serde(rename = "resources")]
    pub resources: Vec<models::RemoteResponseUpdatePolicyReqV1>,
}

impl RemoteResponseUpdatePoliciesReqV1 {
    /// A req to update realtime response policies
    pub fn new(resources: Vec<models::RemoteResponseUpdatePolicyReqV1>) -> RemoteResponseUpdatePoliciesReqV1 {
