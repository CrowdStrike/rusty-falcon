...
impl IoaRuleGroupsPeriodRuleGroupV1 {
    ...
    pub fn new(comment: String, committed_timestamp: String, created_by: String, created_timestamp: String, customer_id: String, deleted: bool, description: String, enabled: bool, id: String, modified_by: String, modified_timestamp: String, name: String, platform: String, rule_ids: Vec<String>, version: i64) -> IoaRuleGroupsPeriodRuleGroupV1 {
