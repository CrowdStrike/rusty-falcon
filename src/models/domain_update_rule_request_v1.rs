...
impl DomainUpdateRuleRequestV1 {
    pub fn new(filter: String, id: String, name: String, permissions: String, priority: String) -> DomainUpdateRuleRequestV1 {
        DomainUpdateRuleRequestV1 { filter, id, name, permissions, priority }
    }
}
