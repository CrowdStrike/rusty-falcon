...
impl DomainUpdateRuleRequestV1 {
    pub fn new(breach_monitor_only: bool, breach_monitoring_enabled: bool, filter: String, id: String, match_on_tsq_result_types: Vec<String>, name: String, permissions: String, priority: String, substring_matching_enabled: bool) -> DomainUpdateRuleRequestV1 {
