...
pub struct DomainPeriodEvent {
    ...
    pub botnet_config_source: Option<Box<models::DomainPeriodBotnetConfigSource>>,
    /// The date the event was created (in UTC format)
    #[serde(rename = "created_date")]
    pub created_date: String,
    #[serde(rename = "ddos_attack_source", skip_serializing_if = "Option::is_none")]
    pub ddos_attack_source: Option<Box<models::DomainPeriodDdosAttackSource>>,
    ...
    pub matched_rules: Option<Vec<models::DomainPeriodMatchedRule>>,
    #[serde(rename = "pastebin_text_source", skip_serializing_if = "Option::is_none")]
    pub pastebin_text_source: Option<Box<models::DomainPeriodPastebinTextSource>>,
    /// A list of tags summarizing event content
    #[serde(rename = "tags", skip_serializing_if = "Option::is_none")]
    pub tags: Option<Vec<String>>,
    #[serde(rename = "tweet_source", skip_serializing_if = "Option::is_none")]
    pub tweet_source: Option<Box<models::DomainPeriodTweetSource>>,
...
impl DomainPeriodEvent {
    pub fn new(body: String, body_is_truncated: bool, created_date: String, event_type: String, fingerprint: String, id: String, updated_date: String) -> DomainPeriodEvent {
        DomainPeriodEvent {
            body,
            body_is_truncated,
            body_link: None,
