...
pub struct Alert85f2306d175b4314b4d51d0096103dcc {
...
impl Alert85f2306d175b4314b4d51d0096103dcc {
    pub fn new(account_id: String, affected_diff: Vec<String>, alert_type: String, description: String, id: String, integration: std::collections::HashMap<String, String>, is_archived: bool, new_affected_count: i32, security_check_api_link: String, source: String, source_id: String, threat_api_link: String, timestamp: String, user_who_archived: String) -> Alert85f2306d175b4314b4d51d0096103dcc {
        Alert85f2306d175b4314b4d51d0096103dcc {
            account_id,
            affected_diff,
            alert_type,
