...
pub struct JsonschemaUiExtensions {
    ...
    pub duration_options: Option<Vec<models::JsonschemaDurationOption>>,
...
impl JsonschemaUiExtensions {
    pub fn new() -> JsonschemaUiExtensions {
