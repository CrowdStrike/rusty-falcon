...
pub struct SensorUpdatePeriodUpdatePoliciesReqV2 {
    ...
    pub resources: Vec<models::SensorUpdatePeriodUpdatePolicyReqV2>,
}

impl SensorUpdatePeriodUpdatePoliciesReqV2 {
    /// A req to update sensorUpdate policies
    pub fn new(resources: Vec<models::SensorUpdatePeriodUpdatePolicyReqV2>) -> SensorUpdatePeriodUpdatePoliciesReqV2 {
