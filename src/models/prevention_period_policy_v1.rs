...
pub struct PreventionPeriodPolicyV1 {
    ...
    pub ioa_rule_groups: Vec<models::IoaRuleGroupsPeriodRuleGroupV1>,
    ...
    pub prevention_settings: Vec<models::PreventionPeriodCategoryRespV1>,
}

impl PreventionPeriodPolicyV1 {
    /// A fully formed prevention policy
    pub fn new(cid: String, created_by: String, created_timestamp: String, description: String, enabled: bool, groups: Vec<models::HostGroupsPeriodHostGroupV1>, id: String, ioa_rule_groups: Vec<models::IoaRuleGroupsPeriodRuleGroupV1>, modified_by: String, modified_timestamp: String, name: String, platform_name: PlatformName, prevention_settings: Vec<models::PreventionPeriodCategoryRespV1>) -> PreventionPeriodPolicyV1 {
