...
pub struct FalconxPeriodSummaryReportV1 {
    ...
    pub intel: Option<Vec<crate::models::FalconxPeriodIntelSummaryReportV1>>,
    #[serde(
    ...
    pub sandbox: Option<Vec<crate::models::FalconxPeriodSandboxSummaryReportV1>>,
...
impl FalconxPeriodSummaryReportV1 {
    pub fn new() -> FalconxPeriodSummaryReportV1 {
