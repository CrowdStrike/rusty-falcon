...
pub struct DomainDenormalizedThreatUsedMitre {
...
impl DomainDenormalizedThreatUsedMitre {
    pub fn new() -> DomainDenormalizedThreatUsedMitre {
        DomainDenormalizedThreatUsedMitre {
            attack_id: None,
            observables: None,
            reports: None,
            tactic_id: None,
