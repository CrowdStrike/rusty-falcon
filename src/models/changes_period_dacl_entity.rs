...
pub struct ChangesPeriodDaclEntity {
    ...
    pub acl_permission_change: Vec<models::ChangesPeriodAttribute>,
...
impl ChangesPeriodDaclEntity {
    pub fn new(acl_permission_change: Vec<models::ChangesPeriodAttribute>, acl_principal: String, acl_principal_id: String, acl_type: i32) -> ChangesPeriodDaclEntity {
