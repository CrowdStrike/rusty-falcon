...
pub struct RegistrationAwsAccountPatch {
...
impl RegistrationAwsAccountPatch {
    pub fn new(account_id: String, behavior_assessment_enabled: bool, dspm_enabled: bool, iam_role_arn: String, sensor_management_enabled: bool) -> RegistrationAwsAccountPatch {
