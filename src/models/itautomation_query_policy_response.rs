...
pub struct ItautomationQueryPolicyResponse {
...
impl ItautomationQueryPolicyResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ItautomationQueryPolicyResponse {
