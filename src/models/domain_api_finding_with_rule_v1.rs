...
pub struct DomainApiFindingWithRuleV1 {
    ...
    pub rule: Option<Box<models::DomainApiFindingRuleV1>>,
...
impl DomainApiFindingWithRuleV1 {
    pub fn new() -> DomainApiFindingWithRuleV1 {
        DomainApiFindingWithRuleV1 {
