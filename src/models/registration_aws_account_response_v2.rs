...
pub struct RegistrationAwsAccountResponseV2 {
    #[serde(rename = "errors", skip_serializing_if = "Option::is_none")]
    pub errors: Option<Vec<models::MsaspecError>>,
    #[serde(rename = "meta")]
    pub meta: Box<models::MsaspecMetaInfo>,
    #[serde(rename = "resources")]
    pub resources: Vec<models::DomainAwsAccountV2>,
}

impl RegistrationAwsAccountResponseV2 {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<models::DomainAwsAccountV2>) -> RegistrationAwsAccountResponseV2 {
