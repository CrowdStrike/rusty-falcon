...
pub struct FwmgrApiRuleGroupsResponse {
    ...
    pub resources: Vec<crate::models::FwmgrApiRuleGroupV1>,
}

impl FwmgrApiRuleGroupsResponse {
    pub fn new(meta: crate::models::FwmgrMsaMetaInfo, resources: Vec<crate::models::FwmgrApiRuleGroupV1>) -> FwmgrApiRuleGroupsResponse {
