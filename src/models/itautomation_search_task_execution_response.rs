...
pub struct ItautomationSearchTaskExecutionResponse {
...
impl ItautomationSearchTaskExecutionResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ItautomationSearchTaskExecutionResponse {
