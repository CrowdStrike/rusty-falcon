...
pub struct EntitiesRollingAverage {
...
impl EntitiesRollingAverage {
    pub fn new(chrome_os: f64, containers: f64, date: String, lumos: f64, mobile: f64, public_cloud_with_containers: f64, public_cloud_without_containers: f64, servers_with_containers: f64, servers_without_containers: f64, workstations: f64) -> EntitiesRollingAverage {
        EntitiesRollingAverage {
            chrome_os,
            containers,
            date,
            lumos,
