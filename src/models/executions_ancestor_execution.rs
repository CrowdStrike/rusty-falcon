...
pub struct ExecutionsAncestorExecution {
...
impl ExecutionsAncestorExecution {
    pub fn new(field: String, id: String, iteration: i32) -> ExecutionsAncestorExecution {
        ExecutionsAncestorExecution {
            field,
            id,
            iteration,
        }
