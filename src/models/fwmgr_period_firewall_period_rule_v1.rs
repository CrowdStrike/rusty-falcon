...
impl FwmgrPeriodFirewallPeriodRuleV1 {
    pub fn new(action: String, address_family: String, created_by: String, created_on: String, deleted: bool, description: String, direction: String, enabled: bool, family: String, fields: Vec<models::FwmgrPeriodFirewallPeriodFieldValue>, fqdn: String, fqdn_enabled: bool, icmp: models::FwmgrPeriodFirewallPeriodIcmp, id: String, local_address: Vec<models::FwmgrPeriodFirewallPeriodAddressRange>, local_port: Vec<models::FwmgrPeriodFirewallPeriodPortRange>, monitor: models::FwmgrPeriodFirewallPeriodMonitoring, name: String, platform_ids: Vec<String>, protocol: String, remote_address: Vec<models::FwmgrPeriodFirewallPeriodAddressRange>, remote_port: Vec<models::FwmgrPeriodFirewallPeriodPortRange>, rule_group: models::FwmgrPeriodFirewallPeriodRuleGroupSummaryV1, version: i64) -> FwmgrPeriodFirewallPeriodRuleV1 {
