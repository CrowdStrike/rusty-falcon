...
pub struct MlscannerapiPeriodSamplesScanResult {
    ...
    pub samples: Vec<models::MlscannerapiPeriodScannedSample>,
    #[serde(rename = "status")]
    pub status: String,
}

impl MlscannerapiPeriodSamplesScanResult {
    pub fn new(cid: String, id: String, samples: Vec<models::MlscannerapiPeriodScannedSample>, status: String) -> MlscannerapiPeriodSamplesScanResult {
