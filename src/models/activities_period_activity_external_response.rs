...
impl ActivitiesPeriodActivityExternalResponse {
    pub fn new(errors: Vec<models::MsaspecPeriodError>, meta: models::MsaspecPeriodMetaInfo, resources: Vec<models::ActivitiesPeriodActivity>) -> ActivitiesPeriodActivityExternalResponse {
