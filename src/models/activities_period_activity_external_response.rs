...
pub struct ActivitiesPeriodActivityExternalResponse {
    #[serde(rename = "errors")]
...
impl ActivitiesPeriodActivityExternalResponse {
    pub fn new(errors: Vec<models::MsaspecPeriodError>, meta: models::MsaspecPeriodMetaInfo, resources: Vec<models::ActivitiesPeriodExternalActivity>) -> ActivitiesPeriodActivityExternalResponse {
