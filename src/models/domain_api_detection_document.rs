...
pub struct DomainApiDetectionDocument {
    ...
    pub behaviors: Option<Vec<crate::models::DetectsBehavior>>,
    ...
    #[serde(rename = "device")]
    pub device: Box<crate::models::DetectsDeviceDetailIndexed>,
    #[serde(rename = "email_sent")]
    pub email_sent: bool,
    #[serde(rename = "first_behavior")]
    pub first_behavior: String,
    #[serde(rename = "hostinfo")]
    pub hostinfo: Box<crate::models::DetectsHostInfo>,
    ...
    pub quarantined_files: Option<Vec<crate::models::DetectsQuarantinedFile>>,
...
impl DomainApiDetectionDocument {
    pub fn new(behaviors_processed: Vec<String>, cid: String, created_timestamp: String, detection_id: String, device: crate::models::DetectsDeviceDetailIndexed, email_sent: bool, first_behavior: String, hostinfo: crate::models::DetectsHostInfo, last_behavior: String, max_confidence: i32, max_severity: i32, max_severity_displayname: String, seconds_to_resolved: i64, seconds_to_triaged: i64, show_in_ui: bool, status: String) -> DomainApiDetectionDocument {
