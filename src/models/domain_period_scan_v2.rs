...
impl DomainPeriodScanV2 {
    pub fn new(affected_hosts_count: i32, completed_host_count: i32, id: String, incomplete_host_count: i32, missing_host_count: i32, not_started_host_count: i32, started_host_count: i32, targeted_host_count: i32) -> DomainPeriodScanV2 {
        DomainPeriodScanV2 {
