...
pub struct DomainPeriodAggregationResult {
    /// Aggregation buckets containing aggregated information
    #[serde(rename = "buckets")]
    pub buckets: Vec<models::DomainPeriodAggregationResultItem>,
...
impl DomainPeriodAggregationResult {
    pub fn new(buckets: Vec<models::DomainPeriodAggregationResultItem>, name: String) -> DomainPeriodAggregationResult {
        DomainPeriodAggregationResult {
            buckets,
            name,
