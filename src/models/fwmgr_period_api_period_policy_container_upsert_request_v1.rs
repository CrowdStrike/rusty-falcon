...
pub struct FwmgrPeriodApiPeriodPolicyContainerUpsertRequestV1 {
...
impl FwmgrPeriodApiPeriodPolicyContainerUpsertRequestV1 {
    pub fn new(default_inbound: String, default_outbound: String, enforce: bool, local_logging: bool, platform_id: String, policy_id: String, rule_group_ids: Vec<String>, test_mode: bool) -> FwmgrPeriodApiPeriodPolicyContainerUpsertRequestV1 {
