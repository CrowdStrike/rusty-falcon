...
pub struct ClientPeriodSystemDefinitionProvisionRequest {
...
impl ClientPeriodSystemDefinitionProvisionRequest {
    pub fn new(name: String, parameters: models::ParameterPeriodTemplateProvisionParameters, template_id: String, template_name: String, template_version: String) -> ClientPeriodSystemDefinitionProvisionRequest {
        ClientPeriodSystemDefinitionProvisionRequest {
            name,
