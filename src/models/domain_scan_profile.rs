...
pub struct DomainScanProfile {
    ...
    pub metadata: Option<Vec<models::DomainScanProfileMetadata>>,
    ...
    pub schedule: Option<Box<models::DomainSchedule>>,
...
impl DomainScanProfile {
    pub fn new(deleted: bool, id: String) -> DomainScanProfile {
        DomainScanProfile {
            cid: None,
