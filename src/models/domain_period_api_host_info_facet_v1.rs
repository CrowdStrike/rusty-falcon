...
pub struct DomainPeriodApiHostInfoFacetV1 {
    ...
    pub asset_criticality: Option<Box<models::DomainPeriodAssetCriticalityInfoV1>>,
    #[serde(rename = "build_number", skip_serializing_if = "Option::is_none")]
    pub build_number: Option<String>,
    #[serde(rename = "groups")]
    pub groups: Vec<models::DomainPeriodApiHostGroup>,
...
impl DomainPeriodApiHostInfoFacetV1 {
    pub fn new(groups: Vec<models::DomainPeriodApiHostGroup>, name: String) -> DomainPeriodApiHostInfoFacetV1 {
