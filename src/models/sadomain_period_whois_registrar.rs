...
pub struct SadomainPeriodWhoisRegistrar {
...
impl SadomainPeriodWhoisRegistrar {
    pub fn new(name: String, status: Vec<String>) -> SadomainPeriodWhoisRegistrar {
        SadomainPeriodWhoisRegistrar { name, status }
    }
}
