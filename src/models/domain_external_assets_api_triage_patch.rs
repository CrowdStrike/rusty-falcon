...
pub struct DomainExternalAssetsApiTriagePatch {
...
impl DomainExternalAssetsApiTriagePatch {
    pub fn new() -> DomainExternalAssetsApiTriagePatch {
        DomainExternalAssetsApiTriagePatch {
            action: None,
            assigned_to: None,
            description: None,
            status: None,
