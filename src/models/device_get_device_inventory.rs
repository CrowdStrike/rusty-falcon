...
impl DeviceGetDeviceInventory {
    pub fn new(account_id: String, apps_count: Option<i32>, device_name: Option<String>, globally_compliant: Option<String>, globally_managed: Option<String>, has_user_association: Option<bool>, id: String, last_seen: Option<String>, mac_address_list: Option<Vec<String>>, os: Option<String>, os_version: Option<String>, platform: Option<String>, privileged_roles_count: Option<i32>, reported_apps: Option<Vec<String>>, reporters: Vec<String>, user_email: Option<String>, user_exists: Option<bool>) -> DeviceGetDeviceInventory {
