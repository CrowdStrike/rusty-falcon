...
pub struct ParameterConditionFieldParameter {
...
impl ParameterConditionFieldParameter {
    pub fn new(multiple: bool, required: bool) -> ParameterConditionFieldParameter {
        ParameterConditionFieldParameter {
