...
pub struct CsdomainManagedApps {
    #[serde(rename = "airlock", skip_serializing_if = "Option::is_none")]
    pub airlock: Option<Box<crate::models::CsdomainManagedApp>>,
    #[serde(rename = "automox", skip_serializing_if = "Option::is_none")]
    pub automox: Option<Box<crate::models::CsdomainManagedApp>>,
    #[serde(rename = "netskope", skip_serializing_if = "Option::is_none")]
    pub netskope: Option<Box<crate::models::CsdomainManagedApp>>,
}
