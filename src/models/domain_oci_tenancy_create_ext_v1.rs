...
pub struct DomainOciTenancyCreateExtV1 {
...
impl DomainOciTenancyCreateExtV1 {
    pub fn new(home_region: String, products: Vec<models::DomainCloudOciProductFeature>, tenancy_ocid: String, user_email: String) -> DomainOciTenancyCreateExtV1 {
        DomainOciTenancyCreateExtV1 {
            group_name: None,
            home_region,
            policy_name: None,
            products,
