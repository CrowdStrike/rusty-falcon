...
pub struct RemoteResponseCreatePolicyReqV1 {
...
impl RemoteResponseCreatePolicyReqV1 {
    pub fn new(name: String, platform_name: PlatformName) -> RemoteResponseCreatePolicyReqV1 {
