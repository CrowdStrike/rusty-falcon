...
pub struct FlightcontrolapiCombinedUserRolesResourceV2 {
...
impl FlightcontrolapiCombinedUserRolesResourceV2 {
    pub fn new(role_id: String) -> FlightcontrolapiCombinedUserRolesResourceV2 {
        FlightcontrolapiCombinedUserRolesResourceV2 {
            cid: None,
            cid_group_id: None,
            cid_group_name: None,
            expires_at: None,
