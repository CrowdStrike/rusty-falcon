...
impl ModelUserInputViewModel {
    pub fn new(allowed_inputs: Vec<String>, allowed_responders: Vec<String>, completed: bool, completed_at: String, created_at: String, id: String, input: String, note: String, responder: String, timeout_at: String) -> ModelUserInputViewModel {
