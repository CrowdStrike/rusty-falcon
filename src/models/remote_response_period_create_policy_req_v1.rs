...
pub struct RemoteResponsePeriodCreatePolicyReqV1 {
    ...
    pub settings: Option<Vec<crate::models::PreventionPeriodSettingReqV1>>,
}

impl RemoteResponsePeriodCreatePolicyReqV1 {
    pub fn new(name: String, platform_name: PlatformName) -> RemoteResponsePeriodCreatePolicyReqV1 {
