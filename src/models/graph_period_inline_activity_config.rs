...
pub struct GraphPeriodInlineActivityConfig {
...
impl GraphPeriodInlineActivityConfig {
    pub fn new() -> GraphPeriodInlineActivityConfig {
        GraphPeriodInlineActivityConfig {
            config: None,
            input_schema: None,
            output_schema: None,
        }
