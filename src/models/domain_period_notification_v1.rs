...
pub struct DomainPeriodNotificationV1 {
    ...
    pub breach_summary: Option<Box<models::DomainPeriodMatchedBreachSummaryV1>>,
    #[serde(rename = "cid")]
    pub cid: String,
    ...
    pub logs: Option<Vec<models::SadomainPeriodNotificationLog>>,
    ...
    #[serde(rename = "rule_creator_name", skip_serializing_if = "Option::is_none")]
    pub rule_creator_name: Option<String>,
    /// The user ID of the user who created the rule
    #[serde(rename = "rule_creator_uid", skip_serializing_if = "Option::is_none")]
    pub rule_creator_uid: Option<String>,
    /// The unique UUID of the user who created the rule
    #[serde(rename = "rule_creator_uuid", skip_serializing_if = "Option::is_none")]
    pub rule_creator_uuid: Option<String>,
    ...
    pub typosquatting: Option<Box<models::SadomainPeriodTyposquattingComponent>>,
...
impl DomainPeriodNotificationV1 {
    pub fn new(actor_slug: String, cid: String, created_date: String, id: String, item_date: String, item_id: String, item_type: String, raw_intel_id: String, rule_id: String, rule_name: String, rule_priority: String, rule_topic: String, status: String, updated_date: String) -> DomainPeriodNotificationV1 {
        DomainPeriodNotificationV1 {
            ...
            logs: None,
            raw_intel_id,
            rule_creator_name: None,
            rule_creator_uid: None,
            rule_creator_uuid: None,
            rule_id,
            rule_name,
            rule_priority,
            rule_topic,
