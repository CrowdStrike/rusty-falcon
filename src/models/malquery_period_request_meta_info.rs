...
pub struct MalqueryPeriodRequestMetaInfo {
    #[serde(rename = "options", skip_serializing_if = "Option::is_none")]
    pub options: Option<Box<models::MalqueryPeriodExternalHuntOptions>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::MsaspecPeriodPaging>>,
    /// Patterns to search for
    #[serde(rename = "patterns", skip_serializing_if = "Option::is_none")]
    pub patterns: Option<Vec<models::MalqueryPeriodSearchParameter>>,
    ...
    pub stats: Option<Box<models::MalqueryPeriodStats>>,
    ...
    pub writes: Option<Box<models::MsaspecPeriodWrites>>,
    /// YARA rule to be monitored
    #[serde(rename = "yara_rule", skip_serializing_if = "Option::is_none")]
    pub yara_rule: Option<String>,
}

impl MalqueryPeriodRequestMetaInfo {
    pub fn new(trace_id: String) -> MalqueryPeriodRequestMetaInfo {
