...
impl ItautomationPeriodAggregateHostCount {
    pub fn new(canceled_host_count: i32, expired_host_count: i32, failed_host_count: i32, initiated_host_count: i32, offline_host_count: i32, queued_host_count: i32, running_host_count: i32, success_host_count: i32) -> ItautomationPeriodAggregateHostCount {
