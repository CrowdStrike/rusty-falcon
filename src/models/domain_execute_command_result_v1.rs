...
pub struct DomainExecuteCommandResultV1 {
...
impl DomainExecuteCommandResultV1 {
    pub fn new(id: String, status_code: i32) -> DomainExecuteCommandResultV1 {
        DomainExecuteCommandResultV1 {
            headers: None,
            id,
            parsed_headers: None,
            response_body: None,
