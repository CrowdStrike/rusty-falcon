...
pub struct DomainCloudAwsAccountV1 {
    ...
    #[serde(rename = "registration_status", skip_serializing_if = "Option::is_none")]
...
impl DomainCloudAwsAccountV1 {
    pub fn new(created_at: String, deleted_at: String, id: i32, updated_at: String, iam_service_permissions_status: Vec<models::DomainProductPermission>, inventory_filter: Vec<models::DomainAwsInventoryFilterSetting>, is_custom_rolename: bool, products: Vec<models::DomainProductFeatures>, resource_metadata: models::DomainAwsAccountResourceMetadata) -> DomainCloudAwsAccountV1 {
