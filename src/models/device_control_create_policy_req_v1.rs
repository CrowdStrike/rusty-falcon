...
pub struct DeviceControlCreatePolicyReqV1 {
    ...
    pub settings: Option<Box<models::DeviceControlSettingsReqV1>>,
}

impl DeviceControlCreatePolicyReqV1 {
    pub fn new(name: String, platform_name: PlatformName) -> DeviceControlCreatePolicyReqV1 {
