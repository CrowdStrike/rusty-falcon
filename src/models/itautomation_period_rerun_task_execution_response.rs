...
pub struct ItautomationPeriodRerunTaskExecutionResponse {
...
impl ItautomationPeriodRerunTaskExecutionResponse {
    pub fn new(meta: models::MsaspecPeriodMetaInfo, resources: Vec<String>) -> ItautomationPeriodRerunTaskExecutionResponse {
        ItautomationPeriodRerunTaskExecutionResponse {
            errors: None,
            meta: Box::new(meta),
            resources,
        }
