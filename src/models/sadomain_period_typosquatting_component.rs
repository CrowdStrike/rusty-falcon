...
impl SadomainPeriodTyposquattingComponent {
    pub fn new(base_domain: models::SadomainPeriodTyposquattingBaseDomain, id: String, parent_domain: models::SadomainPeriodTyposquattingParentDomain, punycode_format: String, unicode_format: String) -> SadomainPeriodTyposquattingComponent {
