...
pub struct DomainPeriodExternalAssetsApiTriage {
...
impl DomainPeriodExternalAssetsApiTriage {
    pub fn new() -> DomainPeriodExternalAssetsApiTriage {
        DomainPeriodExternalAssetsApiTriage {
            action: None,
            assigned_to: None,
            description: None,
            status: None,
