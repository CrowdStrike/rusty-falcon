...
pub struct ActivitiesActivityExtField {
    ...
    pub fields: Option<Vec<models::ActivitiesActivityExtField>>,
    /// Name of the field as it should be passed back to the API through conditions or data mapping.
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "source", skip_serializing_if = "Option::is_none")]
    pub source: Option<Box<models::FielddataFieldSource>>,
...
impl ActivitiesActivityExtField {
    pub fn new(display: String, name: String) -> ActivitiesActivityExtField {
        ActivitiesActivityExtField {
            description: None,
            display,
            example: None,
            fields: None,
