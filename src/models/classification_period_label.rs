...
pub struct ClassificationPeriodLabel {
    #[serde(rename = "criteria", skip_serializing_if = "Option::is_none")]
    pub criteria: Option<Vec<crate::models::ClassificationPeriodCriteria>>,
...
impl ClassificationPeriodLabel {
    pub fn new() -> ClassificationPeriodLabel {
