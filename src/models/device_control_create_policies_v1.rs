...
pub struct DeviceControlCreatePoliciesV1 {
    /// List of policies to create. Maximum batch size: 1000.
    #[serde(rename = "resources")]
    pub resources: Vec<models::DeviceControlCreatePolicyReqV1>,
}

impl DeviceControlCreatePoliciesV1 {
    /// A req to create DeviceControl policies
    pub fn new(resources: Vec<models::DeviceControlCreatePolicyReqV1>) -> DeviceControlCreatePoliciesV1 {
