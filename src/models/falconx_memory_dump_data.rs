...
pub struct FalconxMemoryDumpData {
    ...
    #[serde(rename = "file_process_disc_pathway", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "file_process_sha256", skip_serializing_if = "Option::is_none")]
...
impl FalconxMemoryDumpData {
    pub fn new() -> FalconxMemoryDumpData {
        FalconxMemoryDumpData {
            address: None,
