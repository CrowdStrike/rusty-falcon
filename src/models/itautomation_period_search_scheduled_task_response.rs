...
pub struct ItautomationPeriodSearchScheduledTaskResponse {
...
impl ItautomationPeriodSearchScheduledTaskResponse {
    pub fn new(meta: models::MsaspecPeriodMetaInfo, resources: Vec<String>) -> ItautomationPeriodSearchScheduledTaskResponse {
        ItautomationPeriodSearchScheduledTaskResponse {
            errors: None,
            meta: Box::new(meta),
            resources,
        }
