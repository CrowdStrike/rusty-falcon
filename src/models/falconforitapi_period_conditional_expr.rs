...
pub struct FalconforitapiPeriodConditionalExpr {
...
impl FalconforitapiPeriodConditionalExpr {
    pub fn new(data_comparator: DataComparator, data_type: DataType, key: String, task_id: String, value: String) -> FalconforitapiPeriodConditionalExpr {
        FalconforitapiPeriodConditionalExpr {
            data_comparator,
            data_type,
            key,
            task_id,
