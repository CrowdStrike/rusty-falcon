...
pub struct DeviceControlPeriodExceptionRespV1 {
...
impl DeviceControlPeriodExceptionRespV1 {
    pub fn new(class: String, id: String) -> DeviceControlPeriodExceptionRespV1 {
