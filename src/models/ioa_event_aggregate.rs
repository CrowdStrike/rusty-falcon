...
pub struct IoaEventAggregate {
    ...
    pub threatintel: Option<Box<models::DetectionAggregateThreatIntel>>,
    #[serde(rename = "timestamps", skip_serializing_if = "Option::is_none")]
    pub timestamps: Option<Vec<String>>,
}

impl IoaEventAggregate {
    pub fn new(resource: models::Resource) -> IoaEventAggregate {
        IoaEventAggregate {
            cid_severity: None,
            confidence: None,
            count: None,
