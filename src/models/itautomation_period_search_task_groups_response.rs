...
pub struct ItautomationPeriodSearchTaskGroupsResponse {
...
impl ItautomationPeriodSearchTaskGroupsResponse {
    pub fn new(meta: models::MsaspecPeriodMetaInfo, resources: Vec<String>) -> ItautomationPeriodSearchTaskGroupsResponse {
        ItautomationPeriodSearchTaskGroupsResponse {
            errors: None,
            meta: Box::new(meta),
            resources,
        }
