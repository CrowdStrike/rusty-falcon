...
pub struct ClientSystemDefinitionProvisionRequest {
...
impl ClientSystemDefinitionProvisionRequest {
    pub fn new(name: String, parameters: models::ParameterTemplateProvisionParameters, template_id: String, template_name: String, template_version: String) -> ClientSystemDefinitionProvisionRequest {
