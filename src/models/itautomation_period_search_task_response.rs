...
pub struct ItautomationPeriodSearchTaskResponse {
...
impl ItautomationPeriodSearchTaskResponse {
    pub fn new(meta: models::MsaspecPeriodMetaInfo, resources: Vec<String>) -> ItautomationPeriodSearchTaskResponse {
        ItautomationPeriodSearchTaskResponse {
            errors: None,
            meta: Box::new(meta),
            resources,
        }
