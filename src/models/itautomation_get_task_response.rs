...
pub struct ItautomationGetTaskResponse {
...
impl ItautomationGetTaskResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<models::ItautomationTask>) -> ItautomationGetTaskResponse {
