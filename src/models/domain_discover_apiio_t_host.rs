...
pub struct DomainDiscoverApiioTHost {
    ...
    pub triage: Option<Box<models::DomainDiscoverApiioTHostTriage>>,
...
impl DomainDiscoverApiioTHost {
    pub fn new(cid: String, id: String) -> DomainDiscoverApiioTHost {
