...
pub struct DevicecontentPeriodContentCategory {
    ...
    pub policy_setting: Option<String>,
}

impl DevicecontentPeriodContentCategory {
    pub fn new() -> DevicecontentPeriodContentCategory {
        DevicecontentPeriodContentCategory {
            last_update: None,
            r#override: None,
            policy_setting: None,
        }
