...
pub struct ItautomationPeriodDeletePolicyResponse {
...
impl ItautomationPeriodDeletePolicyResponse {
    pub fn new(meta: models::MsaspecPeriodMetaInfo, resources: Vec<String>) -> ItautomationPeriodDeletePolicyResponse {
        ItautomationPeriodDeletePolicyResponse {
            errors: None,
            meta: Box::new(meta),
            resources,
        }
