...
impl DomainPeriodGcpAccountV1 {
    pub fn new(created_at: String, deleted_at: String, id: i32, updated_at: String, cid: String, cspm_enabled: bool, gcp_permissions_status: Vec<models::DomainPeriodPermission>, parent_id: String, service_account_project_id: String) -> DomainPeriodGcpAccountV1 {
