...
pub struct SensorUpdateCreatePoliciesReqV2 {
    /// A collection of policies to create
    #[serde(rename = "resources")]
    pub resources: Vec<models::SensorUpdateCreatePolicyReqV2>,
}

impl SensorUpdateCreatePoliciesReqV2 {
    /// A req to create sensor update policies
    pub fn new(resources: Vec<models::SensorUpdateCreatePolicyReqV2>) -> SensorUpdateCreatePoliciesReqV2 {
