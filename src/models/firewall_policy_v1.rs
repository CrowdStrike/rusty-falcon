...
impl FirewallPolicyV1 {
    pub fn new(channel_version: i32, cid: String, created_by: String, created_timestamp: String, description: String, enabled: bool, groups: Vec<models::HostGroupsHostGroupV1>, id: String, modified_by: String, modified_timestamp: String, name: String, platform_name: PlatformName, rule_set_id: String) -> FirewallPolicyV1 {
        FirewallPolicyV1 {
            channel_version,
            cid,
            created_by,
