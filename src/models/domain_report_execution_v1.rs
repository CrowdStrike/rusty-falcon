...
pub struct DomainReportExecutionV1 {
    ...
    pub execution_metadata: Option<Box<models::DomainExecutionMetadataV1>>,
...
impl DomainReportExecutionV1 {
    pub fn new(created_on: String, customer_id: String, expiration_on: String, id: String, last_updated_on: String, report_params: models::DomainReportParams, scheduled_report_id: String, shared_with: Vec<String>, status: String, status_display: String, status_msg: String, r#type: String, user_id: String, user_uuid: String) -> DomainReportExecutionV1 {
        DomainReportExecutionV1 {
            can_write: None,
            created_on,
            customer_id,
