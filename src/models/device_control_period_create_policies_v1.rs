...
pub struct DeviceControlPeriodCreatePoliciesV1 {
    ...
    pub resources: Vec<models::DeviceControlPeriodCreatePolicyReqV1>,
}

impl DeviceControlPeriodCreatePoliciesV1 {
    /// A req to create DeviceControl policies
    pub fn new(resources: Vec<models::DeviceControlPeriodCreatePolicyReqV1>) -> DeviceControlPeriodCreatePoliciesV1 {
