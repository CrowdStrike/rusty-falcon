...
pub struct FwmgrMsaAggregationResultItem {
    #[serde(rename = "count")]
    pub count: i64,
    ...
    pub sub_aggregates: Option<Vec<crate::models::FwmgrMsaAggregationResult>>,
...
impl FwmgrMsaAggregationResultItem {
    pub fn new(count: i64) -> FwmgrMsaAggregationResultItem {
