...
pub struct ItautomationTaskExecutionResultsResponse {
...
impl ItautomationTaskExecutionResultsResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<serde_json::Value>) -> ItautomationTaskExecutionResultsResponse {
