...
pub struct DomainAwsAccountV2 {
    ...
    #[serde(rename = "cloudformation_root_stack_arn", skip_serializing_if = "Option::is_none")]
    pub cloudformation_root_stack_arn: Option<String>,
    #[serde(rename = "cloudformation_update_url", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "is_cloud_registration", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "template_source_region", skip_serializing_if = "Option::is_none")]
...
impl DomainAwsAccountV2 {
    pub fn new(created_at: String, deleted_at: String, id: i32, updated_at: String, aws_permissions_status: Vec<models::DomainPermission>, inventory_filter: Vec<models::DomainAwsInventoryFilterSetting>, is_custom_rolename: bool, sensor_management_enabled: bool) -> DomainAwsAccountV2 {
        DomainAwsAccountV2 {
            created_at,
            deleted_at,
            id,
