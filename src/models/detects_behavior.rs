...
pub struct DetectsBehavior {
    ...
    pub parent_details: Box<models::DetectsParentDetails>,
    #[serde(rename = "pattern_disposition")]
    pub pattern_disposition: i32,
    #[serde(rename = "pattern_disposition_details")]
    pub pattern_disposition_details: Box<models::PatterndispositionPatternDisposition>,
...
impl DetectsBehavior {
    pub fn new(alleged_filetype: String, behavior_id: String, cmdline: String, confidence: i32, control_graph_id: String, description: String, device_id: String, display_name: String, filename: String, filepath: String, ioc_description: String, ioc_source: String, ioc_type: String, ioc_value: String, md5: String, objective: String, parent_details: models::DetectsParentDetails, pattern_disposition: i32, pattern_disposition_details: models::PatterndispositionPatternDisposition, scenario: String, severity: i32, sha256: String, tactic: String, tactic_id: String, technique: String, technique_id: String, timestamp: String, triggering_process_graph_id: String, user_id: String, user_name: String) -> DetectsBehavior {
        DetectsBehavior {
            alleged_filetype,
            behavior_id,
            cmdline,
