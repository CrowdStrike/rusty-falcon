...
pub struct FalconxPeriodReportV1 {
    ...
    pub intel: Option<Vec<models::FalconxPeriodIntelReportV1>>,
    #[serde(rename = "intelx", skip_serializing_if = "Option::is_none")]
    pub intelx: Option<Box<models::FalconxPeriodIntelXReportV1>>,
    #[serde(
    ...
    pub malquery: Option<Vec<models::FalconxPeriodMalqueryReportV1>>,
    #[serde(rename = "origin", skip_serializing_if = "Option::is_none")]
    pub origin: Option<String>,
    #[serde(rename = "sandbox", skip_serializing_if = "Option::is_none")]
    pub sandbox: Option<Vec<models::FalconxPeriodSandboxReportV1>>,
    #[serde(rename = "tags", skip_serializing_if = "Option::is_none")]
    pub tags: Option<Vec<String>>,
    #[serde(rename = "threat_graph", skip_serializing_if = "Option::is_none")]
    pub threat_graph: Option<Box<models::FalconxPeriodThreatGraphReportV1>>,
