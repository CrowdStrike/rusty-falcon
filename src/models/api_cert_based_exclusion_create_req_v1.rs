...
impl ApiCertBasedExclusionCreateReqV1 {
    pub fn new(name: String) -> ApiCertBasedExclusionCreateReqV1 {
        ApiCertBasedExclusionCreateReqV1 {
