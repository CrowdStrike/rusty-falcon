...
pub struct TypesPeriodActionRun {
    ...
    pub create_time: Option<Box<models::TypesPeriodTimestamp>>,
    #[serde(rename = "events", skip_serializing_if = "Option::is_none")]
    pub events: Option<Vec<models::TypesPeriodActionRunEvent>>,
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<i64>,
    #[serde(rename = "latest_event", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "trace_uuid", skip_serializing_if = "Option::is_none")]
