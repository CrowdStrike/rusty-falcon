...
pub struct PoliciesPrecedenceResponse {
...
impl PoliciesPrecedenceResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> PoliciesPrecedenceResponse {
