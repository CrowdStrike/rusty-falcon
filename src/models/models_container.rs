...
pub struct ModelsContainer {
    ...
    #[serde(rename = "allow_privilege_escalation", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "host_config_devices", skip_serializing_if = "Option::is_none")]
    pub host_config_devices: Option<String>,
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "image_application_package_count", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "image_detection_count", skip_serializing_if = "Option::is_none")]
    pub image_detection_count: Option<i32>,
    #[serde(rename = "image_detection_id_list", skip_serializing_if = "Option::is_none")]
    pub image_detection_id_list: Option<Vec<String>>,
    #[serde(rename = "image_detection_name_list", skip_serializing_if = "Option::is_none")]
    pub image_detection_name_list: Option<Vec<String>>,
    #[serde(rename = "image_detection_severity_by_type", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "image_highest_severity_vulnerability", skip_serializing_if = "Option::is_none")]
    pub image_highest_severity_vulnerability: Option<String>,
    #[serde(rename = "image_id", skip_serializing_if = "Option::is_none")]
    pub image_id: Option<String>,
    #[serde(rename = "image_package_count", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "image_vulnerability_count", skip_serializing_if = "Option::is_none")]
    pub image_vulnerability_count: Option<i32>,
    #[serde(rename = "image_vulnerability_severity_by_type", skip_serializing_if = "Option::is_none")]
    pub image_vulnerability_severity_by_type: Option<std::collections::HashMap<String, i32>>,
    #[serde(rename = "insecure_mount_source", skip_serializing_if = "Option::is_none")]
    pub insecure_mount_source: Option<String>,
    #[serde(rename = "insecure_mount_type", skip_serializing_if = "Option::is_none")]
    pub insecure_mount_type: Option<String>,
    #[serde(rename = "insecure_propagation_mode", skip_serializing_if = "Option::is_none")]
