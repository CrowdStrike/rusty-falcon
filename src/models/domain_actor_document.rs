...
impl DomainActorDocument {
    ...
    pub fn new(
        active: bool,
        capabilities: Vec<models::DomainEntity>,
        created_date: i64,
        ...
        motivations: Vec<models::DomainEntity>,
        notify_users: bool,
        objectives: Vec<models::DomainEntity>,
        origins: Vec<models::DomainEntity>,
        short_description: String,
        status: String,
        target_countries: Vec<models::DomainEntity>,
        target_industries: Vec<models::DomainEntity>,
        target_regions: Vec<models::DomainEntity>,
    ) -> DomainActorDocument {
        DomainActorDocument {
            active,
            actor_type: None,
