...
impl FwmgrPeriodApiPeriodNetworkLocationsV1 {
    pub fn new(cid: String, connection_types: models::FwmgrPeriodDomainPeriodConnectionType, default_gateways: Vec<String>, description: String, dhcp_servers: Vec<String>, dns_resolution_targets: models::FwmgrPeriodDomainPeriodDnsResolutionTargetsWithPolling, dns_servers: Vec<String>, enabled: bool, host_addresses: Vec<String>, https_reachable_hosts: models::FwmgrPeriodDomainPeriodHttpsHostsWithPolling, icmp_request_targets: models::FwmgrPeriodDomainPeriodIcmpTargetsWithPolling, id: String, name: String, rule_count: i32) -> FwmgrPeriodApiPeriodNetworkLocationsV1 {
