...
pub struct FwmgrPeriodApiPeriodNetworkLocationsV1 {
    ...
    pub dns_resolution_targets:
        Box<crate::models::FwmgrPeriodDomainPeriodDnsResolutionTargetsWithPolling>,
    ...
    pub https_reachable_hosts: Box<crate::models::FwmgrPeriodDomainPeriodHttpsHostsWithPolling>,
    #[serde(rename = "icmp_request_targets")]
    pub icmp_request_targets: Box<crate::models::FwmgrPeriodDomainPeriodIcmpTargetsWithPolling>,
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Box<crate::models::FwmgrPeriodApiPeriodNetworkLocationsMetadataV1>>,
...
impl FwmgrPeriodApiPeriodNetworkLocationsV1 {
    pub fn new(
        ...
        dns_resolution_targets: crate::models::FwmgrPeriodDomainPeriodDnsResolutionTargetsWithPolling,
        dns_servers: Vec<String>,
        enabled: bool,
        host_addresses: Vec<String>,
        https_reachable_hosts: crate::models::FwmgrPeriodDomainPeriodHttpsHostsWithPolling,
        icmp_request_targets: crate::models::FwmgrPeriodDomainPeriodIcmpTargetsWithPolling,
        id: String,
        name: String,
        rule_count: i32,
