...
impl ModelsApiCustomerAndImage {
    pub fn new(ai_related: bool, base_os: String, base_os_version: String, cid: String, created_at: String, crowdstrike_user: String, digest: String, eol_date: String, first_scanned: String, image_id: String, image_scanning_active: bool, image_size: i64, is_base_image: bool, registry: String, repository: String, source: String, source_base_image: models::ModelsImageDetails, tag: String, updated_at: String, uuid: String, warning: i32) -> ModelsApiCustomerAndImage {
