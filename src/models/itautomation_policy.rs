...
impl ItautomationPolicy {
    pub fn new(created_at: String, created_by: String, description: String, id: String, modified_at: String, modified_by: String, name: String, target: Target) -> ItautomationPolicy {
        ItautomationPolicy {
            config: None,
            created_at,
            created_by,
