...
pub struct ModelsDefinitionUpdateRequestV2 {
...
impl ModelsDefinitionUpdateRequestV2 {
    pub fn new(definition: models::V2Definition, enabled: bool, id: String) -> ModelsDefinitionUpdateRequestV2 {
