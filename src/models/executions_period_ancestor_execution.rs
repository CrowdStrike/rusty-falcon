...
pub struct ExecutionsPeriodAncestorExecution {
...
impl ExecutionsPeriodAncestorExecution {
    pub fn new(field: String, id: String, iteration: i32) -> ExecutionsPeriodAncestorExecution {
        ExecutionsPeriodAncestorExecution {
            field,
            id,
            iteration,
        }
