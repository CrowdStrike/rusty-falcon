...
pub struct DomainPeriodApiEvaluationLogicHostInfoV1 {
    ...
    pub entities_matched: Vec<models::DomainPeriodApiEntityMatchedV1>,
}

impl DomainPeriodApiEvaluationLogicHostInfoV1 {
    pub fn new(entities_matched: Vec<models::DomainPeriodApiEntityMatchedV1>) -> DomainPeriodApiEvaluationLogicHostInfoV1 {
