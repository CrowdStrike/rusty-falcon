...
pub struct ItautomationAggregateHostCount {
...
impl ItautomationAggregateHostCount {
    pub fn new(canceled_host_count: i32, expired_host_count: i32, failed_host_count: i32, initiated_host_count: i32, offline_host_count: i32, queued_host_count: i32, running_host_count: i32, success_host_count: i32) -> ItautomationAggregateHostCount {
        ItautomationAggregateHostCount {
            canceled_host_count,
            expired_host_count,
            failed_host_count,
