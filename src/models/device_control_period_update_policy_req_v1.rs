...
pub struct DeviceControlPeriodUpdatePolicyReqV1 {
    ...
    pub settings: Box<models::DeviceControlPeriodSettingsReqV1>,
}

impl DeviceControlPeriodUpdatePolicyReqV1 {
    /// An update for a specific policy
    pub fn new(id: String, settings: models::DeviceControlPeriodSettingsReqV1) -> DeviceControlPeriodUpdatePolicyReqV1 {
