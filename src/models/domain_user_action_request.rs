...
pub struct DomainUserActionRequest {
    #[serde(rename = "action")]
    pub action: Box<models::DomainUserAction>,
    /// User ID(s).
    #[serde(rename = "ids")]
    pub ids: Vec<String>,
}
...
impl DomainUserActionRequest {
    ...
    pub fn new(action: models::DomainUserAction, ids: Vec<String>) -> DomainUserActionRequest {
