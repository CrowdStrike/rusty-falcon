...
pub struct RequestsPreventionSettingV1 {
...
impl RequestsPreventionSettingV1 {
    /// A specific setting to update
    pub fn new(id: String, value: serde_json::Value) -> RequestsPreventionSettingV1 {
        RequestsPreventionSettingV1 { id, value }
    }
}
