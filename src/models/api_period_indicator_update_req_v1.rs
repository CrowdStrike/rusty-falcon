...
pub struct ApiPeriodIndicatorUpdateReqV1 {
    ...
    pub metadata: Option<Box<models::ApiPeriodMetadataReqV1>>,
...
impl ApiPeriodIndicatorUpdateReqV1 {
    pub fn new() -> ApiPeriodIndicatorUpdateReqV1 {
