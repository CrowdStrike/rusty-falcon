...
impl FwmgrApiRuleCreateRequestV1 {
    pub fn new(action: String, address_family: String, description: String, direction: String, enabled: bool, fields: Vec<crate::models::FwmgrApiWorkaroundUiFieldValue>, icmp: crate::models::FwmgrDomainIcmp, local_address: Vec<crate::models::FwmgrDomainAddressRange>, local_port: Vec<crate::models::FwmgrDomainPortRange>, log: bool, monitor: crate::models::FwmgrDomainMonitoring, name: String, platform_ids: Vec<String>, protocol: String, remote_address: Vec<crate::models::FwmgrDomainAddressRange>, remote_port: Vec<crate::models::FwmgrDomainPortRange>, temp_id: String) -> FwmgrApiRuleCreateRequestV1 {
