...
pub struct DomainPeriodDiscoverApiActiveDiscoveryHost {
    ...
    pub networks: Option<Vec<models::DomainPeriodDiscoverApiActiveDiscoveryNetwork>>,
...
impl DomainPeriodDiscoverApiActiveDiscoveryHost {
    /// Information obtained from active discovery.
    pub fn new() -> DomainPeriodDiscoverApiActiveDiscoveryHost {
