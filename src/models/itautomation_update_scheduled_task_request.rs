...
pub struct ItautomationUpdateScheduledTaskRequest {
    ...
    pub schedule: Option<Box<models::FalconforitapiSchedule>>,
...
impl ItautomationUpdateScheduledTaskRequest {
    pub fn new() -> ItautomationUpdateScheduledTaskRequest {
