...
pub struct ApiUpdateParserRequestV1 {
...
impl ApiUpdateParserRequestV1 {
    pub fn new(fields_to_be_removed_before_parsing: Vec<String>, fields_to_tag: Vec<String>, id: String, repository: String, script: String) -> ApiUpdateParserRequestV1 {
