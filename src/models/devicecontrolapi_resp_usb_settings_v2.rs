...
impl DevicecontrolapiRespUsbSettingsV2 {
    pub fn new(classes: Vec<models::DevicecontrolapiRespUsbClassSettingsV2>, end_user_notification: String, enforcement_mode: String, enhanced_file_metadata: bool) -> DevicecontrolapiRespUsbSettingsV2 {
