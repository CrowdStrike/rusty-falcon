...
pub struct ParameterTriggerFieldParameter {
...
impl ParameterTriggerFieldParameter {
    pub fn new(required: bool) -> ParameterTriggerFieldParameter {
        ParameterTriggerFieldParameter {
            default_value: None,
            properties: None,
            required,
        }
