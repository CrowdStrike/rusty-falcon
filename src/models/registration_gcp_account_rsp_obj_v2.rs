...
pub struct RegistrationGcpAccountRspObjV2 {
...
impl RegistrationGcpAccountRspObjV2 {
    pub fn new(parent_id: String) -> RegistrationGcpAccountRspObjV2 {
        RegistrationGcpAccountRspObjV2 {
            client_email: None,
            client_id: None,
            parent_id,
            parent_type: None,
