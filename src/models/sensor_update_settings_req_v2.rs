...
pub struct SensorUpdateSettingsReqV2 {
    ...
    #[serde(rename = "show_early_adopter_builds", skip_serializing_if = "Option::is_none")]
    ...
    pub variants: Vec<models::SensorUpdateBuildReqV1>,
}

impl SensorUpdateSettingsReqV2 {
    pub fn new(scheduler: models::PolicySensorUpdateScheduler, variants: Vec<models::SensorUpdateBuildReqV1>) -> SensorUpdateSettingsReqV2 {
        SensorUpdateSettingsReqV2 {
            build: None,
