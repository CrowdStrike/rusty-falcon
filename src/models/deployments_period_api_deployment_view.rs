...
pub struct DeploymentsPeriodApiDeploymentView {
    ...
    pub rings: Option<Vec<models::DeploymentsPeriodApiDeploymentRingView>>,
...
impl DeploymentsPeriodApiDeploymentView {
    pub fn new(id: String, status: String) -> DeploymentsPeriodApiDeploymentView {
        DeploymentsPeriodApiDeploymentView {
