...
pub struct ItautomationDeletePolicyResponse {
...
impl ItautomationDeletePolicyResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ItautomationDeletePolicyResponse {
