...
pub struct JsonschemaSubSchema {
    ...
    pub all_of: Option<Vec<models::JsonschemaSubSchema>>,
    #[serde(rename = "anyOf", skip_serializing_if = "Option::is_none")]
    pub any_of: Option<Vec<models::JsonschemaSubSchema>>,
    ...
    pub dependencies: Option<std::collections::HashMap<String, models::JsonschemaSubSchema>>,
    #[serde(rename = "deprecated", skip_serializing_if = "Option::is_none")]
    pub deprecated: Option<bool>,
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[serde(rename = "else", skip_serializing_if = "Option::is_none")]
    pub r#else: Option<Box<models::JsonschemaSubSchema>>,
    ...
    pub r#if: Option<Box<models::JsonschemaSubSchema>>,
    #[serde(rename = "items", skip_serializing_if = "Option::is_none")]
    pub items: Option<Box<models::JsonschemaSubSchema>>,
    ...
    pub media: Option<Box<models::JsonschemaSubSchema>>,
    ...
    pub not: Option<Box<models::JsonschemaSubSchema>>,
    #[serde(rename = "oneOf", skip_serializing_if = "Option::is_none")]
    pub one_of: Option<Vec<models::JsonschemaSubSchema>>,
    #[serde(rename = "pattern", skip_serializing_if = "Option::is_none")]
    pub pattern: Option<String>,
    #[serde(rename = "patternProperties", skip_serializing_if = "Option::is_none")]
    pub pattern_properties: Option<std::collections::HashMap<String, models::JsonschemaSubSchema>>,
    #[serde(rename = "properties", skip_serializing_if = "Option::is_none")]
    pub properties: Option<std::collections::HashMap<String, models::JsonschemaSubSchema>>,
    #[serde(rename = "required", skip_serializing_if = "Option::is_none")]
    pub required: Option<Vec<String>>,
    #[serde(rename = "then", skip_serializing_if = "Option::is_none")]
    pub then: Option<Box<models::JsonschemaSubSchema>>,
    ...
    pub x_cs_authorization: Option<Box<models::JsonschemaAuthorization>>,
    #[serde(rename = "x-cs-can-create", skip_serializing_if = "Option::is_none")]
    pub x_cs_can_create: Option<bool>,
    #[serde(
        rename = "x-cs-condition-group-fields",
        skip_serializing_if = "Option::is_none"
    )]
    pub x_cs_condition_group_fields: Option<Box<models::JsonschemaConditionGroupFields>>,
    ...
    #[serde(
        rename = "x-cs-indexable-fields",
        skip_serializing_if = "Option::is_none"
    )]
    pub x_cs_indexable_fields: Option<Vec<models::JsonschemaCollectionIndexField>>,
    ...
    pub x_cs_pivot: Option<Box<models::JsonschemaPivot>>,
    #[serde(rename = "x-cs-signals", skip_serializing_if = "Option::is_none")]
    pub x_cs_signals: Option<Box<models::JsonschemaSignalsExtensions>>,
    #[serde(
        rename = "x-cs-signals-category",
        skip_serializing_if = "Option::is_none"
    )]
    pub x_cs_signals_category: Option<String>,
    #[serde(
        rename = "x-cs-signals-operators",
        skip_serializing_if = "Option::is_none"
    )]
    pub x_cs_signals_operators: Option<Vec<String>>,
    #[serde(
        rename = "x-cs-signals-subCategory",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    pub x_cs_ui: Option<Box<models::JsonschemaUiExtensions>>,
    #[serde(rename = "x-cs-workflow", skip_serializing_if = "Option::is_none")]
    pub x_cs_workflow: Option<Box<models::JsonschemaWorkflowExtensions>>,
}

impl JsonschemaSubSchema {
    pub fn new() -> JsonschemaSubSchema {
        JsonschemaSubSchema {
            dollar_ref: None,
            dollar_schema: None,
