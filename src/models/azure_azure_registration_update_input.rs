...
pub struct AzureAzureRegistrationUpdateInput {
...
impl AzureAzureRegistrationUpdateInput {
    pub fn new(additional_features: Vec<models::AzureAdditionalFeature>, event_hub_settings: Vec<models::AzureEventHubSettings>, management_group_ids: Vec<String>, microsoft_graph_permission_ids: Vec<String>, subscription_ids: Vec<String>, tags: std::collections::HashMap<String, String>, tenant_id: String, tenant_name: String) -> AzureAzureRegistrationUpdateInput {
        AzureAzureRegistrationUpdateInput {
            account_type: None,
            additional_features,
