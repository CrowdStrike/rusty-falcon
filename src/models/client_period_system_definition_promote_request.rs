...
pub struct ClientPeriodSystemDefinitionPromoteRequest {
    ...
    pub parameters: Box<models::ParameterPeriodTemplateProvisionParameters>,
...
impl ClientPeriodSystemDefinitionPromoteRequest {
    pub fn new(customer_definition_id: String, name: String, parameters: models::ParameterPeriodTemplateProvisionParameters, template_id: String, template_name: String, template_version: String) -> ClientPeriodSystemDefinitionPromoteRequest {
        ClientPeriodSystemDefinitionPromoteRequest {
