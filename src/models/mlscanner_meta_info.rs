...
pub struct MlscannerMetaInfo {
    ...
    pub quota: Option<Box<crate::models::MlscannerQuota>>,
...
impl MlscannerMetaInfo {
    pub fn new(query_time: f64, trace_id: String) -> MlscannerMetaInfo {
        MlscannerMetaInfo {
            pagination: None,
            powered_by: None,
            query_time,
