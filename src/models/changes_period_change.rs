...
pub struct ChangesPeriodChange {
    ...
    pub attributes: Option<Vec<models::ChangesPeriodAttribute>>,
    #[serde(rename = "cid")]
    pub cid: String,
    #[serde(rename = "command_line")]
    pub command_line: String,
    #[serde(rename = "diff", skip_serializing_if = "Option::is_none")]
    pub diff: Option<Box<models::ChangesPeriodDiff>>,
    ...
    pub file_size: i32,
    #[serde(rename = "grandparent_process_image_file_name", skip_serializing_if = "Option::is_none")]
    pub grandparent_process_image_file_name: Option<String>,
    #[serde(rename = "host", skip_serializing_if = "Option::is_none")]
    pub host: Option<Box<models::ChangesPeriodHost>>,
    #[serde(rename = "id")]
    pub id: String,
    ...
    #[serde(rename = "parent_process_image_file_name", skip_serializing_if = "Option::is_none")]
    pub parent_process_image_file_name: Option<String>,
    #[serde(rename = "permissions", skip_serializing_if = "Option::is_none")]
    pub permissions: Option<Box<models::ChangesPeriodPermissions>>,
    #[serde(rename = "permissions_lin", skip_serializing_if = "Option::is_none")]
    pub permissions_lin: Option<Box<models::ChangesPeriodPermissionsLin>>,
    #[serde(rename = "permissions_mac", skip_serializing_if = "Option::is_none")]
    pub permissions_mac: Option<Box<models::ChangesPeriodPermissionsMac>>,
    #[serde(rename = "platform_name")]
    pub platform_name: String,
    #[serde(rename = "policy", skip_serializing_if = "Option::is_none")]
    pub policy: Option<Box<models::ChangesPeriodPolicy>>,
    #[serde(rename = "prevalence", skip_serializing_if = "Option::is_none")]
    pub prevalence: Option<Box<models::ChangesPeriodPrevalence>>,
    ...
    pub tags: Option<Vec<models::ChangesPeriodTag>>,
...
impl ChangesPeriodChange {
    pub fn new(action_timestamp: String, action_type: String, aid: String, cid: String, command_line: String, entity_path: String, entity_type: String, file_size: i32, id: String, ingestion_timestamp: String, is_from_different_mount_namespace: bool, is_suppressed: bool, platform_name: String, process_id: String, process_image_file_name: String, severity: String, user_id: String, user_name: String) -> ChangesPeriodChange {
        ChangesPeriodChange {
            action_timestamp,
            action_type,
            aid,
