...
pub struct ReleasenotesPeriodNoteDetail {
...
impl ReleasenotesPeriodNoteDetail {
    pub fn new(note_content: String) -> ReleasenotesPeriodNoteDetail {
        ReleasenotesPeriodNoteDetail {
            category: None,
            cloud: None,
            note_content,
            platforms: None,
