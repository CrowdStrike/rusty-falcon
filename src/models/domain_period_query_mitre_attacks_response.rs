...
pub struct DomainPeriodQueryMitreAttacksResponse {
    /// Array of API Errors
    #[serde(rename = "errors")]
...
impl DomainPeriodQueryMitreAttacksResponse {
    pub fn new(errors: Vec<models::MsaspecPeriodError>, meta: models::MsaspecPeriodMetaInfo, resources: Vec<String>) -> DomainPeriodQueryMitreAttacksResponse {
