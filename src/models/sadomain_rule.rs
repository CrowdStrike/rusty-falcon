...
impl SadomainRule {
    pub fn new(breach_monitor_only: bool, breach_monitoring_enabled: bool, cid: String, created_timestamp: String, filter: String, id: String, match_on_tsq_result_types: Vec<String>, name: String, permissions: String, priority: String, status: String, substring_matching_enabled: bool, topic: String, updated_timestamp: String, user_uuid: String) -> SadomainRule {
        SadomainRule {
            breach_monitor_only,
