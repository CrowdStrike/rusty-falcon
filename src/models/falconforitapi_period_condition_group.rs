...
pub struct FalconforitapiPeriodConditionGroup {
    ...
    pub groups: Option<Vec<models::FalconforitapiPeriodConditionGroup>>,
    /// Logical operator to apply between group statements
    #[serde(rename = "operator", skip_serializing_if = "Option::is_none")]
    pub operator: Option<Operator>,
    /// List of conditional expressions to evaluate
    #[serde(rename = "statements")]
    pub statements: Vec<models::FalconforitapiPeriodConditionalExpr>,
}

impl FalconforitapiPeriodConditionGroup {
    pub fn new(statements: Vec<models::FalconforitapiPeriodConditionalExpr>) -> FalconforitapiPeriodConditionGroup {
        FalconforitapiPeriodConditionGroup {
            groups: None,
            operator: None,
            statements,
        }
