...
pub struct EmpowerapiMsaIdListResponse {
...
impl EmpowerapiMsaIdListResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> EmpowerapiMsaIdListResponse {
