...
pub struct DomainPeriodAwsd4CAccountV1 {
    ...
    pub organization: Option<Box<crate::models::DomainPeriodAwsd4COrganizationAccountV1>>,
    #[serde(rename = "status")]
    pub status: String,
}

impl DomainPeriodAwsd4CAccountV1 {
    pub fn new(status: String) -> DomainPeriodAwsd4CAccountV1 {
