...
pub struct DomainAwsAccountResourceMetadata {
...
impl DomainAwsAccountResourceMetadata {
    pub fn new(created_at: String, deleted_at: String, id: i32, updated_at: String) -> DomainAwsAccountResourceMetadata {
