...
pub struct SadomainPeriodRule {
    ...
    #[serde(rename = "originating_template_id", skip_serializing_if = "Option::is_none")]
...
impl SadomainPeriodRule {
    pub fn new(breach_monitor_only: bool, breach_monitoring_enabled: bool, cid: String, created_timestamp: String, filter: String, id: String, match_on_tsq_result_types: Vec<String>, name: String, permissions: String, priority: String, status: String, substring_matching_enabled: bool, topic: String, updated_timestamp: String, user_uuid: String) -> SadomainPeriodRule {
        SadomainPeriodRule {
            breach_monitor_only,
