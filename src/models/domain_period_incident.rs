...
pub struct DomainPeriodIncident {
    ...
    pub events_histogram: Option<Vec<models::DomainPeriodEventHistogram>>,
    ...
    pub hosts: Option<Vec<models::DetectsPeriodDeviceDetailIndexed>>,
...
impl DomainPeriodIncident {
    pub fn new(cid: String, created: String, end: String, fine_score: i32, host_ids: Vec<String>, incident_id: String, start: String, state: String) -> DomainPeriodIncident {
