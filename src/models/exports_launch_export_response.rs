...
pub struct ExportsLaunchExportResponse {
...
impl ExportsLaunchExportResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ExportsLaunchExportResponse {
