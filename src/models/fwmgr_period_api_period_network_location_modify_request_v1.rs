...
impl FwmgrPeriodApiPeriodNetworkLocationModifyRequestV1 {
    pub fn new(
        ...
        dns_resolution_targets: models::FwmgrPeriodDomainPeriodDnsResolutionTargets,
        dns_servers: Vec<String>,
        enabled: bool,
        host_addresses: Vec<String>,
        https_reachable_hosts: models::FwmgrPeriodDomainPeriodHttpsHosts,
        icmp_request_targets: models::FwmgrPeriodDomainPeriodIcmpTargets,
        id: String,
        name: String,
