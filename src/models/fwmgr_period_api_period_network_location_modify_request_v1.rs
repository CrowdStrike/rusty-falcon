...
pub struct FwmgrPeriodApiPeriodNetworkLocationModifyRequestV1 {
    ...
    pub connection_types: Box<crate::models::FwmgrPeriodDomainPeriodConnectionType>,
    ...
    pub dns_resolution_targets: Box<crate::models::FwmgrPeriodDomainPeriodDnsResolutionTargets>,
    ...
    pub https_reachable_hosts: Box<crate::models::FwmgrPeriodDomainPeriodHttpsHosts>,
    #[serde(rename = "icmp_request_targets")]
    pub icmp_request_targets: Box<crate::models::FwmgrPeriodDomainPeriodIcmpTargets>,
    #[serde(rename = "id")]
    pub id: String,
...
impl FwmgrPeriodApiPeriodNetworkLocationModifyRequestV1 {
    pub fn new(
        connection_types: crate::models::FwmgrPeriodDomainPeriodConnectionType,
        default_gateways: Vec<String>,
        description: String,
        dhcp_servers: Vec<String>,
        dns_resolution_targets: crate::models::FwmgrPeriodDomainPeriodDnsResolutionTargets,
        dns_servers: Vec<String>,
        enabled: bool,
        host_addresses: Vec<String>,
        https_reachable_hosts: crate::models::FwmgrPeriodDomainPeriodHttpsHosts,
        icmp_request_targets: crate::models::FwmgrPeriodDomainPeriodIcmpTargets,
        id: String,
        name: String,
