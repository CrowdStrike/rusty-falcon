...
pub struct DomainPeriodMatchedBreachSummaryV1 {
    ...
    #[serde(rename = "credential_statuses", skip_serializing_if = "Option::is_none")]
    pub credential_statuses: Option<Vec<String>>,
    #[serde(rename = "credentials_domains", skip_serializing_if = "Option::is_none")]
    ...
    pub files: Option<Vec<models::DomainPeriodFileDetailsV1>>,
...
impl DomainPeriodMatchedBreachSummaryV1 {
    pub fn new(description: String, fields: Vec<String>, is_retroactively_deduped: bool, name: String) -> DomainPeriodMatchedBreachSummaryV1 {
