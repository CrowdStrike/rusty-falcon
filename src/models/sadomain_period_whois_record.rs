...
pub struct SadomainPeriodWhoisRecord {
    ...
    pub registrant: Option<Box<crate::models::SadomainPeriodWhoisRegistrant>>,
    #[serde(rename = "registrar", skip_serializing_if = "Option::is_none")]
    pub registrar: Option<Box<crate::models::SadomainPeriodWhoisRegistrar>>,
}

impl SadomainPeriodWhoisRecord {
    pub fn new() -> SadomainPeriodWhoisRecord {
