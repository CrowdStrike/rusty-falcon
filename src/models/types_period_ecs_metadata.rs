...
pub struct TypesPeriodEcsMetadata {
    ...
    pub collection_method: Option<i32>,
    #[serde(rename = "resourceArn", skip_serializing_if = "Option::is_none")]
...
impl TypesPeriodEcsMetadata {
    pub fn new() -> TypesPeriodEcsMetadata {
        TypesPeriodEcsMetadata {
            cluster_name: None,
