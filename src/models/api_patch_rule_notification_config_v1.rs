...
pub struct ApiPatchRuleNotificationConfigV1 {
...
impl ApiPatchRuleNotificationConfigV1 {
    pub fn new() -> ApiPatchRuleNotificationConfigV1 {
        ApiPatchRuleNotificationConfigV1 {
            cid: None,
            config_id: None,
            plugin_id: None,
            recipients: None,
