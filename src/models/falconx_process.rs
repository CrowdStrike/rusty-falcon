...
pub struct FalconxProcess {
    #[serde(rename = "amsi_calls", skip_serializing_if = "Option::is_none")]
    pub amsi_calls: Option<Vec<models::FalconxAmsiCall>>,
    ...
    pub file_accesses: Option<Vec<models::FalconxFileAccess>>,
    #[serde(rename = "handles", skip_serializing_if = "Option::is_none")]
    pub handles: Option<Vec<models::FalconxHandle>>,
    ...
    pub modules: Option<Vec<models::FalconxModule>>,
    ...
    pub process_flags: Option<Vec<models::FalconxProcessFlag>>,
    #[serde(rename = "registry", skip_serializing_if = "Option::is_none")]
    pub registry: Option<Vec<models::FalconxRegistry>>,
    #[serde(rename = "script_calls", skip_serializing_if = "Option::is_none")]
    pub script_calls: Option<Vec<models::FalconxScriptCall>>,
    #[serde(rename = "sha256", skip_serializing_if = "Option::is_none")]
    pub sha256: Option<String>,
    #[serde(rename = "streams", skip_serializing_if = "Option::is_none")]
    pub streams: Option<Vec<models::FalconxStream>>,
    #[serde(rename = "uid", skip_serializing_if = "Option::is_none")]
    pub uid: Option<String>,
}

impl FalconxProcess {
    pub fn new() -> FalconxProcess {
        FalconxProcess {
            amsi_calls: None,
            command_line: None,
            file_accesses: None,
