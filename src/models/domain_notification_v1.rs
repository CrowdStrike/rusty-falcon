...
pub struct DomainNotificationV1 {
    ...
    pub breach_summary: Option<Box<models::DomainMatchedBreachSummaryV1>>,
    #[serde(rename = "cid")]
    pub cid: String,
    ...
    pub logs: Option<Vec<models::SadomainNotificationLog>>,
    ...
    pub typosquatting: Option<Box<models::SadomainTyposquattingComponent>>,
...
impl DomainNotificationV1 {
    pub fn new(actor_slug: String, cid: String, created_date: String, id: String, item_date: String, item_id: String, item_type: String, raw_intel_id: String, rule_id: String, rule_name: String, rule_priority: String, rule_topic: String, status: String, updated_date: String) -> DomainNotificationV1 {
