...
impl DomainPeriodQueuedSessionJob {
    pub fn new(commands: Vec<models::DomainPeriodQueuedSessionCommand>, aid: String, created_at: String, deleted_at: String, id: String, status: String, updated_at: String, user_id: String, user_uuid: String) -> DomainPeriodQueuedSessionJob {
