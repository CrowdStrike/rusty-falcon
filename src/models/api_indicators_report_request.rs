...
pub struct ApiIndicatorsReportRequest {
    #[serde(rename = "from_parent", skip_serializing_if = "Option::is_none")]
    pub from_parent: Option<bool>,
    #[serde(rename = "report_format")]
    pub report_format: String,
    #[serde(rename = "search")]
    pub search: Box<models::ApiIndicatorsSortedSearch>,
}

impl ApiIndicatorsReportRequest {
    pub fn new(report_format: String, search: models::ApiIndicatorsSortedSearch) -> ApiIndicatorsReportRequest {
