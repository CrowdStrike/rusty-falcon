...
pub struct ParameterPeriodTriggerFieldParameter {
...
impl ParameterPeriodTriggerFieldParameter {
    pub fn new(required: bool) -> ParameterPeriodTriggerFieldParameter {
        ParameterPeriodTriggerFieldParameter {
            default_value: None,
            properties: None,
            required,
        }
