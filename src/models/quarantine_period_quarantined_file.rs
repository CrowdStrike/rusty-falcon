...
pub struct QuarantinePeriodQuarantinedFile {
    ...
    #[serde(rename = "is_on_removable_disk", skip_serializing_if = "Option::is_none")]
    pub is_on_removable_disk: Option<bool>,
    #[serde(rename = "paths", skip_serializing_if = "Option::is_none")]
    pub paths: Option<Vec<models::QuarantinePeriodQuarantinedFilePath>>,
    #[serde(rename = "primary_module", skip_serializing_if = "Option::is_none")]
    pub primary_module: Option<bool>,
    #[serde(rename = "release_path_for_removable_media", skip_serializing_if = "Option::is_none")]
