...
pub struct ItautomationUpdatePoliciesHostGroupsRequest {
...
impl ItautomationUpdatePoliciesHostGroupsRequest {
    pub fn new(action: String, host_group_ids: Vec<String>, policy_id: String) -> ItautomationUpdatePoliciesHostGroupsRequest {
