...
pub struct DomainPeriodAwsAccountV2 {
    ...
    pub aws_permissions_status: Vec<models::DomainPeriodPermission>,
    ...
    pub d4c: Option<Box<models::DomainPeriodAwsd4CAccountV1>>,
    ...
    pub features: Option<Vec<models::DomainPeriodProductFeatures>>,
...
impl DomainPeriodAwsAccountV2 {
    pub fn new(created_at: String, deleted_at: String, id: i32, updated_at: String, aws_permissions_status: Vec<models::DomainPeriodPermission>, inventory_filter: Vec<models::DomainPeriodAwsInventoryFilterSetting>, is_custom_rolename: bool, sensor_management_enabled: bool) -> DomainPeriodAwsAccountV2 {
