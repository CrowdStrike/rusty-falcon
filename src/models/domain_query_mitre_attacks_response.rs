...
pub struct DomainQueryMitreAttacksResponse {
    /// Array of API Errors
    #[serde(rename = "errors")]
...
impl DomainQueryMitreAttacksResponse {
    pub fn new(errors: Vec<models::MsaspecError>, meta: models::MsaspecMetaInfo, resources: Vec<String>) -> DomainQueryMitreAttacksResponse {
