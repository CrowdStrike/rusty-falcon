...
pub struct FalconxPeriodThreatGraphIndicatorV1 {
    #[serde(
...
impl FalconxPeriodThreatGraphIndicatorV1 {
    pub fn new() -> FalconxPeriodThreatGraphIndicatorV1 {
        FalconxPeriodThreatGraphIndicatorV1 {
            customer_prevalence: None,
