...
impl RegistrationAzureManagementGroupV1Ext {
    pub fn new(created_at: String, deleted_at: String, id: i32, updated_at: String, azure_management_group_id: String, cid: String, tenant_id: String) -> RegistrationAzureManagementGroupV1Ext {
