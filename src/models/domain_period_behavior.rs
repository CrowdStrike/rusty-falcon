...
pub struct DomainPeriodBehavior {
    ...
    #[serde(rename = "pattern_description", skip_serializing_if = "Option::is_none")]
    ...
    pub pattern_disposition_details: Option<Box<models::PatterndispositionPeriodPatternDisposition>>,
...
impl DomainPeriodBehavior {
    pub fn new(pattern_id: i32, template_instance_id: i32, timestamp: String) -> DomainPeriodBehavior {
