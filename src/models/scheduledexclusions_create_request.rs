...
pub struct ScheduledexclusionsCreateRequest {
...
impl ScheduledexclusionsCreateRequest {
    pub fn new(name: String, timezone: String) -> ScheduledexclusionsCreateRequest {
