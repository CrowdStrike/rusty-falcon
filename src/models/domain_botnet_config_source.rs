...
pub struct DomainBotnetConfigSource {
    ...
    pub injects: Vec<models::DomainBotnetInject>,
    ...
    pub variables: Vec<models::DomainKeyValuePair>,
}

impl DomainBotnetConfigSource {
    pub fn new(actions: Vec<models::DomainKeyValuePair>, body: String, botnet: String, config_type: String, injects: Vec<models::DomainBotnetInject>, sub_botnet: String, subject: String, variables: Vec<models::DomainKeyValuePair>) -> DomainBotnetConfigSource {
