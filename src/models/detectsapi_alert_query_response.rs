...
pub struct DetectsapiAlertQueryResponse {
...
impl DetectsapiAlertQueryResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> DetectsapiAlertQueryResponse {
