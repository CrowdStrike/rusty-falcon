...
pub struct GetMetrics {
    ...
    pub errors: Option<Vec<models::Error94f9ac51c55f4fec89a57051edbed431>>,
    #[serde(rename = "meta", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Option<Box<models::Meta09bb6b286221441896cffbaaff395ace>>>,
    #[serde(rename = "resources", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub resources: Option<Option<Vec<models::SecurityCheckMetrics2c3c230216d249bf9ec93ca3f6fcf330>>>,
}

impl GetMetrics {
    pub fn new() -> GetMetrics {
        GetMetrics {
            errors: None,
            meta: None,
            resources: None,
