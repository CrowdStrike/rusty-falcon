...
pub struct GraphPeriodFlow {
    ...
    #[serde(rename = "source_alias", skip_serializing_if = "Option::is_none")]
...
impl GraphPeriodFlow {
    pub fn new(source: String, target: String) -> GraphPeriodFlow {
        GraphPeriodFlow {
            condition: None,
            source,
            source_alias: None,
