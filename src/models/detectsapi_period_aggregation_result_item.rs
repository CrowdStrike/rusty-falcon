...
pub struct DetectsapiPeriodAggregationResultItem {
    ...
    pub sub_aggregates: Option<Vec<models::DetectsapiPeriodAggregationResult>>,
...
impl DetectsapiPeriodAggregationResultItem {
    pub fn new(count: i64) -> DetectsapiPeriodAggregationResultItem {
        DetectsapiPeriodAggregationResultItem {
            count,
            from: None,
            key_as_string: None,
            label: None,
