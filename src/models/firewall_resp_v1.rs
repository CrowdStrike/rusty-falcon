...
pub struct FirewallRespV1 {
    ...
    pub resources: Vec<models::FirewallPolicyV1>,
}

impl FirewallRespV1 {
    pub fn new(errors: Vec<models::MsaspecError>, meta: models::MsaspecMetaInfo, resources: Vec<models::FirewallPolicyV1>) -> FirewallRespV1 {
        FirewallRespV1 {
            errors,
            meta: Box::new(meta),
            resources,
