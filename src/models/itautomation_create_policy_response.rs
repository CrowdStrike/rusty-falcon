...
pub struct ItautomationCreatePolicyResponse {
...
impl ItautomationCreatePolicyResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<models::ItautomationPolicy>) -> ItautomationCreatePolicyResponse {
