...
pub struct MetaGetActivityMonitor {
    #[serde(rename = "pagination", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Option<Box<models::PaginationMetaGetActivityMonitor>>>,
...
impl MetaGetActivityMonitor {
    pub fn new() -> MetaGetActivityMonitor {
