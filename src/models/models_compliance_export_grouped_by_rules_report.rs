...
pub struct ModelsComplianceExportGroupedByRulesReport {
...
impl ModelsComplianceExportGroupedByRulesReport {
    pub fn new(asset_type: String, authority: String, clusters: i64, clusters_list: String, failed_containers: i64, failed_images: i64, name: String, passed_containers: i64, passed_images: i64, rule_id: String, severity: f64, total_containers: i64, total_images: i64) -> ModelsComplianceExportGroupedByRulesReport {
