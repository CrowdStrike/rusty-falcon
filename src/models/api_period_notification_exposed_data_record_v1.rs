...
pub struct ApiPeriodNotificationExposedDataRecordV1 {
    ...
    pub bot: Option<Box<models::ApiPeriodExposedDataRecordBotV1>>,
    /// The customer ID
    #[serde(rename = "cid")]
    pub cid: String,
    ...
    pub file: Option<Box<models::ApiPeriodExposedDataFileDetailsV1>>,
    #[serde(rename = "financial", skip_serializing_if = "Option::is_none")]
    pub financial: Option<Box<models::ApiPeriodExposedDataRecordFinancialV1>>,
    ...
    pub location: Option<Box<models::ApiPeriodExposedDataRecordLocationV1>>,
    ...
    #[serde(rename = "rule")]
    pub rule: Box<models::ApiPeriodRuleDetailsV1>,
    ...
    pub social: Option<Box<models::ApiPeriodExposedDataRecordSocialV1>>,
...
impl ApiPeriodNotificationExposedDataRecordV1 {
    pub fn new(author: String, cid: String, created_date: String, event_date: String, exposure_date: String, id: String, notification_id: String, raw_intel_id: String, rule: models::ApiPeriodRuleDetailsV1, site: String, source_category: String, user_uuid: String) -> ApiPeriodNotificationExposedDataRecordV1 {
