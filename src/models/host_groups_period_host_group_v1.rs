...
impl HostGroupsPeriodHostGroupV1 {
    ...
    pub fn new(created_by: String, created_timestamp: String, description: String, id: String, modified_by: String, modified_timestamp: String, name: String) -> HostGroupsPeriodHostGroupV1 {
