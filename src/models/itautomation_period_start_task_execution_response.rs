...
pub struct ItautomationPeriodStartTaskExecutionResponse {
...
impl ItautomationPeriodStartTaskExecutionResponse {
    pub fn new(meta: models::MsaspecPeriodMetaInfo, resources: Vec<String>) -> ItautomationPeriodStartTaskExecutionResponse {
        ItautomationPeriodStartTaskExecutionResponse {
            errors: None,
            meta: Box::new(meta),
            resources,
        }
