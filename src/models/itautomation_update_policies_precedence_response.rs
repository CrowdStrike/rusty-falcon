...
pub struct ItautomationUpdatePoliciesPrecedenceResponse {
...
impl ItautomationUpdatePoliciesPrecedenceResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ItautomationUpdatePoliciesPrecedenceResponse {
