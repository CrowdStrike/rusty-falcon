...
pub struct TypesActionRun {
    #[serde(rename = "createTime", skip_serializing_if = "Option::is_none")]
    pub create_time: Option<String>,
    #[serde(rename = "events", skip_serializing_if = "Option::is_none")]
    pub events: Option<Vec<models::TypesActionRunEvent>>,
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[serde(rename = "latestEvent", skip_serializing_if = "Option::is_none")]
    pub latest_event: Option<Box<models::TypesActionRunEvent>>,
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Box<models::TypesActionRunMetadata>>,
