...
pub struct DomainDetectsEntitiesPatchRequest {
    ...
    #[serde(rename = "new_behaviors_processed", skip_serializing_if = "Option::is_none")]
...
impl DomainDetectsEntitiesPatchRequest {
    pub fn new() -> DomainDetectsEntitiesPatchRequest {
