...
pub struct ItautomationPeriodRunLiveQueryRequest {
...
impl ItautomationPeriodRunLiveQueryRequest {
    pub fn new(target: String) -> ItautomationPeriodRunLiveQueryRequest {
        ItautomationPeriodRunLiveQueryRequest {
