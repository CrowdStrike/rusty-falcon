...
impl RegistrationPolicyExtV1 {
    pub fn new(account_id: String, account_ids: Vec<String>, enabled: bool, policy_id: i32, regions: Vec<String>, severity: String, tag_excluded: bool) -> RegistrationPolicyExtV1 {
