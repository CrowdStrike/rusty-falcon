...
pub struct RegistrationIoaEvent {
    ...
    pub aggregate: Option<Box<models::IoaEventAggregate>>,
    ...
    pub cloud_account_id: Option<Box<models::IoaCloudAccountId>>,
    ...
    pub enrichments: Option<Box<models::IoaEnrichments>>,
