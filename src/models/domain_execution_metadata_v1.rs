...
impl DomainExecutionMetadataV1 {
    pub fn new(report_params: models::DomainReportParams, retry_allowed: bool, retry_performed: bool, retry_report_execution_id: String, subtype: String, unscheduled_execution_type: String, xdr_data: models::DomainXdrData, xdr_params: models::DomainXdrParams) -> DomainExecutionMetadataV1 {
