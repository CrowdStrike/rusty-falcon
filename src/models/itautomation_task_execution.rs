...
pub struct ItautomationTaskExecution {
    ...
    pub status_by_stage: Option<Box<models::ItautomationTaskStageExecutionStatus>>,
...
impl ItautomationTaskExecution {
    pub fn new(id: String, run_by: String, run_type: String, target: String, task_type: TaskType) -> ItautomationTaskExecution {
        ItautomationTaskExecution {
