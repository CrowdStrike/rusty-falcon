...
pub struct UninstallTokenUninstallTokenV1 {
...
impl UninstallTokenUninstallTokenV1 {
    /// An uninstall token for a device
    pub fn new(device_id: String, seed_id: i32, uninstall_token: String) -> UninstallTokenUninstallTokenV1 {
        UninstallTokenUninstallTokenV1 {
            device_id,
            seed_id,
            uninstall_token,
        }
