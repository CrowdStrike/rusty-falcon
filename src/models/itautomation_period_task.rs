...
impl ItautomationPeriodTask {
    pub fn new(created_by: String, created_time: String, description: String, groups: Vec<models::FalconforitapiPeriodGroupMembership>, id: String, last_run_time: String, modified_by: String, modified_time: String, name: String, runs: i32, supported_os: Vec<String>, target: String, task_type: String) -> ItautomationPeriodTask {
