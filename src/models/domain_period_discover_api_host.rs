...
pub struct DomainPeriodDiscoverApiHost {
    ...
    pub active_discovery: Option<Box<models::DomainPeriodDiscoverApiActiveDiscoveryHost>>,
    ...
    pub field_metadata: Option<std::collections::HashMap<String, models::DomainPeriodDiscoverApiFieldMetadata>>,
    ...
    pub iot_imported: Option<Box<models::DomainPeriodIotImportedHost>>,
    ...
    pub scan_details: Option<Vec<models::DomainPeriodDiscoverApiScanDetailsHost>>,
    ...
    pub triage: Option<Box<models::DomainPeriodDiscoverApiHostTriage>>,
