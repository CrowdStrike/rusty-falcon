...
impl DomainPeriodCve {
    pub fn new(
        actors: Vec<String>,
        base_score: f64,
        cisa_kev_info: models::DomainPeriodCisaKnownExploitedVulnerabilitiesInfo,
        cps_rating: models::DomainPeriodCpsRating,
        cvss_version: String,
        id: String,
        is_supported: bool,
        metadata_hash: i32,
        ...
        references: Vec<models::DomainPeriodReference>,
        severity: String,
        source: String,
        source_type: String,
