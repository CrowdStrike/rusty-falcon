...
impl DomainPeriodExposedDataRecordBotV1 {
    pub fn new(bot_id: String, domain_detects: Vec<String>, infection_build_id: String, infection_date: String, infection_path: String, location: models::DomainPeriodExposedDataRecordBotLocationV1, operating_system: models::DomainPeriodExposedDataRecordBotOperatingSystemV1) -> DomainPeriodExposedDataRecordBotV1 {
