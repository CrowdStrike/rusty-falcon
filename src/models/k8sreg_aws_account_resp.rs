...
impl K8sregAwsAccountResp {
    pub fn new(account_id: String, aws_permissions_status: Vec<models::K8sregAccountPermissionsStatus>, cid: String, created_at: String, from_cspm: bool, iam_role_arn: String, is_master: bool, status: String, updated_at: String) -> K8sregAwsAccountResp {
