...
pub struct PreventionPeriodCategoryRespV1 {
    ...
    pub settings: Vec<models::PreventionPeriodSettingRespV1>,
}

impl PreventionPeriodCategoryRespV1 {
    /// A prevention policy category
    pub fn new(name: String, settings: Vec<models::PreventionPeriodSettingRespV1>) -> PreventionPeriodCategoryRespV1 {
