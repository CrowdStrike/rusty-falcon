...
pub struct PreventionPeriodCategoryRespV1 {
    ...
    pub settings: Vec<crate::models::PreventionPeriodSettingRespV1>,
}

impl PreventionPeriodCategoryRespV1 {
    /// A prevention policy category
    pub fn new(
        name: String,
        settings: Vec<crate::models::PreventionPeriodSettingRespV1>,
    ) -> PreventionPeriodCategoryRespV1 {
        PreventionPeriodCategoryRespV1 { name, settings }
    }
}
