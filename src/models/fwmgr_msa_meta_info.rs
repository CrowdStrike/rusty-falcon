...
pub struct FwmgrMsaMetaInfo {
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<crate::models::FwmgrMsaPaging>>,
...
impl FwmgrMsaMetaInfo {
    pub fn new(query_time: f64, trace_id: String) -> FwmgrMsaMetaInfo {
        FwmgrMsaMetaInfo {
            pagination: None,
            powered_by: None,
            query_time,
