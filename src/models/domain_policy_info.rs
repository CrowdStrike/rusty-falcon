...
impl DomainPolicyInfo {
    pub fn new(created_at: String, deleted_at: String, id: i32, updated_at: String, account_scope: String, is_enabled: bool, is_remediable: bool) -> DomainPolicyInfo {
        DomainPolicyInfo {
            created_at,
            deleted_at,
            id,
