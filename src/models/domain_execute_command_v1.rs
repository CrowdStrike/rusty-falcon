...
impl DomainExecuteCommandV1 {
    pub fn new(config_auth_type: String, config_id: String, definition_id: String, id: String, operation_id: String, request: models::DomainRequest, version: i32) -> DomainExecuteCommandV1 {
