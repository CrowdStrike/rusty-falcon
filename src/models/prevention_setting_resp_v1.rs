...
pub struct PreventionSettingRespV1 {
...
impl PreventionSettingRespV1 {
    /// A prevention policy setting
    pub fn new(id: String, name: String, r#type: Type, value: serde_json::Value) -> PreventionSettingRespV1 {
        PreventionSettingRespV1 {
            description: None,
            id,
            name,
            r#type,
