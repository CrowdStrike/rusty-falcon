...
pub struct DevicecontrolapiPeriodBluetoothExceptionBase {
...
impl DevicecontrolapiPeriodBluetoothExceptionBase {
    pub fn new(id: String) -> DevicecontrolapiPeriodBluetoothExceptionBase {
        DevicecontrolapiPeriodBluetoothExceptionBase {
            action: None,
            class: None,
            description: None,
