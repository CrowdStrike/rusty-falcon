...
pub struct MalquerySampleMetadataResponse {
    ...
    #[serde(rename = "errors")]
    pub errors: Vec<crate::models::MalqueryQueryError>,
    #[serde(rename = "meta")]
    pub meta: Box<crate::models::MalquerySamplesMetadataMetaInfo>,
    /// List of sample metadata
    #[serde(rename = "resources")]
    pub resources: Vec<crate::models::MalquerySampleMetadata>,
}
