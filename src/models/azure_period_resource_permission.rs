...
pub struct AzurePeriodResourcePermission {
...
impl AzurePeriodResourcePermission {
    pub fn new(status: String) -> AzurePeriodResourcePermission {
        AzurePeriodResourcePermission {
            name: None,
            resource_id: None,
            role_id: None,
            status,
