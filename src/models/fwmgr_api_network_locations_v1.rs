...
impl FwmgrApiNetworkLocationsV1 {
    pub fn new(
        ...
        dns_resolution_targets: models::FwmgrDomainDnsResolutionTargetsWithPolling,
        dns_servers: Vec<String>,
        enabled: bool,
        host_addresses: Vec<String>,
        https_reachable_hosts: models::FwmgrDomainHttpsHostsWithPolling,
        icmp_request_targets: models::FwmgrDomainIcmpTargetsWithPolling,
        id: String,
        name: String,
        rule_count: i32,
