...
pub struct FwmgrApiNetworkLocationsV1 {
    ...
    pub connection_types: Box<crate::models::FwmgrDomainConnectionType>,
    ...
    pub dns_resolution_targets: Box<crate::models::FwmgrDomainDnsResolutionTargetsWithPolling>,
    ...
    pub https_reachable_hosts: Box<crate::models::FwmgrDomainHttpsHostsWithPolling>,
    #[serde(rename = "icmp_request_targets")]
    pub icmp_request_targets: Box<crate::models::FwmgrDomainIcmpTargetsWithPolling>,
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Box<crate::models::FwmgrApiNetworkLocationsMetadataV1>>,
...
impl FwmgrApiNetworkLocationsV1 {
    pub fn new(
        cid: String,
        connection_types: crate::models::FwmgrDomainConnectionType,
        default_gateways: Vec<String>,
        description: String,
        dhcp_servers: Vec<String>,
        dns_resolution_targets: crate::models::FwmgrDomainDnsResolutionTargetsWithPolling,
        dns_servers: Vec<String>,
        enabled: bool,
        host_addresses: Vec<String>,
        https_reachable_hosts: crate::models::FwmgrDomainHttpsHostsWithPolling,
        icmp_request_targets: crate::models::FwmgrDomainIcmpTargetsWithPolling,
        id: String,
        name: String,
        rule_count: i32,
