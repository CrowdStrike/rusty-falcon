...
pub struct DomainSpapiVulnerabilitiesEntitiesResponseV2 {
    ...
    pub resources: Vec<models::DomainApiVulnerabilityV2>,
}

impl DomainSpapiVulnerabilitiesEntitiesResponseV2 {
    pub fn new(meta: models::DomainMetaInfo, resources: Vec<models::DomainApiVulnerabilityV2>) -> DomainSpapiVulnerabilitiesEntitiesResponseV2 {
