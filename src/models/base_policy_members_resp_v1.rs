...
pub struct BasePolicyMembersRespV1 {
...
impl BasePolicyMembersRespV1 {
    pub fn new(errors: Vec<models::MsaspecError>, meta: models::MsaspecMetaInfo, resources: Vec<models::DeviceDevice>) -> BasePolicyMembersRespV1 {
