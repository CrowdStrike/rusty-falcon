...
pub struct MetaGetUserInventory {
    #[serde(rename = "pagination", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Option<Box<models::PaginationMetaGetUserInventory>>>,
...
impl MetaGetUserInventory {
    pub fn new() -> MetaGetUserInventory {
