...
pub struct DetectsapiAggregationResultItem {
    ...
    pub sub_aggregates: Option<Vec<models::DetectsapiAggregationResult>>,
...
impl DetectsapiAggregationResultItem {
    pub fn new(count: i64) -> DetectsapiAggregationResultItem {
