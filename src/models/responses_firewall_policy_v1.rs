...
pub struct ResponsesFirewallPolicyV1 {
...
impl ResponsesFirewallPolicyV1 {
    pub fn new(channel_version: i32, created_by: String, created_timestamp: String, description: String, enabled: bool, groups: Vec<crate::models::ResponsesHostGroupV1>, id: String, modified_by: String, modified_timestamp: String, name: String, platform_name: PlatformName, rule_set_id: String) -> ResponsesFirewallPolicyV1 {
