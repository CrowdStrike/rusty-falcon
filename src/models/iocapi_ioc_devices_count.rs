...
pub struct IocapiIocDevicesCount {
...
impl IocapiIocDevicesCount {
    pub fn new(device_count: i32, id: String, r#type: String, value: String) -> IocapiIocDevicesCount {
        IocapiIocDevicesCount {
            device_count,
            id,
            limit_exceeded: None,
            r#type,
