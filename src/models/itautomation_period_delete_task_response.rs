...
pub struct ItautomationPeriodDeleteTaskResponse {
...
impl ItautomationPeriodDeleteTaskResponse {
    pub fn new(meta: models::MsaspecPeriodMetaInfo, resources: Vec<String>) -> ItautomationPeriodDeleteTaskResponse {
        ItautomationPeriodDeleteTaskResponse {
            errors: None,
            meta: Box::new(meta),
            resources,
        }
