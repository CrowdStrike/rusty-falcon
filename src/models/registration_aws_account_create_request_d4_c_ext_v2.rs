...
pub struct RegistrationAwsAccountCreateRequestD4CExtV2 {
    ...
    pub resources: Vec<models::RegistrationAwsAccountD4CExtV2>,
}

impl RegistrationAwsAccountCreateRequestD4CExtV2 {
    pub fn new(resources: Vec<models::RegistrationAwsAccountD4CExtV2>) -> RegistrationAwsAccountCreateRequestD4CExtV2 {
