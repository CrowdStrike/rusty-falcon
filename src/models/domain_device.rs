...
pub struct DomainDevice {
    ...
    pub device_policies: Option<Box<models::DomainMappedDevicePolicies>>,
...
impl DomainDevice {
    pub fn new(platform_id_numeric: i32, device_id: String) -> DomainDevice {
        DomainDevice {
            platform_id_numeric,
            agent_version: None,
            config_id_base: None,
