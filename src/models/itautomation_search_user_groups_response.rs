...
pub struct ItautomationSearchUserGroupsResponse {
...
impl ItautomationSearchUserGroupsResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ItautomationSearchUserGroupsResponse {
