...
impl ModelsApiUnidentifiedContainer {
    pub fn new(assessed_images: Vec<models::ModelsImageInformation>, assessed_images_count: String, cid: String, cluster_name: String, containers_impacted: Vec<models::ModelsContainerInformation>, containers_impacted_count: String, detect_timestamp: String, detections_count: String, first_seen: String, host_id: String, image_assessment_detections_count: String, last_seen: String, namespace: String, node_name: String, pod_id: String, pod_name: String, runtime_detections_count: String, severity: String, unassessed_images: Vec<models::ModelsImageInformation>, unassessed_images_count: String, visible_to_k8s: String) -> ModelsApiUnidentifiedContainer {
