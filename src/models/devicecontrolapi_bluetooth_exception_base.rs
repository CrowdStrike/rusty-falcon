...
pub struct DevicecontrolapiBluetoothExceptionBase {
...
impl DevicecontrolapiBluetoothExceptionBase {
    pub fn new(id: String) -> DevicecontrolapiBluetoothExceptionBase {
        DevicecontrolapiBluetoothExceptionBase {
            action: None,
            class: None,
            description: None,
