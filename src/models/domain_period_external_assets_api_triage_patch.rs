...
pub struct DomainPeriodExternalAssetsApiTriagePatch {
...
impl DomainPeriodExternalAssetsApiTriagePatch {
    pub fn new() -> DomainPeriodExternalAssetsApiTriagePatch {
        DomainPeriodExternalAssetsApiTriagePatch {
            action: None,
            assigned_to: None,
            description: None,
            status: None,
