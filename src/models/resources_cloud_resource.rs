...
pub struct ResourcesCloudResource {
    ...
    pub cloud_context: Option<Box<models::ResourcesCloudContext>>,
    ...
    pub relationships: Option<Vec<models::ResourcesRelationship>>,
    ...
    #[serde(rename = "supplementary_configuration", skip_serializing_if = "Option::is_none")]
...
impl ResourcesCloudResource {
    pub fn new() -> ResourcesCloudResource {
        ResourcesCloudResource {
            account_id: None,
            account_name: None,
            active: None,
            arn: None,
