...
pub struct DevicecontrolapiPeriodReqUpdateUsbClassV1 {
...
impl DevicecontrolapiPeriodReqUpdateUsbClassV1 {
    pub fn new(action: Action, class: Class) -> DevicecontrolapiPeriodReqUpdateUsbClassV1 {
        DevicecontrolapiPeriodReqUpdateUsbClassV1 { action, class }
    }
}
/// Action to be taken for devices in this class
