...
pub struct RemoteResponsePeriodUpdatePoliciesReqV1 {
    ...
    pub resources: Vec<crate::models::RemoteResponsePeriodUpdatePolicyReqV1>,
}

impl RemoteResponsePeriodUpdatePoliciesReqV1 {
    /// A req to update realtime response policies
    pub fn new(
        resources: Vec<crate::models::RemoteResponsePeriodUpdatePolicyReqV1>,
    ) -> RemoteResponsePeriodUpdatePoliciesReqV1 {
        RemoteResponsePeriodUpdatePoliciesReqV1 { resources }
    }
}
