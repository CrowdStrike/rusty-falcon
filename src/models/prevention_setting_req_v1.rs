...
pub struct PreventionSettingReqV1 {
...
impl PreventionSettingReqV1 {
    /// A specific setting to update
    pub fn new(id: String, value: serde_json::Value) -> PreventionSettingReqV1 {
        PreventionSettingReqV1 { id, value }
    }
}
