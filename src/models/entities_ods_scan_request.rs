...
pub struct EntitiesOdsScanRequest {
...
impl EntitiesOdsScanRequest {
    pub fn new(cloud_ml_level_detection: i32, cloud_ml_level_prevention: i32, cloud_pup_adware_level_detection: i32, cloud_pup_adware_level_prevention: i32, cpu_priority: i32, description: String, endpoint_notification: bool, file_paths: Vec<String>, host_groups: Vec<String>, hosts: Vec<String>, initiated_from: String, max_duration: i32, pause_duration: i32, quarantine: bool, scan_exclusions: Vec<String>, scan_inclusions: Vec<String>, sensor_ml_level_detection: i32, sensor_ml_level_prevention: i32) -> EntitiesOdsScanRequest {
