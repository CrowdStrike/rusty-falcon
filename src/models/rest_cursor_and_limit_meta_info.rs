...
pub struct RestCursorAndLimitMetaInfo {
    #[serde(rename = "next", skip_serializing_if = "Option::is_none")]
    pub next: Option<String>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::RestPaging>>,
...
impl RestCursorAndLimitMetaInfo {
    pub fn new(query_time: f64, trace_id: String) -> RestCursorAndLimitMetaInfo {
