...
pub struct FalconxPeriodContactedHost {
    #[serde(rename = "address", skip_serializing_if = "Option::is_none")]
    pub address: Option<String>,
    #[serde(rename = "associated_runtime", skip_serializing_if = "Option::is_none")]
    pub associated_runtime: Option<Vec<crate::models::FalconxPeriodAssociatedRuntime>>,
...
impl FalconxPeriodContactedHost {
    pub fn new() -> FalconxPeriodContactedHost {
