...
pub struct MalqueryPeriodRateLimitsMeta {
    ...
    pub download_counts: Option<Vec<models::MalqueryPeriodUserRequestCount>>,
    ...
    pub hunt_counts: Option<Vec<models::MalqueryPeriodUserRequestCount>>,
...
impl MalqueryPeriodRateLimitsMeta {
    pub fn new(days_left: i32, download_count: i32, download_limit: i32, hunt_count: i32, hunt_limit: i32, monitor_count: i32, monitor_limit: i32, refresh_time: String) -> MalqueryPeriodRateLimitsMeta {
