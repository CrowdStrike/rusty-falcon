...
pub struct SensorUpdatePolicyV2 {
    ...
    pub settings: Box<models::SensorUpdateSettingsRespV2>,
}

impl SensorUpdatePolicyV2 {
    pub fn new(cid: String, created_by: String, created_timestamp: String, description: String, enabled: bool, groups: Vec<models::HostGroupsHostGroupV1>, id: String, modified_by: String, modified_timestamp: String, name: String, platform_name: PlatformName, settings: models::SensorUpdateSettingsRespV2) -> SensorUpdatePolicyV2 {
        SensorUpdatePolicyV2 {
            cid,
            created_by,
            created_timestamp,
            description,
