...
pub struct ApiCertBasedExclusionUpdateReqV1 {
...
impl ApiCertBasedExclusionUpdateReqV1 {
    pub fn new(id: String) -> ApiCertBasedExclusionUpdateReqV1 {
        ApiCertBasedExclusionUpdateReqV1 {
