...
pub struct SensorUpdateUpdatePoliciesReqV2 {
    /// A collection of policies to update
    #[serde(rename = "resources")]
    pub resources: Vec<models::SensorUpdateUpdatePolicyReqV2>,
}

impl SensorUpdateUpdatePoliciesReqV2 {
    /// A req to update sensorUpdate policies
    pub fn new(resources: Vec<models::SensorUpdateUpdatePolicyReqV2>) -> SensorUpdateUpdatePoliciesReqV2 {
