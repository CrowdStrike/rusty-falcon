...
pub struct ApiPeriodIndicatorsReportRequest {
    ...
    #[serde(rename = "search")]
    pub search: Box<models::ApiPeriodIndicatorsSortedSearch>,
}

impl ApiPeriodIndicatorsReportRequest {
    pub fn new(report_format: String, search: models::ApiPeriodIndicatorsSortedSearch) -> ApiPeriodIndicatorsReportRequest {
