...
pub struct PreventionCreatePoliciesReqV1 {
    /// A collection of policies to create
    #[serde(rename = "resources")]
    pub resources: Vec<models::PreventionCreatePolicyReqV1>,
}

impl PreventionCreatePoliciesReqV1 {
    /// A request to create prevention policies
    pub fn new(resources: Vec<models::PreventionCreatePolicyReqV1>) -> PreventionCreatePoliciesReqV1 {
