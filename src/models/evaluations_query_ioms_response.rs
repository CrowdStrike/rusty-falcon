...
pub struct EvaluationsQueryIomsResponse {
...
impl EvaluationsQueryIomsResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> EvaluationsQueryIomsResponse {
