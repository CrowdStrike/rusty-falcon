...
pub struct DeviceControlPolicyV1 {
    ...
    pub settings: Box<models::DeviceControlSettingsRespV1>,
}

impl DeviceControlPolicyV1 {
    pub fn new(cid: String, created_by: String, created_timestamp: String, description: String, enabled: bool, groups: Vec<models::HostGroupsHostGroupV1>, id: String, modified_by: String, modified_timestamp: String, name: String, platform_name: PlatformName, settings: models::DeviceControlSettingsRespV1) -> DeviceControlPolicyV1 {
