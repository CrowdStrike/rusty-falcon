...
pub struct FirewallCreateFirewallPolicyReqV1 {
...
impl FirewallCreateFirewallPolicyReqV1 {
    pub fn new(name: String, platform_name: PlatformName) -> FirewallCreateFirewallPolicyReqV1 {
        FirewallCreateFirewallPolicyReqV1 {
            clone_id: None,
            description: None,
            name,
            platform_name,
