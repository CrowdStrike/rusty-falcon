...
impl V2PeriodDefinition {
    pub fn new(name: String, node_registry: std::collections::HashMap<String, String>, parent: models::V2PeriodModel, trigger: models::V2PeriodTrigger, uniq_node_seen: std::collections::HashMap<String, bool>) -> V2PeriodDefinition {
        V2PeriodDefinition {
            actions: None,
            conditions: None,
            description: None,
