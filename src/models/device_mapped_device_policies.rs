...
pub struct DeviceMappedDevicePolicies {
    ...
    pub airlock: Option<Box<crate::models::DeviceDevicePolicy>>,
    ...
    pub netskope: Option<Box<crate::models::DeviceDevicePolicy>>,
    #[serde(rename = "prevention", skip_serializing_if = "Option::is_none")]
    pub prevention: Option<Box<crate::models::DeviceDevicePolicy>>,
    #[serde(rename = "remote_response", skip_serializing_if = "Option::is_none")]
    pub remote_response: Option<Box<crate::models::DeviceDevicePolicy>>,
    #[serde(rename = "sensor_update", skip_serializing_if = "Option::is_none")]
    pub sensor_update: Option<Box<crate::models::DeviceDevicePolicy>>,
}
