...
pub struct DomainPeriodAzureClientServicePrincipalV1 {
    ...
    pub resource_permissions: Option<Vec<models::AzurePeriodResourcePermission>>,
...
impl DomainPeriodAzureClientServicePrincipalV1 {
    pub fn new(cid: String, cspm_enabled: bool, is_shared_client: bool, tenant_id: String) -> DomainPeriodAzureClientServicePrincipalV1 {
