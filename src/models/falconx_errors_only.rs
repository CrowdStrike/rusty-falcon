...
pub struct FalconxErrorsOnly {
    ...
    pub quota: Option<Box<models::FalconxQuota>>,
}

impl FalconxErrorsOnly {
    pub fn new(meta_info: models::MsaspecMetaInfo, errors: Vec<models::MsaspecError>) -> FalconxErrorsOnly {
        FalconxErrorsOnly {
