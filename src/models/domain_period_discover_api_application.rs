...
pub struct DomainPeriodDiscoverApiApplication {
    ...
    pub browser_extension: Option<Box<models::DomainPeriodDiscoverApiApplicationBrowserExtension>>,
    ...
    pub host: Option<Box<models::DomainPeriodDiscoverApiApplicationHost>>,
