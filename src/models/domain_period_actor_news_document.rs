...
pub struct DomainPeriodActorNewsDocument {
...
impl DomainPeriodActorNewsDocument {
    pub fn new(created_date: i64, id: i64, name: String, slug: String) -> DomainPeriodActorNewsDocument {
        DomainPeriodActorNewsDocument {
            created_date,
            id,
            name,
            slug,
