...
pub struct ItautomationPeriodQueryPolicyResponse {
...
impl ItautomationPeriodQueryPolicyResponse {
    pub fn new(meta: models::MsaspecPeriodMetaInfo, resources: Vec<String>) -> ItautomationPeriodQueryPolicyResponse {
        ItautomationPeriodQueryPolicyResponse {
            errors: None,
            meta: Box::new(meta),
            resources,
        }
