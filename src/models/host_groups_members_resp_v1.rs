...
pub struct HostGroupsMembersRespV1 {
    ...
    pub resources: Vec<models::DeviceDevice>,
}

impl HostGroupsMembersRespV1 {
    pub fn new(errors: Vec<models::MsaspecError>, meta: models::MsaspecMetaInfo, resources: Vec<models::DeviceDevice>) -> HostGroupsMembersRespV1 {
