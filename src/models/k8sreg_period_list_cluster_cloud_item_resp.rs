...
pub struct K8sregPeriodListClusterCloudItemResp {
    ...
    pub aws_meta: Option<Box<models::K8sregPeriodAwsClusterItemResp>>,
    #[serde(rename = "azure_meta", skip_serializing_if = "Option::is_none")]
    pub azure_meta: Option<Box<models::K8sregPeriodAzureAcctClusterItemResp>>,
...
impl K8sregPeriodListClusterCloudItemResp {
    pub fn new(account_id: String, cloud_status: String, cluster_service: String) -> K8sregPeriodListClusterCloudItemResp {
