...
pub struct RegistrationIomEventV2 {
...
impl RegistrationIomEventV2 {
    pub fn new(account_id: String, account_name: String, cid: String, cloud_provider: String, finding: serde_json::Value, findings: Vec<serde_json::Value>, id: String, policy_statement: String, region: String, report_date_time: String, resource_attributes: serde_json::Value, resource_create_time: String, resource_id: String, resource_id_type: String, resource_url: String, resource_uuid: String, scan_time: String, service: String, severity: String, status: String, tags: std::collections::HashMap<String, String>) -> RegistrationIomEventV2 {
