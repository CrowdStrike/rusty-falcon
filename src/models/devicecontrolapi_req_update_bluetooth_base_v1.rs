...
pub struct DevicecontrolapiReqUpdateBluetoothBaseV1 {
    #[serde(rename = "custom_end_user_notifications")]
    pub custom_end_user_notifications: Box<models::DevicecontrolapiBluetoothCustomNotifications>,
...
impl DevicecontrolapiReqUpdateBluetoothBaseV1 {
    pub fn new(custom_end_user_notifications: models::DevicecontrolapiBluetoothCustomNotifications, end_user_notification: EndUserNotification, enforcement_mode: EnforcementMode) -> DevicecontrolapiReqUpdateBluetoothBaseV1 {
        DevicecontrolapiReqUpdateBluetoothBaseV1 {
