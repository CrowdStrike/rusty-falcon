...
pub struct RemoteResponsePolicyV1 {
    ...
    pub settings: Vec<models::PreventionCategoryRespV1>,
}

impl RemoteResponsePolicyV1 {
    /// A fully formed RTR policy
    pub fn new(cid: String, created_by: String, created_timestamp: String, description: String, enabled: bool, groups: Vec<models::HostGroupsHostGroupV1>, id: String, modified_by: String, modified_timestamp: String, name: String, platform_name: PlatformName, settings: Vec<models::PreventionCategoryRespV1>) -> RemoteResponsePolicyV1 {
        RemoteResponsePolicyV1 {
            cid,
            created_by,
            created_timestamp,
            description,
