...
pub struct FalconxPeriodSandboxReportV1 {
    #[serde(rename = "all_extracted_strings_artifact_id", skip_serializing_if = "Option::is_none")]
    pub all_extracted_strings_artifact_id: Option<String>,
    ...
    pub certificates: Option<Vec<models::FalconxPeriodCertificate>>,
    #[serde(rename = "certificates_validation_message", skip_serializing_if = "Option::is_none")]
    ...
    pub contacted_hosts: Option<Vec<models::FalconxPeriodContactedHost>>,
    #[serde(rename = "dll_characteristics", skip_serializing_if = "Option::is_none")]
    pub dll_characteristics: Option<Vec<String>>,
    #[serde(rename = "dns_requests", skip_serializing_if = "Option::is_none")]
    pub dns_requests: Option<Vec<models::FalconxPeriodDnsRequest>>,
    #[serde(rename = "entrypoint", skip_serializing_if = "Option::is_none")]
    pub entrypoint: Option<String>,
    #[serde(rename = "entrypoint_preview_count", skip_serializing_if = "Option::is_none")]
    pub entrypoint_preview_count: Option<i32>,
    #[serde(rename = "entrypoint_preview_instructions", skip_serializing_if = "Option::is_none")]
    ...
    pub extracted_files: Option<Vec<models::FalconxPeriodExtractedFile>>,
    #[serde(rename = "extracted_interesting_strings", skip_serializing_if = "Option::is_none")]
    pub extracted_interesting_strings: Option<Vec<models::FalconxPeriodExtractedInterestingString>>,
    #[serde(rename = "file_data_directories", skip_serializing_if = "Option::is_none")]
    pub file_data_directories: Option<Vec<models::FalconxPeriodFileDataDirectory>>,
    #[serde(rename = "file_imports", skip_serializing_if = "Option::is_none")]
    pub file_imports: Option<Vec<models::FalconxPeriodFileImport>>,
    #[serde(rename = "file_metadata", skip_serializing_if = "Option::is_none")]
    pub file_metadata: Option<Box<models::FalconxPeriodFileMetadata>>,
    #[serde(rename = "file_resources", skip_serializing_if = "Option::is_none")]
    pub file_resources: Option<Vec<models::FalconxPeriodFileResource>>,
    #[serde(rename = "file_sections", skip_serializing_if = "Option::is_none")]
    pub file_sections: Option<Vec<models::FalconxPeriodFileSection>>,
    ...
    pub http_requests: Option<Vec<models::FalconxPeriodHttpRequest>>,
    #[serde(rename = "icon", skip_serializing_if = "Option::is_none")]
    pub icon: Option<String>,
    #[serde(rename = "image_base", skip_serializing_if = "Option::is_none")]
    pub image_base: Option<String>,
    #[serde(rename = "image_file_characteristics", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "intelligence_mitre_attacks", skip_serializing_if = "Option::is_none")]
    pub intelligence_mitre_attacks: Option<Vec<models::FalconxPeriodMitreAttack>>,
    ...
    pub memory_dumps: Option<Vec<models::FalconxPeriodMemoryDumpData>>,
    #[serde(rename = "memory_dumps_artifact_id", skip_serializing_if = "Option::is_none")]
    pub memory_dumps_artifact_id: Option<String>,
    #[serde(rename = "memory_forensics", skip_serializing_if = "Option::is_none")]
    pub memory_forensics: Option<Vec<models::FalconxPeriodMemoryForensic>>,
    ...
    pub mitre_attacks: Option<Vec<models::FalconxPeriodMitreAttack>>,
    ...
    pub processes: Option<Vec<models::FalconxPeriodProcess>>,
    ...
    pub signatures: Option<Vec<models::FalconxPeriodSignature>>,
    ...
    pub suricata_alerts: Option<Vec<models::FalconxPeriodSuricataAlert>>,
...
impl FalconxPeriodSandboxReportV1 {
    pub fn new(is_certificates_valid: bool) -> FalconxPeriodSandboxReportV1 {
        FalconxPeriodSandboxReportV1 {
            all_extracted_strings_artifact_id: None,
            architecture: None,
            certificates: None,
