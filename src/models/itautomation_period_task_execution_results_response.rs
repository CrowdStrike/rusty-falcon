...
pub struct ItautomationPeriodTaskExecutionResultsResponse {
...
impl ItautomationPeriodTaskExecutionResultsResponse {
    pub fn new(meta: models::MsaspecPeriodMetaInfo, resources: Vec<serde_json::Value>) -> ItautomationPeriodTaskExecutionResultsResponse {
        ItautomationPeriodTaskExecutionResultsResponse {
            errors: None,
            meta: Box::new(meta),
            resources,
        }
