...
pub struct DomainPeriodApiRemediationInfo {
    /// Contains the ID of the minimum remediation
    #[serde(rename = "minimum_id", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "recommended_id", skip_serializing_if = "Option::is_none")]
    pub recommended_id: Option<String>,
}

impl DomainPeriodApiRemediationInfo {
    pub fn new() -> DomainPeriodApiRemediationInfo {
        DomainPeriodApiRemediationInfo {
            minimum_id: None,
