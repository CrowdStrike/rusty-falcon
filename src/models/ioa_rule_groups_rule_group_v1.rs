...
pub struct IoaRuleGroupsRuleGroupV1 {
...
impl IoaRuleGroupsRuleGroupV1 {
    /// An IOA rule group which contains a set of IOA rules
    pub fn new(comment: String, committed_timestamp: String, created_by: String, created_timestamp: String, customer_id: String, deleted: bool, description: String, enabled: bool, id: String, modified_by: String, modified_timestamp: String, name: String, platform: String, rule_ids: Vec<String>, version: i64) -> IoaRuleGroupsRuleGroupV1 {
        IoaRuleGroupsRuleGroupV1 {
            comment,
            committed_timestamp,
            created_by,
            created_timestamp,
