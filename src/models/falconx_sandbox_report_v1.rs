...
pub struct FalconxSandboxReportV1 {
    ...
    pub certificates: Option<Vec<models::FalconxCertificate>>,
    ...
    pub contacted_hosts: Option<Vec<models::FalconxContactedHost>>,
    ...
    pub dns_requests: Option<Vec<models::FalconxDnsRequest>>,
    ...
    pub extracted_files: Option<Vec<models::FalconxExtractedFile>>,
    #[serde(rename = "extracted_interesting_strings", skip_serializing_if = "Option::is_none")]
    pub extracted_interesting_strings: Option<Vec<models::FalconxExtractedInterestingString>>,
    #[serde(rename = "file_data_directories", skip_serializing_if = "Option::is_none")]
    pub file_data_directories: Option<Vec<models::FalconxFileDataDirectory>>,
    #[serde(rename = "file_imports", skip_serializing_if = "Option::is_none")]
    pub file_imports: Option<Vec<models::FalconxFileImport>>,
    #[serde(rename = "file_metadata", skip_serializing_if = "Option::is_none")]
    pub file_metadata: Option<Box<models::FalconxFileMetadata>>,
    #[serde(rename = "file_resources", skip_serializing_if = "Option::is_none")]
    pub file_resources: Option<Vec<models::FalconxFileResource>>,
    #[serde(rename = "file_sections", skip_serializing_if = "Option::is_none")]
    pub file_sections: Option<Vec<models::FalconxFileSection>>,
    ...
    pub http_requests: Option<Vec<models::FalconxHttpRequest>>,
    ...
    pub incidents: Option<Vec<models::FalconxIncident>>,
    #[serde(rename = "intelligence_mitre_attacks", skip_serializing_if = "Option::is_none")]
    pub intelligence_mitre_attacks: Option<Vec<models::FalconxMitreAttack>>,
    ...
    pub memory_dumps: Option<Vec<models::FalconxMemoryDumpData>>,
    ...
    pub memory_forensics: Option<Vec<models::FalconxMemoryForensic>>,
    ...
    pub mitre_attacks: Option<Vec<models::FalconxMitreAttack>>,
    ...
    pub processes: Option<Vec<models::FalconxProcess>>,
    ...
    pub signatures: Option<Vec<models::FalconxSignature>>,
    ...
    pub suricata_alerts: Option<Vec<models::FalconxSuricataAlert>>,
...
impl FalconxSandboxReportV1 {
    pub fn new(is_certificates_valid: bool) -> FalconxSandboxReportV1 {
