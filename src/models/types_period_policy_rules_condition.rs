...
pub struct TypesPeriodPolicyRulesCondition {
...
impl TypesPeriodPolicyRulesCondition {
    pub fn new() -> TypesPeriodPolicyRulesCondition {
        TypesPeriodPolicyRulesCondition {
            exclude: None,
            include: None,
        }
    }
