...
pub struct TypesSonatypeMetadata {
    #[serde(rename = "CVEId", skip_serializing_if = "Option::is_none")]
    pub cveid: Option<String>,
    #[serde(rename = "applicationPublicId", skip_serializing_if = "Option::is_none")]
    pub application_public_id: Option<String>,
    #[serde(rename = "componentNameVersion", skip_serializing_if = "Option::is_none")]
...
impl TypesSonatypeMetadata {
    pub fn new() -> TypesSonatypeMetadata {
        TypesSonatypeMetadata {
            cveid: None,
