...
pub struct GraphPeriodTimerEventDefinition {
...
impl GraphPeriodTimerEventDefinition {
    pub fn new(skip_concurrent: bool, time_cycle: String, tz: String) -> GraphPeriodTimerEventDefinition {
        GraphPeriodTimerEventDefinition {
            end_date: None,
            skip_concurrent,
            start_date: None,
            time_cycle,
