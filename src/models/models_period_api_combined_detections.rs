...
impl ModelsPeriodApiCombinedDetections {
    pub fn new(cid: String, containers_impacted: i64, description: String, details: Vec<String>, detection_id: String, detection_name: String, detection_severity: String, detection_type: String, images_impacted: i64, last_detected: String, remediation: String, title: String) -> ModelsPeriodApiCombinedDetections {
