...
pub struct DomainPeriodExternalAssetCertificateEntityIdentifiers {
    ...
    #[serde(rename = "generation_qualifier", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "state_or_province_name", skip_serializing_if = "Option::is_none")]
...
impl DomainPeriodExternalAssetCertificateEntityIdentifiers {
    pub fn new() -> DomainPeriodExternalAssetCertificateEntityIdentifiers {
        DomainPeriodExternalAssetCertificateEntityIdentifiers {
            common_name: None,
            country_name: None,
            dn_qualifier: None,
