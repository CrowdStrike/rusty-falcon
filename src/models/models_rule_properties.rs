...
impl ModelsRuleProperties {
    pub fn new(
        ...
        exploit_sources: Vec<models::IngestionCveExploitSource>,
        ...
        references: Vec<models::IngestionReference>,
        ...
        severity: String,
        top_exprt_rating_factors: Vec<models::IngestionExPrtRatingFactors>,
