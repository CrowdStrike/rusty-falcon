...
pub struct ClientPeriodSystemDefinitionDeProvisionRequest {
    ...
    #[serde(rename = "deprovision_all")]
    pub deprovision_all: bool,
...
impl ClientPeriodSystemDefinitionDeProvisionRequest {
    pub fn new(definition_id: String, deprovision_all: bool, template_id: String, template_name: String) -> ClientPeriodSystemDefinitionDeProvisionRequest {
        ClientPeriodSystemDefinitionDeProvisionRequest {
            definition_id,
            deprovision_all,
            template_id,
            template_name,
