...
pub struct ItautomationPeriodDeleteTaskGroupsResponse {
...
impl ItautomationPeriodDeleteTaskGroupsResponse {
    pub fn new(meta: models::MsaspecPeriodMetaInfo, resources: Vec<String>) -> ItautomationPeriodDeleteTaskGroupsResponse {
        ItautomationPeriodDeleteTaskGroupsResponse {
            errors: None,
            meta: Box::new(meta),
            resources,
        }
