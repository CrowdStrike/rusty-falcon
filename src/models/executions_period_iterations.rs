...
pub struct ExecutionsPeriodIterations {
    ...
    #[serde(rename = "is_nonrecoverable")]
    pub is_nonrecoverable: bool,
...
impl ExecutionsPeriodIterations {
    pub fn new(completed: i32, failed: i32, in_progress: i32, is_nonrecoverable: bool, pending: i32, total: i32) -> ExecutionsPeriodIterations {
        ExecutionsPeriodIterations {
            completed,
            failed,
            in_progress,
            is_nonrecoverable,
