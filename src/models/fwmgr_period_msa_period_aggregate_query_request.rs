...
pub struct FwmgrPeriodMsaPeriodAggregateQueryRequest {
    ...
    pub date_ranges: Vec<crate::models::FwmgrPeriodMsaPeriodDateRangeSpec>,
    ...
    pub q: String,
    #[serde(rename = "ranges")]
    pub ranges: Vec<crate::models::FwmgrPeriodMsaPeriodRangeSpec>,
    #[serde(rename = "size")]
    pub size: i32,
    #[serde(rename = "sort")]
    pub sort: String,
    #[serde(rename = "sub_aggregates")]
    pub sub_aggregates: Vec<crate::models::FwmgrPeriodMsaPeriodAggregateQueryRequest>,
...
impl FwmgrPeriodMsaPeriodAggregateQueryRequest {
    pub fn new(
        date_ranges: Vec<crate::models::FwmgrPeriodMsaPeriodDateRangeSpec>,
        exclude: String,
        field: String,
        filter: String,
        from: i32,
        ...
        name: String,
        q: String,
        ranges: Vec<crate::models::FwmgrPeriodMsaPeriodRangeSpec>,
        size: i32,
        sort: String,
        sub_aggregates: Vec<crate::models::FwmgrPeriodMsaPeriodAggregateQueryRequest>,
        time_zone: String,
        r#type: String,
