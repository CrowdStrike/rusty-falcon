...
impl FwmgrPeriodMsaPeriodAggregateQueryRequest {
    pub fn new(date_ranges: Vec<models::FwmgrPeriodMsaPeriodDateRangeSpec>, exclude: String, field: String, filter: String, from: i32, include: String, interval: String, missing: String, name: String, q: String, ranges: Vec<models::FwmgrPeriodMsaPeriodRangeSpec>, size: i32, sort: String, sub_aggregates: Vec<models::FwmgrPeriodMsaPeriodAggregateQueryRequest>, time_zone: String, r#type: String) -> FwmgrPeriodMsaPeriodAggregateQueryRequest {
