...
pub struct DomainPeriodNewsDocument {
    ...
    #[serde(rename = "actors")]
    pub actors: Vec<models::DomainPeriodSimpleActor>,
    /// News attachment, containing either pdf url or feeds zip and/or gzip archive
    #[serde(rename = "attachments", skip_serializing_if = "Option::is_none")]
    pub attachments: Option<Vec<models::DomainPeriodFile>>,
    ...
    pub malware: Option<Vec<models::DomainPeriodReportMalware>>,
    ...
    pub sub_type: Option<Box<models::DomainPeriodEntity>>,
    ...
    #[serde(rename = "tags")]
    pub tags: Vec<models::DomainPeriodEntity>,
    ...
    pub thumbnail: Box<models::DomainPeriodImage>,
    #[serde(rename = "topic", skip_serializing_if = "Option::is_none")]
    pub topic: Option<Box<models::DomainPeriodEntity>>,
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<Box<models::DomainPeriodEntity>>,
...
impl DomainPeriodNewsDocument {
    pub fn new(actors: Vec<models::DomainPeriodSimpleActor>, created_date: i64, id: i64, last_modified_date: i64, motivations: Vec<models::DomainPeriodEntity>, name: String, slug: String, tags: Vec<models::DomainPeriodEntity>, target_countries: Vec<models::DomainPeriodEntity>, target_industries: Vec<models::DomainPeriodEntity>, thumbnail: models::DomainPeriodImage) -> DomainPeriodNewsDocument {
