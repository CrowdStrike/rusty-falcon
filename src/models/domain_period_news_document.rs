...
pub struct DomainPeriodNewsDocument {
    ...
    #[serde(
        rename = "rich_text_short_description",
        skip_serializing_if = "Option::is_none"
    )]
...
impl DomainPeriodNewsDocument {
    pub fn new(
        actors: Vec<models::DomainPeriodSimpleActor>,
        created_date: i64,
        id: i64,
