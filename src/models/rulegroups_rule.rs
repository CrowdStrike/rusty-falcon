...
pub struct RulegroupsRule {
    #[serde(rename = "content_files", skip_serializing_if = "Option::is_none")]
    pub content_files: Option<Vec<String>>,
    #[serde(rename = "content_registry_values", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "enable_content_capture", skip_serializing_if = "Option::is_none")]
    pub enable_content_capture: Option<bool>,
    #[serde(rename = "enable_hash_capture", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "type")]
    pub r#type: String,
    #[serde(rename = "watch_attributes_directory_changes", skip_serializing_if = "Option::is_none")]
    pub watch_attributes_directory_changes: Option<bool>,
    #[serde(rename = "watch_attributes_file_changes", skip_serializing_if = "Option::is_none")]
    pub watch_attributes_file_changes: Option<bool>,
    #[serde(rename = "watch_create_directory_changes", skip_serializing_if = "Option::is_none")]
    pub watch_create_directory_changes: Option<bool>,
    #[serde(rename = "watch_create_file_changes", skip_serializing_if = "Option::is_none")]
    pub watch_create_file_changes: Option<bool>,
    #[serde(rename = "watch_create_key_changes", skip_serializing_if = "Option::is_none")]
    pub watch_create_key_changes: Option<bool>,
    #[serde(rename = "watch_delete_directory_changes", skip_serializing_if = "Option::is_none")]
    pub watch_delete_directory_changes: Option<bool>,
    #[serde(rename = "watch_delete_file_changes", skip_serializing_if = "Option::is_none")]
    pub watch_delete_file_changes: Option<bool>,
    #[serde(rename = "watch_delete_key_changes", skip_serializing_if = "Option::is_none")]
    pub watch_delete_key_changes: Option<bool>,
    #[serde(rename = "watch_delete_value_changes", skip_serializing_if = "Option::is_none")]
    pub watch_delete_value_changes: Option<bool>,
    #[serde(rename = "watch_permissions_directory_changes", skip_serializing_if = "Option::is_none")]
    pub watch_permissions_directory_changes: Option<bool>,
    #[serde(rename = "watch_permissions_file_changes", skip_serializing_if = "Option::is_none")]
    pub watch_permissions_file_changes: Option<bool>,
    #[serde(rename = "watch_permissions_key_changes", skip_serializing_if = "Option::is_none")]
    pub watch_permissions_key_changes: Option<bool>,
    #[serde(rename = "watch_rename_directory_changes", skip_serializing_if = "Option::is_none")]
    pub watch_rename_directory_changes: Option<bool>,
    #[serde(rename = "watch_rename_file_changes", skip_serializing_if = "Option::is_none")]
    pub watch_rename_file_changes: Option<bool>,
    #[serde(rename = "watch_rename_key_changes", skip_serializing_if = "Option::is_none")]
    pub watch_rename_key_changes: Option<bool>,
    #[serde(rename = "watch_set_value_changes", skip_serializing_if = "Option::is_none")]
    pub watch_set_value_changes: Option<bool>,
    #[serde(rename = "watch_write_file_changes", skip_serializing_if = "Option::is_none")]
    pub watch_write_file_changes: Option<bool>,
}

impl RulegroupsRule {
    pub fn new(depth: String, id: String, include: String, path: String, rule_group_id: String, severity: String, r#type: String) -> RulegroupsRule {
        RulegroupsRule {
            content_files: None,
