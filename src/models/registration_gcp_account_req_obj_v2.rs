...
pub struct RegistrationGcpAccountReqObjV2 {
...
impl RegistrationGcpAccountReqObjV2 {
    pub fn new(parent_id: String) -> RegistrationGcpAccountReqObjV2 {
        RegistrationGcpAccountReqObjV2 {
            client_email: None,
            client_id: None,
            parent_id,
            parent_type: None,
