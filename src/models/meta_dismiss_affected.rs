...
impl MetaDismissAffected {
    pub fn new() -> MetaDismissAffected {
        MetaDismissAffected {
            pagination: None,
            query_time: None,
            trace_id: None,
