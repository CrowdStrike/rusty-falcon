...
pub struct RegistrationPeriodGcpAccountReqObjV2 {
...
impl RegistrationPeriodGcpAccountReqObjV2 {
    pub fn new(parent_id: String) -> RegistrationPeriodGcpAccountReqObjV2 {
        RegistrationPeriodGcpAccountReqObjV2 {
            client_email: None,
            client_id: None,
            parent_id,
            parent_type: None,
