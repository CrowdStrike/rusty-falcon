...
impl ModelPeriodSessionLog {
    pub fn new(base_command: String, cloud_request_id: String, command_string: String, created_at: String, current_directory: String, id: i32, session_id: String, updated_at: String) -> ModelPeriodSessionLog {
