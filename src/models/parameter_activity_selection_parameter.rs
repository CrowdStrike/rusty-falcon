...
pub struct ParameterActivitySelectionParameter {
...
impl ParameterActivitySelectionParameter {
    pub fn new(id: String, properties: serde_json::Value, source: String) -> ParameterActivitySelectionParameter {
        ParameterActivitySelectionParameter {
            id,
            properties,
            source,
        }
