...
impl ApiPeriodHostMigration {
    pub fn new(created_time: String, host_migration_id: String, hostgroups: Vec<String>, hostname: String, migration_id: String, platform: String, source_cid: String, source_device_id: String, status: String, status_details: String, target_cid: String, target_device_id: String, updated_time: String) -> ApiPeriodHostMigration {
