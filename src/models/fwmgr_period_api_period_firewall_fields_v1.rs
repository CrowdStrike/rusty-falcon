...
pub struct FwmgrPeriodApiPeriodFirewallFieldsV1 {
    ...
    pub default_monitor: Box<crate::models::FwmgrPeriodDomainPeriodMonitoring>,
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "platform")]
    pub platform: String,
    #[serde(rename = "platform_fields")]
    pub platform_fields: Vec<crate::models::FwmgrPeriodDomainPeriodField>,
}

impl FwmgrPeriodApiPeriodFirewallFieldsV1 {
    pub fn new(
        default_monitor: crate::models::FwmgrPeriodDomainPeriodMonitoring,
        id: String,
        platform: String,
        platform_fields: Vec<crate::models::FwmgrPeriodDomainPeriodField>,
