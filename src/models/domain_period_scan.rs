...
pub struct DomainPeriodScan {
    ...
    #[serde(rename = "cloud_pup_adware_level_detection", skip_serializing_if = "Option::is_none")]
    pub cloud_pup_adware_level_detection: Option<i32>,
    #[serde(rename = "cloud_pup_adware_level_prevention", skip_serializing_if = "Option::is_none")]
    pub cloud_pup_adware_level_prevention: Option<i32>,
    #[serde(rename = "completed_host_count", skip_serializing_if = "Option::is_none")]
    pub completed_host_count: Option<i32>,
    ...
    pub filecount: Option<Box<models::DomainPeriodFileCount>>,
    ...
    #[serde(rename = "hosts_created", skip_serializing_if = "Option::is_none")]
    pub hosts_created: Option<bool>,
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "incomplete_host_count", skip_serializing_if = "Option::is_none")]
    pub incomplete_host_count: Option<i32>,
    ...
    pub metadata: Option<Vec<models::DomainPeriodScanMetadata>>,
    #[serde(rename = "missing_host_count", skip_serializing_if = "Option::is_none")]
    pub missing_host_count: Option<i32>,
    #[serde(rename = "not_started_host_count", skip_serializing_if = "Option::is_none")]
    pub not_started_host_count: Option<i32>,
    ...
    #[serde(rename = "rollup_version", skip_serializing_if = "Option::is_none")]
    pub rollup_version: Option<i32>,
    ...
    #[serde(rename = "scan_scheduled_on", skip_serializing_if = "Option::is_none")]
    pub scan_scheduled_on: Option<String>,
    ...
    #[serde(rename = "started_host_count", skip_serializing_if = "Option::is_none")]
    pub started_host_count: Option<i32>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "targeted_host_count", skip_serializing_if = "Option::is_none")]
    pub targeted_host_count: Option<i32>,
}

impl DomainPeriodScan {
    pub fn new(id: String) -> DomainPeriodScan {
        DomainPeriodScan {
            affected_hosts_count: None,
            cid: None,
            ...
            hosts_created: None,
            id,
            incomplete_host_count: None,
            initiated_from: None,
            last_updated: None,
            max_duration: None,
            metadata: None,
            missing_host_count: None,
            not_started_host_count: None,
            pause_duration: None,
            policy_setting: None,
