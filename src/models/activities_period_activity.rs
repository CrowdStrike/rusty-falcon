...
pub struct ActivitiesPeriodActivity {
...
impl ActivitiesPeriodActivity {
    pub fn new(cid: String, description: String, disruptive: bool, has_permission: bool, id: String, name: String) -> ActivitiesPeriodActivity {
        ActivitiesPeriodActivity {
            api_scope: None,
            app_id: None,
            cid,
            class: None,
