...
impl MetaGetIntegrations {
    pub fn new() -> MetaGetIntegrations {
        MetaGetIntegrations {
            pagination: None,
            query_time: None,
            trace_id: None,
