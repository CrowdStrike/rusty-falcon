...
pub struct V2ForLoop {
    ...
    #[serde(rename = "input")]
    pub input: String,
    #[serde(rename = "max_execution_seconds", skip_serializing_if = "Option::is_none")]
    pub max_execution_seconds: Option<i32>,
    #[serde(rename = "max_iteration_count", skip_serializing_if = "Option::is_none")]
...
impl V2ForLoop {
    pub fn new(continue_on_partial_execution: bool, input: String) -> V2ForLoop {
        V2ForLoop {
            cel_condition: None,
            condition: None,
