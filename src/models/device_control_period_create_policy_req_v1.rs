...
pub struct DeviceControlPeriodCreatePolicyReqV1 {
    ...
    pub settings: Option<Box<crate::models::DeviceControlPeriodSettingsReqV1>>,
}

impl DeviceControlPeriodCreatePolicyReqV1 {
    pub fn new(name: String, platform_name: PlatformName) -> DeviceControlPeriodCreatePolicyReqV1 {
