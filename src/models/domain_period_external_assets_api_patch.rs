...
/// DomainPeriodExternalAssetsApiPatch : Represents information about a managed, an unmanaged or an unsupported asset.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DomainPeriodExternalAssetsApiPatch {
    ...
    pub triage: Option<Box<models::DomainPeriodExternalAssetsApiTriagePatch>>,
}

impl DomainPeriodExternalAssetsApiPatch {
    /// Represents information about a managed, an unmanaged or an unsupported asset.
    pub fn new(id: String) -> DomainPeriodExternalAssetsApiPatch {
        DomainPeriodExternalAssetsApiPatch {
            cid: None,
            criticality: None,
