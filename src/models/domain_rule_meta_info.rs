...
pub struct DomainRuleMetaInfo {
    ...
    pub quota: Option<Box<models::DomainRuleQuota>>,
...
impl DomainRuleMetaInfo {
    pub fn new(query_time: f64, trace_id: String) -> DomainRuleMetaInfo {
        DomainRuleMetaInfo {
            pagination: None,
            powered_by: None,
            query_time,
