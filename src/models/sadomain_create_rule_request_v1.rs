...
impl SadomainCreateRuleRequestV1 {
    pub fn new(breach_monitor_only: bool, breach_monitoring_enabled: bool, filter: String, match_on_tsq_result_types: Vec<String>, name: String, originating_template_id: String, permissions: String, priority: String, substring_matching_enabled: bool, topic: String) -> SadomainCreateRuleRequestV1 {
