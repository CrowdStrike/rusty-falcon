...
pub struct PreventionUpdatePolicyReqV1 {
...
impl PreventionUpdatePolicyReqV1 {
    /// An update for a specific policy
    pub fn new(id: String, settings: Vec<models::PreventionSettingReqV1>) -> PreventionUpdatePolicyReqV1 {
