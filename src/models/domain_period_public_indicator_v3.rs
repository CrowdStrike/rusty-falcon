...
impl DomainPeriodPublicIndicatorV3 {
    pub fn new(_marker: String, actors: Vec<String>, deleted: bool, domain_types: Vec<String>, id: String, indicator: String, ip_address_types: Vec<String>, kill_chains: Vec<String>, labels: Vec<models::DomainPeriodCsixLabel>, last_updated: i64, malicious_confidence: String, malware_families: Vec<String>, published_date: i64, relations: Vec<models::DomainPeriodCsixRelation>, reports: Vec<String>, targets: Vec<String>, threat_types: Vec<String>, r#type: String, vulnerabilities: Vec<String>) -> DomainPeriodPublicIndicatorV3 {
