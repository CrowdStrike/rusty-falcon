...
pub struct DomainPeriodPublicIndicatorV3 {
    ...
    #[serde(rename = "labels")]
    pub labels: Vec<crate::models::DomainPeriodCsixLabel>,
    ...
    pub relations: Vec<crate::models::DomainPeriodCsixRelation>,
...
impl DomainPeriodPublicIndicatorV3 {
    pub fn new(
        ...
        labels: Vec<crate::models::DomainPeriodCsixLabel>,
        last_updated: i64,
        malicious_confidence: String,
        malware_families: Vec<String>,
        published_date: i64,
        relations: Vec<crate::models::DomainPeriodCsixRelation>,
        reports: Vec<String>,
        targets: Vec<String>,
