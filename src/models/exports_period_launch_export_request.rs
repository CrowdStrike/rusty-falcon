...
pub struct ExportsPeriodLaunchExportRequest {
    /// Format of the export file. One of: csv, json
    #[serde(rename = "format")]
    pub format: String,
    /// Falcon Query Language string to filter documents
    #[serde(rename = "fql", skip_serializing_if = "Option::is_none")]
...
impl ExportsPeriodLaunchExportRequest {
    pub fn new(format: String, resource: String, sort: String) -> ExportsPeriodLaunchExportRequest {
        ExportsPeriodLaunchExportRequest {
            format,
            fql: None,
            resource,
            sort,
