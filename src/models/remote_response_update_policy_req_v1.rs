...
pub struct RemoteResponseUpdatePolicyReqV1 {
    ...
    pub settings: Vec<models::PreventionSettingReqV1>,
}

impl RemoteResponseUpdatePolicyReqV1 {
    /// An update for a specific policy
    pub fn new(id: String, settings: Vec<models::PreventionSettingReqV1>) -> RemoteResponseUpdatePolicyReqV1 {
        RemoteResponseUpdatePolicyReqV1 {
            description: None,
            id,
            name: None,
            settings,
