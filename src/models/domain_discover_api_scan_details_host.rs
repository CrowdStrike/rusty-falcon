...
pub struct DomainDiscoverApiScanDetailsHost {
...
impl DomainDiscoverApiScanDetailsHost {
    pub fn new() -> DomainDiscoverApiScanDetailsHost {
        DomainDiscoverApiScanDetailsHost {
            scan_date: None,
            scan_id: None,
            schedule_id: None,
        }
