...
pub struct ResourcesPeriodCloudContext {
    ...
    #[serde(rename = "allows_public_access", skip_serializing_if = "Option::is_none")]
    pub allows_public_access: Option<bool>,
    #[serde(rename = "application_security", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "data_classifications", skip_serializing_if = "Option::is_none")]
