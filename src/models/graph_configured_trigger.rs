...
pub struct GraphConfiguredTrigger {
    ...
    pub parameters: Option<Box<models::JsonschemaSchema>>,
    #[serde(
        rename = "timer_event_definition",
        skip_serializing_if = "Option::is_none"
    )]
    pub timer_event_definition: Option<Box<models::GraphTimerEventDefinition>>,
    ...
    pub webhook_config: Option<Box<models::WebhooktriggerApiRequest>>,
}
