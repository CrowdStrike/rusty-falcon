...
impl FwmgrPeriodFirewallPeriodMatchEventResponse {
    pub fn new(aid: String, cid: String, command_line: String, connection_direction: String, domain_name_list: String, event_type: String, flags: models::FwmgrPeriodFirewallPeriodFlags, hidden: bool, host_name: String, icmp_code: String, icmp_type: String, id: String, image_file_name: String, ipv: String, local_address: String, local_port: String, match_count: String, match_count_since_last_event: String, network_profile: String, pid: String, platform: String, policy_id: String, policy_name: String, protocol: String, remote_address: String, remote_port: String, rule_action: String, rule_description: String, rule_family_id: String, rule_group_name: String, rule_id: String, rule_name: String, status: String, timestamp: String, tree_id: String) -> FwmgrPeriodFirewallPeriodMatchEventResponse {
