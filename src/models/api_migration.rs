...
impl ApiMigration {
    pub fn new(created_by: String, created_time: String, migration_id: String, migration_status: String, name: String, target_cid: String, total_hosts: i32, updated_by: String, updated_time: String) -> ApiMigration {
        ApiMigration {
            canceled_by: None,
            completed_time: None,
            created_by,
