...
pub struct ItautomationUserGroupMember {
...
impl ItautomationUserGroupMember {
    pub fn new(created_by: String, created_time: String, user_id: String) -> ItautomationUserGroupMember {
        ItautomationUserGroupMember {
            created_by,
            created_time,
            user_id,
        }
