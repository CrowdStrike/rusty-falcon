...
pub struct DomainPeriodFileCount {
    ...
    #[serde(rename = "traversed", skip_serializing_if = "Option::is_none")]
    pub traversed: Option<i32>,
}

impl DomainPeriodFileCount {
    pub fn new() -> DomainPeriodFileCount {
