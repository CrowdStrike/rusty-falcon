...
pub struct ItautomationCreateTaskRequest {
...
impl ItautomationCreateTaskRequest {
    pub fn new(access_type: AccessType, name: String, target: String, task_type: TaskType) -> ItautomationCreateTaskRequest {
