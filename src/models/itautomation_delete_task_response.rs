...
pub struct ItautomationDeleteTaskResponse {
...
impl ItautomationDeleteTaskResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ItautomationDeleteTaskResponse {
