...
pub struct MetaGetEndTransaction {
    #[serde(rename = "pagination", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Option<Box<models::PaginationMetaGetEndTransaction>>>,
...
impl MetaGetEndTransaction {
    pub fn new() -> MetaGetEndTransaction {
