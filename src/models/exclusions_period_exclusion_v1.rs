...
impl ExclusionsPeriodExclusionV1 {
    pub fn new(applied_globally: bool, created_by: String, created_on: String, groups: Vec<models::HostGroupsPeriodHostGroupV1>, id: String, last_modified: String, modified_by: String, regexp_value: String, value: String, value_hash: String) -> ExclusionsPeriodExclusionV1 {
