...
impl ItautomationPeriodScheduledTask {
    pub fn new(created_by: String, created_time: String, id: String, is_active: bool, is_preset: bool, schedule: models::FalconforitapiPeriodSchedule, target: String, task_id: String, task_name: String, task_type: String) -> ItautomationPeriodScheduledTask {
