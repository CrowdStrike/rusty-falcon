...
pub struct ApiParserTestCaseOutputAssertions {
    ...
    #[serde(rename = "fields_have_values")]
    pub fields_have_values: Vec<models::ApiFieldHasValue>,
    /// Fields which must not be present in the output
    #[serde(rename = "fields_not_present")]
    pub fields_not_present: Vec<String>,
}

impl ApiParserTestCaseOutputAssertions {
    pub fn new(fields_have_values: Vec<models::ApiFieldHasValue>, fields_not_present: Vec<String>) -> ApiParserTestCaseOutputAssertions {
        ApiParserTestCaseOutputAssertions {
            fields_have_values,
            fields_not_present,
        }
    }
