...
pub struct QuickscanproScanResult {
    ...
    pub file_artifacts: Vec<models::QuickscanproFileResult>,
    #[serde(rename = "mitre_attacks", skip_serializing_if = "Option::is_none")]
    pub mitre_attacks: Option<Vec<models::DomainMitreAttack>>,
    #[serde(rename = "url_artifacts", skip_serializing_if = "Option::is_none")]
    pub url_artifacts: Option<Vec<models::QuickscanproUrlResult>>,
...
impl QuickscanproScanResult {
    pub fn new(file_artifacts: Vec<models::QuickscanproFileResult>, verdict: Verdict, verdict_reason: String) -> QuickscanproScanResult {
        QuickscanproScanResult {
