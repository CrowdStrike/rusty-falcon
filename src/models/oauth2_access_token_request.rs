...
pub struct Oauth2AccessTokenRequest {
    ...
    #[serde(rename = "member_cid", skip_serializing_if = "Option::is_none")]
    pub member_cid: Option<String>,
}

impl Oauth2AccessTokenRequest {
    pub fn new(client_id: String, client_secret: String) -> Oauth2AccessTokenRequest {
