...
pub struct GraphPeriodMulti {
    ...
    pub condition: Option<Box<models::GraphPeriodCondition>>,
...
impl GraphPeriodMulti {
    pub fn new(array_field: String, array_field_display_name: String, continue_on_partial_execution: bool, max_execution_seconds: i32, max_iteration_count: i32) -> GraphPeriodMulti {
        GraphPeriodMulti {
            array_field,
