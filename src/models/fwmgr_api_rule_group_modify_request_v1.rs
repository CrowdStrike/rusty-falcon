...
pub struct FwmgrApiRuleGroupModifyRequestV1 {
    ...
    pub diff_operations: Vec<models::FwmgrApiJsonDiff>,
...
impl FwmgrApiRuleGroupModifyRequestV1 {
    pub fn new(diff_operations: Vec<models::FwmgrApiJsonDiff>, diff_type: String, id: String, rule_ids: Vec<String>, rule_versions: Vec<i32>, tracking: String) -> FwmgrApiRuleGroupModifyRequestV1 {
