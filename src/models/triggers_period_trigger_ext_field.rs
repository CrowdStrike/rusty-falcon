...
pub struct TriggersPeriodTriggerExtField {
...
impl TriggersPeriodTriggerExtField {
    pub fn new(display: String, name: String) -> TriggersPeriodTriggerExtField {
        TriggersPeriodTriggerExtField {
            description: None,
            display,
            example: None,
            fields: None,
