...
impl ApiScheduledReportV1 {
    pub fn new(can_write: bool, created_on: String, customer_id: String, description: String, id: String, last_updated_on: String, name: String, notifications: Vec<crate::models::DomainNotifications>, report_params: crate::models::DomainReportParams, schedule: crate::models::DomainSchedule, shared_with: Vec<String>, status: String, trigger_reference: String, _type: String, user_id: String, user_uuid: String) -> ApiScheduledReportV1 {
