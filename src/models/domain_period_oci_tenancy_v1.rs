...
pub struct DomainPeriodOciTenancyV1 {
    ...
    pub products: std::collections::HashMap<String, std::collections::HashMap<String, models::DomainPeriodProductFeatureStatus>>,
...
impl DomainPeriodOciTenancyV1 {
    pub fn new(cid: String, created_at: String, cspm_enabled: bool, finger_print: String, group_name: String, group_ocid: String, home_region: String, is_connected: bool, key_age: i32, overall_status: String, policy_name: String, policy_ocid: String, products: std::collections::HashMap<String, std::collections::HashMap<String, models::DomainPeriodProductFeatureStatus>>, public_key: String, stack_name: String, stack_ocid: String, tenancy_name: String, tenancy_ocid: String, updated_at: String, user_email: String, user_name: String, user_ocid: String) -> DomainPeriodOciTenancyV1 {
