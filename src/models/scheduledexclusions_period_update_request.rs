...
pub struct ScheduledexclusionsPeriodUpdateRequest {
...
impl ScheduledexclusionsPeriodUpdateRequest {
    pub fn new(id: String, name: String, timezone: String) -> ScheduledexclusionsPeriodUpdateRequest {
        ScheduledexclusionsPeriodUpdateRequest {
            description: None,
            id,
            name,
            policy_id: None,
