...
pub struct WebhooktriggerPeriodHmacConfig {
    ...
    #[serde(rename = "message_id_header_name", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "signature_header_name", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "timestamp_header_name", skip_serializing_if = "Option::is_none")]
    pub timestamp_header_name: Option<String>,
}

impl WebhooktriggerPeriodHmacConfig {
    pub fn new() -> WebhooktriggerPeriodHmacConfig {
        WebhooktriggerPeriodHmacConfig {
