...
impl IoaExclusionsPeriodIoaExclusionRespV1 {
    pub fn new(applied_globally: bool, cl_regex: String, created_by: String, created_on: String, description: String, detection_json: String, groups: Vec<models::HostGroupsPeriodHostGroupV1>, id: String, ifn_regex: String, last_modified: String, modified_by: String, name: String, pattern_id: String, pattern_name: String) -> IoaExclusionsPeriodIoaExclusionRespV1 {
