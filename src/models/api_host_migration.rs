...
pub struct ApiHostMigration {
    #[serde(rename = "created_time")]
    pub created_time: String,
    #[serde(rename = "events", skip_serializing_if = "Option::is_none")]
    pub events: Option<Vec<models::ApiEvent>>,
...
impl ApiHostMigration {
    pub fn new(created_time: String, host_migration_id: String, hostgroups: Vec<String>, hostname: String, migration_id: String, platform: String, source_cid: String, source_device_id: String, status: String, status_details: String, target_cid: String, target_device_id: String, updated_time: String) -> ApiHostMigration {
        ApiHostMigration {
            created_time,
            events: None,
            host_migration_id,
