...
pub struct ExecutionsPeriodChildExecutionResult {
...
impl ExecutionsPeriodChildExecutionResult {
    pub fn new(id: String, iteration: i32, start_timestamp: String, status: String) -> ExecutionsPeriodChildExecutionResult {
        ExecutionsPeriodChildExecutionResult {
            end_timestamp: None,
            id,
            iteration,
            start_timestamp,
