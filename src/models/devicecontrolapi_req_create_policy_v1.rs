...
pub struct DevicecontrolapiReqCreatePolicyV1 {
    ...
    pub usb_settings: Option<Box<models::DevicecontrolapiReqUpdateUsbBaseV1>>,
}

impl DevicecontrolapiReqCreatePolicyV1 {
    pub fn new() -> DevicecontrolapiReqCreatePolicyV1 {
        DevicecontrolapiReqCreatePolicyV1 {
