...
pub struct K8sregPeriodClusterResp {
    ...
    pub agent_version: Box<crate::models::K8sregPeriodVersionResp>,
    #[serde(rename = "cid")]
    pub cid: String,
    ...
    pub helm_version: Box<crate::models::K8sregPeriodVersionResp>,
    #[serde(rename = "k8s_version")]
    pub k8s_version: Box<crate::models::K8sregPeriodVersionResp>,
...
impl K8sregPeriodClusterResp {
    pub fn new(
        account_id: String,
        agent_version: crate::models::K8sregPeriodVersionResp,
        cid: String,
        cluster_id: String,
        cluster_name: String,
        cluster_service: String,
        created_at: String,
        helm_version: crate::models::K8sregPeriodVersionResp,
        k8s_version: crate::models::K8sregPeriodVersionResp,
