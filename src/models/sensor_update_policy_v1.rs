...
pub struct SensorUpdatePolicyV1 {
    ...
    pub settings: Box<models::SensorUpdateSettingsRespV1>,
}

impl SensorUpdatePolicyV1 {
    pub fn new(cid: String, created_by: String, created_timestamp: String, description: String, enabled: bool, groups: Vec<models::HostGroupsHostGroupV1>, id: String, modified_by: String, modified_timestamp: String, name: String, platform_name: PlatformName, settings: models::SensorUpdateSettingsRespV1) -> SensorUpdatePolicyV1 {
        SensorUpdatePolicyV1 {
            cid,
            created_by,
            created_timestamp,
            description,
