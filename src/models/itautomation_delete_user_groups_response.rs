...
pub struct ItautomationDeleteUserGroupsResponse {
...
impl ItautomationDeleteUserGroupsResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ItautomationDeleteUserGroupsResponse {
