...
pub struct ApiMfaResourceIdsResponse {
...
impl ApiMfaResourceIdsResponse {
    pub fn new(meta: models::MsaspecMetaInfo, resources: Vec<String>) -> ApiMfaResourceIdsResponse {
