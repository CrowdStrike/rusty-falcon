...
pub struct DomainPeriodDdosTargetDetails {
...
impl DomainPeriodDdosTargetDetails {
    pub fn new(asn: i32, asn_name: String, cidr: String, city: String, company_name: String, connection_type: String, country: String, country_code: String, pdns: Vec<String>, rdns: String) -> DomainPeriodDdosTargetDetails {
