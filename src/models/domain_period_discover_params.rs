...
impl DomainPeriodDiscoverParams {
    pub fn new(application_filters: String, application_group_id: String, application_vendors: String, inline_app_filter: String, requirement_criteria: String) -> DomainPeriodDiscoverParams {
