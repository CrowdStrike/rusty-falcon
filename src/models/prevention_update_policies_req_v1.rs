...
pub struct PreventionUpdatePoliciesReqV1 {
    /// A collection of policies to update
    #[serde(rename = "resources")]
    pub resources: Vec<models::PreventionUpdatePolicyReqV1>,
}

impl PreventionUpdatePoliciesReqV1 {
    /// A request to update prevention policies
    pub fn new(resources: Vec<models::PreventionUpdatePolicyReqV1>) -> PreventionUpdatePoliciesReqV1 {
