...
pub struct CsdomainDevice {
    ...
    pub device_policies: Option<Box<crate::models::CsdomainMappedDevicePolicies>>,
    ...
    pub managed_apps: Option<Box<crate::models::CsdomainManagedApps>>,
    #[serde(rename = "meta", skip_serializing_if = "Option::is_none")]
    pub meta: Option<Box<crate::models::CsdomainDeviceMeta>>,
    ...
    pub policies: Option<Vec<crate::models::CsdomainDevicePolicy>>,
...
impl CsdomainDevice {
    pub fn new(cid: String, device_id: String) -> CsdomainDevice {
        CsdomainDevice {
