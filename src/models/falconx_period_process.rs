...
pub struct FalconxPeriodProcess {
    ...
    pub amsi_calls: Option<Vec<crate::models::FalconxPeriodAmsiCall>>,
    ...
    pub file_accesses: Option<Vec<crate::models::FalconxPeriodFileAccess>>,
    #[serde(rename = "handles", skip_serializing_if = "Option::is_none")]
    pub handles: Option<Vec<crate::models::FalconxPeriodHandle>>,
    ...
    pub modules: Option<Vec<crate::models::FalconxPeriodModule>>,
    ...
    pub process_flags: Option<Vec<crate::models::FalconxPeriodProcessFlag>>,
    #[serde(rename = "registry", skip_serializing_if = "Option::is_none")]
    pub registry: Option<Vec<crate::models::FalconxPeriodRegistry>>,
    #[serde(rename = "script_calls", skip_serializing_if = "Option::is_none")]
    pub script_calls: Option<Vec<crate::models::FalconxPeriodScriptCall>>,
    #[serde(rename = "sha256", skip_serializing_if = "Option::is_none")]
    pub sha256: Option<String>,
    #[serde(rename = "streams", skip_serializing_if = "Option::is_none")]
    pub streams: Option<Vec<crate::models::FalconxPeriodStream>>,
