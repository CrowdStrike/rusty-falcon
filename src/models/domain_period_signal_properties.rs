...
pub struct DomainPeriodSignalProperties {
    ...
    pub assessment: Box<crate::models::DomainPeriodAssessment>,
    #[serde(rename = "assessment_items")]
    pub assessment_items: Box<crate::models::DomainPeriodAssessmentItems>,
    #[serde(rename = "cid")]
    pub cid: String,
...
impl DomainPeriodSignalProperties {
    pub fn new(
        aid: String,
        assessment: crate::models::DomainPeriodAssessment,
        assessment_items: crate::models::DomainPeriodAssessmentItems,
        cid: String,
