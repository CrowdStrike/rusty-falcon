...
pub struct PreventionPolicyV1 {
    ...
    pub ioa_rule_groups: Vec<models::IoaRuleGroupsRuleGroupV1>,
    ...
    pub prevention_settings: Vec<models::PreventionCategoryRespV1>,
}

impl PreventionPolicyV1 {
    /// A fully formed prevention policy
    pub fn new(cid: String, created_by: String, created_timestamp: String, description: String, enabled: bool, groups: Vec<models::HostGroupsHostGroupV1>, id: String, ioa_rule_groups: Vec<models::IoaRuleGroupsRuleGroupV1>, modified_by: String, modified_timestamp: String, name: String, platform_name: PlatformName, prevention_settings: Vec<models::PreventionCategoryRespV1>) -> PreventionPolicyV1 {
        PreventionPolicyV1 {
            cid,
            created_by,
            created_timestamp,
