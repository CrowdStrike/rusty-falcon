...
pub struct DetectsapiPeriodAggregationResult {
    /// collection of aggregate results matching the criteria
    #[serde(rename = "buckets")]
    pub buckets: Vec<models::DetectsapiPeriodAggregationResultItem>,
...
impl DetectsapiPeriodAggregationResult {
    pub fn new(buckets: Vec<models::DetectsapiPeriodAggregationResultItem>, name: String) -> DetectsapiPeriodAggregationResult {
        DetectsapiPeriodAggregationResult {
            buckets,
            name,
