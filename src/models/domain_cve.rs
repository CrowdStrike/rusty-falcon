...
impl DomainCve {
    pub fn new(actors: Vec<String>, base_score: f64, cisa_kev_info: models::DomainCisaKnownExploitedVulnerabilitiesInfo, cps_rating: models::DomainCpsRating, cvss_version: String, id: String, is_supported: bool, metadata_hash: i32, name: String, published_date: String, references: Vec<models::DomainReference>, severity: String, source: String, source_type: String, spotlight_published_date: String, types: Vec<String>, vector: String) -> DomainCve {
        DomainCve {
            actors,
