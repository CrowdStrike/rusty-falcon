...
impl DomainSignalProperties {
    pub fn new(aid: String, assessment: crate::models::DomainAssessment, assessment_items: crate::models::DomainAssessmentItems, cid: String, event_platform: String, modified_time: String, product_type_desc: String, sensor_file_status: String, system_serial_number: String) -> DomainSignalProperties {
