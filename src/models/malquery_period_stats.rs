...
pub struct MalqueryPeriodStats {
...
impl MalqueryPeriodStats {
    pub fn new(clean_count: i32, malware_count: i32, pua_count: i32, total_count: i32, unknown_count: i32) -> MalqueryPeriodStats {
        MalqueryPeriodStats {
            clean_count,
            malware_count,
            pua_count,
