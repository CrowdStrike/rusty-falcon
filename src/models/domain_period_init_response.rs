...
pub struct DomainPeriodInitResponse {
    ...
    pub scripts: Vec<models::DomainPeriodScriptHelp>,
    #[serde(rename = "session_id")]
    pub session_id: String,
}

impl DomainPeriodInitResponse {
    pub fn new(created_at: String, existing_aid_sessions: i32, offline_queued: bool, scripts: Vec<models::DomainPeriodScriptHelp>, session_id: String) -> DomainPeriodInitResponse {
