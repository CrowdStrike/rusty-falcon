...
pub struct ApiNotificationExposedDataRecordV1 {
    ...
    pub bot: Option<Box<models::ApiExposedDataRecordBotV1>>,
    /// The customer ID
    #[serde(rename = "cid")]
    pub cid: String,
    ...
    pub file: Option<Box<models::ApiExposedDataFileDetailsV1>>,
    #[serde(rename = "financial", skip_serializing_if = "Option::is_none")]
    pub financial: Option<Box<models::ApiExposedDataRecordFinancialV1>>,
    ...
    pub location: Option<Box<models::ApiExposedDataRecordLocationV1>>,
    ...
    #[serde(rename = "rule")]
    pub rule: Box<models::ApiRuleDetailsV1>,
    ...
    pub social: Option<Box<models::ApiExposedDataRecordSocialV1>>,
...
impl ApiNotificationExposedDataRecordV1 {
    pub fn new(author: String, cid: String, created_date: String, event_date: String, exposure_date: String, id: String, notification_id: String, raw_intel_id: String, rule: models::ApiRuleDetailsV1, site: String, source_category: String, user_uuid: String) -> ApiNotificationExposedDataRecordV1 {
