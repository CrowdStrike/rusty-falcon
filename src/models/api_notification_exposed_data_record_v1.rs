...
pub struct ApiNotificationExposedDataRecordV1 {
    ...
    #[serde(rename = "email_domain", skip_serializing_if = "Option::is_none")]
    ...
    pub file: Option<Box<crate::models::ApiExposedDataFileDetailsV1>>,
    #[serde(rename = "financial", skip_serializing_if = "Option::is_none")]
    pub financial: Option<Box<crate::models::ApiExposedDataRecordFinancialV1>>,
    ...
    #[serde(rename = "impacted_domain", skip_serializing_if = "Option::is_none")]
    pub impacted_domain: Option<String>,
    /// The IP where the credentials are valid
    #[serde(rename = "impacted_ip", skip_serializing_if = "Option::is_none")]
    pub impacted_ip: Option<String>,
    /// The URL where the credentials are valid
    #[serde(rename = "impacted_url", skip_serializing_if = "Option::is_none")]
    pub impacted_url: Option<String>,
    ...
    pub location: Option<Box<crate::models::ApiExposedDataRecordLocationV1>>,
    ...
    #[serde(rename = "rule")]
    pub rule: Box<crate::models::ApiRuleDetailsV1>,
    ...
    pub social: Option<Box<crate::models::ApiExposedDataRecordSocialV1>>,
...
impl ApiNotificationExposedDataRecordV1 {
    pub fn new(
        author: String,
        cid: String,
        created_date: String,
        ...
        raw_intel_id: String,
        rule: crate::models::ApiRuleDetailsV1,
        site: String,
        source_category: String,
        user_uuid: String,
    ) -> ApiNotificationExposedDataRecordV1 {
        ApiNotificationExposedDataRecordV1 {
            author,
            author_id: None,
            cid,
