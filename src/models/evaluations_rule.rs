...
pub struct EvaluationsRule {
    ...
    pub r#override: Option<Box<models::PolicyframeworkRuleOverride>>,
    #[serde(rename = "policy", skip_serializing_if = "Option::is_none")]
    pub policy: Option<Box<models::PolicyframeworkPolicyMetadata>>,
    ...
    pub rule_group: Option<Vec<models::PolicyframeworkRuleGroupMetadata>>,
    #[serde(rename = "threat", skip_serializing_if = "Option::is_none")]
    pub threat: Option<Box<models::EvaluationsThreat>>,
}

impl EvaluationsRule {
    pub fn new() -> EvaluationsRule {
        EvaluationsRule {
            alert_logic: None,
            controls: None,
            description: None,
