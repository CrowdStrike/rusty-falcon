...
pub struct ScheduledexclusionsScheduledExclusion {
    ...
    pub repeated: Option<Box<models::ScheduledexclusionsRepeated>>,
...
impl ScheduledexclusionsScheduledExclusion {
    pub fn new(id: String, name: String, timezone: String) -> ScheduledexclusionsScheduledExclusion {
        ScheduledexclusionsScheduledExclusion {
