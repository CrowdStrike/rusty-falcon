...
impl FwmgrApiNetworkLocationModifyRequestV1 {
    pub fn new(
        ...
        dns_resolution_targets: models::FwmgrDomainDnsResolutionTargets,
        dns_servers: Vec<String>,
        enabled: bool,
        host_addresses: Vec<String>,
        https_reachable_hosts: models::FwmgrDomainHttpsHosts,
        icmp_request_targets: models::FwmgrDomainIcmpTargets,
        id: String,
        name: String,
