...
pub struct K8sregGetScriptsResp {
    #[serde(rename = "errors")]
...
impl K8sregGetScriptsResp {
    pub fn new(errors: Vec<models::MsaspecError>, meta: models::MsaspecMetaInfo, resources: Vec<serde_json::Value>) -> K8sregGetScriptsResp {
