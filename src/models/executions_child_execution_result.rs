...
pub struct ExecutionsChildExecutionResult {
...
impl ExecutionsChildExecutionResult {
    pub fn new(id: String, iteration: i32, start_timestamp: String, status: String) -> ExecutionsChildExecutionResult {
        ExecutionsChildExecutionResult {
            end_timestamp: None,
            id,
            iteration,
            start_timestamp,
