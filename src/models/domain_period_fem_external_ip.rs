...
pub struct DomainPeriodFemExternalIp {
    /// AID if available
    ...
    pub cloud_vm: Option<Box<models::DomainPeriodExternalAssetCloudVm>>,
    ...
    pub location: Option<Box<models::DomainPeriodExternalAssetGeographicalLocation>>,
    /// The PTR record
...
impl DomainPeriodFemExternalIp {
    pub fn new() -> DomainPeriodFemExternalIp {
        DomainPeriodFemExternalIp {
            aid: None,
            asn: None,
            cloud_provider: None,
            cloud_vm: None,
