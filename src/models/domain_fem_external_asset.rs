...
impl DomainFemExternalAsset {
    pub fn new(applicable_actions: Vec<String>, asset_type: String, cid: String, confidence: i32, data_providers: Vec<String>, entity_type: String, id: String, status: String) -> DomainFemExternalAsset {
