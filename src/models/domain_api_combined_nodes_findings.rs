...
pub struct DomainApiCombinedNodesFindings {
    #[serde(rename = "aid")]
    pub aid: String,
...
impl DomainApiCombinedNodesFindings {
    pub fn new(aid: String, assessments: Vec<models::DomainAssetFinding>, cid: String) -> DomainApiCombinedNodesFindings {
        DomainApiCombinedNodesFindings {
            aid,
            assessments,
            cid,
