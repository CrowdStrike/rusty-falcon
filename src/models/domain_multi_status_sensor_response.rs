...
pub struct DomainMultiStatusSensorResponse {
    #[serde(rename = "aid")]
    pub aid: String,
...
impl DomainMultiStatusSensorResponse {
    pub fn new(aid: String, complete: bool, errors: Vec<models::MsaspecError>, offline_queued: bool, query_time: f64, session_id: String, stderr: String, stdout: String) -> DomainMultiStatusSensorResponse {
