...
pub struct ChangesAcl {
    #[serde(rename = "acl_permission_change", skip_serializing_if = "Option::is_none")]
    pub acl_permission_change: Option<Vec<models::ChangesAclChange>>,
