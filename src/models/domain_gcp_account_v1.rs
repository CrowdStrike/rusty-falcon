...
pub struct DomainGcpAccountV1 {
    ...
    #[serde(rename = "service_account_client_email", skip_serializing_if = "Option::is_none")]
    pub service_account_client_email: Option<String>,
    #[serde(rename = "service_account_client_id", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "service_account_private_key_id", skip_serializing_if = "Option::is_none")]
...
impl DomainGcpAccountV1 {
    pub fn new(created_at: String, deleted_at: String, id: i32, updated_at: String, cid: String, cspm_enabled: bool, gcp_permissions_status: Vec<models::DomainPermission>, parent_id: String, service_account_project_id: String) -> DomainGcpAccountV1 {
        DomainGcpAccountV1 {
            created_at,
            deleted_at,
            id,
