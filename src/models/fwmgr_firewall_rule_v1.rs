...
impl FwmgrFirewallRuleV1 {
    pub fn new(action: String, address_family: String, created_by: String, created_on: String, deleted: bool, description: String, direction: String, enabled: bool, family: String, fields: Vec<crate::models::FwmgrFirewallFieldValue>, icmp: crate::models::FwmgrFirewallIcmp, id: String, local_address: Vec<crate::models::FwmgrFirewallAddressRange>, local_port: Vec<crate::models::FwmgrFirewallPortRange>, monitor: crate::models::FwmgrFirewallMonitoring, name: String, platform_ids: Vec<String>, protocol: String, remote_address: Vec<crate::models::FwmgrFirewallAddressRange>, remote_port: Vec<crate::models::FwmgrFirewallPortRange>, rule_group: crate::models::FwmgrFirewallRuleGroupSummaryV1, version: i64) -> FwmgrFirewallRuleV1 {
        FwmgrFirewallRuleV1 {
            action,
            address_family,
            created_by,
