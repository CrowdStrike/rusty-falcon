...
pub struct ApiPeriodPatchRuleNotificationConfigV1 {
...
impl ApiPeriodPatchRuleNotificationConfigV1 {
    pub fn new() -> ApiPeriodPatchRuleNotificationConfigV1 {
        ApiPeriodPatchRuleNotificationConfigV1 {
            cid: None,
            config_id: None,
            plugin_id: None,
            recipients: None,
