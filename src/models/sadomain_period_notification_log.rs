...
impl SadomainPeriodNotificationLog {
    pub fn new(action: String, cid: String, created_date: String, details: String, id: String, message: String, notification_id: String, user_email: String, user_uuid: String, username: String) -> SadomainPeriodNotificationLog {
