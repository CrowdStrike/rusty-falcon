...
pub struct DeviceapiDeviceSwagger {
    ...
    pub device_policies: Option<Box<models::DeviceapiMappedDevicePoliciesSwagger>>,
...
impl DeviceapiDeviceSwagger {
    pub fn new(cid: String, device_id: String) -> DeviceapiDeviceSwagger {
