...
pub struct GraphDefinitionModel {
    ...
    pub activities: Option<std::collections::HashMap<String, models::GraphConfiguredActivity>>,
    #[serde(rename = "end", skip_serializing_if = "Option::is_none")]
    pub end: Option<Box<models::GraphEnd>>,
    /// Details all the sequence flows within the model. Each flow has a unique node ID as the key, that is set by the caller.
    #[serde(rename = "flows")]
    pub flows: std::collections::HashMap<String, models::GraphFlow>,
    ...
    pub gateways: Option<std::collections::HashMap<String, models::GraphGateway>>,
    ...
    pub sub_models: Option<std::collections::HashMap<String, models::GraphSubModel>>,
    #[serde(rename = "trigger")]
    pub trigger: Box<models::GraphConfiguredTrigger>,
}

impl GraphDefinitionModel {
    pub fn new(flows: std::collections::HashMap<String, models::GraphFlow>, node_registry: serde_json::Value, trigger: models::GraphConfiguredTrigger) -> GraphDefinitionModel {
