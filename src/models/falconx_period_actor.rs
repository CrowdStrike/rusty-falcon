...
pub struct FalconxPeriodActor {
    ...
    pub origins: Option<Vec<crate::models::FalconxPeriodEntity>>,
    ...
    pub target_countries: Option<Vec<crate::models::FalconxPeriodEntity>>,
    #[serde(rename = "target_industries", skip_serializing_if = "Option::is_none")]
    pub target_industries: Option<Vec<crate::models::FalconxPeriodEntity>>,
    #[serde(
...
impl FalconxPeriodActor {
    pub fn new() -> FalconxPeriodActor {
        FalconxPeriodActor {
