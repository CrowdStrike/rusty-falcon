...
pub struct FalconxPeriodActor {
    ...
    pub origins: Option<Vec<models::FalconxPeriodEntity>>,
    ...
    pub target_countries: Option<Vec<models::FalconxPeriodEntity>>,
    #[serde(rename = "target_industries", skip_serializing_if = "Option::is_none")]
    pub target_industries: Option<Vec<models::FalconxPeriodEntity>>,
    #[serde(
