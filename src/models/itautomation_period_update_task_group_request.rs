...
pub struct ItautomationPeriodUpdateTaskGroupRequest {
    ...
    #[serde(rename = "add_task_ids", skip_serializing_if = "Option::is_none")]
    pub add_task_ids: Option<Vec<String>>,
    ...
    #[serde(rename = "remove_task_ids", skip_serializing_if = "Option::is_none")]
    pub remove_task_ids: Option<Vec<String>>,
}

impl ItautomationPeriodUpdateTaskGroupRequest {
    pub fn new() -> ItautomationPeriodUpdateTaskGroupRequest {
        ItautomationPeriodUpdateTaskGroupRequest {
            access_type: None,
