...
pub struct ModelsApiAssessmentDetections {
...
impl ModelsApiAssessmentDetections {
    pub fn new(description: String, details: String, detection_type: String, id: String, image_architecture: String, image_created_at: String, image_digest: String, image_id: String, image_registry: String, image_repository: String, image_size: String, image_tag: String, name: String, os_name: String, os_version: String, remediation: String, severity: String, title: String) -> ModelsApiAssessmentDetections {
        ModelsApiAssessmentDetections {
            description,
            details,
            detection_type,
            id,
