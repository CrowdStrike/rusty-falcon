...
impl FwmgrPeriodApiPeriodNetworkLocationModifyMetadataRequestV1 {
    pub fn new(cid: String, dns_resolution_targets_polling_interval: i32, https_reachable_hosts_polling_interval: i32, icmp_request_targets_polling_interval: i32, location_precedence: Vec<String>) -> FwmgrPeriodApiPeriodNetworkLocationModifyMetadataRequestV1 {
