...
pub struct DeviceControlUsbClassExceptionsResponse {
    ...
    pub exceptions: Vec<models::DeviceControlExceptionRespV1>,
    /// USB Class id
    #[serde(rename = "id")]
    pub id: String,
}
...
impl DeviceControlUsbClassExceptionsResponse {
    pub fn new(action: Action, exceptions: Vec<models::DeviceControlExceptionRespV1>, id: String) -> DeviceControlUsbClassExceptionsResponse {
