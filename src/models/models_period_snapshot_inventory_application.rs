...
impl ModelsPeriodSnapshotInventoryApplication {
    pub fn new(major_version: String, package_hash: String, package_provider: String, package_source: String, path: String, product: String, software_architecture: String, r#type: String, vendor: String) -> ModelsPeriodSnapshotInventoryApplication {
