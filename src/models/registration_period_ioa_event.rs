...
pub struct RegistrationPeriodIoaEvent {
    ...
    pub aggregate: Option<Box<models::IoaPeriodEventAggregate>>,
    ...
    pub cloud_account_id: Option<Box<models::IoaPeriodCloudAccountId>>,
    ...
    pub enrichments: Option<Box<models::IoaPeriodEnrichments>>,
...
impl RegistrationPeriodIoaEvent {
    pub fn new(cid: String, cloud_provider: String, policy_id: i32, policy_statement: String, service: String, severity: String, state: String, vertex_id: String, vertex_type: String) -> RegistrationPeriodIoaEvent {
