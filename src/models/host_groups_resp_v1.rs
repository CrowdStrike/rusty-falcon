...
pub struct HostGroupsRespV1 {
    ...
    pub resources: Vec<models::HostGroupsHostGroupV1>,
}

impl HostGroupsRespV1 {
    pub fn new(errors: Vec<models::MsaspecError>, meta: models::MsaspecMetaInfo, resources: Vec<models::HostGroupsHostGroupV1>) -> HostGroupsRespV1 {
        HostGroupsRespV1 {
            errors,
            meta: Box::new(meta),
            resources,
