...
pub struct DomainPeriodFemEcosystemSubsidiary {
...
impl DomainPeriodFemEcosystemSubsidiary {
    pub fn new(children_count: i32, cid: String, id: String, name: String, parent_id: String, primary_domain: String) -> DomainPeriodFemEcosystemSubsidiary {
        DomainPeriodFemEcosystemSubsidiary {
            asset_count: None,
            children_count,
            cid,
            discovery: None,
