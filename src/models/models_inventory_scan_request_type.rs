...
pub struct ModelsInventoryScanRequestType {
    ...
    #[serde(rename = "high_entropy_strings", skip_serializing_if = "Option::is_none")]
    pub high_entropy_strings: Option<Vec<models::ModelsHeStringFileInfoType>>,
    #[serde(rename = "host_ip")]
    pub host_ip: String,
    #[serde(rename = "host_name")]
    pub host_name: String,
    #[serde(rename = "inventory")]
    pub inventory: Box<models::ModelsInventoryType>,
    ...
    pub scan_request: Box<models::ModelsScanRequestType>,
}

impl ModelsInventoryScanRequestType {
    pub fn new(agent_uuid: String, agent_version: String, agent_version_hash: String, cluster_id: String, cluster_name: String, helm_version: String, host_ip: String, host_name: String, inventory: models::ModelsInventoryType, original_image_name: String, runmode: String, scan_request: models::ModelsScanRequestType) -> ModelsInventoryScanRequestType {
