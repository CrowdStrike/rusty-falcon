...
pub struct EmpowerapiRemoteCommandPutFileV1 {
...
impl EmpowerapiRemoteCommandPutFileV1 {
    pub fn new(run_attempt_count: i32, run_success_count: i32, size: i32) -> EmpowerapiRemoteCommandPutFileV1 {
        EmpowerapiRemoteCommandPutFileV1 {
